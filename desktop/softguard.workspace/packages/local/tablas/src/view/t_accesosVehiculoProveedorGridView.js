Ext.define('Tablas.view.t_accesosVehiculoProveedorGridView', {
	extend: 'Ext.grid.GridPanel',
	alias: ['widget.t_accesosvehiculoproveedorgridview'],
	title: 'Templates',
	autoHeight: true,
	viewConfig: {
		trackOver: true,
...
//----------------------------------
		{
			...
			handler: function(grid, rowIndex, colIndex) {
				var view = this.up('t_accesosvehiculoproveedorgridview');
...
//-------------------------------		
		{
		     ...
		     items: [{
		         ...
		         handler: function(grid, rowIndex, colIndex,item, event) {
		             var view = grid.up('t_accesosvehiculoproveedorgridview');
