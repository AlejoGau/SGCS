Ext.define('Tablas.controller.t_accesosVehiculoProveedorGridController', {
    extend: 'Ext.app.Controller',
    //stores: ['SoftguardUsuarioTipoStore'],
    models: ['t_AccesosVehiculoProveedorModel','t_AccesosVehiculoProveedorSearchModel'],
    ...
    onAdd: function (grid, record, item, index, e, options) {
        ...
        var myobject = Ext.create('Tablas.model.t_AccesosVehiculoProveedorModel', {
