...
Ext.define('Cuenta.controller.SoftguardUsuarioGridController', {
    extend : 'Ext.app.Controller',
    stores : [ 'SoftguardUsuarioStore', 'SoftguardUsuarioTipoStore' ],
    models : [ 'Cuenta.model.m_usuariosModel','Cuenta.model.AC_UsuarioSearchModel' , 'SoftguardCuentaModel', 'SoftguardUsuarioModel','SoftguardVehiculosMatriculasCamaraModel' ],
    ...
    onAddClick: function(button,event,options){
        var view = button.up('gridvehicle');
        var myobject = Ext.create('Cuenta.model.m_usuariosModel', {
            usu_ntipo: 7,
