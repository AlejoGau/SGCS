Ext.define('Cuenta.view.m_usuariosFormView', {
	...
	},
	{
		...
		config: {
			...
			valueField: 'cue_iid',
			modelItems: 'Cuenta.model.CuentaSearchModel'
		},
		filter: [{
	...
	},
	{
		...
		maskRe: /[0-9]/,
		regex: /[0-9]/,
		regexText: getLocale('Debe ingresar máximo 12 caracteres'),
		hidden: true
	},
	{
		xtype: 'fieldset',
		...
		items: [
			...
			},
			{
				...
				// El store lo bindea m_usuariosFormController.initview. Referenciarlo aca por
				// storeId hace que el combo intente resolverlo en su initComponent, y si
				// todavia no esta instanciado tira 'Cannot read properties of undefined'.
			...
			{
				xtype: 'button',
				text: getLocale('Tomar un imagen'),
				style: {
					marginTop: '10px',
					marginBottom: '10px',
					width: '100%'
