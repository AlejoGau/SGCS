Ext.define('Cuenta.model.CuentaAwccSearchModel', {
    ...
    fields: [{
        ...
        {name:'cod_cdescripcionUAP',type:'string'},        
        {name:'cod_nColorLetraUAP',type:'string'},        
        {name:'cod_ncolorUAP',type:'string'},
        {name:'rec_tfechahoraUAP',type:'string'},
        ...
        {name:'rec_iPrioridad',type:'string'},
        ...
        {name:'_tfechahoraUAPOffzet', type:'date', dateFormat : 'n/j/Y g:i:s A'}  
    ...
    proxy : {
		...
		url : '/Rest/Search/CuentaByDealerAwcc',
		appendId : false,
        buildUrl : function(request) {
        	var me = this, 
            operation = request.operation || request._operation,
            params = request.params || request._params;
