//MIGRADO2024
Ext.define('Common.view.GenericRTSPVLCModeLinkFormView', {
    extend : 'Ext.form.Panel',
    alias : ['widget.genericrtspvlcmodelinkformview'], 
    items : [
        {xtype: 'textfield', fieldLabel: 'RTSP Link', name: '_rtsplink',allowBlank: false}, 
        {xtype: 'combobox', fieldLabel: 'Subtipo', name: '_rtsptcpforce',store:[['true','ForceTCP'],['false','NoForceTCP']], value:'false'}
     ...
     /*   {xtype: 'textfield', labelWidth: 100,fieldLabel: 'Uri', name: '_uri', allowBlank: false},
        ...
        ,{
            ...
            handler: function (button) {
                var view = button.up('genericrtspvlcmodelinkformview');
                var win = Ext.create('Ext.window.Window', {
                    ...
                    layout: 'fit',
                    items: {  
                        xtype: 'genericrtspvlcmodelinkgridview',
