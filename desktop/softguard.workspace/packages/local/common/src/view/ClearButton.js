...
Ext.define('Common.view.ClearButton', {
  ...
  calculateClearButtonPosition: function (textField) {
      var offsets = textField.getEl().getOffsetsTo(textField.up());//03/09/2024 Daniel O. Medina
      var x = offsets[0]+3;                                                           
      var y = offsets[1];                                                          
      if(textField.up().xtype=='fieldset'){
          y-=15;
      }
      ...
      if (this.textField.triggerWrap) {
          ...
          /* NO FUNCIONA EN SENCHA 7
          var totalTriggerWidth = 0;

          if (this.textField.triggerWrap && !this.textField.hideTrigger && !this.textField.readOnly) {
              totalTriggerWidth = this.textField.triggerEl.getCount() * this.textField.triggerWidth;
          }
      
          right += totalTriggerWidth
             */
