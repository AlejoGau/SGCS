//MIGRADO2024
Ext.define( 'Common.view.ServTecVisitaFormView', {
    extend: 'Ext.form.Panel',
    alias: [ 'widget.sertecvisitasformview' ],
    closeAction: 'destroy',
    preventHeader: true,
    fieldDefaults: {
        labelAlign: 'left',
            ...
            items: [
                {
                    ...
                    validator: function( value ) {
                        var view = this.up( 'sertecvisitasformview' )
                        ...
                        if( fechaHora && fecha && fechaHoraAntecesor >= fechaHora ) {
                            this.markInvalid( 'La fecha de inicio no puede ser inferior a la fecha de creacion de la visita.' );
            ...
            items: [
                {
                    ...
                    fieldLabel: 'Tiempo estimado de ejecucion',
                    itemId: 'svi_nDuracionEstimada',
                    value: 1,
                    minValue: 1,
                    maxValue: 999,
                    // DK-1552 P8: incremento/decremento de a 1 hora
                    step: 1,
                    allowDecimals: false,
                    flex: 1
                }, {
            ...
            items: [
                {
                    ...
                    validator: function( value ) {
                        ...
                        this.textValid = true;
                        if( fechaHora && fecha && fechaHoraAntecesor >= fechaHora ) {
                            this.markInvalid( 'La fecha de la salida del cliente no puede ser inferior a la fecha de creacion de la visita.' );
                            this.textValid = false;
                        }
                        return this.textValid;
                    }
    ...
    initComponent: function() {
        ...
        //this.addEvents( 'moviladded' );
        //this.addEvents( 'tecnicoadded' );
        this.callParent( arguments );
        this.down( 'servtectecnicovisitasgridview' ).record = this.record;
        this.down( 'servtecmovilvisitasgridview' ).record = this.record;
