//MIGRADO2024
Ext.define('Common.view.HIKLinkGridView', {
    extend : 'Ext.form.Panel',
    alias : ['widget.hiklinkgridview'],
    preventHeader: true,
    frame: false,
    fieldDefaults : {
        labelAlign : 'left',
    ...
    items : [
        ...
        items: [
            ...
            {xtype: 'textfield', fieldLabel: 'Port',  itemId: '_port',name: '_port', allowBlank: false},
            ...
            {xtype: 'textfield', fieldLabel: 'Cámara', itemId: '_camara',name: '_camara', allowBlank: false},
            {
                ...
                handler: function(button) {
                    var view = button.up('hiklinkgridview');
                    var instance = {
                    ...
                    items: [
                        {
                            ...
                            handler: function(grid, rowIndex, colIndex,item, event) {
                                var view = grid.up('hiklinkgridview');
    ...
    listeners: {
        afterrender: function(view){
            ...
            var store = Ext.create('Ext.data.Store',{
                model: 'Common.model.HIKLinkModel',
                proxy: {type: 'memory'}
            });
