//MIGRADO2024
Ext.define('Common.view.CuentaNotificacionesFromView', {
                            ...
                            items: [
                               
                                {
                                    ...
                                    items:[
                                        {
                                            xtype: 'combo',                                        
                                    		//store: Ext.create('DealerSearch' +'.store.TablaPlantillasSmsStore'),					
                                			displayField: 'pls_cdescripcion',								
                                			valueField: 'pls_ccodigo',
                                            fieldLabel: 'Plantilla Sms',
                                    ...
                                    xtype : 'combo',
                                    fieldLabel : 'Modem sms',
                                   // store: Ext.create('DealerSearch' +'.store.TablaModemsSmsStore'),
