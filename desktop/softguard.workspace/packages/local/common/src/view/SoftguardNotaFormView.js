//MIGRADO2024
Ext.define('Common.view.SoftguardNotaFormView', {
    ...
    items: [
        {
         ...
         , {
            ...
            items: [
                ...
                margin: '8px 8px 8px 8px',
                fieldLabel: 'Mostrar',
                name: 'cue_iInstrMostrar',
                itemId: 'cue_iInstrMostrar',
                editable: false,
                store: [
                    [ 0, getLocale( 'No' ) ],
                    [ 1, getLocale( 'Si' ) ],
               ...
               , //cierro panel*/
                {
                    ...
                    shrinkWrap: false,
                    flex: 1,
                    itemId: 'cue_cInstrucciones',
                    name : 'cue_cInstrucciones',
                    allowBlank : false,
                    translate:false
                }
            ]//cierro items panel
