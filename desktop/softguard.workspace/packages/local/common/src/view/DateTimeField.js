//MIGRADO2024
Ext.define('Common.view.DateTimeField', {
    ...
    mimicBlur: function(e) {
        ...
        var pickerIsNull = !picker;
        var isOutsidePicker = !e.within(picker.el, false, true);
        var isOutsideTimePicker = !e.within(picker.timePicker.el, false, true);
        
        // Combinar las condiciones
        if (pickerIsNull || (isOutsidePicker && isOutsideTimePicker)) {
    ...
    createPicker: function() {
        var me = this,
            ...
            config = Ext.merge({}, parentPicker.initialConfig, me.initialConfig);
            if (config.renderTo) {
                delete config.renderTo;
            }
        
        parentPicker.destroy();
        return Ext.create('Common.view.DateTimePicker', config);
    },
...
Ext.define('Common.view.DateTimePicker', {
