//MIGRADO2024
Ext.define('Common.view.DahuaLinkGridView', {
    extend : 'Ext.form.Panel',
    alias : ['widget.dahualinkgridview'],
    preventHeader: true,
    frame: false,
    fieldDefaults : {
        labelAlign : 'left',
    ...
    items : [
        ...
        items: [
            ...
            {xtype: 'numberfield', fieldLabel: 'Port',  itemId: '_port',name: '_port', allowBlank: false,maxValue: 65535,minValue: 1},
            ...
            {xtype: 'numberfield', fieldLabel: 'Cámara', itemId: '_camara',name: '_camara', allowBlank: false,maxValue: 128,minValue: 0},
            {xtype: 'combobox', fieldLabel: 'Subtipo',itemId: '_subtype', name: '_subtype',store:[[0,'Main Stream'],[1,'Sub Stream']], value:0},
            {
                xtype: 'button', 
                text:'Agregar',
                formBind : true,
                handler: function(button) {
                    var view = button.up('dahualinkgridview');
                    var instance = {
                        ...
                        _subtype: view.getForm().findField('_subtype').getValue()
                    };
                    ...
                    items: [
                        {
                            ...
                            handler: function(grid, rowIndex, colIndex,item, event) {
                                var view = grid.up('dahualinkgridview');
    ...
    listeners: {
        afterrender: function(view){
            ...
            view.down('#_subtype').setValue(formdata._subtype);
            ...
            var store = Ext.create('Ext.data.Store',{
                model: 'Common.model.DahuaLinkModel',
                proxy: {type: 'memory'}
            });
