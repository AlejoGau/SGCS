...
Ext.define('Common.model.GpsHistoricoSearchModel', {
    ...
    fields: [
		...
		,{name : 'rxt_iRouteID',type : 'int',defaultValue : 0}
		,{name : 'cue_iid',type : 'int'}
    ],
	proxy : {
		type : 'rest',
		//url : '/Rest/Search/TGPosicionesGPS',
		url : '/Rest/Search/TrackGuard_PosicionesGPS_Hist',
		appendId : false,
        reader: {
            type : 'json',
            rootProperty : 'rows',
