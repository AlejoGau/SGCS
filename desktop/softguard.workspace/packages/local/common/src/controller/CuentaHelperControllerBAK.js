//MIGRADO2024
Ext.define('Common.controller.CuentaHelperControllerBAK', {
    extend : 'Ext.app.Controller',
    stores : [ 'Common.store.ProvinciasStore' ],
    models : [ 'ProvinciasModel', 'CuentaSearchModel' ],
    views : [ 'CuentaHelperViewBAK' ],
    ...
    evaluarColumnasHide : function (view) {
        if(view.columnHide) {            
            ...
            Ext.Array.each(arrColumnId, function(value){
                ...
                view.columns[value].setTriggerVisible(false)              
            })            
        }
    },
