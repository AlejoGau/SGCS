//MIGRADO2024
Ext.define('Common.controller.p_controlAcceso_AutorizacionFormController', {
    extend : 'Ext.app.Controller',
    stores : [  ],
    models : [ 'p_controlAcceso_AutorizacionModel' ],
	...
	initview : function(view) {
        ...
        if(view.record.get('Id') != 0) {
               ...
               view.down('#caa_diasemana').setValue({
                    caa_diasemana: [view.record.get('caa_diasemana')]
               });
               
               view.down('checkboxgroup').down('[inputValue='+view.record.get('caa_diasemana')+']').show()
	...
	onSaveClick : function(button, event, options) {
        ...
        if (myform.isValid()){
            ...
            if(view.record.get('Id') != 0) {
                ...
                myobject.set('caa_diasemana',view.down('#caa_diasemana').getValue().caa_diasemana[0])
        		record.save({
        			scope : this,
