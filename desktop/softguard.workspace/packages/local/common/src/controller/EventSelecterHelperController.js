//MIGRADO2024
Ext.define('Common.controller.EventSelecterHelperController', {
    extend : 'Ext.app.Controller',
    stores : [ 'Common.store.SoftguardAlarmasSmsStore' ],
    models : [ 'SoftguardCodigoAlarmaModel' ],
    views : [ 'EventSelectField', 'EventSelecterHelperView' ],
    ...
    onEventoClick: function (btn) {
        ...
        if(view.eventosSeleccionados == undefined){
            view.eventosSeleccionados = "";
        }
