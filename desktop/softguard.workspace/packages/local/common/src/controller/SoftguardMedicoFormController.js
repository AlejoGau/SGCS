//MIGRADO2024
Ext.define('Common.controller.SoftguardMedicoFormController', {
    extend : 'Ext.app.Controller',
    stores : [ 'Common.store.ComboMedicosStore', 'Common.store.ComboObrasSocialesStore', 'Common.store.SoftguardGeneroStore' ],
	models : [ 'TablaMedicosModel', 'TablasMedicosSearchModel' ],
	views : [ 'SoftguardMedicoFormView' ],
