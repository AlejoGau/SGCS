//MIGRADO2024
Ext.define('Common.store.CuentaAccesoSecurityModulesStore', {
    ...
    data : [
		{
			...
			profile: '0',
			view : 'panelview',
			//Federico Vazquez. Dejo comentado el viewconfig porque se pidio en la tarea DS 749 que el boton nuevo panel este disponible.
