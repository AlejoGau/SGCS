Ext.define('WeSafe.controller.WeSafeDeniedController', {
    extend: 'Ext.app.Controller',
    stores: ['WeSafeEventosInformadosStore'],
    views: ['WeSafeDeniedView'],

    init: function () {
        this.control({
            'WeSafeDeniedView grid': {
                afterrender: this.initView
            },
            'WeSafeDeniedView button[text="En Revision"]': {
    ...
    initView: function (grid) {
        ...
        store.load({
            params: { estado: 'Denegado' },
            callback: function (records, operation, success) {
                console.log('Datos cargados en el store:', records);
                if (success) {
        ...
        Ext.Ajax.request({
            ...
            success: function (response) {
                ...
                if (result.success) {
                    ...
                    grid.getStore().reload({ params: { estado: 'Denegado' } });
                } else {
