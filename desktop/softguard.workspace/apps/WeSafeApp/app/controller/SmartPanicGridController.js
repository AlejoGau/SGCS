Ext.define('WeSafe.controller.SmartPanicGridController', {
   extend: 'Common.controller.SmartPanicGridController',
...
onSinAsignarClick: function(button, event, options ) {
    ...
    console.log("AQUI - SmartpanicGridController SinAsignar")
