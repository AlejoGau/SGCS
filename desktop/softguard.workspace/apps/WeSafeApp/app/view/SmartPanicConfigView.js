    ...
    items: [
        {
            ...
            items: [
                        ...
                        },*/
                        {
                            ...
                            items: [
                                ,{
                                    ...
                                    fieldLabel : 'Segundos',
                                    itemId : 'cancelacionalarma',
                                    name : 'cancelacionalarma',
                                    margin : '10px 0',
                                }
                            ]
                        },{
                            ...
                            items: [
                                {
                                    ...
                                    store: [ [ 0, getLocale( 'No habiltado' ) ], [ 1, getLocale( 'Botón blanco' ) ], [ 2, getLocale( 'Botón V.ALERT' ) ],[3,getLocale('Botón BT-650')] ],
                                    margin: '0 0 10 0'
                                }
                            ]
                        }, {
                ...
                , {
                    ...
                    xtype: 'container',
                    layout: 'fit', // Ajusta la vista a todo el contenedor
                    itemId: 'moderacionContainer', // Identificador del container
                    title: getLocale('We Safe'),
                    items: [
                        {
                            xtype: 'WeSafeModerationView' // Carga directamente la vista de moderación
                        }
                    ]
                }
                ...
                /*{
                    xtype: 'container',
                    layout: 'vbox', // Apila elementos verticalmente
                    ...
                    items: [
                        {
                            ...
                            listeners: {
                                change: function (field, newValue) {
                                    // Deshabilita los otros switches si "Aprobar todos" está activo
                        ...
                        },
                        {
                            ...
                            handler: function () {
                                ...
                                var data = {
                                    aprobarTodos: container.down('#chkAprobarTodos').getValue(),
                                    soloTexto: container.down('#chkSoloTexto').getValue(),
                                    enlaceWeb: container.down('#chkEnlaceWeb').getValue(),
                                    emails: container.down('#chkEmails').getValue(),
                                    telefonos: container.down('#chkTelefonos').getValue(),
                                    instagram: container.down('#chkInstagram').getValue()
                                };
                
                                // Enviar datos a la API para almacenarlos en la tabla Moderacion
                                Ext.Ajax.request({
                                    url: '/api/moderacion/save',
                                    method: 'POST',
                                    jsonData: data,
                                    success: function (response) {
                                        Ext.Msg.alert('Éxito', 'Configuración guardada correctamente.');
                                    },
                                    failure: function () {
                                        Ext.Msg.alert('Error', 'No se pudo guardar la configuración.');
                                    }
                                });
                            }
                        }
