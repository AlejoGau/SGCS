Ext.define('WeSafe.view.WeSafeDeniedView', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.WeSafeDeniedView',
    title: 'En Revisión',
    layout: 'fit',
    height: 500,
                ...
                listeners: {
                    itemclick: function (view, record, item, index, e) {
                        ...
                        if (target) {
                            ...
                            var controller = WeSafe.app.getController('WeSafe.controller.WeSafeDeniedController');
                    ...
                    items: [
                        {
                            ...
                            handler: function () {
                                var controller = WeSafe.app.getController('WeSafe.controller.WeSafeDeniedController');
                                controller.handleChangeEstado(this, 1);
                            }
                        }
                    ]
                },
