Ext.define('SgAppAccessControl.controller.AC_accessControlProveedorFormController', {
    extend : 'Ext.app.Controller',
    stores : [ 'Common.store.SoftguardUsuarioTipoStore' ],
    models : [ 'm_AccesosProveedoresModel','m_ProveedorSearchModel'],
	views : [ 'SgAppAccessControl.view.AC_accessControlProveedorFormView' ],
    ...
    onUploadImgClick: function(button, event, options) {
        ...
        var model = this.getM_AccesosProveedoresModelModel();//Ext.ClassManager.get('SgAppAccessControl.model.m_AccesosProveedoresModel')
