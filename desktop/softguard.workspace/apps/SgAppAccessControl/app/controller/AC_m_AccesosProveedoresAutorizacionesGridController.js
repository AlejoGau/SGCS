Ext.define('SgAppAccessControl.controller.AC_m_AccesosProveedoresAutorizacionesGridController', {
    ...
    views: ['AC_m_AccesosProveedoresAutorizacionesGridView'],

    init: function (config) {
        // genero los eventos
        this.control({
            'ac_m_accesosproveedoresautorizacionesgridview': {
            ...
            'ac_m_accesosproveedoresautorizacionesgridview button[action=search]': {
                click: this.onSearchClick
            },
            'ac_m_accesosproveedoresautorizacionesgridview button[action=getall]': {
                click: this.onGetAllClick
            },
            /*    'p_controlacceso_autorizacionview button[action=add]': {
                    click: this.onAdd
                },*/
            'ac_m_accesosproveedoresautorizacionesgridview button[action="delete"]': {
                click: this.onDeleteClick
            },
            'ac_m_accesosproveedoresautorizacionesgridview button[action="filterActivas"]': {
                click: this.onFilterActivasClick
            },
            'ac_m_accesosproveedoresautorizacionesgridview button[action="filterVencidas"]': {
                click: this.onFilterVencidasClick
            },
            'ac_m_accesosproveedoresautorizacionesgridview button[action="nuevaAutorizacion"]': {
                click: this.onNewAutorizacionClick
            },
            'ac_m_accesosproveedoresautorizacionesgridview button[action=export]' : {
    ...
    onItemClick: function (grid, record, item, index, e, options) {
        ...
        var _record = model.load(record.get('Id'), {callback: function(r){
            r.set("usu_cnombre",record.get('apr_cNombre'));
    ...
    onGetAllClick: function (button, event, options) {
        var view = button.up('ac_m_accesosproveedoresautorizacionesgridview');
