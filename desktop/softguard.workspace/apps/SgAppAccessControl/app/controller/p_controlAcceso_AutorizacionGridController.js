Ext.define('SgAppAccessControl.controller.p_controlAcceso_AutorizacionGridController', {
    extend: 'Ext.app.Controller',
    stores: [],
    models: ['p_controlAcceso_AutorizacionSearchModel'
    ...
    init: function (config) {
        ...
        this.control({
            ...
            'p_controlacceso_autorizacionview button[action="filterActivas"]': {
                click: this.onFilterActivasClick
            },
            'p_controlacceso_autorizacionview button[action="filterVencidas"]': {
                click: this.onFilterVencidasClick
            },
            'p_controlacceso_autorizacionview button[action="nuevaAutorizacion"]': {
                click: this.onNewAutorizacionClick
            },
            'p_controlacceso_autorizacionview button[action=export]' : {
    ...
    initView: function (view) {
        ...
        view.filters = [];
        if (view.record) {
            if(view.record.get('usu_idKey'))
                view.down('#nuevaAutorizacion').setVisible(true);
            else
    ...
    onExportarClick: function (button, event, options) {
        ...
        var baseurl = '/handler/ReporteACAutorizacionesHTML';
