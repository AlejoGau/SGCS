Ext.define('SgAppAccessControl.model.p_controlAcceso_IOSearchModel', {
    ...
    fields: [{
        ...
        {name:'_cac_autorizatipo',type:'string', convert:function (value,record) {
            if(record.get('cac_autorizadotipoid')==3227){// solo para proveedor
                return getLocale('PROVEEDOR')
