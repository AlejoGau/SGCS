Ext.define('SgAppAccessControl.model.AC_UsuarioSearchModel', {
    ...
    fields: [{
        ...
        {name:'DomainManipulated', type:'string', convert: function (value, record) {
                let usu_cmetadata = record.get('usu_cmetadata')
                let DomainManipulated = ""
                if ( usu_cmetadata != "" ) {
                    let json = JSON.parse(usu_cmetadata)
                    DomainManipulated = json.domain ? json.domain : ""
                }                
