Ext.define('Administrator.store.AdministratorSecurityModulesStore', {
    extend : 'Ext.data.Store',
    model : 'Administrator'+'.model.ModuleModel',
    id: 'AdministratorSecurityModulesStore',
    data : [
            {
				text : 'Cuenta',
				iconCls : 'icon-cuenta',
				...
				leaf : true,
                profile: '0',
				//Daniel O. Medina 17/04/2024 anulo vista porque da error en admin cuentas para abrir la view viewConfig : '{property: \'zon_ccodigo:like\',value: \'PAR\',id:\'zon_ccodigo\'}]}', //coment oesto porque no muestra particiones {property: \'tip_ntipo:NOT\',value: \'8\',id:\'tip_ntipo\'},
                closable: true,
                closeAction: 'destroy'
			}, {
				text : 'Notas',
	...
	/*
	// dedalo 2019/12/18 copio webdealer pedido por leo.
	 [
            {
    			text : 'Cuenta',
				iconCls : 'icon-cuenta',
