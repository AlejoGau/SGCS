    ...
    Ext.define('Administrator.view.ClearButton', {
        ...
        calculateClearButtonPosition: function(textField) {
            ...
            if (this.textField.triggerWrap) {
               // Suponiendo que 'miCampo' es tu campo de entrada (field)
                var triggers = textField.getTriggers();
                // Verificamos si existen disparadores asociados al campo de entrada
                if (triggers) {
                    // Iteramos sobre cada disparador
                    triggers.forEach(function(trigger) {
                        // Accedemos al ancho del disparador
                        var triggerWidth = trigger.getSize();
                        console.log('Ancho del disparador:', triggerWidth);
                    });
                }
