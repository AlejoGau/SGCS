Ext.define('GestorSim.view.ComandosGpsConfigView', {
                    ...
                    columns: [
                        ...
                        { 
                            ...
                            renderer: function(value, metadata,record){
                                var result = '';
                                try {
                                    // var parametros = Ext.JSON.decode(record.get('Config'));
                                    var parametros = JSON.parse(record.get('Config'));
                                    if (parametros.icon){
                                        result = '<img src="/Gallery/SmartPanics/Comandos/' +parametros.icon + '" width="16" heigth="16" style="background-color:GRAY" >';
                                    }
                                }
                                catch (e){
                                    console.log(e);
                        ...
                        { 
                            ...
                            renderer: function(value, metadata, record, rowIndex, colIndex, store, gridView){
                                ...
                                if (comando)
                                return comando.get('tcm_cdescripcion');
                            }
                        }
                    ]
                },//{
