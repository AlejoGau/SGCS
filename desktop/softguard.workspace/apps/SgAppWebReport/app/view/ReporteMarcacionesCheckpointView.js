Ext.define('SgAppWebReport.view.ReporteMarcacionesCheckpointView', {
    extend: 'Ext.panel.Panel',
    alias: 'widget.marcacionescheckpointview',
            ...
            items: [
                {
                    ...
                    /*handler: function (button) {
                        var iframe = button.up('marcacionescheckpointview').down('#Iframe');
                                            ...
                                            items: [
                                                {
                                                    ...
                                                    listeners: {
                                                        click: function (button) {
                                                            button.up('marcacionescheckpointview').down('#idcuenta').setValue('')
                                                            button.up('marcacionescheckpointview').down('#nombrecuenta').setValue('')
                                                            button.hide()
                                                        }
                                                    }
                                                }, {
                                    ...
                                    items: [
                                        {
                                            xtype: 'checkbox',
                                            labelWidth: 120,
                                            fieldLabel: 'Agrupar por usuario',
                                            itemId: 'checkboxuser',
                                        }
                                    ]
                                }
