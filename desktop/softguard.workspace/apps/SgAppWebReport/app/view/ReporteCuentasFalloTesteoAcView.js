Ext.define('SgAppWebReport.view.ReporteCuentasFalloTesteoAcView', {
    extend : 'Ext.panel.Panel',
    alias : 'widget.reportecuentafallotesteoacview',
            ...
            items: [
                {
                    ...
                    /*handler: function(button){
                        var iframe = button.up('reportecuentafallotesteoacview').down('#Iframe');
