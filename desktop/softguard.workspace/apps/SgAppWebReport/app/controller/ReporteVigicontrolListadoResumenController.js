Ext.define('SgAppWebReport.controller.ReporteVigicontrolListadoResumenController',{
    extend: 'Ext.app.Controller',
    stores: [],
    models: [],
    views:  ['ReporteVigicontrolListadoResumenView'],

    init : function(config) {
        // genero los eventos
        this.control({
            'reportevigicontrollistadoresumenview' : {
            ...
            'reportevigicontrollistadoresumenview button[action=search]' : {
                click: this.onSearchClick
            },
            'reportevigicontrollistadoresumenview button[action=btnprint]': {
                click: this.onBtnprintClick
            }, 
            'reportevigicontrollistadoresumenview button[action=export]' : {
                click: this.onExportClick
            },
            'horasvigiladorpornombreobjetivoview button[action=exportSplit]' : {
                click: this.onExportClick
            },
            //DS-645|adrianlara|20230427 => se agrega handler para poder seleccionar una cuenta
            'reportevigicontrollistadoresumenview button[action=seleccionarCuenta]' : {
    ...
    initView: function(view) {
        ...
        */
        ...
        view.baseurl =  '/handler/ReporteVigicontrolListadoResumenHTML';
    ...
    onSearchClick : function(button, event, options) {
        var view = button.up('reportevigicontrollistadoresumenview');
        var controller = this;
