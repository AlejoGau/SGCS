Ext.define('SgAppWebReport.controller.HorasVigiladorPorNombreobjetivoController', {
    extend : 'Ext.app.Controller',
    stores : [  ],
    models : [  ],
    views : [ 'HorasVigiladorPorNombreobjetivoView' ],

    init : function(config) {
        // genero los eventos
        this.control({
            'horasvigiladorpornombreobjetivoview' : {
            ...
            'horasvigiladorpornombreobjetivoview button[action=search]' : {
                click: this.onSearchClick
            },
            'horasvigiladorpornombreobjetivoview button[action=btnprint]': {
                click: this.onBtnprintClick
            }, 
            'horasvigiladorpornombreobjetivoview button[action=export]' : {
            ...
            'horasvigiladorpornombreobjetivoview button[action=seleccionarCuenta]' : {
    ...
    initView: function(view) {
        ...
        */
        ...
        view.baseurl =  '/handler/ReporteListadoGeneralHorasVigiladorObjetivoHTML';
