Ext.define('SgAppWebReport.controller.ReporteMarcacionesDiaController', {
    extend: 'Ext.app.Controller',
    stores: [  ],
models: [ 'TablaHistoricoAsignacionSearchModel' ],
views: [ 'ReporteMarcacionesDiaView' ],
...
init: function(config ) {
    ...
    this.control( {
        ...
        'marcacionesdiaview button[action=search]': {
            click: this.onSearchClick
        },
        'marcacionesdiaview button[action=export]': {
            click: this.onExportClick
        },
        'marcacionesdiaview button[action=seleccionarCuenta]': {
            click: this.onSeleccionarCuenta
        },
        'marcacionesdiaview #combohistorico': {
            select: this.onComboHistoricoSelect,
            change: this.onCleanDates
        },
        'marcacionesdiaview button[action=btnprint]': {
...
initView: function(view ) {
    ...
    view.baseurl =  '/handler/ReporteMarcacionesDiaHTML';
...
onBtnprintClick: function (button) {
    var view = button.up('marcacionesdiaview');
    var target = view.down('#Iframe');
    url = target.src;
    var contenido;
    fetch(url)
...
onComboHistoricoSelect: function(combo, records, options ) {
    var view = combo.up('marcacionesdiaview');
