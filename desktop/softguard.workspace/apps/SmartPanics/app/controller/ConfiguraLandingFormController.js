Ext.define('SmartPanics.controller.ConfiguraLandingFormController', {
	...
	onSaveClick : function(button, event, options) {
        ...
        if( myform.isValid() ) {
            ...
            var id = record.get('lcfg_iid');            
            var filter = [ {"property":"lcfg_iid", "value":id} , {"property":"lcfg_ccontent", "value":content} ]
        Ext.Ajax.request({
