Ext.define('WebManager.controller.WebManagerInformacionDeCuentasController', {
    extend : 'Ext.app.Controller',
    stores : [  ],
    models : [  ],
    views : [ 'WebManagerInformacionDeCuentasView', 'chartestadodecuentasview' ],
    ...
    init : function(config) {
       this.control({
            'webmanagerinformaciondecuentasview' : {
