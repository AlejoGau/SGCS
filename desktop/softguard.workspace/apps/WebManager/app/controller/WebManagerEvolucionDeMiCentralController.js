Ext.define('WebManager.controller.WebManagerEvolucionDeMiCentralController', {
    extend : 'Ext.app.Controller',
    stores : [  ],
    models : [  ],
    views : [ 'WebManagerEvolucionDeMiCentralView', 'chartevolucioncuentas12mesesview', 'chartevolucionsmartpanicsview' ],
    ...
    initView : function(view, record, recordsLogueado) {
        var controller = this;
    ...
    init : function(config) {
       this.control({
            'webmanagerevoluciondemicentralview' : {
