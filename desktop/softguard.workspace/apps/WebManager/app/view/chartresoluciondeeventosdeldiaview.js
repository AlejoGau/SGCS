Ext.define('WebManager.view.chartresoluciondeeventosdeldiaview', {
    extend : 'Ext.chart.PolarChart',
    alias : 'widget.chartresoluciondeeventosdeldiaview',
                ...
                var myWindow = Ext.widget('window',{
                    ...
                    items:[{
                        ...
                        items: [{
                            ...
                            xtype: 'chartresoluciondeeventosdeldiaFULLview',
                            flex: 1,
                            layout: 'fit',
                            margin: 0
                        }]
    ...
    initComponent: function () {
        ...
        var myModel = Ext.define('chartresoluciondeeventosdeldiaModel1', {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            alias: 'store.chartresoluciondeeventosdeldia',
            ...
            proxy: {
                ...
                url: '/Rest/search/ResolucionDeEventosDelDia'
            }
        });
