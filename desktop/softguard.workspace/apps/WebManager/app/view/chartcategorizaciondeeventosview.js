Ext.define('WebManager.view.chartcategorizaciondeeventosview', {
    extend : 'Ext.chart.CartesianChart',
    alias : 'widget.chartcategorizaciondeeventosview',
    ...
    initComponent: function () {
        ...
        var myModel = Ext.define('chartcategorizaciondeeventosModel', {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            alias: 'store.chartcategorizaciondeeventos',
            ...
            proxy: {
                ...
                url: '/Rest/search/CategorizacionDeEventos'
            } 
        });
