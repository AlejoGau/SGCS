Ext.define('WebManager.view.chartevolucioncuentas12mesesview', {
    extend : 'Ext.chart.CartesianChart',
    alias : 'widget.chartevolucioncuentas12mesesview',
    itemId: 'chartevolucioncuentas12mesesview',
        ...
        items: [
             '->', 
             {
                ...
                handler: function(btn){
                    var view = btn.up('chartevolucioncuentas12mesesview');
    ...
    initComponent: function () {
        ...
        var myModel = Ext.define('chartevolucioncuentas12mesesModel', {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            alias: 'store.chartevolucioncuentas12meses',
            ...
            proxy: {
                ...
                url: '/Rest/search/EvolucionCuentas12meses'
            },
