Ext.define('WebManager.view.chartevolucionvigicontrolview', {
    extend : 'Ext.chart.CartesianChart',
    alias : 'widget.chartevolucionvigicontrolview',
    itemId: 'chartevolucionvigicontrolview',
        ...
        items: [
             '->', 
             {
                ...
                handler: function(btn){
                    var view = btn.up('chartevolucionvigicontrolview');
    ...
    initComponent: function () {
        ...
        var myModel = Ext.define('chartevolucionvigicontrolview', {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            alias: 'store.chartevolucionvigicontrolview',
            ...
            proxy: {
                ...
                url: '/Rest/search/evolucionvigicontrol'
            },
