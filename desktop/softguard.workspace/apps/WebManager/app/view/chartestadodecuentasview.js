Ext.define('WebManager.view.chartestadodecuentasview', {
    extend : 'Ext.chart.PolarChart',
    alias : 'widget.chartestadodecuentasview',
    ...
    initComponent: function () {
        ...
        var myModel = Ext.define('chartestadodecuentasModel', {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            alias: 'store.chartestadodecuentas',
            ...
            proxy: {
                ...
                url: '/Rest/search/EstadoDeCuenta'
            } 
        });
