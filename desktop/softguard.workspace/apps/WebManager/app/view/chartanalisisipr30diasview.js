Ext.define('WebManager.view.chartanalisisipr30diasview', {
    extend : 'Ext.chart.PolarChart',
    alias : 'widget.chartanalisisipr30diasview',
                ...
                var myWindow = Ext.widget('window',{
                    ...
                    items:[{
                        ...
                        items: [{
                            ...
                            xtype: 'chartanalisisipr30diasFULLview',
                            flex: 1,
                            layout: 'fit'
                        }]
    ...
    initComponent: function () {
        ...
        var myModel = Ext.define('chartanalisisipr30diasModel', {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            alias: 'store.chartanalisisipr30dias',
            ...
            proxy: {
                ...
                url: '/Rest/search/AnalisisIPR30Dias'
            } 
        });
