Ext.define('WebManager.view.charteventosautoprocesadosdeldiaFULLview', {
    extend : 'Ext.chart.PolarChart',
    alias : 'widget.charteventosautoprocesadosdeldiaFULLview',
    ...
    initComponent: function () {
        ...
        var myModel = Ext.define('charteventosautoprocesadosdeldiaview1', {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            alias: 'store.charteventosautoprocesadosdeldiaview1',
