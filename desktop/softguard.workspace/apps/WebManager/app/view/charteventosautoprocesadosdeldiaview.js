Ext.define('WebManager.view.charteventosautoprocesadosdeldiaview', {
    extend : 'Ext.chart.PolarChart',
    alias : 'widget.charteventosautoprocesadosdeldiaview',
                ...
                var myWindow = Ext.widget('window',{
                    ...
                    items:[{
                        ...
                        items: [{
                            ...
                            xtype: 'charteventosautoprocesadosdeldiaFULLview',
                            flex: 1,
                            layout: 'fit'
                        }]
                    }]
    ...
    initComponent: function () {
        ...
        var myModel = Ext.define('charteventosautoprocesadosdeldiaview2', {
        ...
        var myStore = Ext.create('Ext.data.Store', {
            alias: 'store.charteventosautoprocesadosdeldiaview2',
            ...
            proxy: {
                ...
                url: '/Rest/search/SearchEventosAutoprocesadosDelDia'
            } 
        });
