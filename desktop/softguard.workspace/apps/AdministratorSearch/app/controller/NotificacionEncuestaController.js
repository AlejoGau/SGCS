Ext.define('AdministratorSearch.controller.NotificacionEncuestaController', {
       ...
       // console.log(view.record.data.lin_ccodigo)
        ...
        notifStore.load({
            callback: function(records, operation, success) {
                if(records[0].raw.rows.length>0)
                    controller.loadData(records[0].raw.rows[0].Id,view);
                else
