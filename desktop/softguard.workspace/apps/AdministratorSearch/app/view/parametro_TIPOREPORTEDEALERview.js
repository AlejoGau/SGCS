Ext.define('AdministratorSearch.view.parametro_TIPOREPORTEDEALERview', {
    extend : 'Ext.form.Panel',
    alias : 'widget.parametro_TIPOREPORTEDEALERview',
    preventHeader: true,
    frame: true,
    border : 0,
    fieldDefaults : {
    ...
    items:[{
        ...
        items: [{
            ...
            validator: function(v){
                ...
                var view = this.up('parametro_TIPOREPORTEDEALERview');
            ...
            listeners:{
                change: function (combo, value) {
                    var view = combo.up('parametro_TIPOREPORTEDEALERview')
                    if(value == 1) {
            ...
            listeners : {
                sync: function(editor, html){
                    var view = editor.up('parametro_TIPOREPORTEDEALERview');
                },
                change : function (textareafield, value, e, eOpts) {
                    var view = textareafield.up('parametro_TIPOREPORTEDEALERview');
                    view.down('#pdfAttach').validate();
