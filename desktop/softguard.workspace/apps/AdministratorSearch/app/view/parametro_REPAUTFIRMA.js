Ext.define('AdministratorSearch.view.parametro_REPAUTFIRMA', {
    extend : 'Ext.form.Panel',
    alias : ['widget.parametro_REPAUTFIRMA'],
    preventHeader: true,
    frame: true,
    border : 0,
    fieldDefaults : {
       ...
       {    
            ...
            listeners:{
                change: function (combo, value) {
                    var view = combo.up('parametro_REPAUTFIRMA')
        ...
        /* Nuevo para el agregado de Logo y Texto */
        {
            ...
            items:[
                {
                    ...
                    listeners : {
                        change : function (button, value) {
                            var view = button.up('parametro_REPAUTFIRMA')
                            view.calculateValues();
                        }
                    }
        		},{
            ...
            listeners : {
                change : function (textareafield, value, e, eOpts) {
                    var view = textareafield.up('parametro_REPAUTFIRMA');
                    view.calculateValues();
                }                
            },
            maxLength : 300
