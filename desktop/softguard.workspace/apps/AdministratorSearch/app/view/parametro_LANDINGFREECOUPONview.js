Ext.define('AdministratorSearch.view.parametro_LANDINGFREECOUPONview', {
    extend : 'Ext.form.Panel',
    alias : 'widget.parametro_LANDINGFREECOUPONview',
    preventHeader: true,
    frame: true,
    border : 0,
    fieldDefaults : {
    ...
    items:[{
        ...
        listeners : {
            change : function (textareafield, value, e, eOpts) {
                var view = textareafield.up('parametro_LANDINGFREECOUPONview');
