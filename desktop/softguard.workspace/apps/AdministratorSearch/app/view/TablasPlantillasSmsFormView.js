Ext.define( 'AdministratorSearch.view.TablasPlantillasSmsFormView', {
    extend: 'Ext.form.Panel',
    alias: [ 'widget.tablasplantillassmsformview' ],
    preventHeader: true,
    frame: true,
    border: 0,
    fieldDefaults: {
                    ...
                    store.load( {
                        callback: function( records, operation, success ) {
                            if( records.length > 0 ) {
                                ...
                                t.textValid = false;
                                t.up( 'tablasplantillassmsformview' ).down( '#save' ).setDisabled( true );
                            } else {
                                t.clearInvalid();
                                t.textValid = true;
                                t.up( 'tablasplantillassmsformview' ).down( '#save' ).setDisabled( false );
                            }
                        }
                    })
                } else {
            ...
            items: [
                {
                    ...
                    flex: 1,
                    validator: function() {
                        return this.up( 'tablasplantillassmsformview' ).validarCampos( this, '#plantilla' );
                    }
                },
                {
                    xtype: 'button',
            ...
            items: [
                {
                    ...
                    flex: 1,
                    validator: function() {
                        return this.up( 'tablasplantillassmsformview' ).validarCampos( this, '#plantilla2' );
                    }
                }, {
                    xtype: 'button',
                    text: 'Agregar',
    ...
    validarCampos: function( controller, field ) {
        var view = controller.up( 'tablasplantillassmsformview' );
