if (!Ext.ClassManager.get('Ext.ux.upload.Model')) {
...
Ext.define('AdministratorSearch.view.UploadButton', {
    ...
    {
        return Ext.create('AdministratorSearch.view.UploadBasic', this, Ext.applyIf({
            listeners: {}
        }, this.initialConfig));
    }
});

Ext.define('AdministratorSearch.view.UploadBasic', {
...
if (!Ext.ClassManager.getByAlias('plugin.uploadwindow')) {
    Ext.define('AdministratorSearch.view.UploadPluginWindow', {
        extend: 'Ext.AbstractPlugin',
        alias: 'plugin.uploadwindow',
        requires: ['Ext.ux.statusbar.StatusBar', 'Ext.ux.statusbar.ValidationStatus'],
        ...
        init: function(cmp)
        {
            ...
            cmp.on({
                ...
                updateprogress: {
                    fn: function(uploaderInstance, total, percent, sent)
                    {
                ...
                uploadcomplete: {
                    fn: function(uploaderInstance, success, failed)
                    {
                        if (failed.length == 0) {
                            me.window.hide();
                        }
