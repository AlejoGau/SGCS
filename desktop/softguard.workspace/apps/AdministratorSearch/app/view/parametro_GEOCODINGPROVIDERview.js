Ext.define( 'AdministratorSearch.view.parametro_GEOCODINGPROVIDERview', {
    extend: 'Ext.form.Panel',
    alias: 'widget.parametro_GEOCODINGPROVIDERview',
    preventHeader: true,
    frame: true,
    border: 0,
    fieldDefaults: {
    ...
    items: [
        {
            ...
            items: [ {
                ...
                validator: function(v){
                    ...
                    var view = this.up('parametro_GEOCODINGPROVIDERview');
                ...
                listeners: {
                    change: function( combo, value ) {
                        var view = combo.up( 'parametro_GEOCODINGPROVIDERview' )
                    ...
                    listeners: {
                        sync: function( editor, html ) {
                            var view = editor.up( 'parametro_GEOCODINGPROVIDERview' );
                        },
                        change: function( textareafield, value, e, eOpts ) {
                            var view = textareafield.up( 'parametro_GEOCODINGPROVIDERview' );
                            view.down('#pdfAttach').validate();
                            view.customReport();
                        }
                    },
