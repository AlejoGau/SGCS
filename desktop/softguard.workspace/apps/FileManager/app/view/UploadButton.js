Ext.define('FileManager.view.UploadButton', {
    ...
    {
        return Ext.create('@ViewBag.UIApplicationName'+'.view.UploadBasic', this, Ext.applyIf({
            listeners: {}
        }, this.initialConfig));
    }
});
...
Ext.define('@ViewBag.UIApplicationName'+'.view.UploadBasic', {
...
Ext.define('@ViewBag.UIApplicationName'+'.view.UploadPluginWindow', {
