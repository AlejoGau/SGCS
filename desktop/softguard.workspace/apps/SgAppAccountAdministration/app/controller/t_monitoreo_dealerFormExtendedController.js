Ext.define('SgAppAccountAdministration.controller.t_monitoreo_dealerFormExtendedController', {
    extend : 'Ext.app.Controller',
    stores : [  ],
    models : [ 'Common.model.t_monitoreo_dealerModel', 'Common.model.t_monitoreo_dealerSearchModel' ],
    views : [ 'Common.view.t_monitoreo_dealerFormExtendedView' ],
	...
	//	myform.updateRecord(record);
        ...
        if (myform.isValid()){
             ...
             Ext.create('Ext.data.Store',{
                model: 'Common.model.t_monitoreo_dealerSearchModel',
                pageSize: 999,
                remoteSort: true,
                remoteFilter: true,
                filters: [{
                ...
                Ext.Array.each(dias,function (iddia,k) {
                    ...
                    if(colicion) {
                     ...
                     Ext.Array.each(dias,function (iddia,k) {
                        var myobject = Ext.create('Common.model.t_monitoreo_dealerModel', {
                            Id: 0,
