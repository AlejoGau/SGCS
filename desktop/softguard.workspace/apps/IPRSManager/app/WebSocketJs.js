...
Ext.define('IPRSManager.javascript.WebSocketJs', {
    alias: 'websocket',
            ...
            if (me.getAutoReconnect() && (typeof me.autoReconnectTask === 'undefined')) {
                me.autoReconnectTask = Ext.TaskManager.start({
                    run: function () {
                        ...
                        if (me.getStatus() === me.CLOSED && me.autoreconnectCount < me.getAutoReconnectQtty()) {
                            // cuento la cantidad
                            me.autoreconnectCount++;
                            me.initWebsocket();
                        }
                    },
