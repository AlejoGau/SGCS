Ext.define('SgAppSerTec.view.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.datetimefield',
    //requires: ['SgAppSerTec.view.DateTimePicker'],
    ...
    createPicker: function() {
        ...
        return Ext.create('SgAppSerTec.view.DateTimePicker', config);
    },
...
Ext.define('SgAppSerTec.view.DateTimePicker', {
