Ext.define('AccessControl.controller.AccessControlCuentaController', {
    ...
    initview: function(view){
        ...
        record.load(objectId, {
			callback : function(record,operation) {
                ...
                var datos = Ext.create('Ext.data.TreeStore', {
                ...
                var west = view.down('#westac');
                west.bindStore(datos);
                //west.insert(0,datos);
