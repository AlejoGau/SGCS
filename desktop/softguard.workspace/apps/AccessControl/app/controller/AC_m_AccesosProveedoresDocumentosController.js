Ext.define('AccessControl.controller.AC_m_AccesosProveedoresDocumentosController', {
    ...
    initView: function (view) {
        view.filters = [];
        var recordDoc = Ext.create('AccessControl.model.m_AccesosProveedoresDocumentosSearchModel',{
...
//----------------------------------------------------------
    ...
    onUploadDocClick: function(button, event, options) {
            ...
            var model = Ext.ClassManager.get('AccessControl.model.m_AccesosProveedoresModel')
            ...
            if(view.down('#uploaddoc').isVisible() && recordDoc.get('apd_cPathFile')=='' ){
                ...
                recordDoc.save({
                    success: function(record, operation){
                        ...
                        view.down('#apd_cPathFile').setValue('');
                        view.recordDoc = Ext.create('AccessControl.model.m_AccesosProveedoresDocumentosSearchModel',{
                            Id: 0,
