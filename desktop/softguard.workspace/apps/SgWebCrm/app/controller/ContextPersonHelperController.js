Ext.define('SGWebCrm.controller.ContextPersonHelperController', {
    extend : 'Ext.app.Controller',
    stores : [  ],
    models : [ 'PersonSearchModel' ],
    views : [ 'ContextPersonHelperView', 'ContextPersonGridView' ],
	...
	initView : function(view) {
        ...
        var targetTab = view.down('tabpanel');
        ...
        if(view.mismaOrganizacion) {
            ...
            view.tabMismaOrganizacion = Ext.widget('contextpersongridview', {
    			...
    			closable : false,
                autoDestroy: true,
                multiSelect: view.mismaOrganizacion.multiSelect
    		});
        ...
        if(view.organizacionSecundaria) {
            ...
            if (view.organizacionSecundaria.record && !view.filterByParentTaxonomy){
             ...
             view.tabOrganizacionSecundaria = Ext.widget('contextpersongridview', {
        		...
        		closable : false,
                autoDestroy: true,
                multiSelect: view.organizacionSecundaria.multiSelect
    		});
        ...
        if(view.mostrarTodo.mostrar) {
            view.tabMstrarTodo = Ext.widget('contextpersongridview', {
        		...
        		closable : false,
                autoDestroy: true,
                multiSelect: view.mostrarTodo.multiSelect
    		});
            var store =Ext.create('Ext.data.Store',{
                model: this.getPersonSearchModelModel(),
                pageSize: 50,
