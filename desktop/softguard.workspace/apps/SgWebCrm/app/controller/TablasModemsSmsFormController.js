Ext.define("SGWebCrm.controller.TablasModemsSmsFormController", {
  extend: "Ext.app.Controller",
  stores: ["TablasTerminalesStore"],
  models: [
    "TablasModemsSmsModel",
    "TablasTerminalesSearchModel",
    "TablasMedicosSearchModel",
