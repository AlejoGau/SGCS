Ext.define("SGWebCrm.controller.CuentaCorrientePanelController", {
  ...
  onRefresh: function (view) {
    if (view.down("mgcomprobantesgridview")) {
      view
        .down("mgcomprobantesgridview")
        .fireEvent("refresh", view.down("mgcomprobantesgridview"));
    }
    if (view.down("comprobantesdepagogridview")) {
      view
        .down("comprobantesdepagogridview")
        .fireEvent("refresh", view.down("comprobantesdepagogridview"));
    }
  },
