var navigate = function (panel, direction) {
  ...
  panel
    .up("pagoformview")
    .fireEvent("calcularContadores", panel.up("pagoformview"));
};

Ext.define("SGWebCrm.view.PagoFormView", {
          ...
          renderer: function (value) {
            if (this.up("pagoformview").moneySymbol) {
              return Ext.util.Format.currency(
                value,
                this.up("pagoformview").moneySymbol
              );
            } else {
              return "";
            }
              ...
              columns: [
                                		...
                                		}*/,
                {
                  ...
                  renderer: function (value, metadata, record) {
                    var tipo = this.up(
                      "pagoformview"
                    ).TipoComprobanteStore.findRecord("cbt_ccodigo", value);
                    if (tipo) {
