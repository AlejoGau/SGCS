Ext.define('SgAppMapGuardWeb.view.MapguardInfoMovileView', {
    extend : 'Ext.panel.Panel',
    alias : 'widget.mapguardinfomovileview',
    itemId:'mapguardinfomovileview',
    layout : 'border',
    frame : false,
    border : 0,
    items: [
        {
            xtype: 'gmappanel6',
            itemId: 'mapguardinfomovileviewgooglemap',
            region: 'center',
            zoomLevel : 14,
			gmapType : 'map',
