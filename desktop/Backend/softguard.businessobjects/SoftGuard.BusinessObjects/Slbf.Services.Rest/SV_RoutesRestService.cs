...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SV_RoutesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleSV_Routes),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleSV_Routes();
        ...
        SoftGuard.BusinessObjects.SV_Routes GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.SV_Routes>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SV_Routes");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleSV_Routes instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleSV_Routes instance)
        {
