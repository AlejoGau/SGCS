...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class s_terminalesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simples_terminales),
        ...
        s_terminales GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<s_terminales>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "s_terminales");
        }
        ...
        public SimpleBaseObject Create(Simples_terminales instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simples_terminales instance)
        {
