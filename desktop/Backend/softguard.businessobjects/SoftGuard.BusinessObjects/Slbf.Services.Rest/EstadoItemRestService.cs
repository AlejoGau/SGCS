...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class EstadoItemRestService
    {
        ...
        EstadoItem GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<EstadoItem>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "EstadoItem");
        }
        ...
        public SimpleBaseObject Create(SimpleEstadoItem instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleEstadoItem instance)
        {
