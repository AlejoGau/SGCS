...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class HorarioToleranciaRestService
    {
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleHorarioTolerancia();
        ...
        HorarioTolerancia GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<HorarioTolerancia>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "HorarioTolerancia");
        }
        ...
        public SimpleBaseObject Create(SimpleHorarioTolerancia instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleHorarioTolerancia instance)
        {
