...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class ReporteAutoridadesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleReporteAutoridades),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleReporteAutoridades();
        ...
        ReporteAutoridades GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<ReporteAutoridades>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "ReporteAutoridades");
        }
        ...
        public SimpleBaseObject Create(SimpleReporteAutoridades instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleReporteAutoridades instance)
        {
