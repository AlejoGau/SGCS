...
// Type: Slbf.Services.Rest.HorarioAlternativoRestService
...
namespace Slbf.Services.Rest
{
  ...
  [DataContractFormat]
  public class HorarioAlternativoRestService
  {
    private string _CurrentObjectName;

    public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
    {
      return (IEnumerable<Type>) new List<Type>() { typeof (SimpleHorarioAlternativo), typeof (SimpleMembershipUser), typeof (SimpleUserAccount), typeof (SimpleMenu), typeof (SimplePermission), typeof (SimpleRole), typeof (SimpleTaxonomy), typeof (SimpleMenuItem), typeof (SimpleGroups), typeof (SimpleGroups), typeof (SimpleMetaData), typeof (SimpleFrameworkAudit) };
    }
    ...
    {
      foreach (MemberInfo knownType in HorarioAlternativoRestService.GetKnownTypes((ICustomAttributeProvider) null))
      {
    ...
    public SimpleBaseObject Create(SimpleHorarioAlternativo instance)
    {
      ISpecialization currentObject = this.GetCurrentObject();
    ...
    public SimpleBaseObject Update(string id, SimpleHorarioAlternativo instance)
    {
      try
      {
        ISpecialization currentObject = this.GetCurrentObject();
