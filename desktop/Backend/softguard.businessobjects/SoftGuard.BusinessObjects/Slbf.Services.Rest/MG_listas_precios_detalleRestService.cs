...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class MG_listas_precios_detalleRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleMG_listas_precios_detalle),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleMG_listas_precios_detalle();
        ...
        MG_listas_precios_detalle GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<MG_listas_precios_detalle>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "MG_listas_precios_detalle");
        }
        ...
        public SimpleBaseObject Create(SimpleMG_listas_precios_detalle instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleMG_listas_precios_detalle instance)
        {
