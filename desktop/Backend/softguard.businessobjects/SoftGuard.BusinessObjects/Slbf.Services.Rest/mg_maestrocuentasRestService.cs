...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class mg_maestrocuentasRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplemg_maestrocuentas),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplemg_maestrocuentas();
        ...
        mg_maestrocuentas GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<mg_maestrocuentas>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "mg_maestrocuentas");
        }
        ...
        public SimpleBaseObject Create(Simplemg_maestrocuentas instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplemg_maestrocuentas instance)
        {
