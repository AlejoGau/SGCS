...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_autoridaddestinoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_autoridaddestino),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_autoridaddestino();
        ...
        t_autoridaddestino GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_autoridaddestino>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_autoridaddestino");
        }
        ...
        public SimpleBaseObject Create(Simplet_autoridaddestino instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_autoridaddestino instance)
        {
