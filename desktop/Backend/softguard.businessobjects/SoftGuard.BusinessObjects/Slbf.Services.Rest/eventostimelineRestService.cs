...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class eventostimelineRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simpleeventostimeline),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simpleeventostimeline();
        ...
        eventostimeline GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<eventostimeline>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "eventostimeline");
        }
        ...
        public SimpleBaseObject Create(Simpleeventostimeline instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simpleeventostimeline instance)
        {
