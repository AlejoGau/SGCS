...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class MG_product_impuestoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleMG_product_impuesto),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleMG_product_impuesto();
        ...
        MG_product_impuesto GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<MG_product_impuesto>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "MG_product_impuesto");
        }
        ...
        public SimpleBaseObject Create(SimpleMG_product_impuesto instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleMG_product_impuesto instance)
        {
