...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_encuestaRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_encuesta),
        ...
        p_encuesta GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_encuesta>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_encuesta");
        }
        ...
        public SimpleBaseObject Create(Simplep_encuesta instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_encuesta instance)
        {
