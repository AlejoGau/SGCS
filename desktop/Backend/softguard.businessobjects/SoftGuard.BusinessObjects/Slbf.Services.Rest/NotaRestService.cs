...
// Type: Slbf.Services.Rest.NotaRestService
...
namespace Slbf.Services.Rest
{
  ...
  public class NotaRestService
  {
    ...
    {
      return (IEnumerable<Type>) new List<Type>() { typeof (SimpleNota), typeof (SimpleMembershipUser), typeof (SimpleUserAccount), typeof (SimpleMenu), typeof (SimplePermission), typeof (SimpleRole), typeof (SimpleTaxonomy), typeof (SimpleMenuItem), typeof (SimpleGroups), typeof (SimpleGroups), typeof (SimpleMetaData), typeof (SimpleFrameworkAudit) };
    }
    ...
    {
      foreach (MemberInfo knownType in NotaRestService.GetKnownTypes((ICustomAttributeProvider) null))
      {
    ...
    public SimpleBaseObject Create(SimpleNota instance)
    {
      ISpecialization currentObject = this.GetCurrentObject();
    ...
    public SimpleBaseObject Update(string id, SimpleNota instance)
    {
      try
      {
        ISpecialization currentObject = this.GetCurrentObject();
