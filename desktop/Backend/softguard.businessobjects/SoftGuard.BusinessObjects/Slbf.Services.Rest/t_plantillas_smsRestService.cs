...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_plantillas_smsRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.Simplet_plantillas_sms),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.Simplet_plantillas_sms();
        ...
        SoftGuard.BusinessObjects.t_plantillas_sms GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.t_plantillas_sms>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_plantillas_sms");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.Simplet_plantillas_sms instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.Simplet_plantillas_sms instance)
        {
