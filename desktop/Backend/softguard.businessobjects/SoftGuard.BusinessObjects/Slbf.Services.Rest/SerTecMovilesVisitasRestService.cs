...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SerTecMovilesVisitasRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleSerTecMovilesVisitas),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleSerTecMovilesVisitas();
        ...
        SerTecMovilesVisitas GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SerTecMovilesVisitas>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SerTecMovilesVisitas");
        }
        ...
        public SimpleBaseObject Create(SimpleSerTecMovilesVisitas instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSerTecMovilesVisitas instance)
        {
