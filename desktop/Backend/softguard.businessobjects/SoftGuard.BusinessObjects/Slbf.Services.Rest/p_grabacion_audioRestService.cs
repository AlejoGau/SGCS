...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_grabacion_audioRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_grabacion_audio),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplep_grabacion_audio();
        ...
        p_grabacion_audio GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_grabacion_audio>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_grabacion_audio");
        }
        ...
        public SimpleBaseObject Create(Simplep_grabacion_audio instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_grabacion_audio instance)
        {
