...
namespace SoftGuard.BussinesObjects.Rest
{
    ...
    public partial class VehicleRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BussinesObjects.SimpleVehicle),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BussinesObjects.SimpleVehicle();
        ...
        SoftGuard.BussinesObjects.Vehicle GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BussinesObjects.Vehicle>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "Vehicle");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BussinesObjects.SimpleVehicle instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BussinesObjects.SimpleVehicle instance)
        {
