...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_cuenta_grupo_usuariosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_cuenta_grupo_usuarios),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_cuenta_grupo_usuarios();
        ...
        m_cuenta_grupo_usuarios GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_cuenta_grupo_usuarios>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_cuenta_grupo_usuarios");
        }
        ...
        public SimpleBaseObject Create(Simplem_cuenta_grupo_usuarios instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_cuenta_grupo_usuarios instance)
        {
