...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_monedasRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_monedas),
        ...
        t_monedas GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_monedas>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_monedas");
        }
        ...
        public SimpleBaseObject Create(Simplet_monedas instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_monedas instance)
        {
