...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class OperadorVirtualConfigRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleOperadorVirtualConfig),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleOperadorVirtualConfig();
        ...
        SoftGuard.BusinessObjects.OperadorVirtualConfig GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.OperadorVirtualConfig>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "OperadorVirtualConfig");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleOperadorVirtualConfig instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleOperadorVirtualConfig instance)
        {
