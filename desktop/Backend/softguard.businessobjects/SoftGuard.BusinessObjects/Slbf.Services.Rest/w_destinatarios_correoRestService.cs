...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class w_destinatarios_correoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplew_destinatarios_correo),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplew_destinatarios_correo();
        ...
        w_destinatarios_correo GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<w_destinatarios_correo>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "w_destinatarios_correo");
        }
        ...
        public SimpleBaseObject Create(Simplew_destinatarios_correo instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplew_destinatarios_correo instance)
        {
