...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_SpRemoteBtnRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_SpRemoteBtn),
        ...
        p_SpRemoteBtn GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_SpRemoteBtn>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_SpRemoteBtn");
        }
        ...
        public SimpleBaseObject Create(Simplep_SpRemoteBtn instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_SpRemoteBtn instance)
        {
