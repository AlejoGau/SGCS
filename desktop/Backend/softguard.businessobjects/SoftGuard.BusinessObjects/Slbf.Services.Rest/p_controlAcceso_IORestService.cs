...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_controlAcceso_IORestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_controlAcceso_IO),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplep_controlAcceso_IO();
        ...
        p_controlAcceso_IO GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_controlAcceso_IO>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_controlAcceso_IO");
        }
        ...
        public SimpleBaseObject Create(Simplep_controlAcceso_IO instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_controlAcceso_IO instance)
        {
