...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SchedulerTemplateRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleSchedulerTemplate),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleSchedulerTemplate();
        ...
        SchedulerTemplate GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SchedulerTemplate>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SchedulerTemplate");
        }
        ...
        public SimpleBaseObject Create(SimpleSchedulerTemplate instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSchedulerTemplate instance)
        {
