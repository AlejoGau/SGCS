...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_asignacion_movilRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_asignacion_movil),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_asignacion_movil();
        ...
        m_asignacion_movil GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_asignacion_movil>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_asignacion_movil");
        }
        ...
        public SimpleBaseObject Create(Simplem_asignacion_movil instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_asignacion_movil instance)
        {
