...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_llavesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_llaves),
        ...
        m_llaves GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_llaves>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_llaves");
        }
        ...
        public SimpleBaseObject Create(Simplem_llaves instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_llaves instance)
        {
