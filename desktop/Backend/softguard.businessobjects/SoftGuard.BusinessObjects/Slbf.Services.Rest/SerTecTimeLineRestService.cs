...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SerTecTimeLineRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleSerTecTimeLine),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleSerTecTimeLine();
        ...
        SerTecTimeLine GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SerTecTimeLine>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SerTecTimeLine");
        }
        ...
        public SimpleBaseObject Create(SimpleSerTecTimeLine instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSerTecTimeLine instance)
        {
