...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class UserAccountFilterRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleUserAccountFilter),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleUserAccountFilter();
        ...
        SoftGuard.BusinessObjects.UserAccountFilter GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.UserAccountFilter>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "UserAccountFilter");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleUserAccountFilter instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleUserAccountFilter instance)
        {
