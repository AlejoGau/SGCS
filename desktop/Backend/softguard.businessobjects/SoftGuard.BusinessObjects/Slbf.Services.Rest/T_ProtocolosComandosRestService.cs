...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class T_ProtocolosComandosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleT_ProtocolosComandos),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleT_ProtocolosComandos();
        ...
        T_ProtocolosComandos GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<T_ProtocolosComandos>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "T_ProtocolosComandos");
        }
        ...
        public SimpleBaseObject Create(SimpleT_ProtocolosComandos instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleT_ProtocolosComandos instance)
        {
