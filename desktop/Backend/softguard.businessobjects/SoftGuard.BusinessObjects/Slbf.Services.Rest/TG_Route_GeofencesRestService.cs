...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class TG_Route_GeofencesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleTG_Route_Geofences),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleTG_Route_Geofences();
        ...
        TG_Route_Geofences GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<TG_Route_Geofences>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "TG_Route_Geofences");
        }
        ...
        public SimpleBaseObject Create(SimpleTG_Route_Geofences instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleTG_Route_Geofences instance)
        {
