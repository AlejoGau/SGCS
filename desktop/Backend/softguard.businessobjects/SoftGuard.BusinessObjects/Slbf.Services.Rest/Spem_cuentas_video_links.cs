...
// Type: SoftGuard.BusinessObjects.Spem_cuentas_video_links
...
namespace SoftGuard.BusinessObjects
{
  public abstract class Spem_cuentas_video_links : ISpecialization, ICanCopyProperties
  {
    ...
    public string cvl_calarma
    {
      get
      {
        return this._DalObject.cvl_calarma;
      }
      set
      {
        this._DalObject.cvl_calarma = value;
      }
    }
    ...
    public string cvl_czona
    {
      get
      {
        return this._DalObject.cvl_czona;
      }
      set
      {
        this._DalObject.cvl_czona = value;
      }
    }
    ...
    public string cvl_clink
    {
      get
      {
        return this._DalObject.cvl_clink;
      }
      set
      {
        this._DalObject.cvl_clink = value;
      }
    }
    ...
    public string cvl_clinkdss
    {
      get
      {
        return this._DalObject.cvl_clinkdss;
      }
      set
      {
        this._DalObject.cvl_clinkdss = value;
      }
    }
    ...
    {
      m_cuentas_video_links cuentasVideoLinks = (m_cuentas_video_links) Object;
      cuentasVideoLinks.Name = this.Name;
      cuentasVideoLinks.cvl_calarma = this.cvl_calarma;
      cuentasVideoLinks.cvl_czona = this.cvl_czona;
      cuentasVideoLinks.cvl_clink = this.cvl_clink;
      cuentasVideoLinks.cvl_clinkdss = this.cvl_clinkdss;
    }
