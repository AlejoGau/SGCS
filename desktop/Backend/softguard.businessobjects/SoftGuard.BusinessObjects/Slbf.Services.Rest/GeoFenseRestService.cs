...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class GeoFenseRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleGeoFense),
        ...
        GeoFense GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<GeoFense>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "GeoFense");
        }
        ...
        public SimpleBaseObject Create(SimpleGeoFense instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleGeoFense instance)
        {
