...
// Type: SoftGuard.BusinessObjects.Spem_cuentas_video
...
namespace SoftGuard.BusinessObjects
{
  public abstract class Spem_cuentas_video : ISpecialization, ICanCopyProperties
  {
    ...
    public string cuv_clink
    {
      get
      {
        return this._DalObject.cuv_clink;
      }
      set
      {
        this._DalObject.cuv_clink = value;
      }
    }
    ...
    public string cuv_meventos
    {
      get
      {
        return this._DalObject.cuv_meventos;
      }
      set
      {
        this._DalObject.cuv_meventos = value;
      }
    }
    ...
    public string cuv_clinkdss
    {
      get
      {
        return this._DalObject.cuv_clinkdss;
      }
      set
      {
        this._DalObject.cuv_clinkdss = value;
      }
    }
    ...
    {
      m_cuentas_video mCuentasVideo = (m_cuentas_video) Object;
      mCuentasVideo.Name = this.Name;
      mCuentasVideo.cuv_clink = this.cuv_clink;
      mCuentasVideo.cuv_meventos = this.cuv_meventos;
      mCuentasVideo.cuv_clinkdss = this.cuv_clinkdss;
    }
