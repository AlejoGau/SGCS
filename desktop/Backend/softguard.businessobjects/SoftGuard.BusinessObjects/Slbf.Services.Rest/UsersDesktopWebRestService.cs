...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class UsersDesktopWebRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleUsersDesktopWeb),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleUsersDesktopWeb();
        ...
        UsersDesktopWeb GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<UsersDesktopWeb>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "UsersDesktopWeb");
        }
        ...
        public SimpleBaseObject Get(string id)
        {
            ...
            {
                SimpleUsersDesktopWeb s = (SimpleUsersDesktopWeb)o.GetSimpleObject();
                s.udw_clave = "*****";
                return s;
            }
        }
        ...
        public SimpleBaseObject Create(SimpleUsersDesktopWeb instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleUsersDesktopWeb instance)
        {
			var iid = int.Parse(id);
			UsersDesktopWeb p = GetCurrentObject(iid); // this also loads an object
