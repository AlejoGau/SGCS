...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class MG_Afip_CaeRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleMG_Afip_Cae),
        ...
        MG_Afip_Cae GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<MG_Afip_Cae>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "MG_Afip_Cae");
        }
        ...
        public SimpleBaseObject Create(SimpleMG_Afip_Cae instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleMG_Afip_Cae instance)
        {
