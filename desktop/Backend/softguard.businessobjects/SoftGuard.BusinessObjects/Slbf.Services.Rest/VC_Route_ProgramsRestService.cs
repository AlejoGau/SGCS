...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class VC_Route_ProgramsRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleVC_Route_Programs),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleVC_Route_Programs();
        ...
        VC_Route_Programs GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<VC_Route_Programs>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "VC_Route_Programs");
        }
        ...
        public SimpleBaseObject Create(SimpleVC_Route_Programs instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleVC_Route_Programs instance)
        {
