...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_stock_depositosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_stock_depositos),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_stock_depositos();
        ...
        t_stock_depositos GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_stock_depositos>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_stock_depositos");
        }
        ...
        public SimpleBaseObject Create(Simplet_stock_depositos instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_stock_depositos instance)
        {
