...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_notificaciones_dealerRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_notificaciones_dealer),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_notificaciones_dealer();
        ...
        t_notificaciones_dealer GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_notificaciones_dealer>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_notificaciones_dealer");
        }
        ...
        public SimpleBaseObject Create(Simplet_notificaciones_dealer instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_notificaciones_dealer instance)
        {
