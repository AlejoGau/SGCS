...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class VC_Route_CheckpointsRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleVC_Route_Checkpoints),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleVC_Route_Checkpoints();
        ...
        VC_Route_Checkpoints GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<VC_Route_Checkpoints>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "VC_Route_Checkpoints");
        }
        ...
        public SimpleBaseObject Create(SimpleVC_Route_Checkpoints instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleVC_Route_Checkpoints instance)
        {
