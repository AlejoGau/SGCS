...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_gatewaysmsgRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_gatewaysmsg),
        ...
        t_gatewaysmsg GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_gatewaysmsg>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_gatewaysmsg");
        }
        ...
        public SimpleBaseObject Create(Simplet_gatewaysmsg instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_gatewaysmsg instance)
        {
