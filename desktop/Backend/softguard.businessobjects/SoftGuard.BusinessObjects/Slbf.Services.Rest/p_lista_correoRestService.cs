...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_lista_correoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_lista_correo),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplep_lista_correo();
        ...
        p_lista_correo GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_lista_correo>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_lista_correo");
        }
        ...
        public SimpleBaseObject Create(Simplep_lista_correo instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_lista_correo instance)
        {
