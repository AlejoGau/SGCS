...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_checkPoints_VCRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_checkPoints_VC),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_checkPoints_VC();
        ...
        t_checkPoints_VC GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_checkPoints_VC>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_checkPoints_VC");
        }
        ...
        public SimpleBaseObject Create(Simplet_checkPoints_VC instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_checkPoints_VC instance)
        {
