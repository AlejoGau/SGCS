...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SmartTrackRestService
    {
        ...
        SmartTrack GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SmartTrack>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SmartTrack");
        }
        ...
        public SimpleBaseObject Create(SimpleSmartTrack instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSmartTrack instance)
        {
