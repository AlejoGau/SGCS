...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class ReporteRestService
    {
        ...
        Reporte GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<Reporte>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "Reporte");
        }
        ...
        public SimpleBaseObject Create(SimpleReporte instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleReporte instance)
        {
