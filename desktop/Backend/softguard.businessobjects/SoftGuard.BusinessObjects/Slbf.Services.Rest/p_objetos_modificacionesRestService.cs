...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_objetos_modificacionesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_objetos_modificaciones),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplep_objetos_modificaciones();
        ...
        p_objetos_modificaciones GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_objetos_modificaciones>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_objetos_modificaciones");
        }
        ...
        public SimpleBaseObject Create(Simplep_objetos_modificaciones instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_objetos_modificaciones instance)
        {
