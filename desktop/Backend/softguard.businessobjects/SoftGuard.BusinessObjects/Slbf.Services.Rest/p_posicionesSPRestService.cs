...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_posicionesSPRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_posicionesSP),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplep_posicionesSP();
        ...
        p_posicionesSP GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_posicionesSP>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_posicionesSP");
        }
        ...
        public SimpleBaseObject Create(Simplep_posicionesSP instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_posicionesSP instance)
        {
