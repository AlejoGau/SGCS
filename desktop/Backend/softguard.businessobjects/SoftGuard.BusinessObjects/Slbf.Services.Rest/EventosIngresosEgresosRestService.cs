...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class EventosIngresosEgresosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleEventosIngresosEgresos),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleEventosIngresosEgresos();
        ...
        SoftGuard.BusinessObjects.EventosIngresosEgresos GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.EventosIngresosEgresos>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "EventosIngresosEgresos");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleEventosIngresosEgresos instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleEventosIngresosEgresos instance)
        {
