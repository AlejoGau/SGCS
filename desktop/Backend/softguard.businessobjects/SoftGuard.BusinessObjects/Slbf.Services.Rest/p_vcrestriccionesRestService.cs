...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_vcrestriccionesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_vcrestricciones),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplep_vcrestricciones();
        ...
        p_vcrestricciones GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_vcrestricciones>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_vcrestricciones");
        }
        ...
        public SimpleBaseObject Create(Simplep_vcrestricciones instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_vcrestricciones instance)
        {
