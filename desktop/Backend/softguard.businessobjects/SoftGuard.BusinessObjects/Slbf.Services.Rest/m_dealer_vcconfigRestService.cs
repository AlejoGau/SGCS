...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_dealer_vcconfigRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_dealer_vcconfig),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_dealer_vcconfig();
        ...
        m_dealer_vcconfig GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_dealer_vcconfig>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_dealer_vcconfig");
        }
        ...
        public SimpleBaseObject Create(Simplem_dealer_vcconfig instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_dealer_vcconfig instance)
        {
