...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SerTecTecnicoVisitasRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleSerTecTecnicoVisitas),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleSerTecTecnicoVisitas();
        ...
        SerTecTecnicoVisitas GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SerTecTecnicoVisitas>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SerTecTecnicoVisitas");
        }
        ...
        public SimpleBaseObject Create(SimpleSerTecTecnicoVisitas instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSerTecTecnicoVisitas instance)
        {
