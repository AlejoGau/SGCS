...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class s_ip_rangeRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simples_ip_range),
        ...
        s_ip_range GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<s_ip_range>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "s_ip_range");
        }
        ...
        public SimpleBaseObject Create(Simples_ip_range instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simples_ip_range instance)
        {
