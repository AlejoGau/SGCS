...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_InstaladoresDealerRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_InstaladoresDealer),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_InstaladoresDealer();
        ...
        t_InstaladoresDealer GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_InstaladoresDealer>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_InstaladoresDealer");
        }
        ...
        public SimpleBaseObject Create(Simplet_InstaladoresDealer instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_InstaladoresDealer instance)
        {
