...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_dealerplantillasRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_dealerplantillas),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_dealerplantillas();
        ...
        t_dealerplantillas GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_dealerplantillas>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_dealerplantillas");
        }
        ...
        public SimpleBaseObject Create(Simplet_dealerplantillas instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_dealerplantillas instance)
        {
