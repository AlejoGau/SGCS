...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class s_online_helpRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simples_online_help),
        ...
        s_online_help GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<s_online_help>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "s_online_help");
        }
        ...
        public SimpleBaseObject Create(Simples_online_help instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simples_online_help instance)
        {
