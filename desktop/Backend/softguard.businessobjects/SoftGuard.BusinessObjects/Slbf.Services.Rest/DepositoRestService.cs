...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class DepositoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleDeposito),
        ...
        Deposito GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<Deposito>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "Deposito");
        }
        ...
        public SimpleBaseObject Create(SimpleDeposito instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleDeposito instance)
        {
