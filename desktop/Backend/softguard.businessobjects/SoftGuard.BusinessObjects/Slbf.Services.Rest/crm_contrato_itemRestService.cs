...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class crm_contrato_itemRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplecrm_contrato_item),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplecrm_contrato_item();
        ...
        crm_contrato_item GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<crm_contrato_item>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "crm_contrato_item");
        }
        ...
        public SimpleBaseObject Create(Simplecrm_contrato_item instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplecrm_contrato_item instance)
        {
