...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class VC_RoutesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleVC_Routes),
        ...
        VC_Routes GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<VC_Routes>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "VC_Routes");
        }
        ...
        public SimpleBaseObject Create(SimpleVC_Routes instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleVC_Routes instance)
        {
