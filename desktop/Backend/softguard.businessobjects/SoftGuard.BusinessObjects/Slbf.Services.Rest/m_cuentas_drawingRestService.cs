...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_cuentas_drawingRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_cuentas_drawing),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_cuentas_drawing();
        ...
        m_cuentas_drawing GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_cuentas_drawing>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_cuentas_drawing");
        }
        ...
        public SimpleBaseObject Create(Simplem_cuentas_drawing instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_cuentas_drawing instance)
        {
