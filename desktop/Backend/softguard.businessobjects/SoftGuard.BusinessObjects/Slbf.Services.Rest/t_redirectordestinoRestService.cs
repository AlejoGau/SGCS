...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_redirectordestinoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_redirectordestino),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_redirectordestino();
        ...
        t_redirectordestino GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_redirectordestino>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_redirectordestino");
        }
        ...
        public SimpleBaseObject Create(Simplet_redirectordestino instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_redirectordestino instance)
        {
