...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_encuesta_pregunta_respuestaRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_encuesta_pregunta_respuesta),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplep_encuesta_pregunta_respuesta();
        ...
        p_encuesta_pregunta_respuesta GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_encuesta_pregunta_respuesta>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_encuesta_pregunta_respuesta");
        }
        ...
        public SimpleBaseObject Create(Simplep_encuesta_pregunta_respuesta instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_encuesta_pregunta_respuesta instance)
        {
