...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class TestRestService
    {
        ...
        Test GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<Test>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "Test");
        }
        ...
        public SimpleBaseObject Create(SimpleTest instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleTest instance)
        {
