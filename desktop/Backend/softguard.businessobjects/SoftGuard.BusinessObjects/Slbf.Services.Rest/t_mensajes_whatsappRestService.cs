...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_mensajes_whatsappRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_mensajes_whatsapp),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_mensajes_whatsapp();
        ...
        t_mensajes_whatsapp GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_mensajes_whatsapp>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_mensajes_whatsapp");
        }
        ...
        public SimpleBaseObject Create(Simplet_mensajes_whatsapp instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_mensajes_whatsapp instance)
        {
