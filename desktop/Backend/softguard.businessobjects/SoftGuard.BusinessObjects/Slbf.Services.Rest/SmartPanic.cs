...
{ 
   ///<summary>
     ///SmartPanic class   
     ///</summary>
    public partial class SmartPanic : SpeSmartPanic
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public SmartPanic(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public SmartPanic(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SmartPanic(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SmartPanic(SqlHelper SqlConfig, int UserId, SimpleSmartPanic Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
