...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SmartTrackGeoFenseRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleSmartTrackGeoFense),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleSmartTrackGeoFense();
        ...
        SmartTrackGeoFense GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SmartTrackGeoFense>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SmartTrackGeoFense");
        }
        ...
        public SimpleBaseObject Create(SimpleSmartTrackGeoFense instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSmartTrackGeoFense instance)
        {
