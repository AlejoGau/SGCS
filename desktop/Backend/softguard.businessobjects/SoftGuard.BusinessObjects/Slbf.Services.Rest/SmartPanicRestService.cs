...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SmartPanicRestService
    {
        ...
        SmartPanic GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SmartPanic>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SmartPanic");
        }
        ...
        public SimpleBaseObject Create(SimpleSmartPanic instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSmartPanic instance)
        {
