...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_panelesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_paneles),
        ...
        t_paneles GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_paneles>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_paneles");
        }
        ...
        public SimpleBaseObject Create(Simplet_paneles instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_paneles instance)
        {
