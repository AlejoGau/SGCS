...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_EstadosPanelRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_EstadosPanel),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_EstadosPanel();
        ...
        m_EstadosPanel GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_EstadosPanel>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_EstadosPanel");
        }
        ...
        public SimpleBaseObject Create(Simplem_EstadosPanel instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_EstadosPanel instance)
        {
