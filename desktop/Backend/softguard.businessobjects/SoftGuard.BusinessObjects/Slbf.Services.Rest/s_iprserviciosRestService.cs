...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class s_iprserviciosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simples_iprservicios),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simples_iprservicios();
        ...
        s_iprservicios GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<s_iprservicios>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "s_iprservicios");
        }
        ...
        public SimpleBaseObject Create(Simples_iprservicios instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simples_iprservicios instance)
        {
