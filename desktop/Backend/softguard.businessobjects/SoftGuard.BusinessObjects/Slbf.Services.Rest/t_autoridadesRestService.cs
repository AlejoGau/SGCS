...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_autoridadesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_autoridades),
        ...
        t_autoridades GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_autoridades>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_autoridades");
        }
        ...
        public SimpleBaseObject Create(Simplet_autoridades instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_autoridades instance)
        {
