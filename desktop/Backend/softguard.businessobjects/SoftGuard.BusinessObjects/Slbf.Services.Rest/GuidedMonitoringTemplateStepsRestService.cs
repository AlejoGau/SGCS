...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class GuidedMonitoringTemplateStepsRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleGuidedMonitoringTemplateSteps),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleGuidedMonitoringTemplateSteps();
        ...
        SoftGuard.BusinessObjects.GuidedMonitoringTemplateSteps GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.GuidedMonitoringTemplateSteps>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "GuidedMonitoringTemplateSteps");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleGuidedMonitoringTemplateSteps instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleGuidedMonitoringTemplateSteps instance)
        {
