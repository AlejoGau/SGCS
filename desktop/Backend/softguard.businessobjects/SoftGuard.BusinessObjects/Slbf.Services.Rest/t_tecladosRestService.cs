...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_tecladosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_teclados),
        ...
        t_teclados GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_teclados>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_teclados");
        }
        ...
        public SimpleBaseObject Create(Simplet_teclados instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_teclados instance)
        {
