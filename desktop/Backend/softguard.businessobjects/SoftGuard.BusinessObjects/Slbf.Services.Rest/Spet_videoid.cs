...
// Type: SoftGuard.BusinessObjects.Spet_videoid
...
namespace SoftGuard.BusinessObjects
{
  public abstract class Spet_videoid : ISpecialization, ICanCopyProperties
  {
    ...
    public string tvi_cdescripcion
    {
      get
      {
        return this._DalObject.tvi_cdescripcion;
      }
      set
      {
        this._DalObject.tvi_cdescripcion = value;
      }
    }
    ...
    public string tvi_cnombre
    {
      get
      {
        return this._DalObject.tvi_cnombre;
      }
      set
      {
        this._DalObject.tvi_cnombre = value;
      }
    }
    ...
    {
      t_videoid tVideoid = (t_videoid) Object;
      tVideoid.Name = this.Name;
      tVideoid.tvi_cdescripcion = this.tvi_cdescripcion;
      tVideoid.tvi_cnombre = this.tvi_cnombre;
      tVideoid.tvi_cconfig = this.tvi_cconfig;
    }
