...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_tstconexionRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_tstconexion),
        ...
        m_tstconexion GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_tstconexion>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_tstconexion");
        }
        ...
        public SimpleBaseObject Create(Simplem_tstconexion instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_tstconexion instance)
        {
