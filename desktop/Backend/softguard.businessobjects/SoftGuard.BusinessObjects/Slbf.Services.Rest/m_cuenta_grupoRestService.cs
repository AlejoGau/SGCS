...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_cuenta_grupoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_cuenta_grupo),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_cuenta_grupo();
        ...
        m_cuenta_grupo GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_cuenta_grupo>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_cuenta_grupo");
        }
        ...
        public SimpleBaseObject Create(Simplem_cuenta_grupo instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_cuenta_grupo instance)
        {
