...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_CuentasXtraInfoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_CuentasXtraInfo),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_CuentasXtraInfo();
        ...
        m_CuentasXtraInfo GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_CuentasXtraInfo>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_CuentasXtraInfo");
        }
        ...
        public SimpleBaseObject Create(Simplem_CuentasXtraInfo instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_CuentasXtraInfo instance)
        {
