...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_evento_workflowRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_evento_workflow),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplep_evento_workflow();
        ...
        p_evento_workflow GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_evento_workflow>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_evento_workflow");
        }
        ...
        public SimpleBaseObject Create(Simplep_evento_workflow instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_evento_workflow instance)
        {
