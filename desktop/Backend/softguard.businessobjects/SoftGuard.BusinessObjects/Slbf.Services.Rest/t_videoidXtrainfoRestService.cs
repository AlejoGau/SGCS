...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_videoidXtrainfoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_videoidXtrainfo),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_videoidXtrainfo();
        ...
        t_videoidXtrainfo GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_videoidXtrainfo>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_videoidXtrainfo");
        }
        ...
        public SimpleBaseObject Create(Simplet_videoidXtrainfo instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_videoidXtrainfo instance)
        {
