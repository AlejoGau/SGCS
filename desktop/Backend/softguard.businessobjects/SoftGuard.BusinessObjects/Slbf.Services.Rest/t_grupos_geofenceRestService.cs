...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_grupos_geofenceRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.Simplet_grupos_geofence),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.Simplet_grupos_geofence();
        ...
        SoftGuard.BusinessObjects.t_grupos_geofence GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.t_grupos_geofence>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_grupos_geofence");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.Simplet_grupos_geofence instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.Simplet_grupos_geofence instance)
        {
