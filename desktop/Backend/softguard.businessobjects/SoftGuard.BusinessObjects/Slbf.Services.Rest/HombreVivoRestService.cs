...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class HombreVivoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleHombreVivo),
        ...
        HombreVivo GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<HombreVivo>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "HombreVivo");
        }
        ...
        public SimpleBaseObject Create(SimpleHombreVivo instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleHombreVivo instance)
        {
