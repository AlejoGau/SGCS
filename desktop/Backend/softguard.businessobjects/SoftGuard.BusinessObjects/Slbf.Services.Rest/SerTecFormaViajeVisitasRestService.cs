...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SerTecFormaViajeVisitasRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleSerTecFormaViajeVisitas),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleSerTecFormaViajeVisitas();
        ...
        SerTecFormaViajeVisitas GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SerTecFormaViajeVisitas>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SerTecFormaViajeVisitas");
        }
        ...
        public SimpleBaseObject Create(SimpleSerTecFormaViajeVisitas instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSerTecFormaViajeVisitas instance)
        {
