...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_comandos_ipRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_comandos_ip),
        ...
        p_comandos_ip GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_comandos_ip>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_comandos_ip");
        }
        ...
        public SimpleBaseObject Create(Simplep_comandos_ip instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_comandos_ip instance)
        {
