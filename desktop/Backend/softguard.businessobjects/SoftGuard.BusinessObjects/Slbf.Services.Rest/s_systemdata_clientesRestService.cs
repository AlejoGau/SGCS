...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class s_systemdata_clientesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simples_systemdata_clientes),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simples_systemdata_clientes();
        ...
        s_systemdata_clientes GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<s_systemdata_clientes>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "s_systemdata_clientes");
        }
        ...
        public SimpleBaseObject Create(Simples_systemdata_clientes instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simples_systemdata_clientes instance)
        {
