...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_listas_emergenciaRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_listas_emergencia),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_listas_emergencia();
        ...
        t_listas_emergencia GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_listas_emergencia>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_listas_emergencia");
        }
        ...
        public SimpleBaseObject Create(Simplet_listas_emergencia instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_listas_emergencia instance)
        {
