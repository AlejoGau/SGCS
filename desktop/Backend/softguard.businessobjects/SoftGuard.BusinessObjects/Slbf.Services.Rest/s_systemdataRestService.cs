...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class s_systemdataRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simples_systemdata),
        ...
        s_systemdata GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<s_systemdata>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "s_systemdata");
        }
        ...
        public SimpleBaseObject Create(Simples_systemdata instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simples_systemdata instance)
        {
