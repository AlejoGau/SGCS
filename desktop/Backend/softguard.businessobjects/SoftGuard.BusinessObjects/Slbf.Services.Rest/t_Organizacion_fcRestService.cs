...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_organizacion_fcRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_organizacion_fc),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_organizacion_fc();
        ...
        t_organizacion_fc GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_organizacion_fc>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_organizacion_fc");
        }
        ...
        public SimpleBaseObject Create(Simplet_organizacion_fc instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_organizacion_fc instance)
        {
