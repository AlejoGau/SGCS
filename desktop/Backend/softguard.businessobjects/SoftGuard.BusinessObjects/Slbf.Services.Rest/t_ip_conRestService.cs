...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_ip_conRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_ip_con),
        ...
        t_ip_con GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_ip_con>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_ip_con");
        }
        ...
        public SimpleBaseObject Create(Simplet_ip_con instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_ip_con instance)
        {
