...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class HorarioPlanillaRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleHorarioPlanilla),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleHorarioPlanilla();
        ...
        HorarioPlanilla GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<HorarioPlanilla>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "HorarioPlanilla");
        }
        ...
        public SimpleBaseObject Create(SimpleHorarioPlanilla instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleHorarioPlanilla instance)
        {
