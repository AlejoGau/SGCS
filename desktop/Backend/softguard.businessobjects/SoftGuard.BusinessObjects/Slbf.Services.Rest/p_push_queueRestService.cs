...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_push_queueRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_push_queue),
        ...
        p_push_queue GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_push_queue>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_push_queue");
        }
        ...
        public SimpleBaseObject Create(Simplep_push_queue instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_push_queue instance)
        {
