...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_printQueueRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_printQueue),
        ...
        m_printQueue GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_printQueue>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_printQueue");
        }
        ...
        public SimpleBaseObject Create(Simplem_printQueue instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_printQueue instance)
        {
