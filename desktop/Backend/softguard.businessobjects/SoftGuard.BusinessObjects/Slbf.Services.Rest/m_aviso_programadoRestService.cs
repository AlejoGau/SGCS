...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_aviso_programadoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_aviso_programado),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_aviso_programado();
        ...
        m_aviso_programado GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_aviso_programado>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_aviso_programado");
        }
        ...
        public SimpleBaseObject Create(Simplem_aviso_programado instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_aviso_programado instance)
        {
