...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_tgviajeRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_tgviaje),
        ...
        m_tgviaje GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_tgviaje>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_tgviaje");
        }
        ...
        public SimpleBaseObject Create(Simplem_tgviaje instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_tgviaje instance)
        {
