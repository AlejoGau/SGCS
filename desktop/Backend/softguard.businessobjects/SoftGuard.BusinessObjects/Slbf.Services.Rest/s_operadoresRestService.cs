...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class s_operadoresRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simples_operadores),
        ...
        s_operadores GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<s_operadores>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "s_operadores");
        }
        ...
        public SimpleBaseObject Create(Simples_operadores instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simples_operadores instance)
        {
