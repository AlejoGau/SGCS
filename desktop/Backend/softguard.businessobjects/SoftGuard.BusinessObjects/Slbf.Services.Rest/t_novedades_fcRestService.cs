...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_novedades_fcRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_novedades_fc),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_novedades_fc();
        ...
        t_novedades_fc GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_novedades_fc>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_novedades_fc");
        }
        ...
        public SimpleBaseObject Create(Simplet_novedades_fc instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_novedades_fc instance)
        {
