...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class HorarioExcepcionPlanillaRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleHorarioExcepcionPlanilla),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleHorarioExcepcionPlanilla();
        ...
        SoftGuard.BusinessObjects.HorarioExcepcionPlanilla GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.HorarioExcepcionPlanilla>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "HorarioExcepcionPlanilla");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleHorarioExcepcionPlanilla instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleHorarioExcepcionPlanilla instance)
        {
