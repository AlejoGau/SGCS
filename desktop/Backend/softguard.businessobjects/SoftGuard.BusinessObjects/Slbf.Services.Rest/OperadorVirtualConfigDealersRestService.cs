...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class OperadorVirtualConfigDealersRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleOperadorVirtualConfigDealers),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleOperadorVirtualConfigDealers();
        ...
        SoftGuard.BusinessObjects.OperadorVirtualConfigDealers GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.OperadorVirtualConfigDealers>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "OperadorVirtualConfigDealers");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleOperadorVirtualConfigDealers instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleOperadorVirtualConfigDealers instance)
        {
