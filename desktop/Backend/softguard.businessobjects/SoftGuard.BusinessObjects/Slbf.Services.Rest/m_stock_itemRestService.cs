...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_stock_itemRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_stock_item),
        ...
        m_stock_item GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_stock_item>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_stock_item");
        }
        ...
        public SimpleBaseObject Create(Simplem_stock_item instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_stock_item instance)
        {
