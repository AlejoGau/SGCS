...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_grabacion_imgRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.Simplep_grabacion_img),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.Simplep_grabacion_img();
        ...
        SoftGuard.BusinessObjects.p_grabacion_img GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.p_grabacion_img>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_grabacion_img");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.Simplep_grabacion_img instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.Simplep_grabacion_img instance)
        {
