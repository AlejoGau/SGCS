...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class HorarioExcepcionRestService
    {
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleHorarioExcepcion();
        ...
        HorarioExcepcion GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<HorarioExcepcion>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "HorarioExcepcion");
        }
        ...
        public SimpleBaseObject Create(SimpleHorarioExcepcion instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleHorarioExcepcion instance)
        {
