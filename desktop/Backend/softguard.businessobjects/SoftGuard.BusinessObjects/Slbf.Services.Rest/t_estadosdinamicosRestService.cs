...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_estadosdinamicosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_estadosdinamicos),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_estadosdinamicos();
        ...
        t_estadosdinamicos GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_estadosdinamicos>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_estadosdinamicos");
        }
        ...
        public SimpleBaseObject Create(Simplet_estadosdinamicos instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_estadosdinamicos instance)
        {
