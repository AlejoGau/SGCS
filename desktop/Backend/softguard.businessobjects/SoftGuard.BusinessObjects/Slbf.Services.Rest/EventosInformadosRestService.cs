...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class EventosInformadosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleEventosInformados),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleEventosInformados();
        ...
        SoftGuard.BusinessObjects.EventosInformados GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.EventosInformados>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "EventosInformados");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleEventosInformados instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleEventosInformados instance)
        {
