...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class MG_Afip_Cae_WsRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleMG_Afip_Cae_Ws),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleMG_Afip_Cae_Ws();
        ...
        MG_Afip_Cae_Ws GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<MG_Afip_Cae_Ws>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "MG_Afip_Cae_Ws");
        }
        ...
        public SimpleBaseObject Create(SimpleMG_Afip_Cae_Ws instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleMG_Afip_Cae_Ws instance)
        {
