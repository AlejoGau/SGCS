...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class WeSafeSubscriptionFunctionsRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleWeSafeSubscriptionFunctions),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleWeSafeSubscriptionFunctions();
        ...
        SoftGuard.BusinessObjects.WeSafeSubscriptionFunctions GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.WeSafeSubscriptionFunctions>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "WeSafeSubscriptionFunctions");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleWeSafeSubscriptionFunctions instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleWeSafeSubscriptionFunctions instance)
        {
