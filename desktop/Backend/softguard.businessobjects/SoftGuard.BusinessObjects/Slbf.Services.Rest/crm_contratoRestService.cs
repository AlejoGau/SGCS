...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class crm_contratoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.Simplecrm_contrato),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.Simplecrm_contrato();
		...
		SoftGuard.BusinessObjects.crm_contrato GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.crm_contrato>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "crm_contrato");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.Simplecrm_contrato instance)
        {
			instance.Id = 0;
        ...
        public SimpleBaseObject Update(string id, Stream requestStream)
        {
            ...
            var instance = DeserializeJson<SoftGuard.BusinessObjects.Simplecrm_contrato>(json);
