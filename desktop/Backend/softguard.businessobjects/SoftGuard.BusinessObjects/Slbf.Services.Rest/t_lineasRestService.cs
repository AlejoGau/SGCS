...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_lineasRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.Simplet_lineas),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.Simplet_lineas();
        ...
        SoftGuard.BusinessObjects.t_lineas GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.t_lineas>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_lineas");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.Simplet_lineas instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.Simplet_lineas instance)
        {
