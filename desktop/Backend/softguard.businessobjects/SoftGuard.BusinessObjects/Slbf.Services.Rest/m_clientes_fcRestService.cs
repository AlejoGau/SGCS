...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_clientes_fcRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_clientes_fc),
        ...
        m_clientes_fc GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_clientes_fc>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_clientes_fc");
        }
        ...
        public SimpleBaseObject Create(Simplem_clientes_fc instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_clientes_fc instance)
        {
