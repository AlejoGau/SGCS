...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_linkurlRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_linkurl),
        ...
        t_linkurl GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_linkurl>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_linkurl");
        }
        ...
        public SimpleBaseObject Create(Simplet_linkurl instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_linkurl instance)
        {
