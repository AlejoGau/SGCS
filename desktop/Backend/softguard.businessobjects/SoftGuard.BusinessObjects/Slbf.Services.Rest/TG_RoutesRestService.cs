...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class TG_RoutesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleTG_Routes),
        ...
        TG_Routes GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<TG_Routes>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "TG_Routes");
        }
        ...
        public SimpleBaseObject Create(SimpleTG_Routes instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleTG_Routes instance)
        {
