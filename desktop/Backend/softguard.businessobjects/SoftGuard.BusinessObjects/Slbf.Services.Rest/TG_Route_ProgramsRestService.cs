...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class TG_Route_ProgramsRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleTG_Route_Programs),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleTG_Route_Programs();
        ...
        TG_Route_Programs GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<TG_Route_Programs>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "TG_Route_Programs");
        }
        ...
        public SimpleBaseObject Create(SimpleTG_Route_Programs instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleTG_Route_Programs instance)
        {
