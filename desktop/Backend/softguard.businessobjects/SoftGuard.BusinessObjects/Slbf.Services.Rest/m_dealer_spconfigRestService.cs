...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_dealer_spconfigRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_dealer_spconfig),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_dealer_spconfig();
        ...
        m_dealer_spconfig GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_dealer_spconfig>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_dealer_spconfig");
        }
        ...
        public SimpleBaseObject Create(Simplem_dealer_spconfig instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_dealer_spconfig instance)
        {
