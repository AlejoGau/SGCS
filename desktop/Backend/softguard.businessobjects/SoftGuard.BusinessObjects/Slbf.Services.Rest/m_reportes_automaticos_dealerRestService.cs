...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_reportes_automaticos_dealerRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_reportes_automaticos_dealer),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_reportes_automaticos_dealer();
        ...
        m_reportes_automaticos_dealer GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_reportes_automaticos_dealer>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_reportes_automaticos_dealer");
        }
        ...
        public SimpleBaseObject Create(Simplem_reportes_automaticos_dealer instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_reportes_automaticos_dealer instance)
        {
