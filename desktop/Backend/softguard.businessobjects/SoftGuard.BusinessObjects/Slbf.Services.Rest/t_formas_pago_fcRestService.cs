...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_formas_pago_fcRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_formas_pago_fc),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_formas_pago_fc();
        ...
        t_formas_pago_fc GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_formas_pago_fc>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_formas_pago_fc");
        }
        ...
        public SimpleBaseObject Create(Simplet_formas_pago_fc instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_formas_pago_fc instance)
        {
