...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_VirtualIRRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_VirtualIR),
        ...
        p_VirtualIR GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_VirtualIR>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_VirtualIR");
        }
        ...
        public SimpleBaseObject Create(Simplep_VirtualIR instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_VirtualIR instance)
        {
