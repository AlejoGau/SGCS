...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SchedulerRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleScheduler),
        ...
        Scheduler GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<Scheduler>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "Scheduler");
        }
        ...
        public SimpleBaseObject Create(SimpleScheduler instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleScheduler instance)
        {
