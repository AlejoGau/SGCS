...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class RedirectorQueueRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleRedirectorQueue),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleRedirectorQueue();
        ...
        SoftGuard.BusinessObjects.RedirectorQueue GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.RedirectorQueue>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "RedirectorQueue");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleRedirectorQueue instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleRedirectorQueue instance)
        {
