...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SerTecProductosOrdenRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleSerTecProductosOrden),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleSerTecProductosOrden();
        ...
        SerTecProductosOrden GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SerTecProductosOrden>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SerTecProductosOrden");
        }
        ...
        public SimpleBaseObject Create(SimpleSerTecProductosOrden instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSerTecProductosOrden instance)
        {
