...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class T_AccesosVehiculoProveedorRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleT_AccesosVehiculoProveedor),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleT_AccesosVehiculoProveedor();
        ...
        SoftGuard.BusinessObjects.T_AccesosVehiculoProveedor GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.T_AccesosVehiculoProveedor>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "T_AccesosVehiculoProveedor");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleT_AccesosVehiculoProveedor instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleT_AccesosVehiculoProveedor instance)
        {
