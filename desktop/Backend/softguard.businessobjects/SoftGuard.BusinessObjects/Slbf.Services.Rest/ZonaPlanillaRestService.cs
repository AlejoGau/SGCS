...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class ZonaPlanillaRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleZonaPlanilla),
        ...
        ZonaPlanilla GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<ZonaPlanilla>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "ZonaPlanilla");
        }
        ...
        public SimpleBaseObject Create(SimpleZonaPlanilla instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleZonaPlanilla instance)
        {
