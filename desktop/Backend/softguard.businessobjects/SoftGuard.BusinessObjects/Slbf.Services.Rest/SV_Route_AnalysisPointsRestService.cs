...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SV_Route_AnalysisPointsRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleSV_Route_AnalysisPoints),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleSV_Route_AnalysisPoints();
        ...
        SoftGuard.BusinessObjects.SV_Route_AnalysisPoints GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.SV_Route_AnalysisPoints>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SV_Route_AnalysisPoints");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleSV_Route_AnalysisPoints instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleSV_Route_AnalysisPoints instance)
        {
