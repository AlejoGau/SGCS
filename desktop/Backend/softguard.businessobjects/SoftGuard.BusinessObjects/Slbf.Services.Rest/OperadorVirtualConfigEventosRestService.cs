...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class OperadorVirtualConfigEventosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleOperadorVirtualConfigEventos),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleOperadorVirtualConfigEventos();
        ...
        SoftGuard.BusinessObjects.OperadorVirtualConfigEventos GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.OperadorVirtualConfigEventos>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "OperadorVirtualConfigEventos");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleOperadorVirtualConfigEventos instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleOperadorVirtualConfigEventos instance)
        {
