...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_dealer_stconfigRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.Simplem_dealer_stconfig),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.Simplem_dealer_stconfig();
        ...
        SoftGuard.BusinessObjects.m_dealer_stconfig GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.m_dealer_stconfig>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_dealer_stconfig");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.Simplem_dealer_stconfig instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.Simplem_dealer_stconfig instance)
        {
