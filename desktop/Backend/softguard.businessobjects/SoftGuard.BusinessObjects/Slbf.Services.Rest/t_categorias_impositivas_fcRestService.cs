...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_categorias_impositivas_fcRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_categorias_impositivas_fc),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_categorias_impositivas_fc();
        ...
        t_categorias_impositivas_fc GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_categorias_impositivas_fc>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_categorias_impositivas_fc");
        }
        ...
        public SimpleBaseObject Create(Simplet_categorias_impositivas_fc instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_categorias_impositivas_fc instance)
        {
