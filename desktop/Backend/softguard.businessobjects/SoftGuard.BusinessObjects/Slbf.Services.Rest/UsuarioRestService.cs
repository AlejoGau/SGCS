...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class UsuarioRestService
    {
        ...
        Usuario GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<Usuario>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "Usuario");
        }
        ...
        public SimpleBaseObject Create(SimpleUsuario instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleUsuario instance)
        {
