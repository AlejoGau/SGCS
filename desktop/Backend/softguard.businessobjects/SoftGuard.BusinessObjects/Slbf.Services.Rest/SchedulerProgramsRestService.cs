...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SchedulerProgramsRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleSchedulerPrograms),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleSchedulerPrograms();
        ...
        SchedulerPrograms GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SchedulerPrograms>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SchedulerPrograms");
        }
        ...
        public SimpleBaseObject Create(SimpleSchedulerPrograms instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSchedulerPrograms instance)
        {
