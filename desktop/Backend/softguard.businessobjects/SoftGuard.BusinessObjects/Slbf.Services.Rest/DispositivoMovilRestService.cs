...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class DispositivoMovilRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleDispositivoMovil),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleDispositivoMovil();
        ...
        DispositivoMovil GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<DispositivoMovil>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "DispositivoMovil");
        }
        ...
        public SimpleBaseObject Create(SimpleDispositivoMovil instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleDispositivoMovil instance)
        {
