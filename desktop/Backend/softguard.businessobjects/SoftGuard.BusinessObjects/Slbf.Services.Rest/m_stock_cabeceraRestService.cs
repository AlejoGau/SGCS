...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_stock_cabeceraRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_stock_cabecera),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_stock_cabecera();
        ...
        m_stock_cabecera GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_stock_cabecera>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_stock_cabecera");
        }
        ...
        public SimpleBaseObject Create(Simplem_stock_cabecera instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_stock_cabecera instance)
        {
