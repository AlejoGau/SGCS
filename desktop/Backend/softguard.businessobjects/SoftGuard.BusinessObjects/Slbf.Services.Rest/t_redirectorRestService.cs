...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_redirectorRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_redirector),
        ...
        t_redirector GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_redirector>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_redirector");
        }
        ...
        public SimpleBaseObject Create(Simplet_redirector instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_redirector instance)
        {
