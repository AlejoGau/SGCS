...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_impuestos_fcRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_impuestos_fc),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_impuestos_fc();
        ...
        t_impuestos_fc GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_impuestos_fc>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_impuestos_fc");
        }
        ...
        public SimpleBaseObject Create(Simplet_impuestos_fc instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_impuestos_fc instance)
        {
