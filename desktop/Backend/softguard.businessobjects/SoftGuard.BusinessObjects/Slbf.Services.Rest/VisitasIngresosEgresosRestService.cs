...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class VisitasIngresosEgresosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleVisitasIngresosEgresos),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleVisitasIngresosEgresos();
        ...
        SoftGuard.BusinessObjects.VisitasIngresosEgresos GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.VisitasIngresosEgresos>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "VisitasIngresosEgresos");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleVisitasIngresosEgresos instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleVisitasIngresosEgresos instance)
        {
