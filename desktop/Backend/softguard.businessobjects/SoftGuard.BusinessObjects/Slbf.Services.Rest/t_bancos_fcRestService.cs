...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_bancos_fcRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_bancos_fc),
        ...
        t_bancos_fc GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_bancos_fc>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_bancos_fc");
        }
        ...
        public SimpleBaseObject Create(Simplet_bancos_fc instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_bancos_fc instance)
        {
