...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_comprobantes_item_fcRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_comprobantes_item_fc),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplem_comprobantes_item_fc();
        ...
        m_comprobantes_item_fc GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_comprobantes_item_fc>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_comprobantes_item_fc");
        }
        ...
        public SimpleBaseObject Create(Simplem_comprobantes_item_fc instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_comprobantes_item_fc instance)
        {
