...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_codigos_alarmaRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_codigos_alarma),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_codigos_alarma();
        ...
        t_codigos_alarma GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_codigos_alarma>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_codigos_alarma");
        }
        ...
        public SimpleBaseObject Create(Simplet_codigos_alarma instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_codigos_alarma instance)
        {
