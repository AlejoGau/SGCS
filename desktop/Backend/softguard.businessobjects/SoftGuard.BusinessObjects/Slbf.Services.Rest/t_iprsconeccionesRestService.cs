...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_iprsconeccionesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_iprsconecciones),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_iprsconecciones();
        ...
        t_iprsconecciones GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_iprsconecciones>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_iprsconecciones");
        }
        ...
        public SimpleBaseObject Create(Simplet_iprsconecciones instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_iprsconecciones instance)
        {
