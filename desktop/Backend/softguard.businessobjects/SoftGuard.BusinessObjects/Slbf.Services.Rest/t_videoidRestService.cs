...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_videoidRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_videoid),
        ...
        t_videoid GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_videoid>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_videoid");
        }
        ...
        public SimpleBaseObject Create(Simplet_videoid instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_videoid instance)
        {
