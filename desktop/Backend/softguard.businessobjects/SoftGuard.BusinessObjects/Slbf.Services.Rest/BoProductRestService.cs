...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class BoProductRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleProduct),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleProduct();
		...
		SoftGuard.BusinessObjects.Product GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.Product>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "Product");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleProduct instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleProduct instance)
        {
