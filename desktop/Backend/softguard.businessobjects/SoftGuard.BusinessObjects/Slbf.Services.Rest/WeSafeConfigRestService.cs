...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class WeSafeConfigRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleWeSafeConfig),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleWeSafeConfig();
        ...
        SoftGuard.BusinessObjects.WeSafeConfig GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.WeSafeConfig>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "WeSafeConfig");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleWeSafeConfig instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleWeSafeConfig instance)
        {
