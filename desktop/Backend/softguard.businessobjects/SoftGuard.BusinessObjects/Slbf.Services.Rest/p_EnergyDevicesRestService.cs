...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_EnergyDevicesRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.Simplep_EnergyDevices),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.Simplep_EnergyDevices();
        ...
        SoftGuard.BusinessObjects.p_EnergyDevices GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.p_EnergyDevices>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_EnergyDevices");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.Simplep_EnergyDevices instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.Simplep_EnergyDevices instance)
        {
