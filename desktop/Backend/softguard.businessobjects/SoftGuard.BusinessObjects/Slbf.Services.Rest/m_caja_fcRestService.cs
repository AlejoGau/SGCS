...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_caja_fcRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_caja_fc),
        ...
        m_caja_fc GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_caja_fc>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_caja_fc");
        }
        ...
        public SimpleBaseObject Create(Simplem_caja_fc instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_caja_fc instance)
        {
