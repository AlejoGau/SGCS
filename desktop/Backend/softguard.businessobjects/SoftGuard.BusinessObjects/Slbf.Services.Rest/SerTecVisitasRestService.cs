...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SerTecVisitasRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleSerTecVisitas),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleSerTecVisitas();
        ...
        SoftGuard.BusinessObjects.SerTecVisitas GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.SerTecVisitas>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "SerTecVisitas");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleSerTecVisitas instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleSerTecVisitas instance)
        {
