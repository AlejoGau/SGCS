...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class RemoteCallQueueRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleRemoteCallQueue),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleRemoteCallQueue();
        ...
        RemoteCallQueue GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<RemoteCallQueue>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "RemoteCallQueue");
        }
        ...
        public SimpleBaseObject Create(SimpleRemoteCallQueue instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleRemoteCallQueue instance)
        {
