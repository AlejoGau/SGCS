...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_rximgRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_rximg),
        ...
        p_rximg GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_rximg>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_rximg");
        }
        ...
        public SimpleBaseObject Create(Simplep_rximg instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_rximg instance)
        {
