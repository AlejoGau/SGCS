...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_EscalamientoPorOrganizacionRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_EscalamientoPorOrganizacion),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_EscalamientoPorOrganizacion();
        ...
        t_EscalamientoPorOrganizacion GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_EscalamientoPorOrganizacion>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_EscalamientoPorOrganizacion");
        }
        ...
        public SimpleBaseObject Create(Simplet_EscalamientoPorOrganizacion instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_EscalamientoPorOrganizacion instance)
        {
