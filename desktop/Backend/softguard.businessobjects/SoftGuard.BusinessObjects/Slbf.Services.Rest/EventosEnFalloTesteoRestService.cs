...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class EventosEnFalloTesteoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleEventosEnFalloTesteo),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleEventosEnFalloTesteo();
        ...
        EventosEnFalloTesteo GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<EventosEnFalloTesteo>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "EventosEnFalloTesteo");
        }
        ...
        public SimpleBaseObject Create(SimpleEventosEnFalloTesteo instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleEventosEnFalloTesteo instance)
        {
