...
// Type: Slbf.Services.Rest.FalsaRestService
...
namespace Slbf.Services.Rest
{
  ...
  public class FalsaRestService
  {
    private string _CurrentObjectName;

    public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
    {
      return (IEnumerable<Type>) new List<Type>() { typeof (SimpleFalsa), typeof (SimpleMembershipUser), typeof (SimpleUserAccount), typeof (SimpleMenu), typeof (SimplePermission), typeof (SimpleRole), typeof (SimpleTaxonomy), typeof (SimpleMenuItem), typeof (SimpleGroups), typeof (SimpleGroups), typeof (SimpleMetaData), typeof (SimpleFrameworkAudit) };
    }
    ...
    {
      foreach (MemberInfo knownType in FalsaRestService.GetKnownTypes((ICustomAttributeProvider) null))
      {
    ...
    public SimpleBaseObject Create(SimpleFalsa instance)
    {
      ISpecialization currentObject = this.GetCurrentObject();
    ...
    public SimpleBaseObject Update(string id, SimpleFalsa instance)
    {
      try
      {
        ISpecialization currentObject = this.GetCurrentObject();
