...
// Type: Slbf.Services.Rest.MedicalInfoRestService
...
namespace Slbf.Services.Rest
{
  ...
  public class MedicalInfoRestService
  {
    private string _CurrentObjectName;

    public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
    {
      return (IEnumerable<Type>) new List<Type>() { typeof (SimpleMedicalInfo), typeof (SimpleMembershipUser), typeof (SimpleUserAccount), typeof (SimpleMenu), typeof (SimplePermission), typeof (SimpleRole), typeof (SimpleTaxonomy), typeof (SimpleMenuItem), typeof (SimpleGroups), typeof (SimpleGroups), typeof (SimpleMetaData), typeof (SimpleFrameworkAudit) };
    }
    ...
    {
      foreach (MemberInfo knownType in MedicalInfoRestService.GetKnownTypes((ICustomAttributeProvider) null))
      {
    ...
    public SimpleBaseObject Create(SimpleMedicalInfo instance)
    {
      ISpecialization currentObject = this.GetCurrentObject();
    ...
    public SimpleBaseObject Update(string id, SimpleMedicalInfo instance)
    {
      try
      {
        ISpecialization currentObject = this.GetCurrentObject();
