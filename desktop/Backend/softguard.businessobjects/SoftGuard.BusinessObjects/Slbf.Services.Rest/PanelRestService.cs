...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class PanelRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimplePanel),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimplePanel();
        ...
        SoftGuard.BusinessObjects.Panel GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.Panel>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "Panel");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimplePanel instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimplePanel instance)
        {
