...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_dealer_tgconfigRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.Simplem_dealer_tgconfig),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.Simplem_dealer_tgconfig();
        ...
        SoftGuard.BusinessObjects.m_dealer_tgconfig GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.m_dealer_tgconfig>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_dealer_tgconfig");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.Simplem_dealer_tgconfig instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.Simplem_dealer_tgconfig instance)
        {
