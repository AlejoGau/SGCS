...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeSmartPanic : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalSmartPanic _DalObject;
 ...
 ///<summary>
     ...
     public string  Telefono 
		 { 
                    ...
                    get{ return this._DalObject.Telefono; }
        						set{ this._DalObject.Telefono = value; } 										
	   }
	  ///<summary>
     ///Imei property   
     ///</summary>	
     public string  Imei 
		 { 
                    ...
                    get{ return this._DalObject.Imei; }
        						set{ this._DalObject.Imei = value; } 										
	   }
	  ///<summary>
     ///Modelo property   
     ///</summary>	
     public string  Modelo 
		 { 
                    ...
                    get{ return this._DalObject.Modelo; }
        						set{ this._DalObject.Modelo = value; } 										
	   }
	  ///<summary>
     ///Marca property   
     ///</summary>	
     public string  Marca 
		 { 
                    ...
                    get{ return this._DalObject.Marca; }
        						set{ this._DalObject.Marca = value; } 										
	   }
	  ///<summary>
     ///Version property   
     ///</summary>	
     public string  Version 
		 { 
                    ...
                    get{ return this._DalObject.Version; }
        						set{ this._DalObject.Version = value; } 										
	   }
	  ///<summary>
     ///Tipo property   
     ///</summary>	
     public string  Tipo 
		 { 
                    ...
                    get{ return this._DalObject.Tipo; }
        						set{ this._DalObject.Tipo = value; } 										
	   }
	  ///<summary>
     ///CuentaId property   
     ///</summary>	
     public int  CuentaId 
		 { 
                    ...
                    get{ return this._DalObject.CuentaId; }
        						set{ this._DalObject.CuentaId = value; } 										
	   }
	  ///<summary>
     ///Nombre property   
     ///</summary>	
     public string  Nombre 
		 { 
                    ...
                    get{ return this._DalObject.Nombre; }
        						set{ this._DalObject.Nombre = value; } 										
	   }
	  ///<summary>
     ///Config property   
     ///</summary>	
     public string  Config 
		 { 
                    ...
                    get{ return this._DalObject.Config; }
        						set{ this._DalObject.Config = value; } 										
	   }
	  ///<summary>
     ///GrupoId property   
     ///</summary>	
     public int  GrupoId 
		 { 
                    ...
                    get{ return this._DalObject.GrupoId; }
        						set{ this._DalObject.GrupoId = value; } 										
	   }
	  ///<summary>
     ///Linea property   
     ///</summary>	
     public string  Linea 
		 { 
                    ...
                    get{ return this._DalObject.Linea; }
        						set{ this._DalObject.Linea = value; } 										
	   }
	  ///<summary>
     ///awccUserId property   
     ///</summary>	
     public int  awccUserId 
		 { 
                    ...
                    get{ return this._DalObject.awccUserId; }
        						set{ this._DalObject.awccUserId = value; } 										
	   }
	  ///<summary>
     ///pushToken property   
     ///</summary>	
     public string  pushToken 
		 { 
                    ...
                    get{ return this._DalObject.pushToken; }
        						set{ this._DalObject.pushToken = value; } 										
	   }
	  ///<summary>
     ///AppVersion property   
     ///</summary>	
     public string  AppVersion 
		 { 
                    ...
                    get{ return this._DalObject.AppVersion; }
        						set{ this._DalObject.AppVersion = value; } 										
	   }
	  ///<summary>
     ///AppType property   
     ///</summary>	
     public int  AppType 
		 { 
                    ...
                    get{ return this._DalObject.AppType; }
        						set{ this._DalObject.AppType = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeSmartPanic(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeSmartPanic(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeSmartPanic(SqlHelper SqlConfig, int UserId, SimpleSmartPanic Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleSmartPanic Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The SmartPanic has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalSmartPanic GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The SmartPanic is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalSmartPanic(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.SmartPanic)Object;
			o.Name = this.Name;
			...
			o.CuentaId = this.CuentaId;

			o.Nombre = this.Nombre;

			o.Config = this.Config;

			o.GrupoId = this.GrupoId;

			o.Linea = this.Linea;

			o.awccUserId = this.awccUserId;

			o.pushToken = this.pushToken;

			o.AppVersion = this.AppVersion;

			o.AppType = this.AppType;
