...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class SmsRestService
    {
        ...
        Sms GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<Sms>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "Sms");
        }
        ...
        public SimpleBaseObject Create(SimpleSms instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleSms instance)
        {
