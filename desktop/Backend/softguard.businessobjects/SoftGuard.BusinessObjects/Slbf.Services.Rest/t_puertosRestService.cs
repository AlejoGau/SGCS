...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_puertosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_puertos),
        ...
        t_puertos GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_puertos>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_puertos");
        }
        ...
        public SimpleBaseObject Create(Simplet_puertos instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_puertos instance)
        {
