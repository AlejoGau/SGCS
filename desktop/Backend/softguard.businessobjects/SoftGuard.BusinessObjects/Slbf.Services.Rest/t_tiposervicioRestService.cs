...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_tiposervicioRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_tiposervicio),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_tiposervicio();
        ...
        t_tiposervicio GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_tiposervicio>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_tiposervicio");
        }
        ...
        public SimpleBaseObject Create(Simplet_tiposervicio instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_tiposervicio instance)
        {
