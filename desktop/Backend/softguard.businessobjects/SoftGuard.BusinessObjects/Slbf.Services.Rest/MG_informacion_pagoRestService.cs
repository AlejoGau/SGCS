...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class MG_informacion_pagoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleMG_informacion_pago),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleMG_informacion_pago();
        ...
        MG_informacion_pago GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<MG_informacion_pago>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "MG_informacion_pago");
        }
        ...
        public SimpleBaseObject Create(SimpleMG_informacion_pago instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleMG_informacion_pago instance)
        {
