...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_TG_mantenimiento_serviciosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_TG_mantenimiento_servicios),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_TG_mantenimiento_servicios();
        ...
        t_TG_mantenimiento_servicios GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_TG_mantenimiento_servicios>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_TG_mantenimiento_servicios");
        }
        ...
        public SimpleBaseObject Create(Simplet_TG_mantenimiento_servicios instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_TG_mantenimiento_servicios instance)
        {
