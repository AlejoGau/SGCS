...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class WeSafeSubscriptionRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleWeSafeSubscription),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleWeSafeSubscription();
        ...
        SoftGuard.BusinessObjects.WeSafeSubscription GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.WeSafeSubscription>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "WeSafeSubscription");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleWeSafeSubscription instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleWeSafeSubscription instance)
        {
