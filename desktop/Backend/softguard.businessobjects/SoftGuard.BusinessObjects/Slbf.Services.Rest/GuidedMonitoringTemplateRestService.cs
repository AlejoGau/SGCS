...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class GuidedMonitoringTemplateRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SoftGuard.BusinessObjects.SimpleGuidedMonitoringTemplate),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SoftGuard.BusinessObjects.SimpleGuidedMonitoringTemplate();
        ...
        SoftGuard.BusinessObjects.GuidedMonitoringTemplate GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<SoftGuard.BusinessObjects.GuidedMonitoringTemplate>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "GuidedMonitoringTemplate");
        }
        ...
        public SimpleBaseObject Create(SoftGuard.BusinessObjects.SimpleGuidedMonitoringTemplate instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SoftGuard.BusinessObjects.SimpleGuidedMonitoringTemplate instance)
        {
