...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class TG_mantenimiento_historicoRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(SimpleTG_mantenimiento_historico),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new SimpleTG_mantenimiento_historico();
        ...
        TG_mantenimiento_historico GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<TG_mantenimiento_historico>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "TG_mantenimiento_historico");
        }
        ...
        public SimpleBaseObject Create(SimpleTG_mantenimiento_historico instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, SimpleTG_mantenimiento_historico instance)
        {
