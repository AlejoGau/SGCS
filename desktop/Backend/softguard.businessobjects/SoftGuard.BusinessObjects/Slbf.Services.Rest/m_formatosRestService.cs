...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class m_formatosRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplem_formatos),
        ...
        m_formatos GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<m_formatos>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "m_formatos");
        }
        ...
        public SimpleBaseObject Create(Simplem_formatos instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplem_formatos instance)
        {
