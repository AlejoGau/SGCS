...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class t_mailConnectorRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplet_mailConnector),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplet_mailConnector();
        ...
        t_mailConnector GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<t_mailConnector>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "t_mailConnector");
        }
        ...
        public SimpleBaseObject Create(Simplet_mailConnector instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplet_mailConnector instance)
        {
