...
namespace SoftGuard.BusinessObjects.Rest
{
    ...
    public partial class p_recepcion_notasRestService
    {
        public static IEnumerable<Type> GetKnownTypes(ICustomAttributeProvider provider)
        {
            return new List<Type>(){
                typeof(Simplep_recepcion_notas),
        ...
        public PagedOutput GetCollection(string Page, string Start,string Limit, string Sort, string Group, string Filter )
        {
            ...
            {
                DataColumn c;
                var s = new Simplep_recepcion_notas();
        ...
        p_recepcion_notas GetCurrentObject(int Id = 0)
        {
            var Object = Slbf.ObjectFactoryService.Create<p_recepcion_notas>();
        ...
        {
            return _CurrentObjectName ?? (_CurrentObjectName = "p_recepcion_notas");
        }
        ...
        public SimpleBaseObject Create(Simplep_recepcion_notas instance)
        {
			instance.Id = 0;
        ...
        [WebInvoke(UriTemplate = "{id}", Method = "PUT"
            , RequestFormat = WebMessageFormat.Json
            , ResponseFormat = WebMessageFormat.Json)]
        public SimpleBaseObject Update(string id, Simplep_recepcion_notas instance)
        {
