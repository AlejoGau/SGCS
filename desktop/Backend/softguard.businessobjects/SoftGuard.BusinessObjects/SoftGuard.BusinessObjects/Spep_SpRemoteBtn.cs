...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_SpRemoteBtn : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_SpRemoteBtn _DalObject;
 ...
 ///<summary>
     ...
     public string  srb_spimei 
		 { 
                    ...
                    get{ return this._DalObject.srb_spimei; }
        						set{ this._DalObject.srb_spimei = value; } 										
	   }
	  ///<summary>
     ...
     public string  srb_button_uuid 
		 { 
                    ...
                    get{ return this._DalObject.srb_button_uuid; }
        						set{ this._DalObject.srb_button_uuid = value; } 										
	   }
	  ///<summary>
     ///srb_action property   
     ///</summary>	
     public string  srb_action 
		 { 
                    ...
                    get{ return this._DalObject.srb_action; }
        						set{ this._DalObject.srb_action = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_SpRemoteBtn(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_SpRemoteBtn(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_SpRemoteBtn(SqlHelper SqlConfig, int UserId, Simplep_SpRemoteBtn Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_SpRemoteBtn Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_SpRemoteBtn has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_SpRemoteBtn GetDalObject()
		{
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<Simplep_SpRemoteBtn> GetByParent(string ObjectType, int ObjectId)
		{
			return this._DalObject.GetByParent(ObjectType, ObjectId);
		}
		public IEnumerable<Simplep_SpRemoteBtn> GetByChild(string ObjectType, int ObjectId)
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_SpRemoteBtn is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_SpRemoteBtn(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_SpRemoteBtn)Object;
			o.Name = this.Name;

			o.srb_spimei = this.srb_spimei;

			o.srb_button_uuid = this.srb_button_uuid;

			o.srb_action = this.srb_action;
