...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_encuesta_pregunta_respuesta : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_encuesta_pregunta_respuesta _DalObject;
 ...
 ///<summary>
     ...
     public int  epr_epgidkey 
		 { 
                    ...
                    get{ return this._DalObject.epr_epgidkey; }
        						set{ this._DalObject.epr_epgidkey = value; } 										
	   }
	  ///<summary>
     ///epr_cvalue property   
     ///</summary>	
     public string  epr_cvalue 
		 { 
                    ...
                    get{ return this._DalObject.epr_cvalue; }
        						set{ this._DalObject.epr_cvalue = value; } 										
	   }
	  ///<summary>
     ///epr_ivalue property   
     ///</summary>	
     public int  epr_ivalue 
		 { 
                    ...
                    get{ return this._DalObject.epr_ivalue; }
        						set{ this._DalObject.epr_ivalue = value; } 										
	   }
	  ///<summary>
     ///epr_cuser property   
     ///</summary>	
     public string  epr_cuser 
		 { 
                    ...
                    get{ return this._DalObject.epr_cuser; }
        						set{ this._DalObject.epr_cuser = value; } 										
	   }
	  ///<summary>
     ...
     public string  epr_itipousuario 
		 { 
                    ...
                    get{ return this._DalObject.epr_itipousuario; }
        						set{ this._DalObject.epr_itipousuario = value; } 										
	   }
	  ///<summary>
     ...
     public string  epr_cnombreusuario 
		 { 
                    ...
                    get{ return this._DalObject.epr_cnombreusuario; }
        						set{ this._DalObject.epr_cnombreusuario = value; } 										
	   }
	  ///<summary>
     ...
     public string  epr_cnombrecuenta 
		 { 
                    ...
                    get{ return this._DalObject.epr_cnombrecuenta; }
        						set{ this._DalObject.epr_cnombrecuenta = value; } 										
	   }
	  ///<summary>
     ...
     public int  epr_icuenta 
		 { 
                    ...
                    get{ return this._DalObject.epr_icuenta; }
        						set{ this._DalObject.epr_icuenta = value; } 										
	   }
	  ///<summary>
     ...
     public string  epr_ctelefono 
		 { 
                    ...
                    get{ return this._DalObject.epr_ctelefono; }
        						set{ this._DalObject.epr_ctelefono = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_encuesta_pregunta_respuesta(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_encuesta_pregunta_respuesta(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_encuesta_pregunta_respuesta(SqlHelper SqlConfig, int UserId, Simplep_encuesta_pregunta_respuesta Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_encuesta_pregunta_respuesta Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_encuesta_pregunta_respuesta has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_encuesta_pregunta_respuesta GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_encuesta_pregunta_respuesta is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_encuesta_pregunta_respuesta(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_encuesta_pregunta_respuesta)Object;
			o.Name = this.Name;

			o.epr_epgidkey = this.epr_epgidkey;

			o.epr_cvalue = this.epr_cvalue;

			o.epr_ivalue = this.epr_ivalue;

			o.epr_cuser = this.epr_cuser;

			o.epr_itipousuario = this.epr_itipousuario;

			o.epr_cnombreusuario = this.epr_cnombreusuario;

			o.epr_cnombrecuenta = this.epr_cnombrecuenta;

			o.epr_icuenta = this.epr_icuenta;

			o.epr_ctelefono = this.epr_ctelefono;
