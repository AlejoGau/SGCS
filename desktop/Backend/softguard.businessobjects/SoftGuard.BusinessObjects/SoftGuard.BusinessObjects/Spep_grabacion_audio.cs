...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_grabacion_audio : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_grabacion_audio _DalObject;
 ...
 ///<summary>
     ...
     public int  gra_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.gra_iidcuenta; }
        						set{ this._DalObject.gra_iidcuenta = value; } 										
	   }
	  ///<summary>
     ...
     public int  gra_iidrecepcion 
		 { 
                    ...
                    get{ return this._DalObject.gra_iidrecepcion; }
        						set{ this._DalObject.gra_iidrecepcion = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  gra_dfechahora 
		 { 
                    ...
                    get{ return this._DalObject.gra_dfechahora; }
        						set{ this._DalObject.gra_dfechahora = value; } 										
	   }
	  ///<summary>
     ...
     public string  gra_carchivo 
		 { 
                    ...
                    get{ return this._DalObject.gra_carchivo; }
        						set{ this._DalObject.gra_carchivo = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  gra_nduracion 
		 { 
                    ...
                    get{ return this._DalObject.gra_nduracion; }
        						set{ this._DalObject.gra_nduracion = value; } 										
	   }
	  ///<summary>
     ...
     public int  gra_ioperador 
		 { 
                    ...
                    get{ return this._DalObject.gra_ioperador; }
        						set{ this._DalObject.gra_ioperador = value; } 										
	   }
	  ///<summary>
     ...
     public string  gra_cterminal 
		 { 
                    ...
                    get{ return this._DalObject.gra_cterminal; }
        						set{ this._DalObject.gra_cterminal = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  gra_nestado 
		 { 
                    ...
                    get{ return this._DalObject.gra_nestado; }
        						set{ this._DalObject.gra_nestado = value; } 										
	   }
	  ///<summary>
     ...
     public string  gra_ctelefono 
		 { 
                    ...
                    get{ return this._DalObject.gra_ctelefono; }
        						set{ this._DalObject.gra_ctelefono = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_grabacion_audio(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_grabacion_audio(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_grabacion_audio(SqlHelper SqlConfig, int UserId, Simplep_grabacion_audio Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_grabacion_audio Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_grabacion_audio has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_grabacion_audio GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_grabacion_audio is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_grabacion_audio(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.p_grabacion_audio)Object;
			o.Name = this.Name;

			o.gra_iidcuenta = this.gra_iidcuenta;

			o.gra_iidrecepcion = this.gra_iidrecepcion;

			o.gra_dfechahora = this.gra_dfechahora;

			o.gra_carchivo = this.gra_carchivo;

			o.gra_nduracion = this.gra_nduracion;

			o.gra_ioperador = this.gra_ioperador;

			o.gra_cterminal = this.gra_cterminal;

			o.gra_nestado = this.gra_nestado;

			o.gra_ctelefono = this.gra_ctelefono;
