...
{ 
   ///<summary>
     ///m_AccesosProveedoresDocumentos class   
     ///</summary>
    public partial class m_AccesosProveedoresDocumentos : Spem_AccesosProveedoresDocumentos
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_AccesosProveedoresDocumentos(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_AccesosProveedoresDocumentos(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_AccesosProveedoresDocumentos(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_AccesosProveedoresDocumentos(SqlHelper SqlConfig, int UserId, Simplem_AccesosProveedoresDocumentos Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
