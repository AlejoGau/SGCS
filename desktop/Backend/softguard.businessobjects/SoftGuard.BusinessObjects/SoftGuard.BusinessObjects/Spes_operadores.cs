...
// Type: SoftGuard.BusinessObjects.Spes_operadores
...
{
  public abstract class Spes_operadores : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dals_operadores _DalObject;
    ...
    public string ope_clogin
    {
      get
      {
        return this._DalObject.ope_clogin;
      }
      set
      {
        this._DalObject.ope_clogin = value;
      }
    }
    ...
    public string ope_cnombre
    {
      get
      {
        return this._DalObject.ope_cnombre;
      }
      set
      {
        this._DalObject.ope_cnombre = value;
      }
    }
    ...
    public string ope_cclave
    {
      get
      {
        return this._DalObject.ope_cclave;
      }
      set
      {
        this._DalObject.ope_cclave = value;
      }
    }
    ...
    public int ope_nsql
    {
      get
      {
        return this._DalObject.ope_nsql;
      }
      set
      {
        this._DalObject.ope_nsql = value;
      }
    }
    ...
    public Decimal ope_nsupervisor
    {
      get
      {
        return this._DalObject.ope_nsupervisor;
      }
      set
      {
        this._DalObject.ope_nsupervisor = value;
      }
    }
    ...
    public string ope_clinea
    {
      get
      {
        return this._DalObject.ope_clinea;
      }
      set
      {
        this._DalObject.ope_clinea = value;
      }
    }
    ...
    public Decimal ope_nprioridad
    {
      get
      {
        return this._DalObject.ope_nprioridad;
      }
      set
      {
        this._DalObject.ope_nprioridad = value;
      }
    }
    ...
    public DateTime? ope_dCambio
    {
      get
      {
        return this._DalObject.ope_dCambio;
      }
      set
      {
        this._DalObject.ope_dCambio = value;
      }
    }
    ...
    public Decimal ope_nSereno
    {
      get
      {
        return this._DalObject.ope_nSereno;
      }
      set
      {
        this._DalObject.ope_nSereno = value;
      }
    }
    ...
    public int ope_iid
    {
      get
      {
        return this._DalObject.ope_iid;
      }
      set
      {
        this._DalObject.ope_iid = value;
      }
    }
    ...
    public Spes_operadores(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spes_operadores(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spes_operadores(SqlHelper SqlConfig, int UserId, Simples_operadores Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simples_operadores Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The s_operadores has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dals_operadores GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The s_operadores is null.");
    ...
    {
      this._DalObject = new Dals_operadores(SqlConfig, UserId);
    ...
    {
      s_operadores sOperadores = (s_operadores) Object;
      sOperadores.Name = this.Name;
      sOperadores.ope_clogin = this.ope_clogin;
      sOperadores.ope_cnombre = this.ope_cnombre;
      sOperadores.ope_cclave = this.ope_cclave;
      sOperadores.ope_nsql = this.ope_nsql;
      sOperadores.ope_nsupervisor = this.ope_nsupervisor;
      sOperadores.ope_clinea = this.ope_clinea;
      sOperadores.ope_nprioridad = this.ope_nprioridad;
      sOperadores.ope_dCambio = this.ope_dCambio;
      sOperadores.ope_nSereno = this.ope_nSereno;
      sOperadores.ope_iid = this.ope_iid;
    }
