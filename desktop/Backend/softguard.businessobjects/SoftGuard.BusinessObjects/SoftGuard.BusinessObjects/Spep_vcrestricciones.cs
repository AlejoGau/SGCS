...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_vcrestricciones : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_vcrestricciones _DalObject;
 ...
 ///<summary>
     ...
     public string  vcr_name 
		 { 
                    ...
                    get{ return this._DalObject.vcr_name; }
        						set{ this._DalObject.vcr_name = value; } 										
	   }
	  ///<summary>
     ///vcr_list property   
     ///</summary>	
     public string  vcr_list 
		 { 
                    ...
                    get{ return this._DalObject.vcr_list; }
        						set{ this._DalObject.vcr_list = value; } 										
	   }
	  ///<summary>
     ...
     public int  vcr_distance 
		 { 
                    ...
                    get{ return this._DalObject.vcr_distance; }
        						set{ this._DalObject.vcr_distance = value; } 										
	   }
	  ///<summary>
     ///vcr_status property   
     ///</summary>	
     public int  vcr_status 
		 { 
                    ...
                    get{ return this._DalObject.vcr_status; }
        						set{ this._DalObject.vcr_status = value; } 										
	   }
	  ///<summary>
     ...
     public int  vcr_idorganizacion 
		 { 
                    ...
                    get{ return this._DalObject.vcr_idorganizacion; }
        						set{ this._DalObject.vcr_idorganizacion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_vcrestricciones(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_vcrestricciones(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_vcrestricciones(SqlHelper SqlConfig, int UserId, Simplep_vcrestricciones Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_vcrestricciones Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_vcrestricciones has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_vcrestricciones GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_vcrestricciones is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_vcrestricciones(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_vcrestricciones)Object;
			o.Name = this.Name;

			o.vcr_name = this.vcr_name;

			o.vcr_list = this.vcr_list;

			o.vcr_distance = this.vcr_distance;

			o.vcr_status = this.vcr_status;

			o.vcr_idorganizacion = this.vcr_idorganizacion;
