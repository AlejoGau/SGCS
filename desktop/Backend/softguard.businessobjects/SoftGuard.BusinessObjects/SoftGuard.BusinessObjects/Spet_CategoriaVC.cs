...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_CategoriaVC : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_CategoriaVC _DalObject;
 ...
 ///<summary>
     ...
     public string  cvc_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.cvc_cDescripcion; }
        						set{ this._DalObject.cvc_cDescripcion = value; } 										
	   }
	  ///<summary>
     ///cvc_iWork property   
     ///</summary>	
     public int  cvc_iWork 
		 { 
                    ...
                    get{ return this._DalObject.cvc_iWork; }
        						set{ this._DalObject.cvc_iWork = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_CategoriaVC(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_CategoriaVC(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_CategoriaVC(SqlHelper SqlConfig, int UserId, Simplet_CategoriaVC Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_CategoriaVC Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_CategoriaVC has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_CategoriaVC GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_CategoriaVC is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_CategoriaVC(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_CategoriaVC)Object;
			o.Name = this.Name;

			o.cvc_cDescripcion = this.cvc_cDescripcion;

			o.cvc_iWork = this.cvc_iWork;
