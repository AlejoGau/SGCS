...
{ 
   ///<summary>
     ///t_ResourcesModule_Type class   
     ///</summary>
    public partial class t_ResourcesModule_Type : Spet_ResourcesModule_Type
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_ResourcesModule_Type(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_ResourcesModule_Type(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_ResourcesModule_Type(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_ResourcesModule_Type(SqlHelper SqlConfig, int UserId, Simplet_ResourcesModule_Type Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
