...
{ 	
   ///<summary>
     ///Caller object class   
     ///</summary>
    public class Callerm_cuenta_grupo_usuarios : CallerObject
    { 	
     ...
     ///Constructor   
     ///</summary>
        public Callerm_cuenta_grupo_usuarios() : base()
        {
            InitClass();
        }  
 ///<summary>
     ///Constructor   
     ///</summary>		
        public Callerm_cuenta_grupo_usuarios(int Id, string Name, int cgu_idgrupo, int cgu_idusuario) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
...
Simple.cgu_idusuario = this._cgu_idusuario;
 ...
 ///<summary>
     ///Sets a simpleobject   
     ///</summary>	
		public void SetSimpleObject(Simplem_cuenta_grupo_usuarios Simple)
		{
			base.Id = Simple.Id;
...
this._cgu_idusuario = Simple.cgu_idusuario;
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{
			return new Dalm_cuenta_grupo_usuarios(SqlConfig, UserId, (Simplem_cuenta_grupo_usuarios) GetSimpleObject());
		}
 ///<summary>
     ///Get object's data   
     ///</summary>
