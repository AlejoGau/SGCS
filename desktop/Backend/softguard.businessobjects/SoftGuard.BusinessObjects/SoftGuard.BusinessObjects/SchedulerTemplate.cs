...
// Type: SoftGuard.BusinessObjects.SchedulerTemplate
...
{
  public class SchedulerTemplate : SpeSchedulerTemplate
  {
    public SchedulerTemplate(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public SchedulerTemplate(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public SchedulerTemplate(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public SchedulerTemplate(SqlHelper SqlConfig, int UserId, SimpleSchedulerTemplate Simple)
