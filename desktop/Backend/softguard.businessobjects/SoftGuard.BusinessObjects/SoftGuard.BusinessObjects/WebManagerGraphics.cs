...
// Type: SoftGuard.BusinessObjects.WebManagerGraphics
...
{
  public class WebManagerGraphics : SpeWebManagerGraphics
  {
    public WebManagerGraphics(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public WebManagerGraphics(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public WebManagerGraphics(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public WebManagerGraphics(SqlHelper SqlConfig, int UserId, SimpleWebManagerGraphics Simple)
