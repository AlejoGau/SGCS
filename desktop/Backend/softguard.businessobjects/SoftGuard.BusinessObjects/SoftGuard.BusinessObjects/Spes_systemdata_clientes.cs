...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spes_systemdata_clientes : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dals_systemdata_clientes _DalObject;
 ...
 ///<summary>
     ...
     public DateTime?  sdc_fecha 
		 { 
                    ...
                    get{ return this._DalObject.sdc_fecha; }
        						set{ this._DalObject.sdc_fecha = value; } 										
	   }
	  ///<summary>
     ///sdc_code property   
     ///</summary>	
     public string  sdc_code 
		 { 
                    ...
                    get{ return this._DalObject.sdc_code; }
        						set{ this._DalObject.sdc_code = value; } 										
	   }
	  ///<summary>
     ///sdc_serial property   
     ///</summary>	
     public string  sdc_serial 
		 { 
                    ...
                    get{ return this._DalObject.sdc_serial; }
        						set{ this._DalObject.sdc_serial = value; } 										
	   }
	  ///<summary>
     ///sdc_key_id property   
     ///</summary>	
     public string  sdc_key_id 
		 { 
                    ...
                    get{ return this._DalObject.sdc_key_id; }
        						set{ this._DalObject.sdc_key_id = value; } 										
	   }
	  ///<summary>
     ///sdc_secret property   
     ///</summary>	
     public string  sdc_secret 
		 { 
                    ...
                    get{ return this._DalObject.sdc_secret; }
        						set{ this._DalObject.sdc_secret = value; } 										
	   }
	  ///<summary>
     ...
     public int  sdc_client_id 
		 { 
                    ...
                    get{ return this._DalObject.sdc_client_id; }
        						set{ this._DalObject.sdc_client_id = value; } 										
	   }
	  ///<summary>
     ///sdc_public property   
     ///</summary>	
     public string  sdc_public 
		 { 
                    ...
                    get{ return this._DalObject.sdc_public; }
        						set{ this._DalObject.sdc_public = value; } 										
	   }
	  ///<summary>
     ///sdc_data property   
     ///</summary>	
     public string  sdc_data 
		 { 
                    ...
                    get{ return this._DalObject.sdc_data; }
        						set{ this._DalObject.sdc_data = value; } 										
	   }
	  ///<summary>
     ///sdc_type property   
     ///</summary>	
     public int  sdc_type 
		 { 
                    ...
                    get{ return this._DalObject.sdc_type; }
        						set{ this._DalObject.sdc_type = value; } 										
	   }
	  ///<summary>
     ///sdc_log property   
     ///</summary>	
     public string  sdc_log 
		 { 
                    ...
                    get{ return this._DalObject.sdc_log; }
        						set{ this._DalObject.sdc_log = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  sdc_lastupdate 
		 { 
                    ...
                    get{ return this._DalObject.sdc_lastupdate; }
        						set{ this._DalObject.sdc_lastupdate = value; } 										
	   }
	  ///<summary>
     ///sdc_status property   
     ///</summary>	
     public int  sdc_status 
		 { 
                    ...
                    get{ return this._DalObject.sdc_status; }
        						set{ this._DalObject.sdc_status = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spes_systemdata_clientes(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_systemdata_clientes(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_systemdata_clientes(SqlHelper SqlConfig, int UserId, Simples_systemdata_clientes Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simples_systemdata_clientes Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The s_systemdata_clientes has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dals_systemdata_clientes GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The s_systemdata_clientes is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dals_systemdata_clientes(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (s_systemdata_clientes)Object;
			o.Name = this.Name;

			o.sdc_fecha = this.sdc_fecha;

			o.sdc_code = this.sdc_code;

			o.sdc_serial = this.sdc_serial;

			o.sdc_key_id = this.sdc_key_id;

			o.sdc_secret = this.sdc_secret;

			o.sdc_client_id = this.sdc_client_id;

			o.sdc_public = this.sdc_public;

			o.sdc_data = this.sdc_data;

			o.sdc_type = this.sdc_type;

			o.sdc_log = this.sdc_log;

			o.sdc_lastupdate = this.sdc_lastupdate;

			o.sdc_status = this.sdc_status;
