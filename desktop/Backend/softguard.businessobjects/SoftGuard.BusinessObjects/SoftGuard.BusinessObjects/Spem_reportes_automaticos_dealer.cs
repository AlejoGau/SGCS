...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_reportes_automaticos_dealer : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_reportes_automaticos_dealer _DalObject;
 ...
 ///<summary>
     ...
     public int  rad_linidkey 
		 { 
                    ...
                    get{ return this._DalObject.rad_linidkey; }
        						set{ this._DalObject.rad_linidkey = value; } 										
	   }
	  ///<summary>
     ///rad_ntipo property   
     ///</summary>	
     public int  rad_ntipo 
		 { 
                    ...
                    get{ return this._DalObject.rad_ntipo; }
        						set{ this._DalObject.rad_ntipo = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  rad_tproximoenvio 
		 { 
                    ...
                    get{ return this._DalObject.rad_tproximoenvio; }
        						set{ this._DalObject.rad_tproximoenvio = value; } 										
	   }
	  ///<summary>
     ...
     public int  rad_nfrecuencia 
		 { 
                    ...
                    get{ return this._DalObject.rad_nfrecuencia; }
        						set{ this._DalObject.rad_nfrecuencia = value; } 										
	   }
	  ///<summary>
     ///rad_cmail property   
     ///</summary>	
     public string  rad_cmail 
		 { 
                    ...
                    get{ return this._DalObject.rad_cmail; }
        						set{ this._DalObject.rad_cmail = value; } 										
	   }
	  ///<summary>
     ...
     public int  rad_idGrupo 
		 { 
                    ...
                    get{ return this._DalObject.rad_idGrupo; }
        						set{ this._DalObject.rad_idGrupo = value; } 										
	   }
	  ///<summary>
     ...
     public int  rad_nAlerta 
		 { 
                    ...
                    get{ return this._DalObject.rad_nAlerta; }
        						set{ this._DalObject.rad_nAlerta = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_reportes_automaticos_dealer(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_reportes_automaticos_dealer(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_reportes_automaticos_dealer(SqlHelper SqlConfig, int UserId, Simplem_reportes_automaticos_dealer Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_reportes_automaticos_dealer Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_reportes_automaticos_dealer has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_reportes_automaticos_dealer GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_reportes_automaticos_dealer is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_reportes_automaticos_dealer(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_reportes_automaticos_dealer)Object;
			o.Name = this.Name;

			o.rad_linidkey = this.rad_linidkey;

			o.rad_ntipo = this.rad_ntipo;

			o.rad_tproximoenvio = this.rad_tproximoenvio;

			o.rad_nfrecuencia = this.rad_nfrecuencia;

			o.rad_cmail = this.rad_cmail;

			o.rad_idGrupo = this.rad_idGrupo;

			o.rad_nAlerta = this.rad_nAlerta;
