...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_tipos : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_tipos _DalObject;
 ...
 ///<summary>
     ...
     public string  tip_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.tip_ccodigo; }
        						set{ this._DalObject.tip_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  tip_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.tip_cdescripcion; }
        						set{ this._DalObject.tip_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  tip_curlimagen 
		 { 
                    ...
                    get{ return this._DalObject.tip_curlimagen; }
        						set{ this._DalObject.tip_curlimagen = value; } 										
	   }
	  ///<summary>
     ...
     public string  tip_cservicio 
		 { 
                    ...
                    get{ return this._DalObject.tip_cservicio; }
        						set{ this._DalObject.tip_cservicio = value; } 										
	   }
	  ///<summary>
     ///tip_nTipo property   
     ///</summary>	
     public int  tip_nTipo 
		 { 
                    ...
                    get{ return this._DalObject.tip_nTipo; }
        						set{ this._DalObject.tip_nTipo = value; } 										
	   }
	  ///<summary>
     ...
     public int  tip_nCondicion 
		 { 
                    ...
                    get{ return this._DalObject.tip_nCondicion; }
        						set{ this._DalObject.tip_nCondicion = value; } 										
	   }
	  ///<summary>
     ///tip_cRubro property   
     ///</summary>	
     public string  tip_cRubro 
		 { 
                    ...
                    get{ return this._DalObject.tip_cRubro; }
        						set{ this._DalObject.tip_cRubro = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_tipos(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_tipos(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_tipos(SqlHelper SqlConfig, int UserId, Simplet_tipos Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_tipos Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_tipos has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_tipos GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_tipos is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_tipos(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_tipos)Object;
			o.Name = this.Name;

			o.tip_ccodigo = this.tip_ccodigo;

			o.tip_cdescripcion = this.tip_cdescripcion;

			o.tip_curlimagen = this.tip_curlimagen;

			o.tip_cservicio = this.tip_cservicio;

			o.tip_nTipo = this.tip_nTipo;

			o.tip_nCondicion = this.tip_nCondicion;

			o.tip_cRubro = this.tip_cRubro;
