...
{ 
   ///<summary>
     ///p_lista_correo class   
     ///</summary>
    public partial class p_lista_correo : Spep_lista_correo
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_lista_correo(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_lista_correo(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_lista_correo(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_lista_correo(SqlHelper SqlConfig, int UserId, Simplep_lista_correo Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
