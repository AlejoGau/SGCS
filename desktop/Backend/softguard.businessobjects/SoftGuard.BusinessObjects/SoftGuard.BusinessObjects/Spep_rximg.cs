...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_rximg : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_rximg _DalObject;
 ...
 ///<summary>
     ...
     public int  rxi_irecid 
		 { 
                    ...
                    get{ return this._DalObject.rxi_irecid; }
        						set{ this._DalObject.rxi_irecid = value; } 										
	   }
	  ///<summary>
     ///rxi_cimg property   
     ///</summary>	
     public string  rxi_cimg 
		 { 
                    ...
                    get{ return this._DalObject.rxi_cimg; }
        						set{ this._DalObject.rxi_cimg = value; } 										
	   }
	  ///<summary>
     ...
     public string  rxi_ccarpeta 
		 { 
                    ...
                    get{ return this._DalObject.rxi_ccarpeta; }
        						set{ this._DalObject.rxi_ccarpeta = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  rxi_nestado 
		 { 
                    ...
                    get{ return this._DalObject.rxi_nestado; }
        						set{ this._DalObject.rxi_nestado = value; } 										
	   }
	  ///<summary>
     ///rxi_ctipo property   
     ///</summary>	
     public string  rxi_ctipo 
		 { 
                    ...
                    get{ return this._DalObject.rxi_ctipo; }
        						set{ this._DalObject.rxi_ctipo = value; } 										
	   }
	  ///<summary>
     ...
     public string  rxi_cconfig 
		 { 
                    ...
                    get{ return this._DalObject.rxi_cconfig; }
        						set{ this._DalObject.rxi_cconfig = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_rximg(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_rximg(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_rximg(SqlHelper SqlConfig, int UserId, Simplep_rximg Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_rximg Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_rximg has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_rximg GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_rximg is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_rximg(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_rximg)Object;
			o.Name = this.Name;

			o.rxi_irecid = this.rxi_irecid;

			o.rxi_cimg = this.rxi_cimg;

			o.rxi_ccarpeta = this.rxi_ccarpeta;

			o.rxi_nestado = this.rxi_nestado;

			o.rxi_ctipo = this.rxi_ctipo;

			o.rxi_cconfig = this.rxi_cconfig;
