...
{ 
   ///<summary>
     ///crm_contrato_item class   
     ///</summary>
    public partial class crm_contrato_item : Specrm_contrato_item
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public crm_contrato_item(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public crm_contrato_item(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public crm_contrato_item(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public crm_contrato_item(SqlHelper SqlConfig, int UserId, Simplecrm_contrato_item Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
