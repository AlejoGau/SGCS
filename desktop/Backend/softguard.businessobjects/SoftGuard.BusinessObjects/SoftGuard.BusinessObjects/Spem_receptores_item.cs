...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_receptores_item : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_receptores_item _DalObject;
 ...
 ///<summary>
     ...
     public int  rec_iid 
		 { 
                    ...
                    get{ return this._DalObject.rec_iid; }
        						set{ this._DalObject.rec_iid = value; } 										
	   }
	  ///<summary>
     ...
     public string  rec_cformato 
		 { 
                    ...
                    get{ return this._DalObject.rec_cformato; }
        						set{ this._DalObject.rec_cformato = value; } 										
	   }
	  ///<summary>
     ...
     public int  rec_iConexion 
		 { 
                    ...
                    get{ return this._DalObject.rec_iConexion; }
        						set{ this._DalObject.rec_iConexion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_receptores_item(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_receptores_item(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_receptores_item(SqlHelper SqlConfig, int UserId, Simplem_receptores_item Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_receptores_item Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_receptores_item has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_receptores_item GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_receptores_item is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_receptores_item(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_receptores_item)Object;
			o.Name = this.Name;

			o.rec_iid = this.rec_iid;

			o.rec_cformato = this.rec_cformato;

			o.rec_iConexion = this.rec_iConexion;
