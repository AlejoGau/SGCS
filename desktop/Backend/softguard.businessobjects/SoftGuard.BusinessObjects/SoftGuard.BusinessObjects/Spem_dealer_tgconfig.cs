...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_dealer_tgconfig : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_dealer_tgconfig _DalObject;
 ...
 ///<summary>
     ...
     public string  dtg_cdealer 
		 { 
                    ...
                    get{ return this._DalObject.dtg_cdealer; }
        						set{ this._DalObject.dtg_cdealer = value; } 										
	   }
	  ///<summary>
     ///dtg_config property   
     ///</summary>	
     public string  dtg_config 
		 { 
                    ...
                    get{ return this._DalObject.dtg_config; }
        						set{ this._DalObject.dtg_config = value; } 										
	   }
	  ///<summary>
     ...
     public int  dtg_parking_velocidad 
		 { 
                    ...
                    get{ return this._DalObject.dtg_parking_velocidad; }
        						set{ this._DalObject.dtg_parking_velocidad = value; } 										
	   }
	  ///<summary>
     ...
     public string  dtg_parking_eventos 
		 { 
                    ...
                    get{ return this._DalObject.dtg_parking_eventos; }
        						set{ this._DalObject.dtg_parking_eventos = value; } 										
	   }
	  ///<summary>
     ...
     public string  dtg_parking_eventos_hide 
		 { 
                    ...
                    get{ return this._DalObject.dtg_parking_eventos_hide; }
        						set{ this._DalObject.dtg_parking_eventos_hide = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_dealer_tgconfig(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_dealer_tgconfig(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_dealer_tgconfig(SqlHelper SqlConfig, int UserId, Simplem_dealer_tgconfig Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_dealer_tgconfig Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_dealer_tgconfig has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_dealer_tgconfig GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_dealer_tgconfig is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_dealer_tgconfig(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_dealer_tgconfig)Object;
			o.Name = this.Name;

			o.dtg_cdealer = this.dtg_cdealer;

			o.dtg_config = this.dtg_config;

			o.dtg_parking_velocidad = this.dtg_parking_velocidad;

			o.dtg_parking_eventos = this.dtg_parking_eventos;

			o.dtg_parking_eventos_hide = this.dtg_parking_eventos_hide;
