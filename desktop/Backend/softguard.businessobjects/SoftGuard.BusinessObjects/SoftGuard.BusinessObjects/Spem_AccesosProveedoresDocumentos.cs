...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_AccesosProveedoresDocumentos : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_AccesosProveedoresDocumentos _DalObject;
 ...
 ///<summary>
     ...
     public int  apd_idKeyProveedor 
		 { 
                    ...
                    get{ return this._DalObject.apd_idKeyProveedor; }
        						set{ this._DalObject.apd_idKeyProveedor = value; } 										
	   }
	  ///<summary>
     ...
     public int  apd_idKeyTipoDoc 
		 { 
                    ...
                    get{ return this._DalObject.apd_idKeyTipoDoc; }
        						set{ this._DalObject.apd_idKeyTipoDoc = value; } 										
	   }
	  ///<summary>
     ...
     public string  apd_cDescripcion  
		 { 
                    ...
                    get{ return this._DalObject.apd_cDescripcion ; }
        						set{ this._DalObject.apd_cDescripcion  = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  apd_tFechaVto 
		 { 
                    ...
                    get{ return this._DalObject.apd_tFechaVto; }
        						set{ this._DalObject.apd_tFechaVto = value; } 										
	   }
	  ///<summary>
     ...
     public string  apd_cPathFile 
		 { 
                    ...
                    get{ return this._DalObject.apd_cPathFile; }
        						set{ this._DalObject.apd_cPathFile = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_AccesosProveedoresDocumentos(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_AccesosProveedoresDocumentos(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_AccesosProveedoresDocumentos(SqlHelper SqlConfig, int UserId, Simplem_AccesosProveedoresDocumentos Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_AccesosProveedoresDocumentos Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_AccesosProveedoresDocumentos has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_AccesosProveedoresDocumentos GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_AccesosProveedoresDocumentos is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_AccesosProveedoresDocumentos(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_AccesosProveedoresDocumentos)Object;
			o.Name = this.Name;

			o.apd_idKeyProveedor = this.apd_idKeyProveedor;

			o.apd_idKeyTipoDoc = this.apd_idKeyTipoDoc;

			o.apd_cDescripcion  = this.apd_cDescripcion ;

			o.apd_tFechaVto = this.apd_tFechaVto;

			o.apd_cPathFile = this.apd_cPathFile;
