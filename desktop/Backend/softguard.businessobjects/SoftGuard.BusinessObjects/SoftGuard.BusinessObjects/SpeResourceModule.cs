...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeResourceModule : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalResourceModule _DalObject;
 ...
 ///<summary>
     ...
     public string  rmo_cNombre 
		 { 
                    ...
                    get{ return this._DalObject.rmo_cNombre; }
        						set{ this._DalObject.rmo_cNombre = value; } 										
	   }
	  ///<summary>
     ...
     public int  rmo_iTypeId 
		 { 
                    ...
                    get{ return this._DalObject.rmo_iTypeId; }
        						set{ this._DalObject.rmo_iTypeId = value; } 										
	   }
	  ///<summary>
     ...
     public string  rmo_cImagen 
		 { 
                    ...
                    get{ return this._DalObject.rmo_cImagen; }
        						set{ this._DalObject.rmo_cImagen = value; } 										
	   }
	  ///<summary>
     ...
     public string  rmo_cObservacion 
		 { 
                    ...
                    get{ return this._DalObject.rmo_cObservacion; }
        						set{ this._DalObject.rmo_cObservacion = value; } 										
	   }
	  ///<summary>
     ...
     public string  rmo_cMarcaModelo 
		 { 
                    ...
                    get{ return this._DalObject.rmo_cMarcaModelo; }
        						set{ this._DalObject.rmo_cMarcaModelo = value; } 										
	   }
	  ///<summary>
     ...
     public string  rmo_cNumeroSerie 
		 { 
                    ...
                    get{ return this._DalObject.rmo_cNumeroSerie; }
        						set{ this._DalObject.rmo_cNumeroSerie = value; } 										
	   }
	  ///<summary>
     ...
     public int  rmo_iCuentaId 
		 { 
                    ...
                    get{ return this._DalObject.rmo_iCuentaId; }
        						set{ this._DalObject.rmo_iCuentaId = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeResourceModule(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeResourceModule(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeResourceModule(SqlHelper SqlConfig, int UserId, SimpleResourceModule Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleResourceModule Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The ResourceModule has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalResourceModule GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The ResourceModule is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalResourceModule(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.ResourceModule)Object;
			o.Name = this.Name;

			o.rmo_cNombre = this.rmo_cNombre;

			o.rmo_iTypeId = this.rmo_iTypeId;

			o.rmo_cImagen = this.rmo_cImagen;

			o.rmo_cObservacion = this.rmo_cObservacion;

			o.rmo_cMarcaModelo = this.rmo_cMarcaModelo;

			o.rmo_cNumeroSerie = this.rmo_cNumeroSerie;

			o.rmo_iCuentaId = this.rmo_iCuentaId;
