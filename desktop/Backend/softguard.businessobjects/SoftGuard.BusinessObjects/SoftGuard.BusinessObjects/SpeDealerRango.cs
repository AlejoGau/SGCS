...
// Type: SoftGuard.BusinessObjects.SpeDealerRango
...
{
  public abstract class SpeDealerRango : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalDealerRango _DalObject;
    ...
    public string NombreEntidad
    {
      get
      {
        return this._DalObject.NombreEntidad;
      }
      set
      {
        this._DalObject.NombreEntidad = value;
      }
    }
    ...
    public int IdEntidad
    {
      get
      {
        return this._DalObject.IdEntidad;
      }
      set
      {
        this._DalObject.IdEntidad = value;
      }
    }
    ...
    public string Dealer
    {
      get
      {
        return this._DalObject.Dealer;
      }
      set
      {
        this._DalObject.Dealer = value;
      }
    }
    ...
    public string CuentaDesde
    {
      get
      {
        return this._DalObject.CuentaDesde;
      }
      set
      {
        this._DalObject.CuentaDesde = value;
      }
    }
    ...
    public string CuentaHasta
    {
      get
      {
        return this._DalObject.CuentaHasta;
      }
      set
      {
        this._DalObject.CuentaHasta = value;
      }
    }
    ...
    public SpeDealerRango(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeDealerRango(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeDealerRango(SqlHelper SqlConfig, int UserId, SimpleDealerRango Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleDealerRango Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The DealerRango has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalDealerRango GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The DealerRango is null.");
    ...
    {
      this._DalObject = new DalDealerRango(SqlConfig, UserId);
    ...
    {
      DealerRango dealerRango = (DealerRango) Object;
      dealerRango.Name = this.Name;
      dealerRango.NombreEntidad = this.NombreEntidad;
      dealerRango.IdEntidad = this.IdEntidad;
      dealerRango.Dealer = this.Dealer;
      dealerRango.CuentaDesde = this.CuentaDesde;
      dealerRango.CuentaHasta = this.CuentaHasta;
    }
