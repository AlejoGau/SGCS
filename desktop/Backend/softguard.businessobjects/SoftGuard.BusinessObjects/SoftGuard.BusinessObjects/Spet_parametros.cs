...
// Type: SoftGuard.BusinessObjects.Spet_parametros
...
{
  public abstract class Spet_parametros : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_parametros _DalObject;
    ...
    public string par_ccodigo
    {
      get
      {
        return this._DalObject.par_ccodigo;
      }
      set
      {
        this._DalObject.par_ccodigo = value;
      }
    }
    ...
    public string par_cdescripcion
    {
      get
      {
        return this._DalObject.par_cdescripcion;
      }
      set
      {
        this._DalObject.par_cdescripcion = value;
      }
    }
    ...
    public int par_ivalor
    {
      get
      {
        return this._DalObject.par_ivalor;
      }
      set
      {
        this._DalObject.par_ivalor = value;
      }
    }
    ...
    public string par_mobservacion
    {
      get
      {
        return this._DalObject.par_mobservacion;
      }
      set
      {
        this._DalObject.par_mobservacion = value;
      }
    }
    ...
    public string par_cconfig
    {
      get
      {
        return this._DalObject.par_cconfig;
      }
      set
      {
        this._DalObject.par_cconfig = value;
      }
    }
    ...
    public string par_ccomentario
    {
      get
      {
        return this._DalObject.par_ccomentario;
      }
      set
      {
        this._DalObject.par_ccomentario = value;
      }
    }
    ...
    public string par_cvalor
    {
      get
      {
        return this._DalObject.par_cvalor;
      }
      set
      {
        this._DalObject.par_cvalor = value;
      }
    }
    ...
    public Spet_parametros(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_parametros(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_parametros(SqlHelper SqlConfig, int UserId, Simplet_parametros Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_parametros Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_parametros has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_parametros GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_parametros is null.");
    ...
    {
      this._DalObject = new Dalt_parametros(SqlConfig, UserId);
    ...
    {
      t_parametros tParametros = (t_parametros) Object;
      tParametros.Name = this.Name;
      tParametros.par_ccodigo = this.par_ccodigo;
      tParametros.par_cdescripcion = this.par_cdescripcion;
      tParametros.par_ivalor = this.par_ivalor;
      tParametros.par_mobservacion = this.par_mobservacion;
      tParametros.par_cconfig = this.par_cconfig;
      tParametros.par_ccomentario = this.par_ccomentario;
      tParametros.par_cvalor = this.par_cvalor;
    }
