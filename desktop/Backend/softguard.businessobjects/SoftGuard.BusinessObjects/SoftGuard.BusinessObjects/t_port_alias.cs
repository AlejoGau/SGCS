...
// Type: SoftGuard.BusinessObjects.t_port_alias
...
{
  public class t_port_alias : Spet_port_alias
  {
    public t_port_alias(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_port_alias(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_port_alias(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_port_alias(SqlHelper SqlConfig, int UserId, Simplet_port_alias Simple)
