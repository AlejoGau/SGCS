...
{ 
   ///<summary>
     ///p_recepcion class   
     ///</summary>
    public partial class p_recepcion : Spep_recepcion
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_recepcion(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_recepcion(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_recepcion(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_recepcion(SqlHelper SqlConfig, int UserId, Simplep_recepcion Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
