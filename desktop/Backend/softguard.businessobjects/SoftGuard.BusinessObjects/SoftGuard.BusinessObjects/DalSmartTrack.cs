    ...
    {
     ///<summary>
     ///SmartTrack data access layer   
     ///</summary>
    public class DalSmartTrack : TransactionObject
    { 
    ...
    set{ this._AutoCommit = value; }
     ...
     ///Constructor   
     ///</summary>
    public DalSmartTrack(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    {
    InitClass();
    SetConfig(SqlConfig);
    }
     ...
     ///Constructor   
     ///</summary>
    public DalSmartTrack(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId)
    {
    InitClass();
    SetConfig(SqlConfig);
    Load(Id);
     ...
     ///Constructor   
     ///</summary>
    public DalSmartTrack(SqlHelper SqlConfig, int UserId, SimpleSmartTrack Simple) : base(SqlConfig, UserId)
    {
    InitClass();
    SetConfig(SqlConfig);
    base.Id = Simple.Id;
   ...
   ///<summary>
    ...
    using(var cmd = new SqlCommand("SmartTrackIns", conn))
    {
    // Insert
    cmd.CommandType = CommandType.StoredProcedure;
    cmd.Parameters.Add(new SqlParameter("@Name", SqlDbType.NVarChar));
    cmd.Parameters.Add(new SqlParameter("@Telefono", SqlDbType.NVarChar));cmd.Parameters.Add(new SqlParameter("@Imei", SqlDbType.NVarChar));cmd.Parameters.Add(new SqlParameter("@Modelo", SqlDbType.NVarChar));cmd.Parameters.Add(new SqlParameter("@Marca", SqlDbType.NVarChar));cmd.Parameters.Add(new SqlParameter("@Version", SqlDbType.NVarChar));cmd.Parameters.Add(new SqlParameter("@Tipo", SqlDbType.NVarChar));cmd.Parameters.Add(new SqlParameter("@CuentaId", SqlDbType.Int));cmd.Parameters.Add(new SqlParameter("@Nombre", SqlDbType.NVarChar));cmd.Parameters.Add(new SqlParameter("@Config", SqlDbType.NVarChar));cmd.Parameters.Add(new SqlParameter("@pushToken", SqlDbType.NVarChar));cmd.Parameters.Add(new SqlParameter("@AppType", SqlDbType.NVarChar));
    ...
    cmd.Parameters["@Name"].Value = base.Name;
		...
		cmd.Parameters["@AppType"].Value = (this._AppType == null) ? (object) DBNull.Value : (object) this._AppType;
    ...
    // Update
    using(var conn = new SqlConnection(_ConnectionString))
    using(var cmd = new SqlCommand("SmartTrackUpd", conn))
    {
    cmd.CommandType = CommandType.StoredProcedure;
   ...
   ///<summary>
    ...
    if(base.Id == 0)
    {
    throw new RuntimeException("The SmartTrack is null");
    }
    else
    {
    //delete
    ...
    // Delete
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDel = new SqlCommand("SmartTrackDel", conn))
    {
   ...
   ///<summary>
    ...
    // Select
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdSel = new SqlCommand("SmartTrackSel", conn))
    {
   ...
   ///<summary>
    ...
    {
    var Simple = (SimpleSmartTrack)BaseSimple;
    base.Id = Simple.Id;
    base.Name = Simple.Name;
   ...
   ///<summary>
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdChilds = new SqlCommand("SmartTrackByChildObject", conn))
...
if (Reader.FieldCount > 11)Simple.pushToken = (Reader.IsDBNull(11)) ? "" : Reader.GetString(11);
if (Reader.FieldCount > 12)Simple.AppType = (Reader.IsDBNull(12)) ? "" : Reader.GetString(12);
...
Simple.AppType = (Row["AppType"] == DBNull.Value) ? "" : (string) Row["AppType"];
   ...
   ///<summary>
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdParents = new SqlCommand("SmartTrackByParentObject", conn))
...
if (Reader.FieldCount > 12)Simple.AppType = (Reader.IsDBNull(12)) ? "" : Reader.GetString(12);
   ...
   ///<summary>
    ...
    using (var conn = new SqlConnection(_ConnectionString))
    using (var CmdDataByName = new SqlCommand("SmartTrackByName", conn))
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDataByNameWithChild = new SqlCommand("SmartTrackByNameWithChild", conn))
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDataByNameWithParent = new SqlCommand("SmartTrackByNameWithParent", conn))
    ...
    DataTable Data = new DataTable("Object");
    using( var conn = new SqlConnection(_ConnectionString))
    using (var cmd = new SqlCommand("SmartTrackByFilter", conn))
    ...
    DataTable Data = new DataTable("Object");
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDataByText = new SqlCommand("SmartTrackByText", conn))
    ...
    return Data;
     ...
     ///</summary>
    public DataTable GetDataBySimpleObject(SimpleSmartTrack Simple, TaxonomyCollection Taxonomies, int PageCount, int PagePresent, ref int PageTotal, ref int RowTotal)
    {
    base.Load();
    using(var conn = new SqlConnection(_ConnectionString))
    using(var cmd = new SqlCommand("SmartTrackBySimpleSmartTrack", conn))
    using(var Adapter = new SqlDataAdapter(cmd))
    {
    cmd.CommandType = CommandType.StoredProcedure;
    cmd.Parameters.Add(new SqlParameter("@Name", SqlDbType.NVarChar));
   ...
   ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<SimpleSmartTrack> GetByChild(string ObjectType, int ObjectId)
		{
			base.Load();
			
			using(var conn = new SqlConnection(_ConnectionString))
			using(var Cmd = new SqlCommand("SmartTrackByParentObject", conn))
			{
				conn.Open();
				Cmd.CommandType = CommandType.StoredProcedure;
...
if (Reader.FieldCount > 12)Simple.AppType = (Reader.IsDBNull(12)) ? "" : Reader.GetString(12);
   ...
   ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<SimpleSmartTrack> GetByParent(string ObjectType, int ObjectId)
		{
			base.Load();
			using(var conn = new SqlConnection(_ConnectionString))
			using(var Cmd = new SqlCommand("SmartTrackByChildObject", conn))
			{
				conn.Open();
				Cmd.CommandType = CommandType.StoredProcedure;
				Cmd.Parameters.Add(new SqlParameter("@ObjectType", SqlDbType.NVarChar)).Value = ObjectType;
...
if (Reader.FieldCount > 11)this._pushToken = (Reader.IsDBNull(11)) ? "" : Reader.GetString(11);
if (Reader.FieldCount > 12)this._AppType = (Reader.IsDBNull(12)) ? "" : Reader.GetString(12);
