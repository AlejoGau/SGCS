...
// Type: SoftGuard.BusinessObjects.SerTecFormaViajeVisitas
...
{
  public class SerTecFormaViajeVisitas : SpeSerTecFormaViajeVisitas
  {
    public SerTecFormaViajeVisitas(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public SerTecFormaViajeVisitas(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public SerTecFormaViajeVisitas(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public SerTecFormaViajeVisitas(SqlHelper SqlConfig, int UserId, SimpleSerTecFormaViajeVisitas Simple)
