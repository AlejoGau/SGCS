...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_cuetnta_grupo_usuarios : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_cuetnta_grupo_usuarios _DalObject;
 ...
 ///<summary>
     ...
     public int  cgu_idgrupo 
		 { 
                    ...
                    get{ return this._DalObject.cgu_idgrupo; }
        						set{ this._DalObject.cgu_idgrupo = value; } 										
	   }
	  ///<summary>
     ...
     public int  cgu_idusuario 
		 { 
                    ...
                    get{ return this._DalObject.cgu_idusuario; }
        						set{ this._DalObject.cgu_idusuario = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_cuetnta_grupo_usuarios(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuetnta_grupo_usuarios(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuetnta_grupo_usuarios(SqlHelper SqlConfig, int UserId, Simplem_cuetnta_grupo_usuarios Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_cuetnta_grupo_usuarios Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_cuetnta_grupo_usuarios has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_cuetnta_grupo_usuarios GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_cuetnta_grupo_usuarios is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_cuetnta_grupo_usuarios(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_cuetnta_grupo_usuarios)Object;
			o.Name = this.Name;

			o.cgu_idgrupo = this.cgu_idgrupo;

			o.cgu_idusuario = this.cgu_idusuario;
