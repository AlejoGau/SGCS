...
{ 
   ///<summary>
     ///p_push_queue class   
     ///</summary>
    public partial class p_push_queue : Spep_push_queue
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_push_queue(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_push_queue(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_push_queue(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_push_queue(SqlHelper SqlConfig, int UserId, Simplep_push_queue Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
