...
{ 
   ///<summary>
     ///crm_contrato class   
     ///</summary>
    public partial class crm_contrato : Specrm_contrato
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public crm_contrato(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public crm_contrato(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public crm_contrato(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public crm_contrato(SqlHelper SqlConfig, int UserId, Simplecrm_contrato Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
