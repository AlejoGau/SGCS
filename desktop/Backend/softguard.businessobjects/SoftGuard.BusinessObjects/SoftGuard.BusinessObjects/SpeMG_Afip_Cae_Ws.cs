...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeMG_Afip_Cae_Ws : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalMG_Afip_Cae_Ws _DalObject;
 ...
 ///<summary>
     ...
     public int  mcw_macidkey 
		 { 
                    ...
                    get{ return this._DalObject.mcw_macidkey; }
        						set{ this._DalObject.mcw_macidkey = value; } 										
	   }
	  ///<summary>
     ///mcw_estado property   
     ///</summary>	
     public int  mcw_estado 
		 { 
                    ...
                    get{ return this._DalObject.mcw_estado; }
        						set{ this._DalObject.mcw_estado = value; } 										
	   }
	  ///<summary>
     ///mcw_fecha property   
     ///</summary>	
     public DateTime?  mcw_fecha 
		 { 
                    ...
                    get{ return this._DalObject.mcw_fecha; }
        						set{ this._DalObject.mcw_fecha = value; } 										
	   }
	  ///<summary>
     ...
     public string  mcw_requesturl 
		 { 
                    ...
                    get{ return this._DalObject.mcw_requesturl; }
        						set{ this._DalObject.mcw_requesturl = value; } 										
	   }
	  ///<summary>
     ...
     public string  mcw_requestxml 
		 { 
                    ...
                    get{ return this._DalObject.mcw_requestxml; }
        						set{ this._DalObject.mcw_requestxml = value; } 										
	   }
	  ///<summary>
     ...
     public string  mcw_responsexml 
		 { 
                    ...
                    get{ return this._DalObject.mcw_responsexml; }
        						set{ this._DalObject.mcw_responsexml = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeMG_Afip_Cae_Ws(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_Afip_Cae_Ws(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_Afip_Cae_Ws(SqlHelper SqlConfig, int UserId, SimpleMG_Afip_Cae_Ws Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleMG_Afip_Cae_Ws Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The MG_Afip_Cae_Ws has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalMG_Afip_Cae_Ws GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The MG_Afip_Cae_Ws is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalMG_Afip_Cae_Ws(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (MG_Afip_Cae_Ws)Object;
			o.Name = this.Name;

			o.mcw_macidkey = this.mcw_macidkey;

			o.mcw_estado = this.mcw_estado;

			o.mcw_fecha = this.mcw_fecha;

			o.mcw_requesturl = this.mcw_requesturl;

			o.mcw_requestxml = this.mcw_requestxml;

			o.mcw_responsexml = this.mcw_responsexml;
