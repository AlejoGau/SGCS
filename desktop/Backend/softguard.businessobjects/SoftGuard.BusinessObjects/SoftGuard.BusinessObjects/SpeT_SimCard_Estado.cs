...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeT_SimCard_Estado : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalT_SimCard_Estado _DalObject;
 ...
 ///<summary>
     ...
     public string  tse_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.tse_cDescripcion; }
        						set{ this._DalObject.tse_cDescripcion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeT_SimCard_Estado(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_SimCard_Estado(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_SimCard_Estado(SqlHelper SqlConfig, int UserId, SimpleT_SimCard_Estado Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleT_SimCard_Estado Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The T_SimCard_Estado has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalT_SimCard_Estado GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The T_SimCard_Estado is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalT_SimCard_Estado(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.T_SimCard_Estado)Object;
			o.Name = this.Name;

			o.tse_cDescripcion = this.tse_cDescripcion;
