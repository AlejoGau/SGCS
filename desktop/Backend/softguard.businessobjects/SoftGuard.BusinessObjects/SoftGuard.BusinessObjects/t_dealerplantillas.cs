...
{ 
   ///<summary>
     ///t_dealerplantillas class   
     ///</summary>
    public partial class t_dealerplantillas : Spet_dealerplantillas
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_dealerplantillas(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_dealerplantillas(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_dealerplantillas(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_dealerplantillas(SqlHelper SqlConfig, int UserId, Simplet_dealerplantillas Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
