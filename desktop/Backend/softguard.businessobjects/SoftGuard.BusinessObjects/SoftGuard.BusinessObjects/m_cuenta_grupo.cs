...
{ 
   ///<summary>
     ///m_cuenta_grupo class   
     ///</summary>
    public partial class m_cuenta_grupo : Spem_cuenta_grupo
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuenta_grupo(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuenta_grupo(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuenta_grupo(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuenta_grupo(SqlHelper SqlConfig, int UserId, Simplem_cuenta_grupo Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
