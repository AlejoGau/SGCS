...
{ 
   ///<summary>
     ///Telefono class   
     ///</summary>
    public partial class Telefono : SpeTelefono
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public Telefono(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public Telefono(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Telefono(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Telefono(SqlHelper SqlConfig, int UserId, SimpleTelefono Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
