...
// Type: SoftGuard.BusinessObjects.HorarioTolerancia
...
{
  public class HorarioTolerancia : SpeHorarioTolerancia
  {
    public HorarioTolerancia(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public HorarioTolerancia(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public HorarioTolerancia(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public HorarioTolerancia(SqlHelper SqlConfig, int UserId, SimpleHorarioTolerancia Simple)
