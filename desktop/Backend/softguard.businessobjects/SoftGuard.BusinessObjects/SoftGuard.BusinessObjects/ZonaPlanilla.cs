...
{ 
   ///<summary>
     ///ZonaPlanilla class   
     ///</summary>
    public partial class ZonaPlanilla : SpeZonaPlanilla
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public ZonaPlanilla(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public ZonaPlanilla(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public ZonaPlanilla(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public ZonaPlanilla(SqlHelper SqlConfig, int UserId, SimpleZonaPlanilla Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
