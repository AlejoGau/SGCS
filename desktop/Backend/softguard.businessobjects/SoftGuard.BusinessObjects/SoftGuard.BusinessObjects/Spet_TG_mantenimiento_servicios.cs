...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_TG_mantenimiento_servicios : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_TG_mantenimiento_servicios _DalObject;
 ...
 ///<summary>
     ...
     public string  tgms_cnombre 
		 { 
                    ...
                    get{ return this._DalObject.tgms_cnombre; }
        						set{ this._DalObject.tgms_cnombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgms_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.tgms_cdescripcion; }
        						set{ this._DalObject.tgms_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgms_kilometros 
		 { 
                    ...
                    get{ return this._DalObject.tgms_kilometros; }
        						set{ this._DalObject.tgms_kilometros = value; } 										
	   }
	  ///<summary>
     ///tgms_meses property   
     ///</summary>	
     public int  tgms_meses 
		 { 
                    ...
                    get{ return this._DalObject.tgms_meses; }
        						set{ this._DalObject.tgms_meses = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgms_iorganizacion 
		 { 
                    ...
                    get{ return this._DalObject.tgms_iorganizacion; }
        						set{ this._DalObject.tgms_iorganizacion = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgms_iestado 
		 { 
                    ...
                    get{ return this._DalObject.tgms_iestado; }
        						set{ this._DalObject.tgms_iestado = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgms_icuentatipo 
		 { 
                    ...
                    get{ return this._DalObject.tgms_icuentatipo; }
        						set{ this._DalObject.tgms_icuentatipo = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_TG_mantenimiento_servicios(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_TG_mantenimiento_servicios(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_TG_mantenimiento_servicios(SqlHelper SqlConfig, int UserId, Simplet_TG_mantenimiento_servicios Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_TG_mantenimiento_servicios Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_TG_mantenimiento_servicios has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_TG_mantenimiento_servicios GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_TG_mantenimiento_servicios is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_TG_mantenimiento_servicios(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_TG_mantenimiento_servicios)Object;
			o.Name = this.Name;

			o.tgms_cnombre = this.tgms_cnombre;

			o.tgms_cdescripcion = this.tgms_cdescripcion;

			o.tgms_kilometros = this.tgms_kilometros;

			o.tgms_meses = this.tgms_meses;

			o.tgms_iorganizacion = this.tgms_iorganizacion;

			o.tgms_iestado = this.tgms_iestado;

			o.tgms_icuentatipo = this.tgms_icuentatipo;
