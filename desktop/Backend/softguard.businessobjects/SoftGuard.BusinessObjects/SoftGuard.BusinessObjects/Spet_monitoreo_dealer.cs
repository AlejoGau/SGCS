...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_monitoreo_dealer : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_monitoreo_dealer _DalObject;
 ...
 ///<summary>
     ...
     public string  tmd_clinea 
		 { 
                    ...
                    get{ return this._DalObject.tmd_clinea; }
        						set{ this._DalObject.tmd_clinea = value; } 										
	   }
	  ///<summary>
     ...
     public int  tmd_diasemana 
		 { 
                    ...
                    get{ return this._DalObject.tmd_diasemana; }
        						set{ this._DalObject.tmd_diasemana = value; } 										
	   }
	  ///<summary>
     ...
     public string  tmd_horadesde 
		 { 
                    ...
                    get{ return this._DalObject.tmd_horadesde; }
        						set{ this._DalObject.tmd_horadesde = value; } 										
	   }
	  ///<summary>
     ...
     public string  tmd_horahasta 
		 { 
                    ...
                    get{ return this._DalObject.tmd_horahasta; }
        						set{ this._DalObject.tmd_horahasta = value; } 										
	   }
	  ///<summary>
     ///tmd_estado property   
     ///</summary>	
     public int  tmd_estado 
		 { 
                    ...
                    get{ return this._DalObject.tmd_estado; }
        						set{ this._DalObject.tmd_estado = value; } 										
	   }
	  ///<summary>
     ...
     public int  tmd_iorganizacion 
		 { 
                    ...
                    get{ return this._DalObject.tmd_iorganizacion; }
        						set{ this._DalObject.tmd_iorganizacion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_monitoreo_dealer(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_monitoreo_dealer(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_monitoreo_dealer(SqlHelper SqlConfig, int UserId, Simplet_monitoreo_dealer Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_monitoreo_dealer Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_monitoreo_dealer has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_monitoreo_dealer GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_monitoreo_dealer is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_monitoreo_dealer(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_monitoreo_dealer)Object;
			o.Name = this.Name;

			o.tmd_clinea = this.tmd_clinea;

			o.tmd_diasemana = this.tmd_diasemana;

			o.tmd_horadesde = this.tmd_horadesde;

			o.tmd_horahasta = this.tmd_horahasta;

			o.tmd_estado = this.tmd_estado;

			o.tmd_iorganizacion = this.tmd_iorganizacion;
