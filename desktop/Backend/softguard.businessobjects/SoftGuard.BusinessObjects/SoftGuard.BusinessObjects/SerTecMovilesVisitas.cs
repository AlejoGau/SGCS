...
// Type: SoftGuard.BusinessObjects.SerTecMovilesVisitas
...
{
  public class SerTecMovilesVisitas : SpeSerTecMovilesVisitas
  {
    public SerTecMovilesVisitas(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public SerTecMovilesVisitas(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public SerTecMovilesVisitas(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public SerTecMovilesVisitas(SqlHelper SqlConfig, int UserId, SimpleSerTecMovilesVisitas Simple)
