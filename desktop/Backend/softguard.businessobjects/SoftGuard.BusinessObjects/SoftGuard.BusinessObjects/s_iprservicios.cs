...
{ 
   ///<summary>
     ///s_iprservicios class   
     ///</summary>
    public partial class s_iprservicios : Spes_iprservicios
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public s_iprservicios(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public s_iprservicios(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_iprservicios(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_iprservicios(SqlHelper SqlConfig, int UserId, Simples_iprservicios Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
