...
{ 
   ///<summary>
     ///T_SimCard_Marca class   
     ///</summary>
    public partial class T_SimCard_Marca : SpeT_SimCard_Marca
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public T_SimCard_Marca(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public T_SimCard_Marca(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_SimCard_Marca(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_SimCard_Marca(SqlHelper SqlConfig, int UserId, SimpleT_SimCard_Marca Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
