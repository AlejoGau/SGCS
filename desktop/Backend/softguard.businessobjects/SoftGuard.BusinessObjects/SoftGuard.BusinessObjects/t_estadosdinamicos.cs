...
{ 
   ///<summary>
     ///t_estadosdinamicos class   
     ///</summary>
    public partial class t_estadosdinamicos : Spet_estadosdinamicos
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_estadosdinamicos(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_estadosdinamicos(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_estadosdinamicos(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_estadosdinamicos(SqlHelper SqlConfig, int UserId, Simplet_estadosdinamicos Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
