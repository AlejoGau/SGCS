...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_WeSafePeriodicityOptions : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_WeSafePeriodicityOptions _DalObject;
 ...
 ///<summary>
     ...
     public string  wpo_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.wpo_cDescripcion; }
        						set{ this._DalObject.wpo_cDescripcion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_WeSafePeriodicityOptions(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_WeSafePeriodicityOptions(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_WeSafePeriodicityOptions(SqlHelper SqlConfig, int UserId, Simplet_WeSafePeriodicityOptions Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_WeSafePeriodicityOptions Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_WeSafePeriodicityOptions has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_WeSafePeriodicityOptions GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_WeSafePeriodicityOptions is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_WeSafePeriodicityOptions(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_WeSafePeriodicityOptions)Object;
			o.Name = this.Name;

			o.wpo_cDescripcion = this.wpo_cDescripcion;
