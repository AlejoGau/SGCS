...
{ 
   ///<summary>
     ///t_CategoriaVC class   
     ///</summary>
    public partial class t_CategoriaVC : Spet_CategoriaVC
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_CategoriaVC(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_CategoriaVC(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_CategoriaVC(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_CategoriaVC(SqlHelper SqlConfig, int UserId, Simplet_CategoriaVC Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
