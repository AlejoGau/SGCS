...
{ 
   ///<summary>
     ///t_EscalamientoPorOrganizacion class   
     ///</summary>
    public partial class t_EscalamientoPorOrganizacion : Spet_EscalamientoPorOrganizacion
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_EscalamientoPorOrganizacion(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_EscalamientoPorOrganizacion(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_EscalamientoPorOrganizacion(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_EscalamientoPorOrganizacion(SqlHelper SqlConfig, int UserId, Simplet_EscalamientoPorOrganizacion Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
