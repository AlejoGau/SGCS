...
// Type: SoftGuard.BusinessObjects.HombreVivo
...
{
  public class HombreVivo : SpeHombreVivo
  {
    public HombreVivo(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public HombreVivo(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public HombreVivo(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public HombreVivo(SqlHelper SqlConfig, int UserId, SimpleHombreVivo Simple)
