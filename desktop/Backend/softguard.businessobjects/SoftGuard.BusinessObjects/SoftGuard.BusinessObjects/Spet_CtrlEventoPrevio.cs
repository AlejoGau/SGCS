...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_CtrlEventoPrevio : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_CtrlEventoPrevio _DalObject;
 ...
 ///<summary>
     ...
     public string  cep_cAlarmaEsperada 
		 { 
                    ...
                    get{ return this._DalObject.cep_cAlarmaEsperada; }
        						set{ this._DalObject.cep_cAlarmaEsperada = value; } 										
	   }
	  ///<summary>
     ...
     public string  cep_cAlarmaPrevia 
		 { 
                    ...
                    get{ return this._DalObject.cep_cAlarmaPrevia; }
        						set{ this._DalObject.cep_cAlarmaPrevia = value; } 										
	   }
	  ///<summary>
     ///cep_iHoras property   
     ///</summary>	
     public int  cep_iHoras 
		 { 
                    ...
                    get{ return this._DalObject.cep_iHoras; }
        						set{ this._DalObject.cep_iHoras = value; } 										
	   }
	  ///<summary>
     ...
     public int  cep_iCategorizacion 
		 { 
                    ...
                    get{ return this._DalObject.cep_iCategorizacion; }
        						set{ this._DalObject.cep_iCategorizacion = value; } 										
	   }
	  ///<summary>
     ...
     public string  cep_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.cep_cDescripcion; }
        						set{ this._DalObject.cep_cDescripcion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_CtrlEventoPrevio(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_CtrlEventoPrevio(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_CtrlEventoPrevio(SqlHelper SqlConfig, int UserId, Simplet_CtrlEventoPrevio Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_CtrlEventoPrevio Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_CtrlEventoPrevio has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_CtrlEventoPrevio GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_CtrlEventoPrevio is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_CtrlEventoPrevio(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_CtrlEventoPrevio)Object;
			o.Name = this.Name;

			o.cep_cAlarmaEsperada = this.cep_cAlarmaEsperada;

			o.cep_cAlarmaPrevia = this.cep_cAlarmaPrevia;

			o.cep_iHoras = this.cep_iHoras;

			o.cep_iCategorizacion = this.cep_iCategorizacion;

			o.cep_cDescripcion = this.cep_cDescripcion;
