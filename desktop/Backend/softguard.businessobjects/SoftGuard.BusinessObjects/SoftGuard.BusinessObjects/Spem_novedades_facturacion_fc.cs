...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_novedades_facturacion_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_novedades_facturacion_fc _DalObject;
 ...
 ///<summary>
     ...
     public int  nfc_icliente 
		 { 
                    ...
                    get{ return this._DalObject.nfc_icliente; }
        						set{ this._DalObject.nfc_icliente = value; } 										
	   }
	  ///<summary>
     ...
     public int  nfc_inovedad 
		 { 
                    ...
                    get{ return this._DalObject.nfc_inovedad; }
        						set{ this._DalObject.nfc_inovedad = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  nfc_nrecurrente 
		 { 
                    ...
                    get{ return this._DalObject.nfc_nrecurrente; }
        						set{ this._DalObject.nfc_nrecurrente = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  nfc_nestado 
		 { 
                    ...
                    get{ return this._DalObject.nfc_nestado; }
        						set{ this._DalObject.nfc_nestado = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_novedades_facturacion_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_novedades_facturacion_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_novedades_facturacion_fc(SqlHelper SqlConfig, int UserId, Simplem_novedades_facturacion_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_novedades_facturacion_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_novedades_facturacion_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_novedades_facturacion_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_novedades_facturacion_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_novedades_facturacion_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_novedades_facturacion_fc)Object;
			o.Name = this.Name;

			o.nfc_icliente = this.nfc_icliente;

			o.nfc_inovedad = this.nfc_inovedad;

			o.nfc_nrecurrente = this.nfc_nrecurrente;

			o.nfc_nestado = this.nfc_nestado;
