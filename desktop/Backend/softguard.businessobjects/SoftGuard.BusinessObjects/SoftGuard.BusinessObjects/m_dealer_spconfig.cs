...
{ 
   ///<summary>
     ///m_dealer_spconfig class   
     ///</summary>
    public partial class m_dealer_spconfig : Spem_dealer_spconfig
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_dealer_spconfig(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_dealer_spconfig(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_dealer_spconfig(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_dealer_spconfig(SqlHelper SqlConfig, int UserId, Simplem_dealer_spconfig Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
