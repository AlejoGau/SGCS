...
// Type: SoftGuard.BussinesObjects.SpeVehicle
...
{
  public abstract class SpeVehicle : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalVehicle _DalObject;
    ...
    public string Brand
    {
      get
      {
        return this._DalObject.Brand;
      }
      set
      {
        this._DalObject.Brand = value;
      }
    }
    ...
    public string Model
    {
      get
      {
        return this._DalObject.Model;
      }
      set
      {
        this._DalObject.Model = value;
      }
    }
    ...
    public int Year
    {
      get
      {
        return this._DalObject.Year;
      }
      set
      {
        this._DalObject.Year = value;
      }
    }
    ...
    public string Domain
    {
      get
      {
        return this._DalObject.Domain;
      }
      set
      {
        this._DalObject.Domain = value;
      }
    }
    ...
    public string Colour
    {
      get
      {
        return this._DalObject.Colour;
      }
      set
      {
        this._DalObject.Colour = value;
      }
    }
    ...
    public string VehicleType
    {
      get
      {
        return this._DalObject.VehicleType;
      }
      set
      {
        this._DalObject.VehicleType = value;
      }
    }
    ...
    public byte[] Photo
    {
      get
      {
        return this._DalObject.Photo;
      }
      set
      {
        this._DalObject.Photo = value;
      }
    }
    ...
    public string PhotoType
    {
      get
      {
        return this._DalObject.PhotoType;
      }
      set
      {
        this._DalObject.PhotoType = value;
      }
    }
    ...
    public int VehicleBrand
    {
      get
      {
        return this._DalObject.VehicleBrand;
      }
      set
      {
        this._DalObject.VehicleBrand = value;
      }
    }
    ...
    public int VehicleModel
    {
      get
      {
        return this._DalObject.VehicleModel;
      }
      set
      {
        this._DalObject.VehicleModel = value;
      }
    }
    ...
    public int OwnerTypeId
    {
      get
      {
        return this._DalObject.OwnerTypeId;
      }
      set
      {
        this._DalObject.OwnerTypeId = value;
      }
    }
    ...
    public int OwnerId
    {
      get
      {
        return this._DalObject.OwnerId;
      }
      set
      {
        this._DalObject.OwnerId = value;
      }
    }
    ...
    public int DriverTypeId
    {
      get
      {
        return this._DalObject.DriverTypeId;
      }
      set
      {
        this._DalObject.DriverTypeId = value;
      }
    }
    ...
    public int DriverId
    {
      get
      {
        return this._DalObject.DriverId;
      }
      set
      {
        this._DalObject.DriverId = value;
      }
    }
    ...
    public int MaxSpeed
    {
      get
      {
        return this._DalObject.MaxSpeed;
      }
      set
      {
        this._DalObject.MaxSpeed = value;
      }
    }
    ...
    public SpeVehicle(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeVehicle(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeVehicle(SqlHelper SqlConfig, int UserId, SimpleVehicle Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleVehicle Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The Vehicle has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalVehicle GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The Vehicle is null.");
    ...
    {
      this._DalObject = new DalVehicle(SqlConfig, UserId);
    ...
    public void CopyPropertiesTo(ISpecialization Object)
    {
      ...
      vehicle.Domain = this.Domain;
      vehicle.Colour = this.Colour;
      vehicle.VehicleType = this.VehicleType;
      vehicle.Photo = this.Photo;
      vehicle.PhotoType = this.PhotoType;
      vehicle.VehicleBrand = this.VehicleBrand;
      vehicle.VehicleModel = this.VehicleModel;
      vehicle.OwnerTypeId = this.OwnerTypeId;
      vehicle.OwnerId = this.OwnerId;
      vehicle.DriverTypeId = this.DriverTypeId;
