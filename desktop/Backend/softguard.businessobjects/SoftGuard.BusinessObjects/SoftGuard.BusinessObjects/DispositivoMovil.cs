...
{ 
   ///<summary>
     ...
     ///</summary>
    public partial class DispositivoMovil : SpeDispositivoMovil
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public DispositivoMovil(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public DispositivoMovil(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public DispositivoMovil(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public DispositivoMovil(SqlHelper SqlConfig, int UserId, SimpleDispositivoMovil Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
