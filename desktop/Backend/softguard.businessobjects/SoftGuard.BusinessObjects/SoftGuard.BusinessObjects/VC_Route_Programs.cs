...
// Type: SoftGuard.BusinessObjects.VC_Route_Programs
...
{
  public class VC_Route_Programs : SpeVC_Route_Programs
  {
    public VC_Route_Programs(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public VC_Route_Programs(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public VC_Route_Programs(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public VC_Route_Programs(SqlHelper SqlConfig, int UserId, SimpleVC_Route_Programs Simple)
