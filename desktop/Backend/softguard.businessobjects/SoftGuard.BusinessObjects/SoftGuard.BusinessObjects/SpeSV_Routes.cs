...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeSV_Routes : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalSV_Routes _DalObject;
 ...
 ///<summary>
     ...
     public int  svr_iid 
		 { 
                    ...
                    get{ return this._DalObject.svr_iid; }
        						set{ this._DalObject.svr_iid = value; } 										
	   }
	  ///<summary>
     ...
     public int  svr_iCuentaId 
		 { 
                    ...
                    get{ return this._DalObject.svr_iCuentaId; }
        						set{ this._DalObject.svr_iCuentaId = value; } 										
	   }
	  ///<summary>
     ///svr_cName property   
     ///</summary>	
     public string  svr_cName 
		 { 
                    ...
                    get{ return this._DalObject.svr_cName; }
        						set{ this._DalObject.svr_cName = value; } 										
	   }
	  ///<summary>
     ...
     public string  svr_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.svr_cDescripcion; }
        						set{ this._DalObject.svr_cDescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  svr_cRouteType 
		 { 
                    ...
                    get{ return this._DalObject.svr_cRouteType; }
        						set{ this._DalObject.svr_cRouteType = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  svr_dDateStart 
		 { 
                    ...
                    get{ return this._DalObject.svr_dDateStart; }
        						set{ this._DalObject.svr_dDateStart = value; } 										
	   }
	  ///<summary>
     ...
     public int  svr_iParallel 
		 { 
                    ...
                    get{ return this._DalObject.svr_iParallel; }
        						set{ this._DalObject.svr_iParallel = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeSV_Routes(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeSV_Routes(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeSV_Routes(SqlHelper SqlConfig, int UserId, SimpleSV_Routes Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleSV_Routes Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The SV_Routes has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalSV_Routes GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The SV_Routes is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalSV_Routes(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.SV_Routes)Object;
			o.Name = this.Name;

			o.svr_iid = this.svr_iid;

			o.svr_iCuentaId = this.svr_iCuentaId;

			o.svr_cName = this.svr_cName;

			o.svr_cDescripcion = this.svr_cDescripcion;

			o.svr_cRouteType = this.svr_cRouteType;

			o.svr_dDateStart = this.svr_dDateStart;

			o.svr_iParallel = this.svr_iParallel;
