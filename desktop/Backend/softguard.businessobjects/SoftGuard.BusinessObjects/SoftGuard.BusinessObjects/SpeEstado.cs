...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeEstado : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalEstado _DalObject;
 ...
 ///<summary>
     ...
     public Decimal  est_nestado 
		 { 
                    ...
                    get{ return this._DalObject.est_nestado; }
        						set{ this._DalObject.est_nestado = value; } 										
	   }
	  ///<summary>
     ///est_ntipo property   
     ///</summary>	
     public Decimal  est_ntipo 
		 { 
                    ...
                    get{ return this._DalObject.est_ntipo; }
        						set{ this._DalObject.est_ntipo = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  est_dfechadesde 
		 { 
                    ...
                    get{ return this._DalObject.est_dfechadesde; }
        						set{ this._DalObject.est_dfechadesde = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  est_nduracion 
		 { 
                    ...
                    get{ return this._DalObject.est_nduracion; }
        						set{ this._DalObject.est_nduracion = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  est_dfechahasta 
		 { 
                    ...
                    get{ return this._DalObject.est_dfechahasta; }
        						set{ this._DalObject.est_dfechahasta = value; } 										
	   }
	  ///<summary>
     ///est_mnota property   
     ///</summary>	
     public string  est_mnota 
		 { 
                    ...
                    get{ return this._DalObject.est_mnota; }
        						set{ this._DalObject.est_mnota = value; } 										
	   }
	  ///<summary>
     ///token property   
     ///</summary>	
     public string  token 
		 { 
                    ...
                    get{ return this._DalObject.token; }
        						set{ this._DalObject.token = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeEstado(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeEstado(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeEstado(SqlHelper SqlConfig, int UserId, SimpleEstado Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleEstado Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The Estado has dependencies.");
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The Estado is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalEstado(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public void CopyPropertiesTo(ISpecialization Object)
        {
			...
			o.est_nestado = this.est_nestado;

			o.est_ntipo = this.est_ntipo;

			o.est_dfechadesde = this.est_dfechadesde;

			o.est_nduracion = this.est_nduracion;

			o.est_dfechahasta = this.est_dfechahasta;

			o.est_mnota = this.est_mnota;
