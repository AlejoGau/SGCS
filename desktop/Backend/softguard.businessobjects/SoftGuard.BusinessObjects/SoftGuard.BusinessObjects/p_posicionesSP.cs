...
// Type: SoftGuard.BusinessObjects.p_posicionesSP
...
{
  public class p_posicionesSP : Spep_posicionesSP
  {
    public p_posicionesSP(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public p_posicionesSP(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public p_posicionesSP(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public p_posicionesSP(SqlHelper SqlConfig, int UserId, Simplep_posicionesSP Simple)
