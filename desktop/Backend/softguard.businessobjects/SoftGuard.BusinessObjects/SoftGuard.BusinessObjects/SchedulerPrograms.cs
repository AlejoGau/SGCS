...
// Type: SoftGuard.BusinessObjects.SchedulerPrograms
...
{
  public class SchedulerPrograms : SpeSchedulerPrograms
  {
    public SchedulerPrograms(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public SchedulerPrograms(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public SchedulerPrograms(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public SchedulerPrograms(SqlHelper SqlConfig, int UserId, SimpleSchedulerPrograms Simple)
