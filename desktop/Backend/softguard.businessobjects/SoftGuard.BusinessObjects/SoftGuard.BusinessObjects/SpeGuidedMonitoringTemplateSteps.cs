...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeGuidedMonitoringTemplateSteps : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalGuidedMonitoringTemplateSteps _DalObject;
 ...
 ///<summary>
     ...
     public int  gms_iTemplateID 
		 { 
                    ...
                    get{ return this._DalObject.gms_iTemplateID; }
        						set{ this._DalObject.gms_iTemplateID = value; } 										
	   }
	  ///<summary>
     ...
     public int  gms_iStepNumber 
		 { 
                    ...
                    get{ return this._DalObject.gms_iStepNumber; }
        						set{ this._DalObject.gms_iStepNumber = value; } 										
	   }
	  ///<summary>
     ...
     public int  gms_iStepID 
		 { 
                    ...
                    get{ return this._DalObject.gms_iStepID; }
        						set{ this._DalObject.gms_iStepID = value; } 										
	   }
	  ///<summary>
     ...
     public string  gms_cToolTip 
		 { 
                    ...
                    get{ return this._DalObject.gms_cToolTip; }
        						set{ this._DalObject.gms_cToolTip = value; } 										
	   }
	  ///<summary>
     ///gms_cText property   
     ///</summary>	
     public string  gms_cText 
		 { 
                    ...
                    get{ return this._DalObject.gms_cText; }
        						set{ this._DalObject.gms_cText = value; } 										
	   }
	  ///<summary>
     ...
     public string  gms_cListID 
		 { 
                    ...
                    get{ return this._DalObject.gms_cListID; }
        						set{ this._DalObject.gms_cListID = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeGuidedMonitoringTemplateSteps(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeGuidedMonitoringTemplateSteps(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeGuidedMonitoringTemplateSteps(SqlHelper SqlConfig, int UserId, SimpleGuidedMonitoringTemplateSteps Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleGuidedMonitoringTemplateSteps Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The GuidedMonitoringTemplateSteps has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalGuidedMonitoringTemplateSteps GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The GuidedMonitoringTemplateSteps is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalGuidedMonitoringTemplateSteps(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.GuidedMonitoringTemplateSteps)Object;
			o.Name = this.Name;

			o.gms_iTemplateID = this.gms_iTemplateID;

			o.gms_iStepNumber = this.gms_iStepNumber;

			o.gms_iStepID = this.gms_iStepID;

			o.gms_cToolTip = this.gms_cToolTip;

			o.gms_cText = this.gms_cText;

			o.gms_cListID = this.gms_cListID;
