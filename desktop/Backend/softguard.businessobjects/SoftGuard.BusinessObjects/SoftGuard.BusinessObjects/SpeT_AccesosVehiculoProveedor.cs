...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeT_AccesosVehiculoProveedor : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalT_AccesosVehiculoProveedor _DalObject;
 ...
 ///<summary>
     ...
     public int  avp_iVehicleBrand 
		 { 
                    ...
                    get{ return this._DalObject.avp_iVehicleBrand; }
        						set{ this._DalObject.avp_iVehicleBrand = value; } 										
	   }
	  ///<summary>
     ...
     public int  avp_iVehicleModel 
		 { 
                    ...
                    get{ return this._DalObject.avp_iVehicleModel; }
        						set{ this._DalObject.avp_iVehicleModel = value; } 										
	   }
	  ///<summary>
     ...
     public string  avp_cMatricula 
		 { 
                    ...
                    get{ return this._DalObject.avp_cMatricula; }
        						set{ this._DalObject.avp_cMatricula = value; } 										
	   }
	  ///<summary>
     ///avp_cColor property   
     ///</summary>	
     public string  avp_cColor 
		 { 
                    ...
                    get{ return this._DalObject.avp_cColor; }
        						set{ this._DalObject.avp_cColor = value; } 										
	   }
	  ///<summary>
     ///avp_iYear property   
     ///</summary>	
     public int  avp_iYear 
		 { 
                    ...
                    get{ return this._DalObject.avp_iYear; }
        						set{ this._DalObject.avp_iYear = value; } 										
	   }
	  ///<summary>
     ///avp_cTipo property   
     ///</summary>	
     public string  avp_cTipo 
		 { 
                    ...
                    get{ return this._DalObject.avp_cTipo; }
        						set{ this._DalObject.avp_cTipo = value; } 										
	   }
	  ///<summary>
     ...
     public string  avp_cCiaSeguro 
		 { 
                    ...
                    get{ return this._DalObject.avp_cCiaSeguro; }
        						set{ this._DalObject.avp_cCiaSeguro = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  avp_tVtoSeguro 
		 { 
                    ...
                    get{ return this._DalObject.avp_tVtoSeguro; }
        						set{ this._DalObject.avp_tVtoSeguro = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  avp_tVtoVTV 
		 { 
                    ...
                    get{ return this._DalObject.avp_tVtoVTV; }
        						set{ this._DalObject.avp_tVtoVTV = value; } 										
	   }
	  ///<summary>
     ...
     public string  avp_cIdentificacion 
		 { 
                    ...
                    get{ return this._DalObject.avp_cIdentificacion; }
        						set{ this._DalObject.avp_cIdentificacion = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  avp_tVtoIdentificacion 
		 { 
                    ...
                    get{ return this._DalObject.avp_tVtoIdentificacion; }
        						set{ this._DalObject.avp_tVtoIdentificacion = value; } 										
	   }
	  ///<summary>
     ...
     public string  avp_cObservaciones 
		 { 
                    ...
                    get{ return this._DalObject.avp_cObservaciones; }
        						set{ this._DalObject.avp_cObservaciones = value; } 										
	   }
	  ///<summary>
     ...
     public string  avp_cPathPicture 
		 { 
                    ...
                    get{ return this._DalObject.avp_cPathPicture; }
        						set{ this._DalObject.avp_cPathPicture = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeT_AccesosVehiculoProveedor(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_AccesosVehiculoProveedor(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_AccesosVehiculoProveedor(SqlHelper SqlConfig, int UserId, SimpleT_AccesosVehiculoProveedor Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleT_AccesosVehiculoProveedor Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The T_AccesosVehiculoProveedor has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalT_AccesosVehiculoProveedor GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The T_AccesosVehiculoProveedor is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalT_AccesosVehiculoProveedor(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.T_AccesosVehiculoProveedor)Object;
			o.Name = this.Name;

			o.avp_iVehicleBrand = this.avp_iVehicleBrand;

			o.avp_iVehicleModel = this.avp_iVehicleModel;

			o.avp_cMatricula = this.avp_cMatricula;

			o.avp_cColor = this.avp_cColor;

			o.avp_iYear = this.avp_iYear;

			o.avp_cTipo = this.avp_cTipo;

			o.avp_cCiaSeguro = this.avp_cCiaSeguro;

			o.avp_tVtoSeguro = this.avp_tVtoSeguro;

			o.avp_tVtoVTV = this.avp_tVtoVTV;

			o.avp_cIdentificacion = this.avp_cIdentificacion;

			o.avp_tVtoIdentificacion = this.avp_tVtoIdentificacion;

			o.avp_cObservaciones = this.avp_cObservaciones;

			o.avp_cPathPicture = this.avp_cPathPicture;
