...
// Type: SoftGuard.BusinessObjects.t_flotas
...
{
  public class t_flotas : Spet_flotas
  {
    public t_flotas(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_flotas(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_flotas(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_flotas(SqlHelper SqlConfig, int UserId, Simplet_flotas Simple)
