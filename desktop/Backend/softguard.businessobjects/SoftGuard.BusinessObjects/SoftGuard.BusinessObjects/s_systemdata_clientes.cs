...
{ 
   ///<summary>
     ///s_systemdata_clientes class   
     ///</summary>
    public partial class s_systemdata_clientes : Spes_systemdata_clientes
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public s_systemdata_clientes(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public s_systemdata_clientes(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_systemdata_clientes(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_systemdata_clientes(SqlHelper SqlConfig, int UserId, Simples_systemdata_clientes Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
