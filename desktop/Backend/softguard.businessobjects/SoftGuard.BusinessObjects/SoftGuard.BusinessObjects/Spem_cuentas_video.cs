...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_cuentas_video : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_cuentas_video _DalObject;
 ...
 ///<summary>
     ...
     public int  cuv_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.cuv_iidcuenta; }
        						set{ this._DalObject.cuv_iidcuenta = value; } 										
	   }
	  ///<summary>
     ///cuv_clink property   
     ///</summary>	
     public string  cuv_clink 
		 { 
                    ...
                    get{ return this._DalObject.cuv_clink; }
        						set{ this._DalObject.cuv_clink = value; } 										
	   }
	  ///<summary>
     ...
     public string  cuv_meventos 
		 { 
                    ...
                    get{ return this._DalObject.cuv_meventos; }
        						set{ this._DalObject.cuv_meventos = value; } 										
	   }
	  ///<summary>
     ...
     public string  cuv_clinkdss 
		 { 
                    ...
                    get{ return this._DalObject.cuv_clinkdss; }
        						set{ this._DalObject.cuv_clinkdss = value; } 										
	   }
	  ///<summary>
     ...
     public int  cuv_ivideoid 
		 { 
                    ...
                    get{ return this._DalObject.cuv_ivideoid; }
        						set{ this._DalObject.cuv_ivideoid = value; } 										
	   }
	  ///<summary>
     ...
     public Single  cuv_rlatitud 
		 { 
                    ...
                    get{ return this._DalObject.cuv_rlatitud; }
        						set{ this._DalObject.cuv_rlatitud = value; } 										
	   }
	  ///<summary>
     ...
     public Single  cuv_rlongitud 
		 { 
                    ...
                    get{ return this._DalObject.cuv_rlongitud; }
        						set{ this._DalObject.cuv_rlongitud = value; } 										
	   }
	  ///<summary>
     ...
     ///Constructor   
     ///</summary>
    		public Spem_cuentas_video(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuentas_video(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuentas_video(SqlHelper SqlConfig, int UserId, Simplem_cuentas_video Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_cuentas_video Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_cuentas_video has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_cuentas_video GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_cuentas_video is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_cuentas_video(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_cuentas_video)Object;
			o.Name = this.Name;

			o.cuv_iidcuenta = this.cuv_iidcuenta;

			o.cuv_clink = this.cuv_clink;

			o.cuv_meventos = this.cuv_meventos;

			o.cuv_clinkdss = this.cuv_clinkdss;

			o.cuv_ivideoid = this.cuv_ivideoid;

			o.cuv_rlatitud = this.cuv_rlatitud;

			o.cuv_rlongitud = this.cuv_rlongitud;
