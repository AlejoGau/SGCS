...
// Type: SoftGuard.BusinessObjects.w_cuentas_x_usuario
...
{
  public class w_cuentas_x_usuario : Spew_cuentas_x_usuario
  {
    public w_cuentas_x_usuario(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public w_cuentas_x_usuario(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public w_cuentas_x_usuario(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public w_cuentas_x_usuario(SqlHelper SqlConfig, int UserId, Simplew_cuentas_x_usuario Simple)
