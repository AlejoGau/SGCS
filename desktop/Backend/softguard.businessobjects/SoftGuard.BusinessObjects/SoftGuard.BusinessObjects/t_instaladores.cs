...
{ 
   ///<summary>
     ///t_instaladores class   
     ///</summary>
    public partial class t_instaladores : Spet_instaladores
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_instaladores(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_instaladores(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_instaladores(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_instaladores(SqlHelper SqlConfig, int UserId, Simplet_instaladores Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
