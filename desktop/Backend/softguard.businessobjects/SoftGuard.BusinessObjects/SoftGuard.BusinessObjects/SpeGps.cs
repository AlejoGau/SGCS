...
// Type: SoftGuard.BusinessObjects.SpeGps
...
{
  public abstract class SpeGps : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalGps _DalObject;
    ...
    public DateTime gps_tfechahora
    {
      get
      {
        return this._DalObject.gps_tfechahora;
      }
      set
      {
        this._DalObject.gps_tfechahora = value;
      }
    }
    ...
    public int gps_idCuenta
    {
      get
      {
        return this._DalObject.gps_idCuenta;
      }
      set
      {
        this._DalObject.gps_idCuenta = value;
      }
    }
    ...
    public int gps_idRec
    {
      get
      {
        return this._DalObject.gps_idRec;
      }
      set
      {
        this._DalObject.gps_idRec = value;
      }
    }
    ...
    public float gps_rLatitud
    {
      get
      {
        return this._DalObject.gps_rLatitud;
      }
      set
      {
        this._DalObject.gps_rLatitud = value;
      }
    }
    ...
    public float gps_rLongitud
    {
      get
      {
        return this._DalObject.gps_rLongitud;
      }
      set
      {
        this._DalObject.gps_rLongitud = value;
      }
    }
    ...
    public SpeGps(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeGps(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeGps(SqlHelper SqlConfig, int UserId, SimpleGps Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleGps Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The Gps has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The Gps is null.");
    ...
    {
      this._DalObject = new DalGps(SqlConfig, UserId);
    ...
    public void CopyPropertiesTo(ISpecialization Object)
    {
      Gps gps = (Gps) Object;
      gps.Name = this.Name;
      gps.gps_tfechahora = this.gps_tfechahora;
      gps.gps_idCuenta = this.gps_idCuenta;
      gps.gps_idRec = this.gps_idRec;
      gps.gps_rLatitud = this.gps_rLatitud;
      gps.gps_rLongitud = this.gps_rLongitud;
    }
