...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_tgviaje : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_tgviaje _DalObject;
 ...
 ///<summary>
     ...
     public string  tgv_nombre 
		 { 
                    ...
                    get{ return this._DalObject.tgv_nombre; }
        						set{ this._DalObject.tgv_nombre = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  tgv_fechainicio 
		 { 
                    ...
                    get{ return this._DalObject.tgv_fechainicio; }
        						set{ this._DalObject.tgv_fechainicio = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  tgv_fechafin 
		 { 
                    ...
                    get{ return this._DalObject.tgv_fechafin; }
        						set{ this._DalObject.tgv_fechafin = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgv_reciid_inicio 
		 { 
                    ...
                    get{ return this._DalObject.tgv_reciid_inicio; }
        						set{ this._DalObject.tgv_reciid_inicio = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgv_reciid_fin 
		 { 
                    ...
                    get{ return this._DalObject.tgv_reciid_fin; }
        						set{ this._DalObject.tgv_reciid_fin = value; } 										
	   }
	  ///<summary>
     ///tgv_usuiid property   
     ///</summary>	
     public int  tgv_usuiid 
		 { 
                    ...
                    get{ return this._DalObject.tgv_usuiid; }
        						set{ this._DalObject.tgv_usuiid = value; } 										
	   }
	  ///<summary>
     ///tgv_cueiid property   
     ///</summary>	
     public int  tgv_cueiid 
		 { 
                    ...
                    get{ return this._DalObject.tgv_cueiid; }
        						set{ this._DalObject.tgv_cueiid = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgv_codigoexterno 
		 { 
                    ...
                    get{ return this._DalObject.tgv_codigoexterno; }
        						set{ this._DalObject.tgv_codigoexterno = value; } 										
	   }
	  ///<summary>
     ///tgv_estado property   
     ///</summary>	
     public int  tgv_estado 
		 { 
                    ...
                    get{ return this._DalObject.tgv_estado; }
        						set{ this._DalObject.tgv_estado = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgv_geofenseinicio 
		 { 
                    ...
                    get{ return this._DalObject.tgv_geofenseinicio; }
        						set{ this._DalObject.tgv_geofenseinicio = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgv_geofensefin 
		 { 
                    ...
                    get{ return this._DalObject.tgv_geofensefin; }
        						set{ this._DalObject.tgv_geofensefin = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgv_metadata 
		 { 
                    ...
                    get{ return this._DalObject.tgv_metadata; }
        						set{ this._DalObject.tgv_metadata = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  tgv_fecha_prg_inicio 
		 { 
                    ...
                    get{ return this._DalObject.tgv_fecha_prg_inicio; }
        						set{ this._DalObject.tgv_fecha_prg_inicio = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  tgv_fecha_prg_fin 
		 { 
                    ...
                    get{ return this._DalObject.tgv_fecha_prg_fin; }
        						set{ this._DalObject.tgv_fecha_prg_fin = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgv_cuenta_cliente 
		 { 
                    ...
                    get{ return this._DalObject.tgv_cuenta_cliente; }
        						set{ this._DalObject.tgv_cuenta_cliente = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgv_movil_transportista 
		 { 
                    ...
                    get{ return this._DalObject.tgv_movil_transportista; }
        						set{ this._DalObject.tgv_movil_transportista = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgv_lugar_inicio 
		 { 
                    ...
                    get{ return this._DalObject.tgv_lugar_inicio; }
        						set{ this._DalObject.tgv_lugar_inicio = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgv_lugar_fin 
		 { 
                    ...
                    get{ return this._DalObject.tgv_lugar_fin; }
        						set{ this._DalObject.tgv_lugar_fin = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_tgviaje(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_tgviaje(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_tgviaje(SqlHelper SqlConfig, int UserId, Simplem_tgviaje Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_tgviaje Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_tgviaje has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_tgviaje GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_tgviaje is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_tgviaje(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_tgviaje)Object;
			o.Name = this.Name;

			o.tgv_nombre = this.tgv_nombre;

			o.tgv_fechainicio = this.tgv_fechainicio;

			o.tgv_fechafin = this.tgv_fechafin;

			o.tgv_reciid_inicio = this.tgv_reciid_inicio;

			o.tgv_reciid_fin = this.tgv_reciid_fin;

			o.tgv_usuiid = this.tgv_usuiid;

			o.tgv_cueiid = this.tgv_cueiid;

			o.tgv_codigoexterno = this.tgv_codigoexterno;

			o.tgv_estado = this.tgv_estado;

			o.tgv_geofenseinicio = this.tgv_geofenseinicio;

			o.tgv_geofensefin = this.tgv_geofensefin;

			o.tgv_metadata = this.tgv_metadata;

			o.tgv_fecha_prg_inicio = this.tgv_fecha_prg_inicio;

			o.tgv_fecha_prg_fin = this.tgv_fecha_prg_fin;

			o.tgv_cuenta_cliente = this.tgv_cuenta_cliente;

			o.tgv_movil_transportista = this.tgv_movil_transportista;

			o.tgv_lugar_inicio = this.tgv_lugar_inicio;

			o.tgv_lugar_fin = this.tgv_lugar_fin;
