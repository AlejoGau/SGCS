...
{ 
   ///<summary>
     ///m_cuetnta_grupo class   
     ///</summary>
    public partial class m_cuetnta_grupo : Spem_cuetnta_grupo
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuetnta_grupo(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuetnta_grupo(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuetnta_grupo(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuetnta_grupo(SqlHelper SqlConfig, int UserId, Simplem_cuetnta_grupo Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
