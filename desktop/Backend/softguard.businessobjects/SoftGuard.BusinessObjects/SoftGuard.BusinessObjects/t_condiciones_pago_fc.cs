...
{ 
   ///<summary>
     ///t_condiciones_pago_fc class   
     ///</summary>
    public partial class t_condiciones_pago_fc : Spet_condiciones_pago_fc
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_condiciones_pago_fc(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_condiciones_pago_fc(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_condiciones_pago_fc(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_condiciones_pago_fc(SqlHelper SqlConfig, int UserId, Simplet_condiciones_pago_fc Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
