...
// Type: SoftGuard.BusinessObjects.HorarioAlternativoPlantilla
...
{
  public class HorarioAlternativoPlantilla : SpeHorarioAlternativoPlantilla
  {
    public HorarioAlternativoPlantilla(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public HorarioAlternativoPlantilla(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public HorarioAlternativoPlantilla(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public HorarioAlternativoPlantilla(SqlHelper SqlConfig, int UserId, SimpleHorarioAlternativoPlantilla Simple)
