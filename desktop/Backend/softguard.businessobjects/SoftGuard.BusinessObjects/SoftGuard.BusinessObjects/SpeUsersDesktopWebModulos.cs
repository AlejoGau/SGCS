...
// Type: SoftGuard.BusinessObjects.SpeUsersDesktopWebModulos
...
{
  public abstract class SpeUsersDesktopWebModulos : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalUsersDesktopWebModulos _DalObject;
    ...
    public int dwm_idKey
    {
      get
      {
        return this._DalObject.dwm_idKey;
      }
      set
      {
        this._DalObject.dwm_idKey = value;
      }
    }
    ...
    public int dwm_idWeb
    {
      get
      {
        return this._DalObject.dwm_idWeb;
      }
      set
      {
        this._DalObject.dwm_idWeb = value;
      }
    }
    ...
    public int dwm_idModules
    {
      get
      {
        return this._DalObject.dwm_idModules;
      }
      set
      {
        this._DalObject.dwm_idModules = value;
      }
    }
    ...
    public string dwm_idTabla
    {
      get
      {
        return this._DalObject.dwm_idTabla;
      }
      set
      {
        this._DalObject.dwm_idTabla = value;
      }
    }
    ...
    public string dwm_dealer
    {
      get
      {
        return this._DalObject.dwm_dealer;
      }
      set
      {
        this._DalObject.dwm_dealer = value;
      }
    }
    ...
    public string dwm_cuenta_desde
    {
      get
      {
        return this._DalObject.dwm_cuenta_desde;
      }
      set
      {
        this._DalObject.dwm_cuenta_desde = value;
      }
    }
    ...
    public string dwm_cuenta_hasta
    {
      get
      {
        return this._DalObject.dwm_cuenta_hasta;
      }
      set
      {
        this._DalObject.dwm_cuenta_hasta = value;
      }
    }
    ...
    public string dwm_data
    {
      get
      {
        return this._DalObject.dwm_data;
      }
      set
      {
        this._DalObject.dwm_data = value;
      }
    }
    ...
    public SpeUsersDesktopWebModulos(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeUsersDesktopWebModulos(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeUsersDesktopWebModulos(SqlHelper SqlConfig, int UserId, SimpleUsersDesktopWebModulos Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleUsersDesktopWebModulos Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The UsersDesktopWebModulos has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalUsersDesktopWebModulos GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The UsersDesktopWebModulos is null.");
    ...
    {
      this._DalObject = new DalUsersDesktopWebModulos(SqlConfig, UserId);
    ...
    {
      UsersDesktopWebModulos desktopWebModulos = (UsersDesktopWebModulos) Object;
