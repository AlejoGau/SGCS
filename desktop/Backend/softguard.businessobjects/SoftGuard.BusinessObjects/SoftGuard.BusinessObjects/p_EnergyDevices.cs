...
{ 
   ///<summary>
     ///p_EnergyDevices class   
     ///</summary>
    public partial class p_EnergyDevices : Spep_EnergyDevices
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_EnergyDevices(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_EnergyDevices(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_EnergyDevices(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_EnergyDevices(SqlHelper SqlConfig, int UserId, Simplep_EnergyDevices Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
