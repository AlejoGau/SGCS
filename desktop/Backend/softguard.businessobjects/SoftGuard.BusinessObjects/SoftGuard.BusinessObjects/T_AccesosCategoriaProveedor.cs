...
{ 
   ///<summary>
     ///T_AccesosCategoriaProveedor class   
     ///</summary>
    public partial class T_AccesosCategoriaProveedor : SpeT_AccesosCategoriaProveedor
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public T_AccesosCategoriaProveedor(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public T_AccesosCategoriaProveedor(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_AccesosCategoriaProveedor(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_AccesosCategoriaProveedor(SqlHelper SqlConfig, int UserId, SimpleT_AccesosCategoriaProveedor Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
