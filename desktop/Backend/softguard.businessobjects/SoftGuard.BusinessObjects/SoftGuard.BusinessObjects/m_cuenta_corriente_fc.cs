...
{ 
   ///<summary>
     ///m_cuenta_corriente_fc class   
     ///</summary>
    public partial class m_cuenta_corriente_fc : Spem_cuenta_corriente_fc
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuenta_corriente_fc(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuenta_corriente_fc(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuenta_corriente_fc(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuenta_corriente_fc(SqlHelper SqlConfig, int UserId, Simplem_cuenta_corriente_fc Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
