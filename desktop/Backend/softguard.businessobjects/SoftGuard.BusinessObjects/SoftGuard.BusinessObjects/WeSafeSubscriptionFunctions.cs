...
{ 
   ///<summary>
     ///WeSafeSubscriptionFunctions class   
     ///</summary>
    public partial class WeSafeSubscriptionFunctions : SpeWeSafeSubscriptionFunctions
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public WeSafeSubscriptionFunctions(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public WeSafeSubscriptionFunctions(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public WeSafeSubscriptionFunctions(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public WeSafeSubscriptionFunctions(SqlHelper SqlConfig, int UserId, SimpleWeSafeSubscriptionFunctions Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
