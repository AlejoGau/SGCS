...
// Type: SoftGuard.BusinessObjects.Spet_medicos
...
{
  public abstract class Spet_medicos : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_medicos _DalObject;
    ...
    public string med_ccodigo
    {
      get
      {
        return this._DalObject.med_ccodigo;
      }
      set
      {
        this._DalObject.med_ccodigo = value;
      }
    }
    ...
    public string med_cnombre
    {
      get
      {
        return this._DalObject.med_cnombre;
      }
      set
      {
        this._DalObject.med_cnombre = value;
      }
    }
    ...
    public string med_ccalle
    {
      get
      {
        return this._DalObject.med_ccalle;
      }
      set
      {
        this._DalObject.med_ccalle = value;
      }
    }
    ...
    public string med_clocalidad
    {
      get
      {
        return this._DalObject.med_clocalidad;
      }
      set
      {
        this._DalObject.med_clocalidad = value;
      }
    }
    ...
    public string med_cprovincia
    {
      get
      {
        return this._DalObject.med_cprovincia;
      }
      set
      {
        this._DalObject.med_cprovincia = value;
      }
    }
    ...
    public string med_ccodigopostal
    {
      get
      {
        return this._DalObject.med_ccodigopostal;
      }
      set
      {
        this._DalObject.med_ccodigopostal = value;
      }
    }
    ...
    public string med_ctelefono
    {
      get
      {
        return this._DalObject.med_ctelefono;
      }
      set
      {
        this._DalObject.med_ctelefono = value;
      }
    }
    ...
    public string med_cfax
    {
      get
      {
        return this._DalObject.med_cfax;
      }
      set
      {
        this._DalObject.med_cfax = value;
      }
    }
    ...
    public Decimal med_ntipo
    {
      get
      {
        return this._DalObject.med_ntipo;
      }
      set
      {
        this._DalObject.med_ntipo = value;
      }
    }
    ...
    public Spet_medicos(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_medicos(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_medicos(SqlHelper SqlConfig, int UserId, Simplet_medicos Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_medicos Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_medicos has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_medicos GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_medicos is null.");
    ...
    {
      this._DalObject = new Dalt_medicos(SqlConfig, UserId);
    ...
    {
      t_medicos tMedicos = (t_medicos) Object;
      tMedicos.Name = this.Name;
      tMedicos.med_ccodigo = this.med_ccodigo;
      tMedicos.med_cnombre = this.med_cnombre;
      tMedicos.med_ccalle = this.med_ccalle;
      tMedicos.med_clocalidad = this.med_clocalidad;
      tMedicos.med_cprovincia = this.med_cprovincia;
      tMedicos.med_ccodigopostal = this.med_ccodigopostal;
      tMedicos.med_ctelefono = this.med_ctelefono;
      tMedicos.med_cfax = this.med_cfax;
      tMedicos.med_ntipo = this.med_ntipo;
    }
