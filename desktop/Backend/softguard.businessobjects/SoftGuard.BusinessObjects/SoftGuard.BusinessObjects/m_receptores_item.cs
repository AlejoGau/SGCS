...
{ 
   ///<summary>
     ///m_receptores_item class   
     ///</summary>
    public partial class m_receptores_item : Spem_receptores_item
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_receptores_item(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_receptores_item(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_receptores_item(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_receptores_item(SqlHelper SqlConfig, int UserId, Simplem_receptores_item Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
