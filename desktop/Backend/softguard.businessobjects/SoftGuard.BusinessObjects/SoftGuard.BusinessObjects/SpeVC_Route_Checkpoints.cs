...
// Type: SoftGuard.BusinessObjects.SpeVC_Route_Checkpoints
...
{
  public abstract class SpeVC_Route_Checkpoints : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalVC_Route_Checkpoints _DalObject;
    ...
    public int checkpointId
    {
      get
      {
        return this._DalObject.checkpointId;
      }
      set
      {
        this._DalObject.checkpointId = value;
      }
    }
    ...
    public int beforetolerance
    {
      get
      {
        return this._DalObject.beforetolerance;
      }
      set
      {
        this._DalObject.beforetolerance = value;
      }
    }
    ...
    public int aftertolerance
    {
      get
      {
        return this._DalObject.aftertolerance;
      }
      set
      {
        this._DalObject.aftertolerance = value;
      }
    }
    ...
    public int order
    {
      get
      {
        return this._DalObject.order;
      }
      set
      {
        this._DalObject.order = value;
      }
    }
    ...
    public SpeVC_Route_Checkpoints(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeVC_Route_Checkpoints(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeVC_Route_Checkpoints(SqlHelper SqlConfig, int UserId, SimpleVC_Route_Checkpoints Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleVC_Route_Checkpoints Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The VC_Route_Checkpoints has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalVC_Route_Checkpoints GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The VC_Route_Checkpoints is null.");
    ...
    {
      this._DalObject = new DalVC_Route_Checkpoints(SqlConfig, UserId);
    ...
    {
      VC_Route_Checkpoints routeCheckpoints = (VC_Route_Checkpoints) Object;
