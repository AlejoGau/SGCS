...
{ 
   ///<summary>
     ...
     ///</summary>
    public partial class ResourceModule : SpeResourceModule
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public ResourceModule(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public ResourceModule(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public ResourceModule(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public ResourceModule(SqlHelper SqlConfig, int UserId, SimpleResourceModule Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
