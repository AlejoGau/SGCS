...
{ 
   ///<summary>
     ///OperadorVirtualConfig class   
     ///</summary>
    public partial class OperadorVirtualConfig : SpeOperadorVirtualConfig
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public OperadorVirtualConfig(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public OperadorVirtualConfig(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public OperadorVirtualConfig(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public OperadorVirtualConfig(SqlHelper SqlConfig, int UserId, SimpleOperadorVirtualConfig Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
