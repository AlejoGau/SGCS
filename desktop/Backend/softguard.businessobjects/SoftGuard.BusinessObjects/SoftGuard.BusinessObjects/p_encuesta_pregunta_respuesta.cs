...
{ 
   ///<summary>
     ///p_encuesta_pregunta_respuesta class   
     ///</summary>
    public partial class p_encuesta_pregunta_respuesta : Spep_encuesta_pregunta_respuesta
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_encuesta_pregunta_respuesta(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_encuesta_pregunta_respuesta(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_encuesta_pregunta_respuesta(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_encuesta_pregunta_respuesta(SqlHelper SqlConfig, int UserId, Simplep_encuesta_pregunta_respuesta Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
