...
// Type: SoftGuard.BusinessObjects.GrupoCuentas
...
{
  public class GrupoCuentas : SpeGrupoCuentas
  {
    public GrupoCuentas(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public GrupoCuentas(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public GrupoCuentas(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public GrupoCuentas(SqlHelper SqlConfig, int UserId, SimpleGrupoCuentas Simple)
