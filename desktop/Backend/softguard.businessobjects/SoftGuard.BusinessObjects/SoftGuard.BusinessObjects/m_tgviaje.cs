...
{ 
   ///<summary>
     ///m_tgviaje class   
     ///</summary>
    public partial class m_tgviaje : Spem_tgviaje
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_tgviaje(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_tgviaje(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_tgviaje(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_tgviaje(SqlHelper SqlConfig, int UserId, Simplem_tgviaje Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
