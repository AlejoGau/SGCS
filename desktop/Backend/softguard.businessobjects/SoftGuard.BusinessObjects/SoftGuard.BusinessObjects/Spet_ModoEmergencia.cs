...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_ModoEmergencia : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_ModoEmergencia _DalObject;
 ...
 ///<summary>
     ...
     public int  tme_nEstado 
		 { 
                    ...
                    get{ return this._DalObject.tme_nEstado; }
        						set{ this._DalObject.tme_nEstado = value; } 										
	   }
	  ///<summary>
     ...
     public string  tme_cEventos 
		 { 
                    ...
                    get{ return this._DalObject.tme_cEventos; }
        						set{ this._DalObject.tme_cEventos = value; } 										
	   }
	  ///<summary>
     ...
     public string  tme_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.tme_cDealer; }
        						set{ this._DalObject.tme_cDealer = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_ModoEmergencia(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_ModoEmergencia(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_ModoEmergencia(SqlHelper SqlConfig, int UserId, Simplet_ModoEmergencia Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_ModoEmergencia Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_ModoEmergencia has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_ModoEmergencia GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_ModoEmergencia is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_ModoEmergencia(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_ModoEmergencia)Object;
			o.Name = this.Name;

			o.tme_nEstado = this.tme_nEstado;

			o.tme_cEventos = this.tme_cEventos;

			o.tme_cDealer = this.tme_cDealer;
