...
// Type: SoftGuard.BusinessObjects.SpeT_ProtocolosComandos
...
{
  public abstract class SpeT_ProtocolosComandos : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalT_ProtocolosComandos _DalObject;
    ...
    public string pcm_cName
    {
      get
      {
        return this._DalObject.pcm_cName;
      }
      set
      {
        this._DalObject.pcm_cName = value;
      }
    }
    ...
    public string pcm_cMetaData
    {
      get
      {
        return this._DalObject.pcm_cMetaData;
      }
      set
      {
        this._DalObject.pcm_cMetaData = value;
      }
    }
    ...
    public string pcm_cComando
    {
      get
      {
        return this._DalObject.pcm_cComando;
      }
      set
      {
        this._DalObject.pcm_cComando = value;
      }
    }
    ...
    public SpeT_ProtocolosComandos(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeT_ProtocolosComandos(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeT_ProtocolosComandos(SqlHelper SqlConfig, int UserId, SimpleT_ProtocolosComandos Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleT_ProtocolosComandos Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The T_ProtocolosComandos has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalT_ProtocolosComandos GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The T_ProtocolosComandos is null.");
    ...
    {
      this._DalObject = new DalT_ProtocolosComandos(SqlConfig, UserId);
    ...
    {
      T_ProtocolosComandos protocolosComandos = (T_ProtocolosComandos) Object;
