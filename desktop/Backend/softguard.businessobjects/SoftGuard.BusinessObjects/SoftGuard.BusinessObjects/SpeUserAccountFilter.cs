...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeUserAccountFilter : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalUserAccountFilter _DalObject;
 ...
 ///<summary>
     ...
     public int  uaf_userId 
		 { 
                    ...
                    get{ return this._DalObject.uaf_userId; }
        						set{ this._DalObject.uaf_userId = value; } 										
	   }
	  ///<summary>
     ...
     public string  uaf_provinciaCodigo 
		 { 
                    ...
                    get{ return this._DalObject.uaf_provinciaCodigo; }
        						set{ this._DalObject.uaf_provinciaCodigo = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeUserAccountFilter(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeUserAccountFilter(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeUserAccountFilter(SqlHelper SqlConfig, int UserId, SimpleUserAccountFilter Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleUserAccountFilter Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The UserAccountFilter has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalUserAccountFilter GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The UserAccountFilter is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalUserAccountFilter(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.UserAccountFilter)Object;
			o.Name = this.Name;

			o.uaf_userId = this.uaf_userId;

			o.uaf_provinciaCodigo = this.uaf_provinciaCodigo;
