...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_push_queue : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_push_queue _DalObject;
 ...
 ///<summary>
     ...
     public string  ppq_msg 
		 { 
                    ...
                    get{ return this._DalObject.ppq_msg; }
        						set{ this._DalObject.ppq_msg = value; } 										
	   }
	  ///<summary>
     ///ppq_estado property   
     ///</summary>	
     public int  ppq_estado 
		 { 
                    ...
                    get{ return this._DalObject.ppq_estado; }
        						set{ this._DalObject.ppq_estado = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  ppq_fechacreacion 
		 { 
                    ...
                    get{ return this._DalObject.ppq_fechacreacion; }
        						set{ this._DalObject.ppq_fechacreacion = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  ppq_fechaenvio 
		 { 
                    ...
                    get{ return this._DalObject.ppq_fechaenvio; }
        						set{ this._DalObject.ppq_fechaenvio = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_push_queue(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_push_queue(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_push_queue(SqlHelper SqlConfig, int UserId, Simplep_push_queue Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_push_queue Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_push_queue has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_push_queue GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_push_queue is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_push_queue(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_push_queue)Object;
			o.Name = this.Name;

			o.ppq_msg = this.ppq_msg;

			o.ppq_estado = this.ppq_estado;

			o.ppq_fechacreacion = this.ppq_fechacreacion;

			o.ppq_fechaenvio = this.ppq_fechaenvio;
