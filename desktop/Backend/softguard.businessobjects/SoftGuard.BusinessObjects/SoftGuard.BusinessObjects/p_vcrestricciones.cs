...
{ 
   ///<summary>
     ///p_vcrestricciones class   
     ///</summary>
    public partial class p_vcrestricciones : Spep_vcrestricciones
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_vcrestricciones(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_vcrestricciones(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_vcrestricciones(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_vcrestricciones(SqlHelper SqlConfig, int UserId, Simplep_vcrestricciones Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
