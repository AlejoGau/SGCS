...
// Type: SoftGuard.BusinessObjects.t_LineasXPuerto
...
{
  public class t_LineasXPuerto : Spet_LineasXPuerto
  {
    public t_LineasXPuerto(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_LineasXPuerto(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_LineasXPuerto(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_LineasXPuerto(SqlHelper SqlConfig, int UserId, Simplet_LineasXPuerto Simple)
