...
{ 
   ///<summary>
     ///t_modems_sms class   
     ///</summary>
    public partial class t_modems_sms : Spet_modems_sms
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_modems_sms(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_modems_sms(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_modems_sms(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_modems_sms(SqlHelper SqlConfig, int UserId, Simplet_modems_sms Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
