...
// Type: SoftGuard.BusinessObjects.SpeNota
...
{
  public abstract class SpeNota : ISpecialization
  {
    private bool _AutoCommit = false;
    protected DalNota _DalObject;
    ...
    public int not_iidcuenta
    {
      get
      {
        return this._DalObject.not_iidcuenta;
      }
      set
      {
        this._DalObject.not_iidcuenta = value;
      }
    }
    ...
    public string not_mnotaprincipal
    {
      get
      {
        return this._DalObject.not_mnotaprincipal;
      }
      set
      {
        this._DalObject.not_mnotaprincipal = value;
      }
    }
    ...
    public string not_mnotatemporal
    {
      get
      {
        return this._DalObject.not_mnotatemporal;
      }
      set
      {
        this._DalObject.not_mnotatemporal = value;
      }
    }
    ...
    public DateTime not_dtemporaldesde
    {
      get
      {
        return this._DalObject.not_dtemporaldesde;
      }
      set
      {
        this._DalObject.not_dtemporaldesde = value;
      }
    }
    ...
    public DateTime not_dtemporalhasta
    {
      get
      {
        return this._DalObject.not_dtemporalhasta;
      }
      set
      {
        this._DalObject.not_dtemporalhasta = value;
      }
    }
    ...
    public SpeNota(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeNota(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeNota(SqlHelper SqlConfig, int UserId, SimpleNota Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleNota Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The Nota has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The Nota is null.");
    ...
    {
      this._DalObject = new DalNota(SqlConfig, UserId);
