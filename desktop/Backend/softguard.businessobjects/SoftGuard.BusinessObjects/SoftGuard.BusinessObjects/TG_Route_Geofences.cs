...
{ 
   ///<summary>
     ///TG_Route_Geofences class   
     ///</summary>
    public partial class TG_Route_Geofences : SpeTG_Route_Geofences
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public TG_Route_Geofences(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public TG_Route_Geofences(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TG_Route_Geofences(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TG_Route_Geofences(SqlHelper SqlConfig, int UserId, SimpleTG_Route_Geofences Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
