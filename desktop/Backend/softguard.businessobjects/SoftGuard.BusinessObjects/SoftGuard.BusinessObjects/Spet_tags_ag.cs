...
// Type: SoftGuard.BusinessObjects.Spet_tags_ag
...
{
  public abstract class Spet_tags_ag : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_tags_ag _DalObject;
    ...
    public string tag_ccodigo
    {
      get
      {
        return this._DalObject.tag_ccodigo;
      }
      set
      {
        this._DalObject.tag_ccodigo = value;
      }
    }
    ...
    public string tag_ctag
    {
      get
      {
        return this._DalObject.tag_ctag;
      }
      set
      {
        this._DalObject.tag_ctag = value;
      }
    }
    ...
    public string tag_czona
    {
      get
      {
        return this._DalObject.tag_czona;
      }
      set
      {
        this._DalObject.tag_czona = value;
      }
    }
    ...
    public int tag_iCuenta
    {
      get
      {
        return this._DalObject.tag_iCuenta;
      }
      set
      {
        this._DalObject.tag_iCuenta = value;
      }
    }
    ...
    public Spet_tags_ag(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_tags_ag(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_tags_ag(SqlHelper SqlConfig, int UserId, Simplet_tags_ag Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_tags_ag Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_tags_ag has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_tags_ag GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_tags_ag is null.");
    ...
    {
      this._DalObject = new Dalt_tags_ag(SqlConfig, UserId);
    ...
    {
      t_tags_ag tTagsAg = (t_tags_ag) Object;
      tTagsAg.Name = this.Name;
      tTagsAg.tag_ccodigo = this.tag_ccodigo;
      tTagsAg.tag_ctag = this.tag_ctag;
      tTagsAg.tag_czona = this.tag_czona;
      tTagsAg.tag_iCuenta = this.tag_iCuenta;
    }
