...
{ 
   ///<summary>
     ///RemoteCallQueue class   
     ///</summary>
    public partial class RemoteCallQueue : SpeRemoteCallQueue
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public RemoteCallQueue(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public RemoteCallQueue(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public RemoteCallQueue(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public RemoteCallQueue(SqlHelper SqlConfig, int UserId, SimpleRemoteCallQueue Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
