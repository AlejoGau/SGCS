...
{ 
   ///<summary>
     ///t_TG_mantenimiento_servicios class   
     ///</summary>
    public partial class t_TG_mantenimiento_servicios : Spet_TG_mantenimiento_servicios
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_TG_mantenimiento_servicios(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_TG_mantenimiento_servicios(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_TG_mantenimiento_servicios(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_TG_mantenimiento_servicios(SqlHelper SqlConfig, int UserId, Simplet_TG_mantenimiento_servicios Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
