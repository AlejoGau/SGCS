...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_mensajes_whatsapp : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_mensajes_whatsapp _DalObject;
 ...
 ///<summary>
     ...
     public string  tmw_ctitulo 
		 { 
                    ...
                    get{ return this._DalObject.tmw_ctitulo; }
        						set{ this._DalObject.tmw_ctitulo = value; } 										
	   }
	  ///<summary>
     ...
     public string  tmw_cmensaje 
		 { 
                    ...
                    get{ return this._DalObject.tmw_cmensaje; }
        						set{ this._DalObject.tmw_cmensaje = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_mensajes_whatsapp(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_mensajes_whatsapp(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_mensajes_whatsapp(SqlHelper SqlConfig, int UserId, Simplet_mensajes_whatsapp Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_mensajes_whatsapp Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_mensajes_whatsapp has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_mensajes_whatsapp GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_mensajes_whatsapp is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_mensajes_whatsapp(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_mensajes_whatsapp)Object;
			o.Name = this.Name;

			o.tmw_ctitulo = this.tmw_ctitulo;

			o.tmw_cmensaje = this.tmw_cmensaje;
