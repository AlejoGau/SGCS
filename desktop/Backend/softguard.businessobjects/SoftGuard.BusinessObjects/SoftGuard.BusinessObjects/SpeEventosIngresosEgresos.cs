...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeEventosIngresosEgresos : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalEventosIngresosEgresos _DalObject;
 ...
 ///<summary>
     ...
     public int  eie_iRecId 
		 { 
                    ...
                    get{ return this._DalObject.eie_iRecId; }
        						set{ this._DalObject.eie_iRecId = value; } 										
	   }
	  ///<summary>
     ...
     public int  eie_iCuentaId 
		 { 
                    ...
                    get{ return this._DalObject.eie_iCuentaId; }
        						set{ this._DalObject.eie_iCuentaId = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  eie_tFechaHora 
		 { 
                    ...
                    get{ return this._DalObject.eie_tFechaHora; }
        						set{ this._DalObject.eie_tFechaHora = value; } 										
	   }
	  ///<summary>
     ...
     public string  eie_cMatricula 
		 { 
                    ...
                    get{ return this._DalObject.eie_cMatricula; }
        						set{ this._DalObject.eie_cMatricula = value; } 										
	   }
	  ///<summary>
     ...
     public string  eie_cUnidadFuncional 
		 { 
                    ...
                    get{ return this._DalObject.eie_cUnidadFuncional; }
        						set{ this._DalObject.eie_cUnidadFuncional = value; } 										
	   }
	  ///<summary>
     ...
     public string  eie_cVecino 
		 { 
                    ...
                    get{ return this._DalObject.eie_cVecino; }
        						set{ this._DalObject.eie_cVecino = value; } 										
	   }
	  ///<summary>
     ...
     public string  eie_cTransito 
		 { 
                    ...
                    get{ return this._DalObject.eie_cTransito; }
        						set{ this._DalObject.eie_cTransito = value; } 										
	   }
	  ///<summary>
     ...
     public string  eie_cUsuario 
		 { 
                    ...
                    get{ return this._DalObject.eie_cUsuario; }
        						set{ this._DalObject.eie_cUsuario = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeEventosIngresosEgresos(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeEventosIngresosEgresos(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeEventosIngresosEgresos(SqlHelper SqlConfig, int UserId, SimpleEventosIngresosEgresos Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleEventosIngresosEgresos Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The EventosIngresosEgresos has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalEventosIngresosEgresos GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The EventosIngresosEgresos is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalEventosIngresosEgresos(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.EventosIngresosEgresos)Object;
			o.Name = this.Name;

			o.eie_iRecId = this.eie_iRecId;

			o.eie_iCuentaId = this.eie_iCuentaId;

			o.eie_tFechaHora = this.eie_tFechaHora;

			o.eie_cMatricula = this.eie_cMatricula;

			o.eie_cUnidadFuncional = this.eie_cUnidadFuncional;

			o.eie_cVecino = this.eie_cVecino;

			o.eie_cTransito = this.eie_cTransito;

			o.eie_cUsuario = this.eie_cUsuario;
