...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_categorizacion : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_categorizacion _DalObject;
 ...
 ///<summary>
     ...
     public int  cat_iEstado 
		 { 
                    ...
                    get{ return this._DalObject.cat_iEstado; }
        						set{ this._DalObject.cat_iEstado = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_categorizacion(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_categorizacion(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_categorizacion(SqlHelper SqlConfig, int UserId, Simplet_categorizacion Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_categorizacion Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_categorizacion has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_categorizacion GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_categorizacion is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_categorizacion(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public void CopyPropertiesTo(ISpecialization Object)
        {
			...
			o.cat_iEstado = this.cat_iEstado;
