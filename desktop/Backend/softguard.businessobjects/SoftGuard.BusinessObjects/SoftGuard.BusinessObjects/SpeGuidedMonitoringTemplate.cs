...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeGuidedMonitoringTemplate : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalGuidedMonitoringTemplate _DalObject;
 ...
 ///<summary>
     ...
     public string  gmt_cTemplateName 
		 { 
                    ...
                    get{ return this._DalObject.gmt_cTemplateName; }
        						set{ this._DalObject.gmt_cTemplateName = value; } 										
	   }
	  ///<summary>
     ///gmt_cDesc property   
     ///</summary>	
     public string  gmt_cDesc 
		 { 
                    ...
                    get{ return this._DalObject.gmt_cDesc; }
        						set{ this._DalObject.gmt_cDesc = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeGuidedMonitoringTemplate(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeGuidedMonitoringTemplate(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeGuidedMonitoringTemplate(SqlHelper SqlConfig, int UserId, SimpleGuidedMonitoringTemplate Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleGuidedMonitoringTemplate Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The GuidedMonitoringTemplate has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalGuidedMonitoringTemplate GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The GuidedMonitoringTemplate is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalGuidedMonitoringTemplate(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.GuidedMonitoringTemplate)Object;
			o.Name = this.Name;

			o.gmt_cTemplateName = this.gmt_cTemplateName;

			o.gmt_cDesc = this.gmt_cDesc;
