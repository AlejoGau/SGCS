...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeProduct : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalProduct _DalObject;
 ...
 ///<summary>
     ...
     public string  SmallComment 
		 { 
                    ...
                    get{ return this._DalObject.SmallComment; }
        						set{ this._DalObject.SmallComment = value; } 										
	   }
	  ///<summary>
     ...
     public string  LargeComment 
		 { 
                    ...
                    get{ return this._DalObject.LargeComment; }
        						set{ this._DalObject.LargeComment = value; } 										
	   }
	  ///<summary>
     ///Body property   
     ///</summary>	
     public string  Body 
		 { 
                    ...
                    get{ return this._DalObject.Body; }
        						set{ this._DalObject.Body = value; } 										
	   }
	  ///<summary>
     ///Available property   
     ///</summary>	
     public string  Available 
		 { 
                    ...
                    get{ return this._DalObject.Available; }
        						set{ this._DalObject.Available = value; } 										
	   }
	  ///<summary>
     ///Price property   
     ///</summary>	
     public Decimal  Price 
		 { 
                    ...
                    get{ return this._DalObject.Price; }
        						set{ this._DalObject.Price = value; } 										
	   }
	  ///<summary>
     ///Structure property   
     ///</summary>	
     public string  Structure 
		 { 
                    ...
                    get{ return this._DalObject.Structure; }
        						set{ this._DalObject.Structure = value; } 										
	   }
	  ///<summary>
     ///Weight property   
     ///</summary>	
     public int  Weight 
		 { 
                    ...
                    get{ return this._DalObject.Weight; }
        						set{ this._DalObject.Weight = value; } 										
	   }
	  ///<summary>
     ...
     public string  MetaDescription 
		 { 
                    ...
                    get{ return this._DalObject.MetaDescription; }
        						set{ this._DalObject.MetaDescription = value; } 										
	   }
	  ///<summary>
     ...
     public string  MetaKeywords 
		 { 
                    ...
                    get{ return this._DalObject.MetaKeywords; }
        						set{ this._DalObject.MetaKeywords = value; } 										
	   }
	  ///<summary>
     ///Status property   
     ///</summary>	
     public string  Status 
		 { 
                    ...
                    get{ return this._DalObject.Status; }
        						set{ this._DalObject.Status = value; } 										
	   }
	  ///<summary>
     ///AttachId property   
     ///</summary>	
     public int  AttachId 
		 { 
                    ...
                    get{ return this._DalObject.AttachId; }
        						set{ this._DalObject.AttachId = value; } 										
	   }
	  ///<summary>
     ///Code property   
     ///</summary>	
     public string  Code 
		 { 
                    ...
                    get{ return this._DalObject.Code; }
        						set{ this._DalObject.Code = value; } 										
	   }
	  ///<summary>
     ///VAT property   
     ///</summary>	
     public Decimal  VAT 
		 { 
                    ...
                    get{ return this._DalObject.VAT; }
        						set{ this._DalObject.VAT = value; } 										
	   }
	  ///<summary>
     ///Cost property   
     ///</summary>	
     public Decimal  Cost 
		 { 
                    ...
                    get{ return this._DalObject.Cost; }
        						set{ this._DalObject.Cost = value; } 										
	   }
	  ///<summary>
     ...
     public string  MeasureUnit 
		 { 
                    ...
                    get{ return this._DalObject.MeasureUnit; }
        						set{ this._DalObject.MeasureUnit = value; } 										
	   }
	  ///<summary>
     ...
     public int  pro_iidorganizacion 
		 { 
                    ...
                    get{ return this._DalObject.pro_iidorganizacion; }
        						set{ this._DalObject.pro_iidorganizacion = value; } 										
	   }
	  ///<summary>
     ///pro_itipo property   
     ///</summary>	
     public int  pro_itipo 
		 { 
                    ...
                    get{ return this._DalObject.pro_itipo; }
        						set{ this._DalObject.pro_itipo = value; } 										
	   }
	  ///<summary>
     ...
     public string  pro_currency 
		 { 
                    ...
                    get{ return this._DalObject.pro_currency; }
        						set{ this._DalObject.pro_currency = value; } 										
	   }
	  ///<summary>
     ...
     public int  pro_cantidad_auto 
		 { 
                    ...
                    get{ return this._DalObject.pro_cantidad_auto; }
        						set{ this._DalObject.pro_cantidad_auto = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeProduct(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeProduct(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeProduct(SqlHelper SqlConfig, int UserId, SimpleProduct Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleProduct Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The Product has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalProduct GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The Product is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalProduct(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.Product)Object;
			o.Name = this.Name;

			o.SmallComment = this.SmallComment;

			o.LargeComment = this.LargeComment;

			o.Body = this.Body;

			o.Available = this.Available;
			...
			o.MetaDescription = this.MetaDescription;

			o.MetaKeywords = this.MetaKeywords;

			o.Status = this.Status;

			o.AttachId = this.AttachId;
			...
			o.MeasureUnit = this.MeasureUnit;

			o.pro_iidorganizacion = this.pro_iidorganizacion;

			o.pro_itipo = this.pro_itipo;

			o.pro_currency = this.pro_currency;

			o.pro_cantidad_auto = this.pro_cantidad_auto;
