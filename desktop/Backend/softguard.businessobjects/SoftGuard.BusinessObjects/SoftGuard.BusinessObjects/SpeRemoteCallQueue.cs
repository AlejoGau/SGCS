...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeRemoteCallQueue : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalRemoteCallQueue _DalObject;
 ...
 ///<summary>
     ...
     public int  rcq_estado 
		 { 
                    ...
                    get{ return this._DalObject.rcq_estado; }
        						set{ this._DalObject.rcq_estado = value; } 										
	   }
	  ///<summary>
     ///rcq_tipo property   
     ///</summary>	
     public string  rcq_tipo 
		 { 
                    ...
                    get{ return this._DalObject.rcq_tipo; }
        						set{ this._DalObject.rcq_tipo = value; } 										
	   }
	  ///<summary>
     ///rcq_url property   
     ///</summary>	
     public string  rcq_url 
		 { 
                    ...
                    get{ return this._DalObject.rcq_url; }
        						set{ this._DalObject.rcq_url = value; } 										
	   }
	  ///<summary>
     ///rcq_result property   
     ///</summary>	
     public string  rcq_result 
		 { 
                    ...
                    get{ return this._DalObject.rcq_result; }
        						set{ this._DalObject.rcq_result = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  rcq_fechaprograma 
		 { 
                    ...
                    get{ return this._DalObject.rcq_fechaprograma; }
        						set{ this._DalObject.rcq_fechaprograma = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  rcq_fechaalta 
		 { 
                    ...
                    get{ return this._DalObject.rcq_fechaalta; }
        						set{ this._DalObject.rcq_fechaalta = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  rcq_fechamodificacion 
		 { 
                    ...
                    get{ return this._DalObject.rcq_fechamodificacion; }
        						set{ this._DalObject.rcq_fechamodificacion = value; } 										
	   }
	  ///<summary>
     ///rcq_config property   
     ///</summary>	
     public string  rcq_config 
		 { 
                    ...
                    get{ return this._DalObject.rcq_config; }
        						set{ this._DalObject.rcq_config = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeRemoteCallQueue(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeRemoteCallQueue(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeRemoteCallQueue(SqlHelper SqlConfig, int UserId, SimpleRemoteCallQueue Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleRemoteCallQueue Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The RemoteCallQueue has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalRemoteCallQueue GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The RemoteCallQueue is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalRemoteCallQueue(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (RemoteCallQueue)Object;
			o.Name = this.Name;

			o.rcq_estado = this.rcq_estado;

			o.rcq_tipo = this.rcq_tipo;

			o.rcq_url = this.rcq_url;

			o.rcq_result = this.rcq_result;

			o.rcq_fechaprograma = this.rcq_fechaprograma;

			o.rcq_fechaalta = this.rcq_fechaalta;

			o.rcq_fechamodificacion = this.rcq_fechamodificacion;

			o.rcq_config = this.rcq_config;
