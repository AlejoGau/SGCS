...
{ 
   ///<summary>
     ///EventosInformados class   
     ///</summary>
    public partial class EventosInformados : SpeEventosInformados
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public EventosInformados(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public EventosInformados(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public EventosInformados(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public EventosInformados(SqlHelper SqlConfig, int UserId, SimpleEventosInformados Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
