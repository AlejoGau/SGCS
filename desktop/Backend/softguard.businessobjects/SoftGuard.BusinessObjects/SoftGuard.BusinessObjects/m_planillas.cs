...
// Type: SoftGuard.BusinessObjects.m_planillas
...
{
  public class m_planillas : Spem_planillas
  {
    public m_planillas(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_planillas(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_planillas(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_planillas(SqlHelper SqlConfig, int UserId, Simplem_planillas Simple)
