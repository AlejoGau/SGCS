...
{ 
   ///<summary>
     ///m_tstconexion class   
     ///</summary>
    public partial class m_tstconexion : Spem_tstconexion
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_tstconexion(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_tstconexion(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_tstconexion(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_tstconexion(SqlHelper SqlConfig, int UserId, Simplem_tstconexion Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
