...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeMG_Afip_Cae : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalMG_Afip_Cae _DalObject;
 ...
 ///<summary>
     ...
     public int  mac_idcbte 
		 { 
                    ...
                    get{ return this._DalObject.mac_idcbte; }
        						set{ this._DalObject.mac_idcbte = value; } 										
	   }
	  ///<summary>
     ///mac_estado property   
     ///</summary>	
     public int  mac_estado 
		 { 
                    ...
                    get{ return this._DalObject.mac_estado; }
        						set{ this._DalObject.mac_estado = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  mac_fechaalta 
		 { 
                    ...
                    get{ return this._DalObject.mac_fechaalta; }
        						set{ this._DalObject.mac_fechaalta = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  mac_fechamod 
		 { 
                    ...
                    get{ return this._DalObject.mac_fechamod; }
        						set{ this._DalObject.mac_fechamod = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeMG_Afip_Cae(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_Afip_Cae(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_Afip_Cae(SqlHelper SqlConfig, int UserId, SimpleMG_Afip_Cae Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleMG_Afip_Cae Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The MG_Afip_Cae has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalMG_Afip_Cae GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The MG_Afip_Cae is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalMG_Afip_Cae(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (MG_Afip_Cae)Object;
			o.Name = this.Name;

			o.mac_idcbte = this.mac_idcbte;

			o.mac_estado = this.mac_estado;

			o.mac_fechaalta = this.mac_fechaalta;

			o.mac_fechamod = this.mac_fechamod;
