...
// Type: SoftGuard.BusinessObjects.t_teclados
...
{
  public class t_teclados : Spet_teclados
  {
    public t_teclados(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_teclados(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_teclados(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_teclados(SqlHelper SqlConfig, int UserId, Simplet_teclados Simple)
