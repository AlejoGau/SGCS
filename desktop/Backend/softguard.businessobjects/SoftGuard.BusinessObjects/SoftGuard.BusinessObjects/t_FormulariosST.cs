...
{ 
   ///<summary>
     ///t_FormulariosST class   
     ///</summary>
    public partial class t_FormulariosST : Spet_FormulariosST
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_FormulariosST(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_FormulariosST(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_FormulariosST(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_FormulariosST(SqlHelper SqlConfig, int UserId, Simplet_FormulariosST Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
