...
// Type: SoftGuard.BusinessObjects.SpeZona
...
{
  public abstract class SpeZona : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalZona _DalObject;
    ...
    public int zon_iidcuenta
    {
      get
      {
        return this._DalObject.zon_iidcuenta;
      }
      set
      {
        this._DalObject.zon_iidcuenta = value;
      }
    }
    ...
    public string zon_ccodigo
    {
      get
      {
        return this._DalObject.zon_ccodigo;
      }
      set
      {
        this._DalObject.zon_ccodigo = value;
      }
    }
    ...
    public string zon_cdescripcion
    {
      get
      {
        return this._DalObject.zon_cdescripcion;
      }
      set
      {
        this._DalObject.zon_cdescripcion = value;
      }
    }
    ...
    public string zon_codigoalarma
    {
      get
      {
        return this._DalObject.zon_codigoalarma;
      }
      set
      {
        this._DalObject.zon_codigoalarma = value;
      }
    }
    ...
    public string zon_clistaemergencia
    {
      get
      {
        return this._DalObject.zon_clistaemergencia;
      }
      set
      {
        this._DalObject.zon_clistaemergencia = value;
      }
    }
    ...
    public string zon_cimagen
    {
      get
      {
        return this._DalObject.zon_cimagen;
      }
      set
      {
        this._DalObject.zon_cimagen = value;
      }
    }
    ...
    public string zon_mobservacion
    {
      get
      {
        return this._DalObject.zon_mobservacion;
      }
      set
      {
        this._DalObject.zon_mobservacion = value;
      }
    }
    ...
    public string zon_ccodigorestauracion
    {
      get
      {
        return this._DalObject.zon_ccodigorestauracion;
      }
      set
      {
        this._DalObject.zon_ccodigorestauracion = value;
      }
    }
    ...
    public Decimal zon_nminutosrestauracion
    {
      get
      {
        return this._DalObject.zon_nminutosrestauracion;
      }
      set
      {
        this._DalObject.zon_nminutosrestauracion = value;
      }
    }
    ...
    public Decimal zon_nmostrar
    {
      get
      {
        return this._DalObject.zon_nmostrar;
      }
      set
      {
        this._DalObject.zon_nmostrar = value;
      }
    }
    ...
    public string zon_cdealer
    {
      get
      {
        return this._DalObject.zon_cdealer;
      }
      set
      {
        this._DalObject.zon_cdealer = value;
      }
    }
    ...
    public string zon_ccuenta
    {
      get
      {
        return this._DalObject.zon_ccuenta;
      }
      set
      {
        this._DalObject.zon_ccuenta = value;
      }
    }
    ...
    public Decimal zon_nautoprocesa
    {
      get
      {
        return this._DalObject.zon_nautoprocesa;
      }
      set
      {
        this._DalObject.zon_nautoprocesa = value;
      }
    }
    ...
    public string zon_cAlarmaAGenerar
    {
      get
      {
        return this._DalObject.zon_cAlarmaAGenerar;
      }
      set
      {
        this._DalObject.zon_cAlarmaAGenerar = value;
      }
    }
    ...
    public SpeZona(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeZona(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeZona(SqlHelper SqlConfig, int UserId, SimpleZona Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleZona Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The Zona has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The Zona is null.");
    ...
    {
      this._DalObject = new DalZona(SqlConfig, UserId);
    ...
    public void CopyPropertiesTo(ISpecialization Object)
    {
      ...
      zona.Name = this.Name;
      zona.zon_iidcuenta = this.zon_iidcuenta;
      zona.zon_ccodigo = this.zon_ccodigo;
      zona.zon_cdescripcion = this.zon_cdescripcion;
      zona.zon_codigoalarma = this.zon_codigoalarma;
      zona.zon_clistaemergencia = this.zon_clistaemergencia;
      zona.zon_cimagen = this.zon_cimagen;
      zona.zon_mobservacion = this.zon_mobservacion;
      zona.zon_ccodigorestauracion = this.zon_ccodigorestauracion;
      zona.zon_nminutosrestauracion = this.zon_nminutosrestauracion;
      zona.zon_nmostrar = this.zon_nmostrar;
      zona.zon_cdealer = this.zon_cdealer;
      zona.zon_ccuenta = this.zon_ccuenta;
      zona.zon_nautoprocesa = this.zon_nautoprocesa;
      zona.zon_cAlarmaAGenerar = this.zon_cAlarmaAGenerar;
    }
