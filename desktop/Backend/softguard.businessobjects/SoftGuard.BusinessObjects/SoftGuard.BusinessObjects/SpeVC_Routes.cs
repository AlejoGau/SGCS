...
// Type: SoftGuard.BusinessObjects.SpeVC_Routes
...
{
  public abstract class SpeVC_Routes : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalVC_Routes _DalObject;
    ...
    public int cuentaId
    {
      get
      {
        return this._DalObject.cuentaId;
      }
      set
      {
        this._DalObject.cuentaId = value;
      }
    }
    ...
    public int userId
    {
      get
      {
        return this._DalObject.userId;
      }
      set
      {
        this._DalObject.userId = value;
      }
    }
    ...
    public string routetype
    {
      get
      {
        return this._DalObject.routetype;
      }
      set
      {
        this._DalObject.routetype = value;
      }
    }
    ...
    public DateTime? datestart
    {
      get
      {
        return this._DalObject.datestart;
      }
      set
      {
        this._DalObject.datestart = value;
      }
    }
    ...
    public int time
    {
      get
      {
        return this._DalObject.time;
      }
      set
      {
        this._DalObject.time = value;
      }
    }
    ...
    public int startbeforetolerance
    {
      get
      {
        return this._DalObject.startbeforetolerance;
      }
      set
      {
        this._DalObject.startbeforetolerance = value;
      }
    }
    ...
    public int startaftertolerance
    {
      get
      {
        return this._DalObject.startaftertolerance;
      }
      set
      {
        this._DalObject.startaftertolerance = value;
      }
    }
    ...
    public int endbeforetolerance
    {
      get
      {
        return this._DalObject.endbeforetolerance;
      }
      set
      {
        this._DalObject.endbeforetolerance = value;
      }
    }
    ...
    public int endaftertolerance
    {
      get
      {
        return this._DalObject.endaftertolerance;
      }
      set
      {
        this._DalObject.endaftertolerance = value;
      }
    }
    ...
    public SpeVC_Routes(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeVC_Routes(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeVC_Routes(SqlHelper SqlConfig, int UserId, SimpleVC_Routes Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleVC_Routes Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The VC_Routes has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalVC_Routes GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The VC_Routes is null.");
    ...
    {
      this._DalObject = new DalVC_Routes(SqlConfig, UserId);
    ...
    {
      VC_Routes vcRoutes = (VC_Routes) Object;
      vcRoutes.Name = this.Name;
      vcRoutes.cuentaId = this.cuentaId;
      vcRoutes.userId = this.userId;
      vcRoutes.routetype = this.routetype;
      vcRoutes.datestart = this.datestart;
      vcRoutes.time = this.time;
      vcRoutes.startbeforetolerance = this.startbeforetolerance;
      vcRoutes.startaftertolerance = this.startaftertolerance;
      vcRoutes.endbeforetolerance = this.endbeforetolerance;
      vcRoutes.endaftertolerance = this.endaftertolerance;
    }
