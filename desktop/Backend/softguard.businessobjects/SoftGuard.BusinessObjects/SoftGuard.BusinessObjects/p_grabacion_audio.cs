...
{ 
   ///<summary>
     ///p_grabacion_audio class   
     ///</summary>
    public partial class p_grabacion_audio : Spep_grabacion_audio
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_grabacion_audio(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_grabacion_audio(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_grabacion_audio(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_grabacion_audio(SqlHelper SqlConfig, int UserId, Simplep_grabacion_audio Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
