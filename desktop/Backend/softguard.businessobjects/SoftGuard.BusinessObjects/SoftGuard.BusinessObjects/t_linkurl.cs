...
{ 
   ///<summary>
     ///t_linkurl class   
     ///</summary>
    public partial class t_linkurl : Spet_linkurl
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_linkurl(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_linkurl(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_linkurl(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_linkurl(SqlHelper SqlConfig, int UserId, Simplet_linkurl Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
