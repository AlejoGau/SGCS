...
{ 
   ///<summary>
     ///m_st_cabecera class   
     ///</summary>
    public partial class m_st_cabecera : Spem_st_cabecera
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_st_cabecera(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_st_cabecera(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_st_cabecera(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_st_cabecera(SqlHelper SqlConfig, int UserId, Simplem_st_cabecera Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
