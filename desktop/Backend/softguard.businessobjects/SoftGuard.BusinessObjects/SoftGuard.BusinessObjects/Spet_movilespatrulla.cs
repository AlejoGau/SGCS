...
// Type: SoftGuard.BusinessObjects.Spet_movilespatrulla
...
{
  public abstract class Spet_movilespatrulla : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_movilespatrulla _DalObject;
    ...
    public string tmp_cnombre
    {
      get
      {
        return this._DalObject.tmp_cnombre;
      }
      set
      {
        this._DalObject.tmp_cnombre = value;
      }
    }
    ...
    public string tmp_cnumero
    {
      get
      {
        return this._DalObject.tmp_cnumero;
      }
      set
      {
        this._DalObject.tmp_cnumero = value;
      }
    }
    ...
    public string tmp_clicencia
    {
      get
      {
        return this._DalObject.tmp_clicencia;
      }
      set
      {
        this._DalObject.tmp_clicencia = value;
      }
    }
    ...
    public string tmp_cmarca
    {
      get
      {
        return this._DalObject.tmp_cmarca;
      }
      set
      {
        this._DalObject.tmp_cmarca = value;
      }
    }
    ...
    public string tmp_cmodelo
    {
      get
      {
        return this._DalObject.tmp_cmodelo;
      }
      set
      {
        this._DalObject.tmp_cmodelo = value;
      }
    }
    ...
    public string tmp_cpathfoto
    {
      get
      {
        return this._DalObject.tmp_cpathfoto;
      }
      set
      {
        this._DalObject.tmp_cpathfoto = value;
      }
    }
    ...
    public string tmp_cflota
    {
      get
      {
        return this._DalObject.tmp_cflota;
      }
      set
      {
        this._DalObject.tmp_cflota = value;
      }
    }
    ...
    public Decimal tmp_nestado
    {
      get
      {
        return this._DalObject.tmp_nestado;
      }
      set
      {
        this._DalObject.tmp_nestado = value;
      }
    }
    ...
    public int tmp_icuenta
    {
      get
      {
        return this._DalObject.tmp_icuenta;
      }
      set
      {
        this._DalObject.tmp_icuenta = value;
      }
    }
    ...
    public int tmp_iAsignado
    {
      get
      {
        return this._DalObject.tmp_iAsignado;
      }
      set
      {
        this._DalObject.tmp_iAsignado = value;
      }
    }
    ...
    public Spet_movilespatrulla(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_movilespatrulla(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_movilespatrulla(SqlHelper SqlConfig, int UserId, Simplet_movilespatrulla Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_movilespatrulla Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_movilespatrulla has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_movilespatrulla GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_movilespatrulla is null.");
    ...
    {
      this._DalObject = new Dalt_movilespatrulla(SqlConfig, UserId);
    ...
    {
      t_movilespatrulla tMovilespatrulla = (t_movilespatrulla) Object;
      tMovilespatrulla.Name = this.Name;
      tMovilespatrulla.tmp_cnombre = this.tmp_cnombre;
      tMovilespatrulla.tmp_cnumero = this.tmp_cnumero;
      tMovilespatrulla.tmp_clicencia = this.tmp_clicencia;
      tMovilespatrulla.tmp_cmarca = this.tmp_cmarca;
      tMovilespatrulla.tmp_cmodelo = this.tmp_cmodelo;
      tMovilespatrulla.tmp_cpathfoto = this.tmp_cpathfoto;
      tMovilespatrulla.tmp_cflota = this.tmp_cflota;
      tMovilespatrulla.tmp_nestado = this.tmp_nestado;
      tMovilespatrulla.tmp_icuenta = this.tmp_icuenta;
      tMovilespatrulla.tmp_iAsignado = this.tmp_iAsignado;
    }
