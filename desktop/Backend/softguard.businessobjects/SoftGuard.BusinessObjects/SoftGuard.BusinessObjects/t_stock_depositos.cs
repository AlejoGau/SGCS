...
{ 
   ///<summary>
     ///t_stock_depositos class   
     ///</summary>
    public partial class t_stock_depositos : Spet_stock_depositos
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_stock_depositos(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_stock_depositos(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_stock_depositos(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_stock_depositos(SqlHelper SqlConfig, int UserId, Simplet_stock_depositos Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
