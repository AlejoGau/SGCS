...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeGeoFense : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalGeoFense _DalObject;
 ...
 ///<summary>
     ...
     public string  GeoType 
		 { 
                    ...
                    get{ return this._DalObject.GeoType; }
        						set{ this._DalObject.GeoType = value; } 										
	   }
	  ///<summary>
     ///Dealer property   
     ///</summary>	
     public string  Dealer 
		 { 
                    ...
                    get{ return this._DalObject.Dealer; }
        						set{ this._DalObject.Dealer = value; } 										
	   }
	  ///<summary>
     ///MetaData property   
     ///</summary>	
     public string  MetaData 
		 { 
                    ...
                    get{ return this._DalObject.MetaData; }
        						set{ this._DalObject.MetaData = value; } 										
	   }
	  ///<summary>
     ///Style property   
     ///</summary>	
     public string  Style 
		 { 
                    ...
                    get{ return this._DalObject.Style; }
        						set{ this._DalObject.Style = value; } 										
	   }
	  ///<summary>
     ///MaxSpeed property   
     ///</summary>	
     ...
     public int  GeoGroup 
		 { 
                    ...
                    get{ return this._DalObject.GeoGroup; }
        						set{ this._DalObject.GeoGroup = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeGeoFense(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeGeoFense(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeGeoFense(SqlHelper SqlConfig, int UserId, SimpleGeoFense Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleGeoFense Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The GeoFense has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalGeoFense GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The GeoFense is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalGeoFense(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.GeoFense)Object;
			o.Name = this.Name;

			o.GeoType = this.GeoType;

			o.Dealer = this.Dealer;
