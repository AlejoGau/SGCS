...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_controlAcceso_puerta : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_controlAcceso_puerta _DalObject;
 ...
 ///<summary>
     ...
     public string  cap_nombre 
		 { 
                    ...
                    get{ return this._DalObject.cap_nombre; }
        						set{ this._DalObject.cap_nombre = value; } 										
	   }
	  ///<summary>
     ///cap_idCta property   
     ///</summary>	
     public int  cap_idCta 
		 { 
                    ...
                    get{ return this._DalObject.cap_idCta; }
        						set{ this._DalObject.cap_idCta = value; } 										
	   }
	  ///<summary>
     ...
     public long  cap_iIngreso 
		 { 
                    ...
                    get{ return this._DalObject.cap_iIngreso; }
        						set{ this._DalObject.cap_iIngreso = value; } 										
	   }
	  ///<summary>
     ...
     public long  cap_iEgreso 
		 { 
                    ...
                    get{ return this._DalObject.cap_iEgreso; }
        						set{ this._DalObject.cap_iEgreso = value; } 										
	   }
	  ///<summary>
     ...
     public long  cap_iIngreso2 
		 { 
                    ...
                    get{ return this._DalObject.cap_iIngreso2; }
        						set{ this._DalObject.cap_iIngreso2 = value; } 										
	   }
	  ///<summary>
     ...
     public long  cap_iEgreso2 
		 { 
                    ...
                    get{ return this._DalObject.cap_iEgreso2; }
        						set{ this._DalObject.cap_iEgreso2 = value; } 										
	   }
	  ///<summary>
     ...
     public long  cap_iIngreso3 
		 { 
                    ...
                    get{ return this._DalObject.cap_iIngreso3; }
        						set{ this._DalObject.cap_iIngreso3 = value; } 										
	   }
	  ///<summary>
     ...
     public long  cap_iEgreso3 
		 { 
                    ...
                    get{ return this._DalObject.cap_iEgreso3; }
        						set{ this._DalObject.cap_iEgreso3 = value; } 										
	   }
	  ///<summary>
     ...
     public long  cap_iIngreso4 
		 { 
                    ...
                    get{ return this._DalObject.cap_iIngreso4; }
        						set{ this._DalObject.cap_iIngreso4 = value; } 										
	   }
	  ///<summary>
     ...
     public long  cap_iEgreso4 
		 { 
                    ...
                    get{ return this._DalObject.cap_iEgreso4; }
        						set{ this._DalObject.cap_iEgreso4 = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_controlAcceso_puerta(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_controlAcceso_puerta(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_controlAcceso_puerta(SqlHelper SqlConfig, int UserId, Simplet_controlAcceso_puerta Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_controlAcceso_puerta Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_controlAcceso_puerta has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_controlAcceso_puerta GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_controlAcceso_puerta is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_controlAcceso_puerta(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_controlAcceso_puerta)Object;
			o.Name = this.Name;

			o.cap_nombre = this.cap_nombre;

			o.cap_idCta = this.cap_idCta;

			o.cap_iIngreso = this.cap_iIngreso;

			o.cap_iEgreso = this.cap_iEgreso;

			o.cap_iIngreso2 = this.cap_iIngreso2;

			o.cap_iEgreso2 = this.cap_iEgreso2;

			o.cap_iIngreso3 = this.cap_iIngreso3;

			o.cap_iEgreso3 = this.cap_iEgreso3;

			o.cap_iIngreso4 = this.cap_iIngreso4;

			o.cap_iEgreso4 = this.cap_iEgreso4;
