...
{ 
   ///<summary>
     ///MG_product_impuesto class   
     ///</summary>
    public partial class MG_product_impuesto : SpeMG_product_impuesto
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_product_impuesto(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_product_impuesto(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_product_impuesto(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_product_impuesto(SqlHelper SqlConfig, int UserId, SimpleMG_product_impuesto Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
