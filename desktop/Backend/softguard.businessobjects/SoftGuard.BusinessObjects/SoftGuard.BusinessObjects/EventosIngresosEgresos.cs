...
{ 
   ///<summary>
     ///EventosIngresosEgresos class   
     ///</summary>
    public partial class EventosIngresosEgresos : SpeEventosIngresosEgresos
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public EventosIngresosEgresos(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public EventosIngresosEgresos(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public EventosIngresosEgresos(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public EventosIngresosEgresos(SqlHelper SqlConfig, int UserId, SimpleEventosIngresosEgresos Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
