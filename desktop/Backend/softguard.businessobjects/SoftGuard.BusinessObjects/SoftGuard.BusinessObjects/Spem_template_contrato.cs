...
// Type: SoftGuard.BusinessObjects.Spem_template_contrato
...
{
  public abstract class Spem_template_contrato : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_template_contrato _DalObject;
    ...
    public string tmp_asunto
    {
      get
      {
        return this._DalObject.tmp_asunto;
      }
      set
      {
        this._DalObject.tmp_asunto = value;
      }
    }
    ...
    public string tmp_cuerpo
    {
      get
      {
        return this._DalObject.tmp_cuerpo;
      }
      set
      {
        this._DalObject.tmp_cuerpo = value;
      }
    }
    ...
    public string tmp_metadata
    {
      get
      {
        return this._DalObject.tmp_metadata;
      }
      set
      {
        this._DalObject.tmp_metadata = value;
      }
    }
    ...
    public int tmp_iorganizacion
    {
      get
      {
        return this._DalObject.tmp_iorganizacion;
      }
      set
      {
        this._DalObject.tmp_iorganizacion = value;
      }
    }
    ...
    public int tmp_itipo
    {
      get
      {
        return this._DalObject.tmp_itipo;
      }
      set
      {
        this._DalObject.tmp_itipo = value;
      }
    }
    ...
    public Spem_template_contrato(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_template_contrato(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_template_contrato(SqlHelper SqlConfig, int UserId, Simplem_template_contrato Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_template_contrato Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_template_contrato has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_template_contrato GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_template_contrato is null.");
    ...
    {
      this._DalObject = new Dalm_template_contrato(SqlConfig, UserId);
    ...
    {
      m_template_contrato templateContrato = (m_template_contrato) Object;
