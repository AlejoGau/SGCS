...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeEventosEnFalloTesteo : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalEventosEnFalloTesteo _DalObject;
 ...
 ///<summary>
     ...
     public int  eft_irecid 
		 { 
                    ...
                    get{ return this._DalObject.eft_irecid; }
        						set{ this._DalObject.eft_irecid = value; } 										
	   }
	  ///<summary>
     ...
     public int  eft_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.eft_iidcuenta; }
        						set{ this._DalObject.eft_iidcuenta = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  eft_teventofechahora 
		 { 
                    ...
                    get{ return this._DalObject.eft_teventofechahora; }
        						set{ this._DalObject.eft_teventofechahora = value; } 										
	   }
	  ///<summary>
     ///eft_clinea property   
     ///</summary>	
     public string  eft_clinea 
		 { 
                    ...
                    get{ return this._DalObject.eft_clinea; }
        						set{ this._DalObject.eft_clinea = value; } 										
	   }
	  ///<summary>
     ...
     public string  eft_ccuenta 
		 { 
                    ...
                    get{ return this._DalObject.eft_ccuenta; }
        						set{ this._DalObject.eft_ccuenta = value; } 										
	   }
	  ///<summary>
     ...
     public string  eft_cnombre 
		 { 
                    ...
                    get{ return this._DalObject.eft_cnombre; }
        						set{ this._DalObject.eft_cnombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  eft_calarma 
		 { 
                    ...
                    get{ return this._DalObject.eft_calarma; }
        						set{ this._DalObject.eft_calarma = value; } 										
	   }
	  ///<summary>
     ...
     public string  eft_calarmadescripcion 
		 { 
                    ...
                    get{ return this._DalObject.eft_calarmadescripcion; }
        						set{ this._DalObject.eft_calarmadescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public int  eft_nalarmacolor 
		 { 
                    ...
                    get{ return this._DalObject.eft_nalarmacolor; }
        						set{ this._DalObject.eft_nalarmacolor = value; } 										
	   }
	  ///<summary>
     ...
     public int  eft_nalarmacolorletra 
		 { 
                    ...
                    get{ return this._DalObject.eft_nalarmacolorletra; }
        						set{ this._DalObject.eft_nalarmacolorletra = value; } 										
	   }
	  ///<summary>
     ...
     public string  eft_calarmaautoprocesa 
		 { 
                    ...
                    get{ return this._DalObject.eft_calarmaautoprocesa; }
        						set{ this._DalObject.eft_calarmaautoprocesa = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeEventosEnFalloTesteo(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeEventosEnFalloTesteo(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeEventosEnFalloTesteo(SqlHelper SqlConfig, int UserId, SimpleEventosEnFalloTesteo Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleEventosEnFalloTesteo Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The EventosEnFalloTesteo has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalEventosEnFalloTesteo GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The EventosEnFalloTesteo is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalEventosEnFalloTesteo(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (EventosEnFalloTesteo)Object;
			o.Name = this.Name;

			o.eft_irecid = this.eft_irecid;

			o.eft_iidcuenta = this.eft_iidcuenta;

			o.eft_teventofechahora = this.eft_teventofechahora;

			o.eft_clinea = this.eft_clinea;

			o.eft_ccuenta = this.eft_ccuenta;

			o.eft_cnombre = this.eft_cnombre;

			o.eft_calarma = this.eft_calarma;

			o.eft_calarmadescripcion = this.eft_calarmadescripcion;

			o.eft_nalarmacolor = this.eft_nalarmacolor;

			o.eft_nalarmacolorletra = this.eft_nalarmacolorletra;

			o.eft_calarmaautoprocesa = this.eft_calarmaautoprocesa;
