...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spes_terminales : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dals_terminales _DalObject;
 ...
 ///<summary>
     ...
     public string  iprs_ccnombre 
		 { 
                    ...
                    get{ return this._DalObject.iprs_ccnombre; }
        						set{ this._DalObject.iprs_ccnombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  iprs_localip 
		 { 
                    ...
                    get{ return this._DalObject.iprs_localip; }
        						set{ this._DalObject.iprs_localip = value; } 										
	   }
	  ///<summary>
     ...
     public int  iprs_commandport 
		 { 
                    ...
                    get{ return this._DalObject.iprs_commandport; }
        						set{ this._DalObject.iprs_commandport = value; } 										
	   }
	  ///<summary>
     ...
     public int  iprs_websocketport 
		 { 
                    ...
                    get{ return this._DalObject.iprs_websocketport; }
        						set{ this._DalObject.iprs_websocketport = value; } 										
	   }
	  ///<summary>
     ...
     public string  iprs_status 
		 { 
                    ...
                    get{ return this._DalObject.iprs_status; }
        						set{ this._DalObject.iprs_status = value; } 										
	   }
	  ///<summary>
     ...
     public string  iprs_config 
		 { 
                    ...
                    get{ return this._DalObject.iprs_config; }
        						set{ this._DalObject.iprs_config = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  iprs_lastserviceupdate 
		 { 
                    ...
                    get{ return this._DalObject.iprs_lastserviceupdate; }
        						set{ this._DalObject.iprs_lastserviceupdate = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spes_terminales(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_terminales(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_terminales(SqlHelper SqlConfig, int UserId, Simples_terminales Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simples_terminales Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The s_terminales has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dals_terminales GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The s_terminales is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dals_terminales(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (s_terminales)Object;
			o.Name = this.Name;

			o.iprs_ccnombre = this.iprs_ccnombre;

			o.iprs_localip = this.iprs_localip;

			o.iprs_commandport = this.iprs_commandport;

			o.iprs_websocketport = this.iprs_websocketport;

			o.iprs_status = this.iprs_status;

			o.iprs_config = this.iprs_config;

			o.iprs_lastserviceupdate = this.iprs_lastserviceupdate;
