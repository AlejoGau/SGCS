...
{ 
   ///<summary>
     ///t_comprobantes_fc class   
     ///</summary>
    public partial class t_comprobantes_fc : Spet_comprobantes_fc
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_comprobantes_fc(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_comprobantes_fc(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_comprobantes_fc(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_comprobantes_fc(SqlHelper SqlConfig, int UserId, Simplet_comprobantes_fc Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
