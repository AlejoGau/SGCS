...
// Type: SoftGuard.BusinessObjects.DealerRango
...
{
  public class DealerRango : SpeDealerRango
  {
    public DealerRango(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public DealerRango(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public DealerRango(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public DealerRango(SqlHelper SqlConfig, int UserId, SimpleDealerRango Simple)
