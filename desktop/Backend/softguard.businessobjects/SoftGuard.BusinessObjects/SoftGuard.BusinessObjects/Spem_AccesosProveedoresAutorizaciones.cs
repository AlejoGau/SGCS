...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_AccesosProveedoresAutorizaciones : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_AccesosProveedoresAutorizaciones _DalObject;
 ...
 ///<summary>
     ...
     public int  apa_idKeyProveedor 
		 { 
                    ...
                    get{ return this._DalObject.apa_idKeyProveedor; }
        						set{ this._DalObject.apa_idKeyProveedor = value; } 										
	   }
	  ///<summary>
     ...
     public int  apa_idKeyUF 
		 { 
                    ...
                    get{ return this._DalObject.apa_idKeyUF; }
        						set{ this._DalObject.apa_idKeyUF = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_AccesosProveedoresAutorizaciones(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_AccesosProveedoresAutorizaciones(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_AccesosProveedoresAutorizaciones(SqlHelper SqlConfig, int UserId, Simplem_AccesosProveedoresAutorizaciones Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_AccesosProveedoresAutorizaciones Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_AccesosProveedoresAutorizaciones has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_AccesosProveedoresAutorizaciones GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_AccesosProveedoresAutorizaciones is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_AccesosProveedoresAutorizaciones(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_AccesosProveedoresAutorizaciones)Object;
			o.Name = this.Name;

			o.apa_idKeyProveedor = this.apa_idKeyProveedor;

			o.apa_idKeyUF = this.apa_idKeyUF;
