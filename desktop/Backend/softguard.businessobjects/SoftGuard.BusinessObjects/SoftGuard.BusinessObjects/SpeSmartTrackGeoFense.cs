...
// Type: SoftGuard.BusinessObjects.SpeSmartTrackGeoFense
...
{
  public abstract class SpeSmartTrackGeoFense : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalSmartTrackGeoFense _DalObject;
    ...
    public string GeoType
    {
      get
      {
        return this._DalObject.GeoType;
      }
      set
      {
        this._DalObject.GeoType = value;
      }
    }
    ...
    public string MetaData
    {
      get
      {
        return this._DalObject.MetaData;
      }
      set
      {
        this._DalObject.MetaData = value;
      }
    }
    ...
    public string Style
    {
      get
      {
        return this._DalObject.Style;
      }
      set
      {
        this._DalObject.Style = value;
      }
    }
    ...
    public SpeSmartTrackGeoFense(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeSmartTrackGeoFense(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeSmartTrackGeoFense(SqlHelper SqlConfig, int UserId, SimpleSmartTrackGeoFense Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleSmartTrackGeoFense Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The SmartTrackGeoFense has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalSmartTrackGeoFense GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The SmartTrackGeoFense is null.");
    ...
    {
      this._DalObject = new DalSmartTrackGeoFense(SqlConfig, UserId);
    ...
    {
      SmartTrackGeoFense smartTrackGeoFense = (SmartTrackGeoFense) Object;
