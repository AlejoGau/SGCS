...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spes_online_help : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dals_online_help _DalObject;
 ...
 ///<summary>
     ...
     public string  UiApplication 
		 { 
                    ...
                    get{ return this._DalObject.UiApplication; }
        						set{ this._DalObject.UiApplication = value; } 										
	   }
	  ///<summary>
     ///Language property   
     ///</summary>	
     public string  Language 
		 { 
                    ...
                    get{ return this._DalObject.Language; }
        						set{ this._DalObject.Language = value; } 										
	   }
	  ///<summary>
     ...
     public string  Translation 
		 { 
                    ...
                    get{ return this._DalObject.Translation; }
        						set{ this._DalObject.Translation = value; } 										
	   }
	  ///<summary>
     ///Status property   
     ///</summary>	
     ...
     public DateTime?  Created 
		 { 
                    ...
                    get{ return this._DalObject.Created; }
        						set{ this._DalObject.Created = value; } 										
	   }
	  ///<summary>
     ///Modified property   
     ///</summary>	
     public DateTime?  Modified 
		 { 
                    ...
                    get{ return this._DalObject.Modified; }
        						set{ this._DalObject.Modified = value; } 										
	   }
	  ///<summary>
     ///UserId property   
     ///</summary>	
     ...
     public string  UserName 
		 { 
                    ...
                    get{ return this._DalObject.UserName; }
        						set{ this._DalObject.UserName = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spes_online_help(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_online_help(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_online_help(SqlHelper SqlConfig, int UserId, Simples_online_help Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simples_online_help Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The s_online_help has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dals_online_help GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The s_online_help is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dals_online_help(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (s_online_help)Object;
			o.Name = this.Name;

			o.UiApplication = this.UiApplication;
