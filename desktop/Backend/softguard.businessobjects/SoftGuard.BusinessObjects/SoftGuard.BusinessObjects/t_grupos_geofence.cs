...
{ 
   ///<summary>
     ///t_grupos_geofence class   
     ///</summary>
    public partial class t_grupos_geofence : Spet_grupos_geofence
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_grupos_geofence(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_grupos_geofence(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_grupos_geofence(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_grupos_geofence(SqlHelper SqlConfig, int UserId, Simplet_grupos_geofence Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
