...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeWeSafeSubscription : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalWeSafeSubscription _DalObject;
 ...
 ///<summary>
     ...
     public string  wsu_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.wsu_cDealer; }
        						set{ this._DalObject.wsu_cDealer = value; } 										
	   }
	  ///<summary>
     ///wsu_cID property   
     ///</summary>	
     public string  wsu_cID 
		 { 
                    ...
                    get{ return this._DalObject.wsu_cID; }
        						set{ this._DalObject.wsu_cID = value; } 										
	   }
	  ///<summary>
     ///wsu_cName property   
     ///</summary>	
     public string  wsu_cName 
		 { 
                    ...
                    get{ return this._DalObject.wsu_cName; }
        						set{ this._DalObject.wsu_cName = value; } 										
	   }
	  ///<summary>
     ///wsu_cDesc property   
     ///</summary>	
     public string  wsu_cDesc 
		 { 
                    ...
                    get{ return this._DalObject.wsu_cDesc; }
        						set{ this._DalObject.wsu_cDesc = value; } 										
	   }
	  ///<summary>
     ...
     public int  wsu_iPriceID 
		 { 
                    ...
                    get{ return this._DalObject.wsu_iPriceID; }
        						set{ this._DalObject.wsu_iPriceID = value; } 										
	   }
	  ///<summary>
     ...
     public int  wsu_iPeriodicityID 
		 { 
                    ...
                    get{ return this._DalObject.wsu_iPeriodicityID; }
        						set{ this._DalObject.wsu_iPeriodicityID = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  wsu_tDateCreation 
		 { 
                    ...
                    get{ return this._DalObject.wsu_tDateCreation; }
        						set{ this._DalObject.wsu_tDateCreation = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  wsu_tDateUpdateAndroid 
		 { 
                    ...
                    get{ return this._DalObject.wsu_tDateUpdateAndroid; }
        						set{ this._DalObject.wsu_tDateUpdateAndroid = value; } 										
	   }
	  ///<summary>
     ...
     public int  wsu_iStatusAndroid 
		 { 
                    ...
                    get{ return this._DalObject.wsu_iStatusAndroid; }
        						set{ this._DalObject.wsu_iStatusAndroid = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  wsu_tDateUpdateIOS 
		 { 
                    ...
                    get{ return this._DalObject.wsu_tDateUpdateIOS; }
        						set{ this._DalObject.wsu_tDateUpdateIOS = value; } 										
	   }
	  ///<summary>
     ...
     public int  wsu_iStatusIOS 
		 { 
                    ...
                    get{ return this._DalObject.wsu_iStatusIOS; }
        						set{ this._DalObject.wsu_iStatusIOS = value; } 										
	   }
	  ///<summary>
     ...
     public string  wsu_cSubscriptionGroupIdIOS 
		 { 
                    ...
                    get{ return this._DalObject.wsu_cSubscriptionGroupIdIOS; }
        						set{ this._DalObject.wsu_cSubscriptionGroupIdIOS = value; } 										
	   }
	  ///<summary>
     ...
     public string  wsu_cSubscriptionIdIOS 
		 { 
                    ...
                    get{ return this._DalObject.wsu_cSubscriptionIdIOS; }
        						set{ this._DalObject.wsu_cSubscriptionIdIOS = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeWeSafeSubscription(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeWeSafeSubscription(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeWeSafeSubscription(SqlHelper SqlConfig, int UserId, SimpleWeSafeSubscription Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleWeSafeSubscription Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The WeSafeSubscription has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalWeSafeSubscription GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The WeSafeSubscription is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalWeSafeSubscription(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.WeSafeSubscription)Object;
			o.Name = this.Name;

			o.wsu_cDealer = this.wsu_cDealer;

			o.wsu_cID = this.wsu_cID;

			o.wsu_cName = this.wsu_cName;

			o.wsu_cDesc = this.wsu_cDesc;

			o.wsu_iPriceID = this.wsu_iPriceID;

			o.wsu_iPeriodicityID = this.wsu_iPeriodicityID;

			o.wsu_tDateCreation = this.wsu_tDateCreation;

			o.wsu_tDateUpdateAndroid = this.wsu_tDateUpdateAndroid;

			o.wsu_iStatusAndroid = this.wsu_iStatusAndroid;

			o.wsu_tDateUpdateIOS = this.wsu_tDateUpdateIOS;

			o.wsu_iStatusIOS = this.wsu_iStatusIOS;

			o.wsu_cSubscriptionGroupIdIOS = this.wsu_cSubscriptionGroupIdIOS;

			o.wsu_cSubscriptionIdIOS = this.wsu_cSubscriptionIdIOS;
