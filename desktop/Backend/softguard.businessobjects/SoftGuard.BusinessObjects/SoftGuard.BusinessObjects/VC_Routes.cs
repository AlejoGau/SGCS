...
// Type: SoftGuard.BusinessObjects.VC_Routes
...
{
  public class VC_Routes : SpeVC_Routes
  {
    public VC_Routes(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public VC_Routes(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public VC_Routes(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public VC_Routes(SqlHelper SqlConfig, int UserId, SimpleVC_Routes Simple)
