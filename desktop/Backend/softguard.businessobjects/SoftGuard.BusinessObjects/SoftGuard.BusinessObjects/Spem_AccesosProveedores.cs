...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_AccesosProveedores : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_AccesosProveedores _DalObject;
 ...
 ///<summary>
     ...
     public string  apr_cNombre 
		 { 
                    ...
                    get{ return this._DalObject.apr_cNombre; }
        						set{ this._DalObject.apr_cNombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  apr_cIdentificacion 
		 { 
                    ...
                    get{ return this._DalObject.apr_cIdentificacion; }
        						set{ this._DalObject.apr_cIdentificacion = value; } 										
	   }
	  ///<summary>
     ...
     public string  apr_cDireccion 
		 { 
                    ...
                    get{ return this._DalObject.apr_cDireccion; }
        						set{ this._DalObject.apr_cDireccion = value; } 										
	   }
	  ///<summary>
     ...
     public string  apr_cCodigoPostal 
		 { 
                    ...
                    get{ return this._DalObject.apr_cCodigoPostal; }
        						set{ this._DalObject.apr_cCodigoPostal = value; } 										
	   }
	  ///<summary>
     ...
     public string  apr_cLocalidad 
		 { 
                    ...
                    get{ return this._DalObject.apr_cLocalidad; }
        						set{ this._DalObject.apr_cLocalidad = value; } 										
	   }
	  ///<summary>
     ...
     public int  apr_iProvincia 
		 { 
                    ...
                    get{ return this._DalObject.apr_iProvincia; }
        						set{ this._DalObject.apr_iProvincia = value; } 										
	   }
	  ///<summary>
     ...
     public string  apr_cTelefono 
		 { 
                    ...
                    get{ return this._DalObject.apr_cTelefono; }
        						set{ this._DalObject.apr_cTelefono = value; } 										
	   }
	  ///<summary>
     ...
     public int  apr_iCategoria 
		 { 
                    ...
                    get{ return this._DalObject.apr_iCategoria; }
        						set{ this._DalObject.apr_iCategoria = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  apr_tFechaAlta 
		 { 
                    ...
                    get{ return this._DalObject.apr_tFechaAlta; }
        						set{ this._DalObject.apr_tFechaAlta = value; } 										
	   }
	  ///<summary>
     ...
     public int  apr_iStatus 
		 { 
                    ...
                    get{ return this._DalObject.apr_iStatus; }
        						set{ this._DalObject.apr_iStatus = value; } 										
	   }
	  ///<summary>
     ...
     public string  apr_cObservaciones 
		 { 
                    ...
                    get{ return this._DalObject.apr_cObservaciones; }
        						set{ this._DalObject.apr_cObservaciones = value; } 										
	   }
	  ///<summary>
     ...
     public string  apr_cPathPicture 
		 { 
                    ...
                    get{ return this._DalObject.apr_cPathPicture; }
        						set{ this._DalObject.apr_cPathPicture = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_AccesosProveedores(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_AccesosProveedores(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_AccesosProveedores(SqlHelper SqlConfig, int UserId, Simplem_AccesosProveedores Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_AccesosProveedores Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_AccesosProveedores has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_AccesosProveedores GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_AccesosProveedores is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_AccesosProveedores(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_AccesosProveedores)Object;
			o.Name = this.Name;

			o.apr_cNombre = this.apr_cNombre;

			o.apr_cIdentificacion = this.apr_cIdentificacion;

			o.apr_cDireccion = this.apr_cDireccion;

			o.apr_cCodigoPostal = this.apr_cCodigoPostal;

			o.apr_cLocalidad = this.apr_cLocalidad;

			o.apr_iProvincia = this.apr_iProvincia;

			o.apr_cTelefono = this.apr_cTelefono;

			o.apr_iCategoria = this.apr_iCategoria;

			o.apr_tFechaAlta = this.apr_tFechaAlta;

			o.apr_iStatus = this.apr_iStatus;

			o.apr_cObservaciones = this.apr_cObservaciones;

			o.apr_cPathPicture = this.apr_cPathPicture;
