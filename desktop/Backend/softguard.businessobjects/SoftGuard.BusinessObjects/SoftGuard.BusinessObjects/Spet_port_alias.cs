...
// Type: SoftGuard.BusinessObjects.Spet_port_alias
...
{
  public abstract class Spet_port_alias : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_port_alias _DalObject;
    ...
    public int tpa_icodigo
    {
      get
      {
        return this._DalObject.tpa_icodigo;
      }
      set
      {
        this._DalObject.tpa_icodigo = value;
      }
    }
    ...
    public string tpa_cdealer
    {
      get
      {
        return this._DalObject.tpa_cdealer;
      }
      set
      {
        this._DalObject.tpa_cdealer = value;
      }
    }
    ...
    public int tpa_ipuerto
    {
      get
      {
        return this._DalObject.tpa_ipuerto;
      }
      set
      {
        this._DalObject.tpa_ipuerto = value;
      }
    }
    ...
    public int tpa_iportip
    {
      get
      {
        return this._DalObject.tpa_iportip;
      }
      set
      {
        this._DalObject.tpa_iportip = value;
      }
    }
    ...
    public Spet_port_alias(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_port_alias(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_port_alias(SqlHelper SqlConfig, int UserId, Simplet_port_alias Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_port_alias Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_port_alias has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_port_alias GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_port_alias is null.");
    ...
    {
      this._DalObject = new Dalt_port_alias(SqlConfig, UserId);
    ...
    {
      t_port_alias tPortAlias = (t_port_alias) Object;
      tPortAlias.Name = this.Name;
      tPortAlias.tpa_icodigo = this.tpa_icodigo;
      tPortAlias.tpa_cdealer = this.tpa_cdealer;
      tPortAlias.tpa_ipuerto = this.tpa_ipuerto;
      tPortAlias.tpa_iportip = this.tpa_iportip;
    }
