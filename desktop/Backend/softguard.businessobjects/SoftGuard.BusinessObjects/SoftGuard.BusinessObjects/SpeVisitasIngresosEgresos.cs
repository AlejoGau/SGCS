...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeVisitasIngresosEgresos : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalVisitasIngresosEgresos _DalObject;
 ...
 ///<summary>
     ...
     public DateTime?  vie_tFechaHora 
		 { 
                    ...
                    get{ return this._DalObject.vie_tFechaHora; }
        						set{ this._DalObject.vie_tFechaHora = value; } 										
	   }
	  ///<summary>
     ...
     public string  vie_cMatricula 
		 { 
                    ...
                    get{ return this._DalObject.vie_cMatricula; }
        						set{ this._DalObject.vie_cMatricula = value; } 										
	   }
	  ///<summary>
     ...
     public string  vie_cUnidadFuncional 
		 { 
                    ...
                    get{ return this._DalObject.vie_cUnidadFuncional; }
        						set{ this._DalObject.vie_cUnidadFuncional = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeVisitasIngresosEgresos(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeVisitasIngresosEgresos(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeVisitasIngresosEgresos(SqlHelper SqlConfig, int UserId, SimpleVisitasIngresosEgresos Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleVisitasIngresosEgresos Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The VisitasIngresosEgresos has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalVisitasIngresosEgresos GetDalObject()
		{
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<SimpleVisitasIngresosEgresos> GetByParent(string ObjectType, int ObjectId)
		{
			return this._DalObject.GetByParent(ObjectType, ObjectId);
		}
		public IEnumerable<SimpleVisitasIngresosEgresos> GetByChild(string ObjectType, int ObjectId)
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The VisitasIngresosEgresos is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalVisitasIngresosEgresos(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.VisitasIngresosEgresos)Object;
			o.Name = this.Name;

			o.vie_tFechaHora = this.vie_tFechaHora;

			o.vie_cMatricula = this.vie_cMatricula;

			o.vie_cUnidadFuncional = this.vie_cUnidadFuncional;
