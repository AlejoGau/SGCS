...
{ 
   ///<summary>
     ///t_tiposervicio class   
     ///</summary>
    public partial class t_tiposervicio : Spet_tiposervicio
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_tiposervicio(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_tiposervicio(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_tiposervicio(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_tiposervicio(SqlHelper SqlConfig, int UserId, Simplet_tiposervicio Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
