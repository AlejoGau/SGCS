...
{ 	
   ///<summary>
     ///Caller object class   
     ///</summary>
    public class Callers_iprservicios : CallerObject
    { 	
     ...
     ///Constructor   
     ///</summary>
        public Callers_iprservicios() : base()
        {
            InitClass();
        }  
 ///<summary>
     ///Constructor   
     ///</summary>		
        public Callers_iprservicios(int Id, string Name, string iprs_ccnombre, string iprs_localip, int iprs_commandport, int iprs_websocketport, string iprs_status, string iprs_config, DateTime? iprs_lastserviceupdate) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
...
Simple.iprs_lastserviceupdate = this._iprs_lastserviceupdate;
 ...
 ///<summary>
     ///Sets a simpleobject   
     ///</summary>	
		public void SetSimpleObject(Simples_iprservicios Simple)
		{
			base.Id = Simple.Id;
...
this._iprs_lastserviceupdate = Simple.iprs_lastserviceupdate;
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{
			return new Dals_iprservicios(SqlConfig, UserId, (Simples_iprservicios) GetSimpleObject());
		}
 ///<summary>
     ///Get object's data   
     ///</summary>
