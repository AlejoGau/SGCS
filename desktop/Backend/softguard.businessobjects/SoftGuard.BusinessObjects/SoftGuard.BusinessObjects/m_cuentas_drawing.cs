...
{ 
   ///<summary>
     ///m_cuentas_drawing class   
     ///</summary>
    public partial class m_cuentas_drawing : Spem_cuentas_drawing
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuentas_drawing(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuentas_drawing(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuentas_drawing(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuentas_drawing(SqlHelper SqlConfig, int UserId, Simplem_cuentas_drawing Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
