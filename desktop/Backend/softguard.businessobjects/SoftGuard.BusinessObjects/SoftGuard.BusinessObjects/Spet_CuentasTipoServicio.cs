...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_CuentasTipoServicio : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_CuentasTipoServicio _DalObject;
 ...
 ///<summary>
     ...
     public string  cts_cnombre 
		 { 
                    ...
                    get{ return this._DalObject.cts_cnombre; }
        						set{ this._DalObject.cts_cnombre = value; } 										
	   }
	  ///<summary>
     ...
     public int  cts_iestado 
		 { 
                    ...
                    get{ return this._DalObject.cts_iestado; }
        						set{ this._DalObject.cts_iestado = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_CuentasTipoServicio(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_CuentasTipoServicio(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_CuentasTipoServicio(SqlHelper SqlConfig, int UserId, Simplet_CuentasTipoServicio Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_CuentasTipoServicio Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_CuentasTipoServicio has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_CuentasTipoServicio GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_CuentasTipoServicio is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_CuentasTipoServicio(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_CuentasTipoServicio)Object;
			o.Name = this.Name;

			o.cts_cnombre = this.cts_cnombre;

			o.cts_iestado = this.cts_iestado;
