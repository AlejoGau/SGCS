...
{ 
   ///<summary>
     ///p_comandos_ip class   
     ///</summary>
    public partial class p_comandos_ip : Spep_comandos_ip
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_comandos_ip(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_comandos_ip(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_comandos_ip(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_comandos_ip(SqlHelper SqlConfig, int UserId, Simplep_comandos_ip Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
