...
{ 
   ///<summary>
     ///VisitasIngresosEgresos class   
     ///</summary>
    public partial class VisitasIngresosEgresos : SpeVisitasIngresosEgresos
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public VisitasIngresosEgresos(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public VisitasIngresosEgresos(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public VisitasIngresosEgresos(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public VisitasIngresosEgresos(SqlHelper SqlConfig, int UserId, SimpleVisitasIngresosEgresos Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
