...
{ 
   ///<summary>
     ///TG_mantenimiento_historico class   
     ///</summary>
    public partial class TG_mantenimiento_historico : SpeTG_mantenimiento_historico
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public TG_mantenimiento_historico(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public TG_mantenimiento_historico(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TG_mantenimiento_historico(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TG_mantenimiento_historico(SqlHelper SqlConfig, int UserId, SimpleTG_mantenimiento_historico Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
