...
{ 	
  ///<summary>
    ///m_cuetnta_grupo_usuarios Slbf Class
    ///</summary>
    [DataContract]
    public class Simplem_cuetnta_grupo_usuarios : SimpleBaseObject
    { 
			 ///<summary>
     ///cgu_idgrupo   
     ///</summary>
	 ...
	 ///<summary>
        ///m_cuetnta_grupo_usuarios Constructor
        ///</summary>
        public Simplem_cuetnta_grupo_usuarios() : base()
  {
  InitClass();
  }
        ///<summary>
        ///m_cuetnta_grupo_usuarios Constructor
        ///</summary>
        public Simplem_cuetnta_grupo_usuarios(int Id, string Name, int cgu_idgrupo, int cgu_idusuario) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
...
///<summary>
    ...
    ///</summary>  
		...
		{
			BaseObject Object = new Dalm_cuetnta_grupo_usuarios(SqlConfig, UserId, this);
