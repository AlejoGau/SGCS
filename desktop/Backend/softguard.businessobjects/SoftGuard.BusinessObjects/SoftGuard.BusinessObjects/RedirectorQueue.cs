...
{ 
   ///<summary>
     ///RedirectorQueue class   
     ///</summary>
    public partial class RedirectorQueue : SpeRedirectorQueue
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public RedirectorQueue(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public RedirectorQueue(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public RedirectorQueue(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public RedirectorQueue(SqlHelper SqlConfig, int UserId, SimpleRedirectorQueue Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
