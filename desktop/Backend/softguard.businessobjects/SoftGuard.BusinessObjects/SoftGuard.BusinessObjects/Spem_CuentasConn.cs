...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_CuentasConn : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_CuentasConn _DalObject;
 ...
 ///<summary>
     ...
     public int  cco_iidCuenta 
		 { 
                    ...
                    get{ return this._DalObject.cco_iidCuenta; }
        						set{ this._DalObject.cco_iidCuenta = value; } 										
	   }
	  ///<summary>
     ...
     public int  cco_iConexion 
		 { 
                    ...
                    get{ return this._DalObject.cco_iConexion; }
        						set{ this._DalObject.cco_iConexion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_CuentasConn(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_CuentasConn(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_CuentasConn(SqlHelper SqlConfig, int UserId, Simplem_CuentasConn Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_CuentasConn Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_CuentasConn has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_CuentasConn GetDalObject()
		{
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<Simplem_CuentasConn> GetByParent(string ObjectType, int ObjectId)
		{
			return this._DalObject.GetByParent(ObjectType, ObjectId);
		}
		public IEnumerable<Simplem_CuentasConn> GetByChild(string ObjectType, int ObjectId)
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_CuentasConn is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_CuentasConn(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_CuentasConn)Object;
			o.Name = this.Name;

			o.cco_iidCuenta = this.cco_iidCuenta;

			o.cco_iConexion = this.cco_iConexion;
