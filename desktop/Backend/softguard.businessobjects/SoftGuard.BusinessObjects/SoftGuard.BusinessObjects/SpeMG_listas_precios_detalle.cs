...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeMG_listas_precios_detalle : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalMG_listas_precios_detalle _DalObject;
 ...
 ///<summary>
     ...
     public int  mglpd_idproducto 
		 { 
                    ...
                    get{ return this._DalObject.mglpd_idproducto; }
        						set{ this._DalObject.mglpd_idproducto = value; } 										
	   }
	  ///<summary>
     ...
     public int  mglpd_idlista 
		 { 
                    ...
                    get{ return this._DalObject.mglpd_idlista; }
        						set{ this._DalObject.mglpd_idlista = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  mglpd_valor 
		 { 
                    ...
                    get{ return this._DalObject.mglpd_valor; }
        						set{ this._DalObject.mglpd_valor = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeMG_listas_precios_detalle(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_listas_precios_detalle(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_listas_precios_detalle(SqlHelper SqlConfig, int UserId, SimpleMG_listas_precios_detalle Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleMG_listas_precios_detalle Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The MG_listas_precios_detalle has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalMG_listas_precios_detalle GetDalObject()
		{
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<SimpleMG_listas_precios_detalle> GetByParent(string ObjectType, int ObjectId)
		{
			return this._DalObject.GetByParent(ObjectType, ObjectId);
		}
		public IEnumerable<SimpleMG_listas_precios_detalle> GetByChild(string ObjectType, int ObjectId)
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The MG_listas_precios_detalle is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalMG_listas_precios_detalle(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (MG_listas_precios_detalle)Object;
			o.Name = this.Name;

			o.mglpd_idproducto = this.mglpd_idproducto;

			o.mglpd_idlista = this.mglpd_idlista;

			o.mglpd_valor = this.mglpd_valor;
