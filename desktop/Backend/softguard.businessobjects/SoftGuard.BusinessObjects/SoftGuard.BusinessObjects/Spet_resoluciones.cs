...
// Type: SoftGuard.BusinessObjects.Spet_resoluciones
...
{
  public abstract class Spet_resoluciones : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_resoluciones _DalObject;
    ...
    public string res_ccodigo
    {
      get
      {
        return this._DalObject.res_ccodigo;
      }
      set
      {
        this._DalObject.res_ccodigo = value;
      }
    }
    ...
    public string res_cdescripcion
    {
      get
      {
        return this._DalObject.res_cdescripcion;
      }
      set
      {
        this._DalObject.res_cdescripcion = value;
      }
    }
    ...
    public Decimal res_nfalsaalarma
    {
      get
      {
        return this._DalObject.res_nfalsaalarma;
      }
      set
      {
        this._DalObject.res_nfalsaalarma = value;
      }
    }
    ...
    public Decimal res_nEstado
    {
      get
      {
        return this._DalObject.res_nEstado;
      }
      set
      {
        this._DalObject.res_nEstado = value;
      }
    }
    ...
    public Spet_resoluciones(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_resoluciones(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_resoluciones(SqlHelper SqlConfig, int UserId, Simplet_resoluciones Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_resoluciones Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_resoluciones has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_resoluciones GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_resoluciones is null.");
    ...
    {
      this._DalObject = new Dalt_resoluciones(SqlConfig, UserId);
    ...
    {
      t_resoluciones tResoluciones = (t_resoluciones) Object;
      tResoluciones.Name = this.Name;
      tResoluciones.res_ccodigo = this.res_ccodigo;
      tResoluciones.res_cdescripcion = this.res_cdescripcion;
      tResoluciones.res_nfalsaalarma = this.res_nfalsaalarma;
      tResoluciones.res_nEstado = this.res_nEstado;
    }
