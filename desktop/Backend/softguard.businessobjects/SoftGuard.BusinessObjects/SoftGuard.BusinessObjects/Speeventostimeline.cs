...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Speeventostimeline : ISpecialization, ICanCopyProperties
    { 
	...
	protected Daleventostimeline _DalObject;
 ...
 ///<summary>
     ...
     public int  etl_irecid 
		 { 
                    ...
                    get{ return this._DalObject.etl_irecid; }
        						set{ this._DalObject.etl_irecid = value; } 										
	   }
	  ///<summary>
     ...
     public int  etl_icuenta 
		 { 
                    ...
                    get{ return this._DalObject.etl_icuenta; }
        						set{ this._DalObject.etl_icuenta = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  etl_tfechahora 
		 { 
                    ...
                    get{ return this._DalObject.etl_tfechahora; }
        						set{ this._DalObject.etl_tfechahora = value; } 										
	   }
	  ///<summary>
     ...
     public string  etl_caccion 
		 { 
                    ...
                    get{ return this._DalObject.etl_caccion; }
        						set{ this._DalObject.etl_caccion = value; } 										
	   }
	  ///<summary>
     ...
     public string  etl_cobservacion 
		 { 
                    ...
                    get{ return this._DalObject.etl_cobservacion; }
        						set{ this._DalObject.etl_cobservacion = value; } 										
	   }
	  ///<summary>
     ///etl_cowner property   
     ///</summary>	
     public string  etl_cowner 
		 { 
                    ...
                    get{ return this._DalObject.etl_cowner; }
        						set{ this._DalObject.etl_cowner = value; } 										
	   }
	  ///<summary>
     ...
     public int  etl_ioperador 
		 { 
                    ...
                    get{ return this._DalObject.etl_ioperador; }
        						set{ this._DalObject.etl_ioperador = value; } 										
	   }
	  ///<summary>
     ...
     public int  etl_iaccioncode  
		 { 
                    ...
                    get{ return this._DalObject.etl_iaccioncode ; }
        						set{ this._DalObject.etl_iaccioncode  = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Speeventostimeline(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Speeventostimeline(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Speeventostimeline(SqlHelper SqlConfig, int UserId, Simpleeventostimeline Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simpleeventostimeline Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The eventostimeline has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Daleventostimeline GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The eventostimeline is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Daleventostimeline(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (eventostimeline)Object;
			o.Name = this.Name;

			o.etl_irecid = this.etl_irecid;

			o.etl_icuenta = this.etl_icuenta;

			o.etl_tfechahora = this.etl_tfechahora;

			o.etl_caccion = this.etl_caccion;

			o.etl_cobservacion = this.etl_cobservacion;

			o.etl_cowner = this.etl_cowner;

			o.etl_ioperador = this.etl_ioperador;

			o.etl_iaccioncode  = this.etl_iaccioncode ;
