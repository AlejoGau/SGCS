...
{ 	
  ///<summary>
    ...
    ///</summary>
    [DataContract]
    public class SimpleTelefono : SimpleBaseObject
    { 
			 ///<summary>
     ///tel_iidcuenta   
     ///</summary>
	 [DataMember]
     public int tel_iidcuenta { get;set;} 
	  ///<summary>
     ///tel_iid   
     ///</summary>
	 [DataMember]
     ...
     ///</summary>
	 [DataMember]
     public Decimal tel_nsp { get;set;} 
	  ///<summary>
     ///tel_cinternacional   
     ///</summary>
	 [DataMember]
  ...
  InitClass();
        ...
        ///Telefono Constructor
        ///</summary>
        public SimpleTelefono(int Id, string Name, int tel_iidcuenta, int tel_iid, string tel_clista, string tel_cnombre, string tel_cobservacion, string tel_ctelefono, Decimal tel_ndiscado, string tel_cpredigito, string tel_cpostdigito, int tel_norden, Decimal tel_ntr, string tel_cclave, string tel_cpermiso, Decimal tel_nsms, Decimal tel_nsp, string tel_cinternacional, string tel_ccountrycode, int tel_iismobile) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
				    this.tel_iidcuenta = tel_iidcuenta;
...
///<summary>
    ...
    ///</summary>  
		...
		{
			BaseObject Object = new DalTelefono(SqlConfig, UserId, this);
...
///<summary>
    ...
    ///</summary>
		public override CallerObject GetCallerObject()
		{
			...
			Caller.tel_iidcuenta = this.tel_iidcuenta;
...
///<summary>
    ...
    {												                
               ...
               //set Row
							 ...
							 dr["Name"] = base.Name;
dr["tel_iidcuenta"] = (object)this.tel_iidcuenta ?? System.DBNull.Value;
...
dr["tel_nsp"] = (object)this.tel_nsp ?? System.DBNull.Value;
