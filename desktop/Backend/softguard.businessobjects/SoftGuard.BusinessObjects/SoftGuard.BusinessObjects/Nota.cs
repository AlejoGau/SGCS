...
// Type: SoftGuard.BusinessObjects.Nota
...
{
  public class Nota : SpeNota
  {
    public Nota(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public Nota(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token;
    }

    public Nota(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public Nota(SqlHelper SqlConfig, int UserId, SimpleNota Simple)
