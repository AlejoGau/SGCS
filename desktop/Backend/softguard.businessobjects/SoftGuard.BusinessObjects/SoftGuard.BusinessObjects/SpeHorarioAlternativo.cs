...
// Type: SoftGuard.BusinessObjects.SpeHorarioAlternativo
...
{
  public abstract class SpeHorarioAlternativo : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalHorarioAlternativo _DalObject;
    ...
    public int alt_iidcuenta
    {
      get
      {
        return this._DalObject.alt_iidcuenta;
      }
      set
      {
        this._DalObject.alt_iidcuenta = value;
      }
    }
    ...
    public SpeHorarioAlternativo(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeHorarioAlternativo(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeHorarioAlternativo(SqlHelper SqlConfig, int UserId, SimpleHorarioAlternativo Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleHorarioAlternativo Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The HorarioAlternativo has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalHorarioAlternativo GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The HorarioAlternativo is null.");
    ...
    {
      this._DalObject = new DalHorarioAlternativo(SqlConfig, UserId);
    ...
    {
      HorarioAlternativo horarioAlternativo = (HorarioAlternativo) Object;
