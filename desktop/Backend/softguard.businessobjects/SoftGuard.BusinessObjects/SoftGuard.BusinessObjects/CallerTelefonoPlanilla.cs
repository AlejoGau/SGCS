...
{ 	
   ///<summary>
     ///Caller object class   
     ///</summary>
    public class CallerTelefonoPlanilla : CallerObject
    { 	
     ...
     ///Constructor   
     ///</summary>
        public CallerTelefonoPlanilla() : base()
        {
            InitClass();
        }  
 ///<summary>
     ///Constructor   
     ///</summary>		
        public CallerTelefonoPlanilla(int Id, string Name, int tel_iidpla, int tel_iid, string tel_clista, string tel_cnombre, string tel_cobservacion, string tel_ctelefono, Decimal tel_ndiscado, string tel_cpredigito, string tel_cpostdigito, int tel_norden, Decimal tel_ntr, string tel_cclave, string tel_cpermiso, Decimal tel_nsms, string tel_cinternacional, string tel_ccountrycode, int tel_iismobile) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
				    this._tel_iidpla = tel_iidpla;
...
Simple.tel_iismobile = this._tel_iismobile;
 ...
 ///<summary>
     ///Sets a simpleobject   
     ///</summary>	
		public void SetSimpleObject(SimpleTelefonoPlanilla Simple)
		{
			base.Id = Simple.Id;
...
this._tel_iismobile = Simple.tel_iismobile;
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{
			return new DalTelefonoPlanilla(SqlConfig, UserId, (SimpleTelefonoPlanilla) GetSimpleObject());
		}
 ///<summary>
     ///Get object's data   
     ///</summary>
