...
// Type: SoftGuard.BusinessObjects.HorarioPlanilla
...
{
  public class HorarioPlanilla : SpeHorarioPlanilla
  {
    public HorarioPlanilla(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public HorarioPlanilla(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public HorarioPlanilla(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public HorarioPlanilla(SqlHelper SqlConfig, int UserId, SimpleHorarioPlanilla Simple)
