...
// Type: SoftGuard.BusinessObjects.t_TimeZone
...
{
  public class t_TimeZone : Spet_TimeZone
  {
    public t_TimeZone(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_TimeZone(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_TimeZone(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_TimeZone(SqlHelper SqlConfig, int UserId, Simplet_TimeZone Simple)
