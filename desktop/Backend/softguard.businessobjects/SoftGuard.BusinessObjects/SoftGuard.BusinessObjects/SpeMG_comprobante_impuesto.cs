...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeMG_comprobante_impuesto : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalMG_comprobante_impuesto _DalObject;
 ...
 ///<summary>
     ...
     public int  mci_cbcicodigoid 
		 { 
                    ...
                    get{ return this._DalObject.mci_cbcicodigoid; }
        						set{ this._DalObject.mci_cbcicodigoid = value; } 										
	   }
	  ///<summary>
     ...
     public int  mci_impidkey 
		 { 
                    ...
                    get{ return this._DalObject.mci_impidkey; }
        						set{ this._DalObject.mci_impidkey = value; } 										
	   }
	  ///<summary>
     ///mci_total property   
     ///</summary>	
     public Decimal  mci_total 
		 { 
                    ...
                    get{ return this._DalObject.mci_total; }
        						set{ this._DalObject.mci_total = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeMG_comprobante_impuesto(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_comprobante_impuesto(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_comprobante_impuesto(SqlHelper SqlConfig, int UserId, SimpleMG_comprobante_impuesto Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleMG_comprobante_impuesto Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The MG_comprobante_impuesto has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalMG_comprobante_impuesto GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The MG_comprobante_impuesto is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalMG_comprobante_impuesto(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (MG_comprobante_impuesto)Object;
			o.Name = this.Name;

			o.mci_cbcicodigoid = this.mci_cbcicodigoid;

			o.mci_impidkey = this.mci_impidkey;

			o.mci_total = this.mci_total;
