...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_videoid : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_videoid _DalObject;
 ...
 ///<summary>
     ...
     public string  tvi_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.tvi_cdescripcion; }
        						set{ this._DalObject.tvi_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  tvi_cnombre 
		 { 
                    ...
                    get{ return this._DalObject.tvi_cnombre; }
        						set{ this._DalObject.tvi_cnombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  tvi_cconfig 
		 { 
                    ...
                    get{ return this._DalObject.tvi_cconfig; }
        						set{ this._DalObject.tvi_cconfig = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  tvi_nLaunch 
		 { 
                    ...
                    get{ return this._DalObject.tvi_nLaunch; }
        						set{ this._DalObject.tvi_nLaunch = value; } 										
	   }
	  ///<summary>
     ...
     public string  tvi_cTemplate 
		 { 
                    ...
                    get{ return this._DalObject.tvi_cTemplate; }
        						set{ this._DalObject.tvi_cTemplate = value; } 										
	   }
	  ///<summary>
     ...
     public int  tvi_iNativeMWR 
		 { 
                    ...
                    get{ return this._DalObject.tvi_iNativeMWR; }
        						set{ this._DalObject.tvi_iNativeMWR = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_videoid(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_videoid(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_videoid(SqlHelper SqlConfig, int UserId, Simplet_videoid Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_videoid Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_videoid has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_videoid GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_videoid is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_videoid(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_videoid)Object;
			o.Name = this.Name;

			o.tvi_cdescripcion = this.tvi_cdescripcion;

			o.tvi_cnombre = this.tvi_cnombre;

			o.tvi_cconfig = this.tvi_cconfig;

			o.tvi_nLaunch = this.tvi_nLaunch;

			o.tvi_cTemplate = this.tvi_cTemplate;

			o.tvi_iNativeMWR = this.tvi_iNativeMWR;
