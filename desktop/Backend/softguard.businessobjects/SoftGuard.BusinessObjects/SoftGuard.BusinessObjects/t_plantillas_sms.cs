...
{ 
   ///<summary>
     ///t_plantillas_sms class   
     ///</summary>
    public partial class t_plantillas_sms : Spet_plantillas_sms
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_plantillas_sms(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_plantillas_sms(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_plantillas_sms(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_plantillas_sms(SqlHelper SqlConfig, int UserId, Simplet_plantillas_sms Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
