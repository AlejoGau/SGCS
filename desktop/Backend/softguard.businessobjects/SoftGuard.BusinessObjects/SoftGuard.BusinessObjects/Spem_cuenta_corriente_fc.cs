...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_cuenta_corriente_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_cuenta_corriente_fc _DalObject;
 ...
 ///<summary>
     ...
     public int  cta_iCodigoCbte 
		 { 
                    ...
                    get{ return this._DalObject.cta_iCodigoCbte; }
        						set{ this._DalObject.cta_iCodigoCbte = value; } 										
	   }
	  ///<summary>
     ///cta_nCuota property   
     ///</summary>	
     public Decimal  cta_nCuota 
		 { 
                    ...
                    get{ return this._DalObject.cta_nCuota; }
        						set{ this._DalObject.cta_nCuota = value; } 										
	   }
	  ///<summary>
     ///cta_yTotal property   
     ///</summary>	
     public Decimal  cta_yTotal 
		 { 
                    ...
                    get{ return this._DalObject.cta_yTotal; }
        						set{ this._DalObject.cta_yTotal = value; } 										
	   }
	  ///<summary>
     ///cta_ySaldo property   
     ///</summary>	
     public Decimal  cta_ySaldo 
		 { 
                    ...
                    get{ return this._DalObject.cta_ySaldo; }
        						set{ this._DalObject.cta_ySaldo = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  cta_dVencimiento 
		 { 
                    ...
                    get{ return this._DalObject.cta_dVencimiento; }
        						set{ this._DalObject.cta_dVencimiento = value; } 										
	   }
	  ///<summary>
     ///cta_dCobro property   
     ///</summary>	
     public DateTime?  cta_dCobro 
		 { 
                    ...
                    get{ return this._DalObject.cta_dCobro; }
        						set{ this._DalObject.cta_dCobro = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_cuenta_corriente_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuenta_corriente_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuenta_corriente_fc(SqlHelper SqlConfig, int UserId, Simplem_cuenta_corriente_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_cuenta_corriente_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_cuenta_corriente_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_cuenta_corriente_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_cuenta_corriente_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_cuenta_corriente_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_cuenta_corriente_fc)Object;
			o.Name = this.Name;

			o.cta_iCodigoCbte = this.cta_iCodigoCbte;

			o.cta_nCuota = this.cta_nCuota;

			o.cta_yTotal = this.cta_yTotal;

			o.cta_ySaldo = this.cta_ySaldo;

			o.cta_dVencimiento = this.cta_dVencimiento;

			o.cta_dCobro = this.cta_dCobro;
