...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_ControlEventosDealer : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_ControlEventosDealer _DalObject;
 ...
 ///<summary>
     ...
     public string  ced_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.ced_cDealer; }
        						set{ this._DalObject.ced_cDealer = value; } 										
	   }
	  ///<summary>
     ...
     public string  ced_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.ced_cDescripcion; }
        						set{ this._DalObject.ced_cDescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  ced_cAlarmaControl 
		 { 
                    ...
                    get{ return this._DalObject.ced_cAlarmaControl; }
        						set{ this._DalObject.ced_cAlarmaControl = value; } 										
	   }
	  ///<summary>
     ...
     public string  ced_cAlarmaEsperada 
		 { 
                    ...
                    get{ return this._DalObject.ced_cAlarmaEsperada; }
        						set{ this._DalObject.ced_cAlarmaEsperada = value; } 										
	   }
	  ///<summary>
     ...
     public int  ced_iMinutos 
		 { 
                    ...
                    get{ return this._DalObject.ced_iMinutos; }
        						set{ this._DalObject.ced_iMinutos = value; } 										
	   }
	  ///<summary>
     ...
     public string  ced_cAlarmaGenerar 
		 { 
                    ...
                    get{ return this._DalObject.ced_cAlarmaGenerar; }
        						set{ this._DalObject.ced_cAlarmaGenerar = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_ControlEventosDealer(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_ControlEventosDealer(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_ControlEventosDealer(SqlHelper SqlConfig, int UserId, Simplet_ControlEventosDealer Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_ControlEventosDealer Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_ControlEventosDealer has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_ControlEventosDealer GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_ControlEventosDealer is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_ControlEventosDealer(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_ControlEventosDealer)Object;
			o.Name = this.Name;

			o.ced_cDealer = this.ced_cDealer;

			o.ced_cDescripcion = this.ced_cDescripcion;

			o.ced_cAlarmaControl = this.ced_cAlarmaControl;

			o.ced_cAlarmaEsperada = this.ced_cAlarmaEsperada;

			o.ced_iMinutos = this.ced_iMinutos;

			o.ced_cAlarmaGenerar = this.ced_cAlarmaGenerar;
