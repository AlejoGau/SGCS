...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeHorarioExcepcion : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalHorarioExcepcion _DalObject;
 ...
 ///<summary>
     ...
     public int  exc_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.exc_iidcuenta; }
        						set{ this._DalObject.exc_iidcuenta = value; } 										
	   }
	  ///<summary>
     ...
     ///Constructor   
     ///</summary>
    		public SpeHorarioExcepcion(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeHorarioExcepcion(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeHorarioExcepcion(SqlHelper SqlConfig, int UserId, SimpleHorarioExcepcion Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleHorarioExcepcion Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The HorarioExcepcion has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalHorarioExcepcion GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The HorarioExcepcion is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalHorarioExcepcion(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (HorarioExcepcion)Object;
			o.Name = this.Name;

			o.exc_iidcuenta = this.exc_iidcuenta;
