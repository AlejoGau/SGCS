...
// Type: SoftGuard.BusinessObjects.Falsa
...
{
  public class Falsa : SpeFalsa
  {
    public Falsa(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public Falsa(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token;
    }

    public Falsa(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public Falsa(SqlHelper SqlConfig, int UserId, SimpleFalsa Simple)
