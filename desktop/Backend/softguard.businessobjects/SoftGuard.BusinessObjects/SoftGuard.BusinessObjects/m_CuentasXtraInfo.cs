...
{ 
   ///<summary>
     ///m_CuentasXtraInfo class   
     ///</summary>
    public partial class m_CuentasXtraInfo : Spem_CuentasXtraInfo
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_CuentasXtraInfo(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_CuentasXtraInfo(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_CuentasXtraInfo(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_CuentasXtraInfo(SqlHelper SqlConfig, int UserId, Simplem_CuentasXtraInfo Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
