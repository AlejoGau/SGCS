...
{ 
   ///<summary>
     ///HorarioExcepcion class   
     ///</summary>
    public partial class HorarioExcepcion : SpeHorarioExcepcion
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public HorarioExcepcion(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public HorarioExcepcion(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public HorarioExcepcion(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public HorarioExcepcion(SqlHelper SqlConfig, int UserId, SimpleHorarioExcepcion Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
