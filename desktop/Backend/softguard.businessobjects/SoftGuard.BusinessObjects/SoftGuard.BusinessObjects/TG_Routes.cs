...
{ 
   ///<summary>
     ///TG_Routes class   
     ///</summary>
    public partial class TG_Routes : SpeTG_Routes
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public TG_Routes(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public TG_Routes(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TG_Routes(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TG_Routes(SqlHelper SqlConfig, int UserId, SimpleTG_Routes Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
