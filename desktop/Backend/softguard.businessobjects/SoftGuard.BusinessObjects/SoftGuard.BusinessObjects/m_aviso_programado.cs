...
// Type: SoftGuard.BusinessObjects.m_aviso_programado
...
{
  public class m_aviso_programado : Spem_aviso_programado
  {
    public m_aviso_programado(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_aviso_programado(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_aviso_programado(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_aviso_programado(SqlHelper SqlConfig, int UserId, Simplem_aviso_programado Simple)
