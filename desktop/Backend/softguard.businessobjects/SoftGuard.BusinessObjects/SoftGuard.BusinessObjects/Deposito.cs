...
// Type: SoftGuard.BusinessObjects.Deposito
...
{
  public class Deposito : SpeDeposito
  {
    public Deposito(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public Deposito(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public Deposito(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public Deposito(SqlHelper SqlConfig, int UserId, SimpleDeposito Simple)
