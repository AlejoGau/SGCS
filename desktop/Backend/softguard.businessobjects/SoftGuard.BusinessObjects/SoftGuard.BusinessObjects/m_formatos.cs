...
// Type: SoftGuard.BusinessObjects.m_formatos
...
{
  public class m_formatos : Spem_formatos
  {
    public m_formatos(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_formatos(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_formatos(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_formatos(SqlHelper SqlConfig, int UserId, Simplem_formatos Simple)
