...
{ 
   ///<summary>
     ///m_sgnotes class   
     ///</summary>
    public partial class m_sgnotes : Spem_sgnotes
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_sgnotes(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_sgnotes(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_sgnotes(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_sgnotes(SqlHelper SqlConfig, int UserId, Simplem_sgnotes Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
