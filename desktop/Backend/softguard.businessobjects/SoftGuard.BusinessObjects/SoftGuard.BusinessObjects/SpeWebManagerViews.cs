...
// Type: SoftGuard.BusinessObjects.SpeWebManagerViews
...
{
  public abstract class SpeWebManagerViews : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalWebManagerViews _DalObject;
    ...
    public string Data
    {
      get
      {
        return this._DalObject.Data;
      }
      set
      {
        this._DalObject.Data = value;
      }
    }
    ...
    public int RefreshTime
    {
      get
      {
        return this._DalObject.RefreshTime;
      }
      set
      {
        this._DalObject.RefreshTime = value;
      }
    }
    ...
    public int Opened
    {
      get
      {
        return this._DalObject.Opened;
      }
      set
      {
        this._DalObject.Opened = value;
      }
    }
    ...
    public SpeWebManagerViews(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeWebManagerViews(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeWebManagerViews(SqlHelper SqlConfig, int UserId, SimpleWebManagerViews Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleWebManagerViews Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The WebManagerViews has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalWebManagerViews GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The WebManagerViews is null.");
    ...
    {
      this._DalObject = new DalWebManagerViews(SqlConfig, UserId);
    ...
    {
      WebManagerViews webManagerViews = (WebManagerViews) Object;
      webManagerViews.Name = this.Name;
      webManagerViews.Data = this.Data;
      webManagerViews.RefreshTime = this.RefreshTime;
      webManagerViews.Opened = this.Opened;
    }
