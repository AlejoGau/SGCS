...
// Type: SoftGuard.BusinessObjects.t_parametros
...
{
  public class t_parametros : Spet_parametros
  {
    public t_parametros(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_parametros(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_parametros(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_parametros(SqlHelper SqlConfig, int UserId, Simplet_parametros Simple)
