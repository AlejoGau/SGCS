...
// Type: SoftGuard.BusinessObjects.t_autoridades
...
{
  public class t_autoridades : Spet_autoridades
  {
    public t_autoridades(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_autoridades(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_autoridades(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_autoridades(SqlHelper SqlConfig, int UserId, Simplet_autoridades Simple)
