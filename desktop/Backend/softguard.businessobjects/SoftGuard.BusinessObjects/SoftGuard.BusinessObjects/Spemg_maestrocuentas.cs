...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spemg_maestrocuentas : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalmg_maestrocuentas _DalObject;
 ...
 ///<summary>
     ...
     public int  mgmc_idorganizacion 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_idorganizacion; }
        						set{ this._DalObject.mgmc_idorganizacion = value; } 										
	   }
	  ///<summary>
     ...
     public string  mgmc_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_ccodigo; }
        						set{ this._DalObject.mgmc_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  mgmc_descripcion 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_descripcion; }
        						set{ this._DalObject.mgmc_descripcion = value; } 										
	   }
	  ///<summary>
     ///mgmc_ctipo property   
     ///</summary>	
     public string  mgmc_ctipo 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_ctipo; }
        						set{ this._DalObject.mgmc_ctipo = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  mgmc_lastupdate 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_lastupdate; }
        						set{ this._DalObject.mgmc_lastupdate = value; } 										
	   }
	  ///<summary>
     ///mgmc_saldo property   
     ///</summary>	
     public Decimal  mgmc_saldo 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_saldo; }
        						set{ this._DalObject.mgmc_saldo = value; } 										
	   }
	  ///<summary>
     ...
     public string  mgmc_moncodigo 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_moncodigo; }
        						set{ this._DalObject.mgmc_moncodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  mgmc_metadata 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_metadata; }
        						set{ this._DalObject.mgmc_metadata = value; } 										
	   }
	  ///<summary>
     ...
     public int  mgmc_capitulo 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_capitulo; }
        						set{ this._DalObject.mgmc_capitulo = value; } 										
	   }
	  ///<summary>
     ///mgmc_rubro property   
     ///</summary>	
     public int  mgmc_rubro 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_rubro; }
        						set{ this._DalObject.mgmc_rubro = value; } 										
	   }
	  ///<summary>
     ...
     public int  mgmc_subrubro 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_subrubro; }
        						set{ this._DalObject.mgmc_subrubro = value; } 										
	   }
	  ///<summary>
     ...
     public int  mgmc_imputacion 
		 { 
                    ...
                    get{ return this._DalObject.mgmc_imputacion; }
        						set{ this._DalObject.mgmc_imputacion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spemg_maestrocuentas(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spemg_maestrocuentas(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spemg_maestrocuentas(SqlHelper SqlConfig, int UserId, Simplemg_maestrocuentas Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplemg_maestrocuentas Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The mg_maestrocuentas has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalmg_maestrocuentas GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The mg_maestrocuentas is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalmg_maestrocuentas(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (mg_maestrocuentas)Object;
			o.Name = this.Name;

			o.mgmc_idorganizacion = this.mgmc_idorganizacion;

			o.mgmc_ccodigo = this.mgmc_ccodigo;

			o.mgmc_descripcion = this.mgmc_descripcion;

			o.mgmc_ctipo = this.mgmc_ctipo;

			o.mgmc_lastupdate = this.mgmc_lastupdate;

			o.mgmc_saldo = this.mgmc_saldo;

			o.mgmc_moncodigo = this.mgmc_moncodigo;

			o.mgmc_metadata = this.mgmc_metadata;

			o.mgmc_capitulo = this.mgmc_capitulo;

			o.mgmc_rubro = this.mgmc_rubro;

			o.mgmc_subrubro = this.mgmc_subrubro;

			o.mgmc_imputacion = this.mgmc_imputacion;
