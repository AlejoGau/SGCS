...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeTG_Route_Geofences : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalTG_Route_Geofences _DalObject;
 ...
 ///<summary>
     ...
     public int  geofenceid 
		 { 
                    ...
                    get{ return this._DalObject.geofenceid; }
        						set{ this._DalObject.geofenceid = value; } 										
	   }
	  ///<summary>
     ///time property   
     ///</summary>	
     ...
     public int  beforetolerance 
		 { 
                    ...
                    get{ return this._DalObject.beforetolerance; }
        						set{ this._DalObject.beforetolerance = value; } 										
	   }
	  ///<summary>
     ...
     public int  aftertolerance 
		 { 
                    ...
                    get{ return this._DalObject.aftertolerance; }
        						set{ this._DalObject.aftertolerance = value; } 										
	   }
	  ///<summary>
     ///order property   
     ///</summary>	
     public int  order 
		 { 
                    ...
                    get{ return this._DalObject.order; }
        						set{ this._DalObject.order = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeTG_Route_Geofences(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTG_Route_Geofences(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTG_Route_Geofences(SqlHelper SqlConfig, int UserId, SimpleTG_Route_Geofences Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleTG_Route_Geofences Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The TG_Route_Geofences has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalTG_Route_Geofences GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The TG_Route_Geofences is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalTG_Route_Geofences(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (TG_Route_Geofences)Object;
			o.Name = this.Name;

			o.routeId = this.routeId;

			o.geofenceid = this.geofenceid;

			o.time = this.time;

			o.beforetolerance = this.beforetolerance;

			o.aftertolerance = this.aftertolerance;
