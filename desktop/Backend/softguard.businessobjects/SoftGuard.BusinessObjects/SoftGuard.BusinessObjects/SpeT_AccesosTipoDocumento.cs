...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeT_AccesosTipoDocumento : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalT_AccesosTipoDocumento _DalObject;
 ...
 ///<summary>
     ...
     public string  atd_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.atd_cDescripcion; }
        						set{ this._DalObject.atd_cDescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public int  atd_iPideVto 
		 { 
                    ...
                    get{ return this._DalObject.atd_iPideVto; }
        						set{ this._DalObject.atd_iPideVto = value; } 										
	   }
	  ///<summary>
     ...
     public int  atd_iUploadFile 
		 { 
                    ...
                    get{ return this._DalObject.atd_iUploadFile; }
        						set{ this._DalObject.atd_iUploadFile = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeT_AccesosTipoDocumento(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_AccesosTipoDocumento(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_AccesosTipoDocumento(SqlHelper SqlConfig, int UserId, SimpleT_AccesosTipoDocumento Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleT_AccesosTipoDocumento Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The T_AccesosTipoDocumento has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalT_AccesosTipoDocumento GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The T_AccesosTipoDocumento is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalT_AccesosTipoDocumento(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.T_AccesosTipoDocumento)Object;
			o.Name = this.Name;

			o.atd_cDescripcion = this.atd_cDescripcion;

			o.atd_iPideVto = this.atd_iPideVto;

			o.atd_iUploadFile = this.atd_iUploadFile;
