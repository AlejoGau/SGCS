...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeZonaPlanilla : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalZonaPlanilla _DalObject;
 ...
 ///<summary>
     ...
     public int  zon_iid 
		 { 
                    ...
                    get{ return this._DalObject.zon_iid; }
        						set{ this._DalObject.zon_iid = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.zon_ccodigo; }
        						set{ this._DalObject.zon_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.zon_cdescripcion; }
        						set{ this._DalObject.zon_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_codigoalarma 
		 { 
                    ...
                    get{ return this._DalObject.zon_codigoalarma; }
        						set{ this._DalObject.zon_codigoalarma = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_clistaemergencia 
		 { 
                    ...
                    get{ return this._DalObject.zon_clistaemergencia; }
        						set{ this._DalObject.zon_clistaemergencia = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_cimagen 
		 { 
                    ...
                    get{ return this._DalObject.zon_cimagen; }
        						set{ this._DalObject.zon_cimagen = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_mobservacion 
		 { 
                    ...
                    get{ return this._DalObject.zon_mobservacion; }
        						set{ this._DalObject.zon_mobservacion = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_ccodigorestauracion 
		 { 
                    ...
                    get{ return this._DalObject.zon_ccodigorestauracion; }
        						set{ this._DalObject.zon_ccodigorestauracion = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  zon_nminutosrestauracion 
		 { 
                    ...
                    get{ return this._DalObject.zon_nminutosrestauracion; }
        						set{ this._DalObject.zon_nminutosrestauracion = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  zon_nmostrar 
		 { 
                    ...
                    get{ return this._DalObject.zon_nmostrar; }
        						set{ this._DalObject.zon_nmostrar = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_cdealer 
		 { 
                    ...
                    get{ return this._DalObject.zon_cdealer; }
        						set{ this._DalObject.zon_cdealer = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_ccuenta 
		 { 
                    ...
                    get{ return this._DalObject.zon_ccuenta; }
        						set{ this._DalObject.zon_ccuenta = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  zon_nautoprocesa 
		 { 
                    ...
                    get{ return this._DalObject.zon_nautoprocesa; }
        						set{ this._DalObject.zon_nautoprocesa = value; } 										
	   }
	  ///<summary>
     ...
     public string  zon_calarmaagenerar 
		 { 
                    ...
                    get{ return this._DalObject.zon_calarmaagenerar; }
        						set{ this._DalObject.zon_calarmaagenerar = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeZonaPlanilla(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeZonaPlanilla(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeZonaPlanilla(SqlHelper SqlConfig, int UserId, SimpleZonaPlanilla Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleZonaPlanilla Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The ZonaPlanilla has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalZonaPlanilla GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The ZonaPlanilla is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalZonaPlanilla(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (ZonaPlanilla)Object;
			o.Name = this.Name;

			o.zon_iid = this.zon_iid;

			o.zon_ccodigo = this.zon_ccodigo;

			o.zon_cdescripcion = this.zon_cdescripcion;

			o.zon_codigoalarma = this.zon_codigoalarma;

			o.zon_clistaemergencia = this.zon_clistaemergencia;

			o.zon_cimagen = this.zon_cimagen;

			o.zon_mobservacion = this.zon_mobservacion;

			o.zon_ccodigorestauracion = this.zon_ccodigorestauracion;

			o.zon_nminutosrestauracion = this.zon_nminutosrestauracion;

			o.zon_nmostrar = this.zon_nmostrar;

			o.zon_cdealer = this.zon_cdealer;

			o.zon_ccuenta = this.zon_ccuenta;

			o.zon_nautoprocesa = this.zon_nautoprocesa;

			o.zon_calarmaagenerar = this.zon_calarmaagenerar;
