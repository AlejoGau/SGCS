...
{ 
   ///<summary>
     ///MG_informacion_pago class   
     ///</summary>
    public partial class MG_informacion_pago : SpeMG_informacion_pago
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_informacion_pago(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_informacion_pago(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_informacion_pago(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_informacion_pago(SqlHelper SqlConfig, int UserId, SimpleMG_informacion_pago Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
