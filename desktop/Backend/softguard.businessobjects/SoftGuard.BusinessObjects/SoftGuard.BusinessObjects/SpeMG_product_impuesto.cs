...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeMG_product_impuesto : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalMG_product_impuesto _DalObject;
 ...
 ///<summary>
     ...
     public int  mpi_idproduct 
		 { 
                    ...
                    get{ return this._DalObject.mpi_idproduct; }
        						set{ this._DalObject.mpi_idproduct = value; } 										
	   }
	  ///<summary>
     ...
     public int  mpi_impidkey 
		 { 
                    ...
                    get{ return this._DalObject.mpi_impidkey; }
        						set{ this._DalObject.mpi_impidkey = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeMG_product_impuesto(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_product_impuesto(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_product_impuesto(SqlHelper SqlConfig, int UserId, SimpleMG_product_impuesto Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleMG_product_impuesto Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The MG_product_impuesto has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalMG_product_impuesto GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The MG_product_impuesto is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalMG_product_impuesto(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (MG_product_impuesto)Object;
			o.Name = this.Name;

			o.mpi_idproduct = this.mpi_idproduct;

			o.mpi_impidkey = this.mpi_impidkey;
