...
{ 
   ///<summary>
     ///p_controlAcceso_Autorizacion class   
     ///</summary>
    public partial class p_controlAcceso_Autorizacion : Spep_controlAcceso_Autorizacion
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_controlAcceso_Autorizacion(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_controlAcceso_Autorizacion(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_controlAcceso_Autorizacion(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_controlAcceso_Autorizacion(SqlHelper SqlConfig, int UserId, Simplep_controlAcceso_Autorizacion Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
