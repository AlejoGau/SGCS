...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_ResourcesModule_Type : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_ResourcesModule_Type _DalObject;
 ...
 ///<summary>
     ...
     public string  rmt_cNombre 
		 { 
                    ...
                    get{ return this._DalObject.rmt_cNombre; }
        						set{ this._DalObject.rmt_cNombre = value; } 										
	   }
	  ///<summary>
     ///rmt_itipo property   
     ///</summary>	
     public int  rmt_itipo 
		 { 
                    ...
                    get{ return this._DalObject.rmt_itipo; }
        						set{ this._DalObject.rmt_itipo = value; } 										
	   }
	  ///<summary>
     ///rmt_idOrg property   
     ///</summary>	
     public int  rmt_idOrg 
		 { 
                    ...
                    get{ return this._DalObject.rmt_idOrg; }
        						set{ this._DalObject.rmt_idOrg = value; } 										
	   }
	  ///<summary>
     ///rmt_cIcono property   
     ///</summary>	
     public string  rmt_cIcono 
		 { 
                    ...
                    get{ return this._DalObject.rmt_cIcono; }
        						set{ this._DalObject.rmt_cIcono = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_ResourcesModule_Type(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_ResourcesModule_Type(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_ResourcesModule_Type(SqlHelper SqlConfig, int UserId, Simplet_ResourcesModule_Type Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_ResourcesModule_Type Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_ResourcesModule_Type has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_ResourcesModule_Type GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_ResourcesModule_Type is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_ResourcesModule_Type(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_ResourcesModule_Type)Object;
			o.Name = this.Name;

			o.rmt_cNombre = this.rmt_cNombre;

			o.rmt_itipo = this.rmt_itipo;

			o.rmt_idOrg = this.rmt_idOrg;

			o.rmt_cIcono = this.rmt_cIcono;
