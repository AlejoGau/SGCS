...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeHorarioExcepcionPlanilla : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalHorarioExcepcionPlanilla _DalObject;
 ...
 ///<summary>
     ...
     public int  exc_iid 
		 { 
                    ...
                    get{ return this._DalObject.exc_iid; }
        						set{ this._DalObject.exc_iid = value; } 										
	   }
	  ///<summary>
     ...
     public string  exc_cevento 
		 { 
                    ...
                    get{ return this._DalObject.exc_cevento; }
        						set{ this._DalObject.exc_cevento = value; } 										
	   }
	  ///<summary>
     ...
     public string  exc_cHoraApertura 
		 { 
                    ...
                    get{ return this._DalObject.exc_cHoraApertura; }
        						set{ this._DalObject.exc_cHoraApertura = value; } 										
	   }
	  ///<summary>
     ...
     public string  exc_cHoraCierre 
		 { 
                    ...
                    get{ return this._DalObject.exc_cHoraCierre; }
        						set{ this._DalObject.exc_cHoraCierre = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeHorarioExcepcionPlanilla(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeHorarioExcepcionPlanilla(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeHorarioExcepcionPlanilla(SqlHelper SqlConfig, int UserId, SimpleHorarioExcepcionPlanilla Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleHorarioExcepcionPlanilla Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The HorarioExcepcionPlanilla has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalHorarioExcepcionPlanilla GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The HorarioExcepcionPlanilla is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalHorarioExcepcionPlanilla(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.HorarioExcepcionPlanilla)Object;
			o.Name = this.Name;

			o.exc_iid = this.exc_iid;

			o.exc_cevento = this.exc_cevento;

			o.exc_cHoraApertura = this.exc_cHoraApertura;

			o.exc_cHoraCierre = this.exc_cHoraCierre;
