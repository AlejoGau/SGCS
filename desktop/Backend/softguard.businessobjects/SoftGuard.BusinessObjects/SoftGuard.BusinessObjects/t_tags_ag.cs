...
// Type: SoftGuard.BusinessObjects.t_tags_ag
...
{
  public class t_tags_ag : Spet_tags_ag
  {
    public t_tags_ag(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_tags_ag(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_tags_ag(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_tags_ag(SqlHelper SqlConfig, int UserId, Simplet_tags_ag Simple)
