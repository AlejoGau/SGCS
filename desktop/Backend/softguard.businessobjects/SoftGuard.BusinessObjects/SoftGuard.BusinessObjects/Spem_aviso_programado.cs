...
// Type: SoftGuard.BusinessObjects.Spem_aviso_programado
...
{
  public abstract class Spem_aviso_programado : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_aviso_programado _DalObject;
    ...
    public string prg_from
    {
      get
      {
        return this._DalObject.prg_from;
      }
      set
      {
        this._DalObject.prg_from = value;
      }
    }
    ...
    public string prg_to
    {
      get
      {
        return this._DalObject.prg_to;
      }
      set
      {
        this._DalObject.prg_to = value;
      }
    }
    ...
    public int prg_estado
    {
      get
      {
        return this._DalObject.prg_estado;
      }
      set
      {
        this._DalObject.prg_estado = value;
      }
    }
    ...
    public string prg_gateway
    {
      get
      {
        return this._DalObject.prg_gateway;
      }
      set
      {
        this._DalObject.prg_gateway = value;
      }
    }
    ...
    public int prg_objecttypeid
    {
      get
      {
        return this._DalObject.prg_objecttypeid;
      }
      set
      {
        this._DalObject.prg_objecttypeid = value;
      }
    }
    ...
    public int prg_objectid
    {
      get
      {
        return this._DalObject.prg_objectid;
      }
      set
      {
        this._DalObject.prg_objectid = value;
      }
    }
    ...
    public DateTime? prg_prgdatetime
    {
      get
      {
        return this._DalObject.prg_prgdatetime;
      }
      set
      {
        this._DalObject.prg_prgdatetime = value;
      }
    }
    ...
    public DateTime? prg_enviodatetime
    {
      get
      {
        return this._DalObject.prg_enviodatetime;
      }
      set
      {
        this._DalObject.prg_enviodatetime = value;
      }
    }
    ...
    public string prg_mensaje
    {
      get
      {
        return this._DalObject.prg_mensaje;
      }
      set
      {
        this._DalObject.prg_mensaje = value;
      }
    }
    ...
    public Spem_aviso_programado(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_aviso_programado(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_aviso_programado(SqlHelper SqlConfig, int UserId, Simplem_aviso_programado Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_aviso_programado Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_aviso_programado has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_aviso_programado GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_aviso_programado is null.");
    ...
    {
      this._DalObject = new Dalm_aviso_programado(SqlConfig, UserId);
    ...
    {
      m_aviso_programado mAvisoProgramado = (m_aviso_programado) Object;
      mAvisoProgramado.Name = this.Name;
      mAvisoProgramado.prg_from = this.prg_from;
      mAvisoProgramado.prg_to = this.prg_to;
      mAvisoProgramado.prg_estado = this.prg_estado;
      mAvisoProgramado.prg_gateway = this.prg_gateway;
      mAvisoProgramado.prg_objecttypeid = this.prg_objecttypeid;
      mAvisoProgramado.prg_objectid = this.prg_objectid;
      mAvisoProgramado.prg_prgdatetime = this.prg_prgdatetime;
      mAvisoProgramado.prg_enviodatetime = this.prg_enviodatetime;
      mAvisoProgramado.prg_mensaje = this.prg_mensaje;
    }
