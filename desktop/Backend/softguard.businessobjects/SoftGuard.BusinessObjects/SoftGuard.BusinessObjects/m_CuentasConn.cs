...
{ 
   ///<summary>
     ///m_CuentasConn class   
     ///</summary>
    public partial class m_CuentasConn : Spem_CuentasConn
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_CuentasConn(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_CuentasConn(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_CuentasConn(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_CuentasConn(SqlHelper SqlConfig, int UserId, Simplem_CuentasConn Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
