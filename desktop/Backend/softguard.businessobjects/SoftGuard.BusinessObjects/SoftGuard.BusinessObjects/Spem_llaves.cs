...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_llaves : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_llaves _DalObject;
 ...
 ///<summary>
     ...
     public string  lla_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.lla_cdescripcion; }
        						set{ this._DalObject.lla_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  lla_cnumero 
		 { 
                    ...
                    get{ return this._DalObject.lla_cnumero; }
        						set{ this._DalObject.lla_cnumero = value; } 										
	   }
	  ///<summary>
     ...
     public string  lla_cubicacion 
		 { 
                    ...
                    get{ return this._DalObject.lla_cubicacion; }
        						set{ this._DalObject.lla_cubicacion = value; } 										
	   }
	  ///<summary>
     ...
     public string  lla_responsable 
		 { 
                    ...
                    get{ return this._DalObject.lla_responsable; }
        						set{ this._DalObject.lla_responsable = value; } 										
	   }
	  ///<summary>
     ...
     public int  lla_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.lla_iidcuenta; }
        						set{ this._DalObject.lla_iidcuenta = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_llaves(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_llaves(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_llaves(SqlHelper SqlConfig, int UserId, Simplem_llaves Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_llaves Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_llaves has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_llaves GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_llaves is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_llaves(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_llaves)Object;
			o.Name = this.Name;

			o.lla_cdescripcion = this.lla_cdescripcion;

			o.lla_cnumero = this.lla_cnumero;

			o.lla_cubicacion = this.lla_cubicacion;

			o.lla_responsable = this.lla_responsable;

			o.lla_iidcuenta = this.lla_iidcuenta;
