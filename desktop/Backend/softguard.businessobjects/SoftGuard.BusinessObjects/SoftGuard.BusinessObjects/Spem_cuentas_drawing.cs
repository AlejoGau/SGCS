...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_cuentas_drawing : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_cuentas_drawing _DalObject;
 ...
 ///<summary>
     ...
     public string  drw_type 
		 { 
                    ...
                    get{ return this._DalObject.drw_type; }
        						set{ this._DalObject.drw_type = value; } 										
	   }
	  ///<summary>
     ///drw_cueiid property   
     ///</summary>	
     public int  drw_cueiid 
		 { 
                    ...
                    get{ return this._DalObject.drw_cueiid; }
        						set{ this._DalObject.drw_cueiid = value; } 										
	   }
	  ///<summary>
     ...
     public string  drw_metadata 
		 { 
                    ...
                    get{ return this._DalObject.drw_metadata; }
        						set{ this._DalObject.drw_metadata = value; } 										
	   }
	  ///<summary>
     ...
     public string  drw_descripcion 
		 { 
                    ...
                    get{ return this._DalObject.drw_descripcion; }
        						set{ this._DalObject.drw_descripcion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_cuentas_drawing(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuentas_drawing(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuentas_drawing(SqlHelper SqlConfig, int UserId, Simplem_cuentas_drawing Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_cuentas_drawing Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_cuentas_drawing has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_cuentas_drawing GetDalObject()
		{
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<Simplem_cuentas_drawing> GetByParent(string ObjectType, int ObjectId)
		{
			return this._DalObject.GetByParent(ObjectType, ObjectId);
		}
		public IEnumerable<Simplem_cuentas_drawing> GetByChild(string ObjectType, int ObjectId)
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_cuentas_drawing is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_cuentas_drawing(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_cuentas_drawing)Object;
			o.Name = this.Name;

			o.drw_type = this.drw_type;

			o.drw_cueiid = this.drw_cueiid;

			o.drw_metadata = this.drw_metadata;

			o.drw_descripcion = this.drw_descripcion;
