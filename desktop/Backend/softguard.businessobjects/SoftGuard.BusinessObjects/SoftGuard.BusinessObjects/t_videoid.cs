...
// Type: SoftGuard.BusinessObjects.t_videoid
...
{
  public class t_videoid : Spet_videoid
  {
    public t_videoid(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_videoid(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_videoid(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_videoid(SqlHelper SqlConfig, int UserId, Simplet_videoid Simple)
