...
// Type: SoftGuard.BusinessObjects.SpeFalsa
...
{
  public abstract class SpeFalsa : ISpecialization
  {
    private bool _AutoCommit = false;
    protected DalFalsa _DalObject;
    ...
    public int fal_iidcuenta
    {
      get
      {
        return this._DalObject.fal_iidcuenta;
      }
      set
      {
        this._DalObject.fal_iidcuenta = value;
      }
    }
    ...
    public Decimal fal_nmargen
    {
      get
      {
        return this._DalObject.fal_nmargen;
      }
      set
      {
        this._DalObject.fal_nmargen = value;
      }
    }
    ...
    public Decimal fal_nmeses
    {
      get
      {
        return this._DalObject.fal_nmeses;
      }
      set
      {
        this._DalObject.fal_nmeses = value;
      }
    }
    ...
    public string fal_mnota
    {
      get
      {
        return this._DalObject.fal_mnota;
      }
      set
      {
        this._DalObject.fal_mnota = value;
      }
    }
    ...
    public SpeFalsa(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeFalsa(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeFalsa(SqlHelper SqlConfig, int UserId, SimpleFalsa Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleFalsa Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The Falsa has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The Falsa is null.");
    ...
    {
      this._DalObject = new DalFalsa(SqlConfig, UserId);
