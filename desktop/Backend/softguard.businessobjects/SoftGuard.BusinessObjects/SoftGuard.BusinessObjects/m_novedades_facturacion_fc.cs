...
{ 
   ///<summary>
     ///m_novedades_facturacion_fc class   
     ///</summary>
    public partial class m_novedades_facturacion_fc : Spem_novedades_facturacion_fc
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_novedades_facturacion_fc(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_novedades_facturacion_fc(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_novedades_facturacion_fc(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_novedades_facturacion_fc(SqlHelper SqlConfig, int UserId, Simplem_novedades_facturacion_fc Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
