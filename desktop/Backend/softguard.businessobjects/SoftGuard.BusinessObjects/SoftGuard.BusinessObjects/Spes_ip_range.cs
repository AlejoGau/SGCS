...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spes_ip_range : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dals_ip_range _DalObject;
 ...
 ///<summary>
     ...
     public string  ipr_name 
		 { 
                    ...
                    get{ return this._DalObject.ipr_name; }
        						set{ this._DalObject.ipr_name = value; } 										
	   }
	  ///<summary>
     ///ipr_desde property   
     ///</summary>	
     public string  ipr_desde 
		 { 
                    ...
                    get{ return this._DalObject.ipr_desde; }
        						set{ this._DalObject.ipr_desde = value; } 										
	   }
	  ///<summary>
     ///ipr_hasta property   
     ///</summary>	
     public string  ipr_hasta 
		 { 
                    ...
                    get{ return this._DalObject.ipr_hasta; }
        						set{ this._DalObject.ipr_hasta = value; } 										
	   }
	  ///<summary>
     ///ipr_estado property   
     ///</summary>	
     public int  ipr_estado 
		 { 
                    ...
                    get{ return this._DalObject.ipr_estado; }
        						set{ this._DalObject.ipr_estado = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spes_ip_range(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_ip_range(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_ip_range(SqlHelper SqlConfig, int UserId, Simples_ip_range Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simples_ip_range Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The s_ip_range has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dals_ip_range GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The s_ip_range is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dals_ip_range(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (s_ip_range)Object;
			o.Name = this.Name;

			o.ipr_name = this.ipr_name;

			o.ipr_desde = this.ipr_desde;

			o.ipr_hasta = this.ipr_hasta;

			o.ipr_estado = this.ipr_estado;
