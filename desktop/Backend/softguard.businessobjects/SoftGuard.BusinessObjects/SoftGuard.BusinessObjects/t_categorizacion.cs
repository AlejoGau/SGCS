...
{ 
   ///<summary>
     ///t_categorizacion class   
     ///</summary>
    public partial class t_categorizacion : Spet_categorizacion
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_categorizacion(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_categorizacion(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_categorizacion(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_categorizacion(SqlHelper SqlConfig, int UserId, Simplet_categorizacion Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
