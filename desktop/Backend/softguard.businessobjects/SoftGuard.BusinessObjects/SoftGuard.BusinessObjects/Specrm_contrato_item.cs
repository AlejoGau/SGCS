...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Specrm_contrato_item : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalcrm_contrato_item _DalObject;
 ...
 ///<summary>
     ...
     public int  idcontrato 
		 { 
                    ...
                    get{ return this._DalObject.idcontrato; }
        						set{ this._DalObject.idcontrato = value; } 										
	   }
	  ///<summary>
     ///Price property   
     ///</summary>	
     ...
     public string  Currency 
		 { 
                    ...
                    get{ return this._DalObject.Currency; }
        						set{ this._DalObject.Currency = value; } 										
	   }
	  ///<summary>
     ///Status property   
     ///</summary>	
     ...
     public string  Description 
		 { 
                    ...
                    get{ return this._DalObject.Description; }
        						set{ this._DalObject.Description = value; } 										
	   }
	  ///<summary>
     ///Quantity property   
     ///</summary>	
     public int  Quantity 
		 { 
                    ...
                    get{ return this._DalObject.Quantity; }
        						set{ this._DalObject.Quantity = value; } 										
	   }
	  ///<summary>
     ...
     public int  QuantityDelivered 
		 { 
                    ...
                    get{ return this._DalObject.QuantityDelivered; }
        						set{ this._DalObject.QuantityDelivered = value; } 										
	   }
	  ///<summary>
     ///Code property   
     ///</summary>	
     ...
     public int  ProductId 
		 { 
                    ...
                    get{ return this._DalObject.ProductId; }
        						set{ this._DalObject.ProductId = value; } 										
	   }
	  ///<summary>
     ///idlista property   
     ///</summary>	
     public int  idlista 
		 { 
                    ...
                    get{ return this._DalObject.idlista; }
        						set{ this._DalObject.idlista = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Specrm_contrato_item(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Specrm_contrato_item(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Specrm_contrato_item(SqlHelper SqlConfig, int UserId, Simplecrm_contrato_item Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplecrm_contrato_item Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The crm_contrato_item has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalcrm_contrato_item GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The crm_contrato_item is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalcrm_contrato_item(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (crm_contrato_item)Object;
			o.Name = this.Name;

			o.idcontrato = this.idcontrato;
			...
			o.QuantityDelivered = this.QuantityDelivered;
