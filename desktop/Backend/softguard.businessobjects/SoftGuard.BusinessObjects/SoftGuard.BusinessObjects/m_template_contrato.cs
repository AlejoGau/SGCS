...
// Type: SoftGuard.BusinessObjects.m_template_contrato
...
{
  public class m_template_contrato : Spem_template_contrato
  {
    public m_template_contrato(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_template_contrato(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_template_contrato(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_template_contrato(SqlHelper SqlConfig, int UserId, Simplem_template_contrato Simple)
