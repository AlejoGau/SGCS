...
// Type: SoftGuard.BusinessObjects.Spem_formatos
...
{
  public abstract class Spem_formatos : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_formatos _DalObject;
    ...
    public string for_cdescripcion
    {
      get
      {
        return this._DalObject.for_cdescripcion;
      }
      set
      {
        this._DalObject.for_cdescripcion = value;
      }
    }
    ...
    public string for_cformato
    {
      get
      {
        return this._DalObject.for_cformato;
      }
      set
      {
        this._DalObject.for_cformato = value;
      }
    }
    ...
    public string for_cnombre
    {
      get
      {
        return this._DalObject.for_cnombre;
      }
      set
      {
        this._DalObject.for_cnombre = value;
      }
    }
    ...
    public string for_calarma
    {
      get
      {
        return this._DalObject.for_calarma;
      }
      set
      {
        this._DalObject.for_calarma = value;
      }
    }
    ...
    public string for_ccodigo
    {
      get
      {
        return this._DalObject.for_ccodigo;
      }
      set
      {
        this._DalObject.for_ccodigo = value;
      }
    }
    ...
    public Spem_formatos(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_formatos(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_formatos(SqlHelper SqlConfig, int UserId, Simplem_formatos Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_formatos Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_formatos has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_formatos GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_formatos is null.");
    ...
    {
      this._DalObject = new Dalm_formatos(SqlConfig, UserId);
    ...
    {
      m_formatos mFormatos = (m_formatos) Object;
      mFormatos.Name = this.Name;
      mFormatos.for_cdescripcion = this.for_cdescripcion;
      mFormatos.for_cformato = this.for_cformato;
      mFormatos.for_cnombre = this.for_cnombre;
      mFormatos.for_calarma = this.for_calarma;
      mFormatos.for_ccodigo = this.for_ccodigo;
    }
