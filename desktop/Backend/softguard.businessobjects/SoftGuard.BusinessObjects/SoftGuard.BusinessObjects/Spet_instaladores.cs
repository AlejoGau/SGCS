...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_instaladores : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_instaladores _DalObject;
 ...
 ///<summary>
     ...
     public string  ins_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.ins_ccodigo; }
        						set{ this._DalObject.ins_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  ins_cnombre 
		 { 
                    ...
                    get{ return this._DalObject.ins_cnombre; }
        						set{ this._DalObject.ins_cnombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  ins_cempresa 
		 { 
                    ...
                    get{ return this._DalObject.ins_cempresa; }
        						set{ this._DalObject.ins_cempresa = value; } 										
	   }
	  ///<summary>
     ///ins_ccalle property   
     ///</summary>	
     public string  ins_ccalle 
		 { 
                    ...
                    get{ return this._DalObject.ins_ccalle; }
        						set{ this._DalObject.ins_ccalle = value; } 										
	   }
	  ///<summary>
     ...
     public int  ins_inumero 
		 { 
                    ...
                    get{ return this._DalObject.ins_inumero; }
        						set{ this._DalObject.ins_inumero = value; } 										
	   }
	  ///<summary>
     ///ins_npiso property   
     ///</summary>	
     public Decimal  ins_npiso 
		 { 
                    ...
                    get{ return this._DalObject.ins_npiso; }
        						set{ this._DalObject.ins_npiso = value; } 										
	   }
	  ///<summary>
     ...
     public string  ins_cdepartamento 
		 { 
                    ...
                    get{ return this._DalObject.ins_cdepartamento; }
        						set{ this._DalObject.ins_cdepartamento = value; } 										
	   }
	  ///<summary>
     ...
     public string  ins_ctelefono 
		 { 
                    ...
                    get{ return this._DalObject.ins_ctelefono; }
        						set{ this._DalObject.ins_ctelefono = value; } 										
	   }
	  ///<summary>
     ///ins_cmail property   
     ///</summary>	
     public string  ins_cmail 
		 { 
                    ...
                    get{ return this._DalObject.ins_cmail; }
        						set{ this._DalObject.ins_cmail = value; } 										
	   }
	  ///<summary>
     ...
     public string  ins_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.ins_cDealer; }
        						set{ this._DalObject.ins_cDealer = value; } 										
	   }
	  ///<summary>
     ///ins_iTipo property   
     ///</summary>	
     public int  ins_iTipo 
		 { 
                    ...
                    get{ return this._DalObject.ins_iTipo; }
        						set{ this._DalObject.ins_iTipo = value; } 										
	   }
	  ///<summary>
     ...
     public int  ins_irelacion 
		 { 
                    ...
                    get{ return this._DalObject.ins_irelacion; }
        						set{ this._DalObject.ins_irelacion = value; } 										
	   }
	  ///<summary>
     ...
     public int  ins_iOrganizacion  
		 { 
                    ...
                    get{ return this._DalObject.ins_iOrganizacion ; }
        						set{ this._DalObject.ins_iOrganizacion  = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_instaladores(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_instaladores(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_instaladores(SqlHelper SqlConfig, int UserId, Simplet_instaladores Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_instaladores Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_instaladores has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_instaladores GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_instaladores is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_instaladores(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_instaladores)Object;
			o.Name = this.Name;

			o.ins_ccodigo = this.ins_ccodigo;

			o.ins_cnombre = this.ins_cnombre;

			o.ins_cempresa = this.ins_cempresa;

			o.ins_ccalle = this.ins_ccalle;

			o.ins_inumero = this.ins_inumero;

			o.ins_npiso = this.ins_npiso;

			o.ins_cdepartamento = this.ins_cdepartamento;

			o.ins_ctelefono = this.ins_ctelefono;

			o.ins_cmail = this.ins_cmail;

			o.ins_cDealer = this.ins_cDealer;

			o.ins_iTipo = this.ins_iTipo;

			o.ins_irelacion = this.ins_irelacion;

			o.ins_iOrganizacion  = this.ins_iOrganizacion ;
