...
{ 	
  ///<summary>
    ///s_iprservicios Slbf Class
    ///</summary>
    [DataContract]
    public class Simples_iprservicios : SimpleBaseObject
    { 
			 ///<summary>
     ///iprs_ccnombre   
     ///</summary>
	 ...
	 ///<summary>
        ///s_iprservicios Constructor
        ///</summary>
        public Simples_iprservicios() : base()
  {
  InitClass();
  }
        ///<summary>
        ///s_iprservicios Constructor
        ///</summary>
        public Simples_iprservicios(int Id, string Name, string iprs_ccnombre, string iprs_localip, int iprs_commandport, int iprs_websocketport, string iprs_status, string iprs_config, DateTime? iprs_lastserviceupdate) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
...
///<summary>
    ...
    ///</summary>  
		...
		{
			BaseObject Object = new Dals_iprservicios(SqlConfig, UserId, this);
