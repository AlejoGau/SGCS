...
// Type: SoftGuard.BusinessObjects.t_autoridaddestino
...
{
  public class t_autoridaddestino : Spet_autoridaddestino
  {
    public t_autoridaddestino(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_autoridaddestino(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_autoridaddestino(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_autoridaddestino(SqlHelper SqlConfig, int UserId, Simplet_autoridaddestino Simple)
