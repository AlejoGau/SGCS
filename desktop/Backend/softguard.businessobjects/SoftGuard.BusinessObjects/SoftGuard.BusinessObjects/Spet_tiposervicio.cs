...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_tiposervicio : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_tiposervicio _DalObject;
 ...
 ///<summary>
     ...
     public Decimal  tip_yvalor 
		 { 
                    ...
                    get{ return this._DalObject.tip_yvalor; }
        						set{ this._DalObject.tip_yvalor = value; } 										
	   }
	  ///<summary>
     ///tip_ndias property   
     ///</summary>	
     public Decimal  tip_ndias 
		 { 
                    ...
                    get{ return this._DalObject.tip_ndias; }
        						set{ this._DalObject.tip_ndias = value; } 										
	   }
	  ///<summary>
     ///tip_nvto property   
     ///</summary>	
     public Decimal  tip_nvto 
		 { 
                    ...
                    get{ return this._DalObject.tip_nvto; }
        						set{ this._DalObject.tip_nvto = value; } 										
	   }
	  ///<summary>
     ///tip_ntipo property   
     ///</summary>	
     ...
     public string  tip_cEventos 
		 { 
                    ...
                    get{ return this._DalObject.tip_cEventos; }
        						set{ this._DalObject.tip_cEventos = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_tiposervicio(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_tiposervicio(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_tiposervicio(SqlHelper SqlConfig, int UserId, Simplet_tiposervicio Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_tiposervicio Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_tiposervicio has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_tiposervicio GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_tiposervicio is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_tiposervicio(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_tiposervicio)Object;
			o.Name = this.Name;
			...
			o.tip_yvalor = this.tip_yvalor;

			o.tip_ndias = this.tip_ndias;

			o.tip_nvto = this.tip_nvto;

			o.tip_ntipo = this.tip_ntipo;

			o.tip_cEventos = this.tip_cEventos;
