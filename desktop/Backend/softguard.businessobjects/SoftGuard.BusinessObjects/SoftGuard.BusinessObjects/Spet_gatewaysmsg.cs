...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_gatewaysmsg : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_gatewaysmsg _DalObject;
 ...
 ///<summary>
     ...
     public int  tgm_idkey 
		 { 
                    ...
                    get{ return this._DalObject.tgm_idkey; }
        						set{ this._DalObject.tgm_idkey = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.tgm_cdescripcion; }
        						set{ this._DalObject.tgm_cdescripcion = value; } 										
	   }
	  ///<summary>
     ///tgm_ntipo property   
     ///</summary>	
     public int  tgm_ntipo 
		 { 
                    ...
                    get{ return this._DalObject.tgm_ntipo; }
        						set{ this._DalObject.tgm_ntipo = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_csmppsystemid 
		 { 
                    ...
                    get{ return this._DalObject.tgm_csmppsystemid; }
        						set{ this._DalObject.tgm_csmppsystemid = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_csmpppassword 
		 { 
                    ...
                    get{ return this._DalObject.tgm_csmpppassword; }
        						set{ this._DalObject.tgm_csmpppassword = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_csmpphostname 
		 { 
                    ...
                    get{ return this._DalObject.tgm_csmpphostname; }
        						set{ this._DalObject.tgm_csmpphostname = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  tgm_nsmppport 
		 { 
                    ...
                    get{ return this._DalObject.tgm_nsmppport; }
        						set{ this._DalObject.tgm_nsmppport = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_nsmpsourceadd 
		 { 
                    ...
                    get{ return this._DalObject.tgm_nsmpsourceadd; }
        						set{ this._DalObject.tgm_nsmpsourceadd = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_chttpurl 
		 { 
                    ...
                    get{ return this._DalObject.tgm_chttpurl; }
        						set{ this._DalObject.tgm_chttpurl = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_capimail 
		 { 
                    ...
                    get{ return this._DalObject.tgm_capimail; }
        						set{ this._DalObject.tgm_capimail = value; } 										
	   }
	  ///<summary>
     ///tgm_cuser property   
     ///</summary>	
     public string  tgm_cuser 
		 { 
                    ...
                    get{ return this._DalObject.tgm_cuser; }
        						set{ this._DalObject.tgm_cuser = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_cpassword 
		 { 
                    ...
                    get{ return this._DalObject.tgm_cpassword; }
        						set{ this._DalObject.tgm_cpassword = value; } 										
	   }
	  ///<summary>
     ///tgm_cdll property   
     ///</summary>	
     public string  tgm_cdll 
		 { 
                    ...
                    get{ return this._DalObject.tgm_cdll; }
        						set{ this._DalObject.tgm_cdll = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_cconfig 
		 { 
                    ...
                    get{ return this._DalObject.tgm_cconfig; }
        						set{ this._DalObject.tgm_cconfig = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgm_cmetadata 
		 { 
                    ...
                    get{ return this._DalObject.tgm_cmetadata; }
        						set{ this._DalObject.tgm_cmetadata = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_gatewaysmsg(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_gatewaysmsg(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_gatewaysmsg(SqlHelper SqlConfig, int UserId, Simplet_gatewaysmsg Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_gatewaysmsg Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_gatewaysmsg has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_gatewaysmsg GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_gatewaysmsg is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_gatewaysmsg(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_gatewaysmsg)Object;
			o.Name = this.Name;

			o.tgm_idkey = this.tgm_idkey;

			o.tgm_cdescripcion = this.tgm_cdescripcion;

			o.tgm_ntipo = this.tgm_ntipo;

			o.tgm_csmppsystemid = this.tgm_csmppsystemid;

			o.tgm_csmpppassword = this.tgm_csmpppassword;

			o.tgm_csmpphostname = this.tgm_csmpphostname;

			o.tgm_nsmppport = this.tgm_nsmppport;

			o.tgm_nsmpsourceadd = this.tgm_nsmpsourceadd;

			o.tgm_chttpurl = this.tgm_chttpurl;

			o.tgm_capimail = this.tgm_capimail;

			o.tgm_cuser = this.tgm_cuser;

			o.tgm_cpassword = this.tgm_cpassword;

			o.tgm_cdll = this.tgm_cdll;

			o.tgm_cconfig = this.tgm_cconfig;

			o.tgm_cmetadata = this.tgm_cmetadata;
