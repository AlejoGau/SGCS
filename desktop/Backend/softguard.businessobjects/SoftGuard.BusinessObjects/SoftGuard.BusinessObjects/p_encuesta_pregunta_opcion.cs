...
{ 
   ///<summary>
     ///p_encuesta_pregunta_opcion class   
     ///</summary>
    public partial class p_encuesta_pregunta_opcion : Spep_encuesta_pregunta_opcion
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_encuesta_pregunta_opcion(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_encuesta_pregunta_opcion(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_encuesta_pregunta_opcion(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_encuesta_pregunta_opcion(SqlHelper SqlConfig, int UserId, Simplep_encuesta_pregunta_opcion Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
