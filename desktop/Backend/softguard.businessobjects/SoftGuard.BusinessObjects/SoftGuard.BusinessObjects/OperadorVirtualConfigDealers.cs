...
{ 
   ///<summary>
     ///OperadorVirtualConfigDealers class   
     ///</summary>
    public partial class OperadorVirtualConfigDealers : SpeOperadorVirtualConfigDealers
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public OperadorVirtualConfigDealers(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public OperadorVirtualConfigDealers(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public OperadorVirtualConfigDealers(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public OperadorVirtualConfigDealers(SqlHelper SqlConfig, int UserId, SimpleOperadorVirtualConfigDealers Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
