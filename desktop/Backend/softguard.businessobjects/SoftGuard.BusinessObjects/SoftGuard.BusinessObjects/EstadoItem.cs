...
{ 
   ///<summary>
     ///EstadoItem class   
     ///</summary>
    public partial class EstadoItem : SpeEstadoItem
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public EstadoItem(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public EstadoItem(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public EstadoItem(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public EstadoItem(SqlHelper SqlConfig, int UserId, SimpleEstadoItem Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
