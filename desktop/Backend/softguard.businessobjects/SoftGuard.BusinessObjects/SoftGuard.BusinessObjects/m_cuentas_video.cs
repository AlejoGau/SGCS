...
{ 
   ///<summary>
     ///m_cuentas_video class   
     ///</summary>
    public partial class m_cuentas_video : Spem_cuentas_video
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuentas_video(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuentas_video(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuentas_video(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuentas_video(SqlHelper SqlConfig, int UserId, Simplem_cuentas_video Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
