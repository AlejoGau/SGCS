...
{ 
   ///<summary>
     ///MG_Afip_Cae class   
     ///</summary>
    public partial class MG_Afip_Cae : SpeMG_Afip_Cae
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_Afip_Cae(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_Afip_Cae(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_Afip_Cae(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_Afip_Cae(SqlHelper SqlConfig, int UserId, SimpleMG_Afip_Cae Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
