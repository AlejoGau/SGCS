...
{ 
   ///<summary>
     ///mg_maestrocuentas class   
     ///</summary>
    public partial class mg_maestrocuentas : Spemg_maestrocuentas
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public mg_maestrocuentas(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public mg_maestrocuentas(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public mg_maestrocuentas(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public mg_maestrocuentas(SqlHelper SqlConfig, int UserId, Simplemg_maestrocuentas Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
