...
// Type: SoftGuard.BusinessObjects.SpeSerTecProductosOrden
...
{
  public abstract class SpeSerTecProductosOrden : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalSerTecProductosOrden _DalObject;
    ...
    public int spr_iServicio
    {
      get
      {
        return this._DalObject.spr_iServicio;
      }
      set
      {
        this._DalObject.spr_iServicio = value;
      }
    }
    ...
    public int spr_iVisita
    {
      get
      {
        return this._DalObject.spr_iVisita;
      }
      set
      {
        this._DalObject.spr_iVisita = value;
      }
    }
    ...
    public int spr_iProducto
    {
      get
      {
        return this._DalObject.spr_iProducto;
      }
      set
      {
        this._DalObject.spr_iProducto = value;
      }
    }
    ...
    public float spr_iCantidad
    {
      get
      {
        return this._DalObject.spr_iCantidad;
      }
      set
      {
        this._DalObject.spr_iCantidad = value;
      }
    }
    ...
    public SpeSerTecProductosOrden(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeSerTecProductosOrden(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeSerTecProductosOrden(SqlHelper SqlConfig, int UserId, SimpleSerTecProductosOrden Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleSerTecProductosOrden Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The SerTecProductosOrden has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalSerTecProductosOrden GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The SerTecProductosOrden is null.");
    ...
    {
      this._DalObject = new DalSerTecProductosOrden(SqlConfig, UserId);
    ...
    {
      SerTecProductosOrden tecProductosOrden = (SerTecProductosOrden) Object;
