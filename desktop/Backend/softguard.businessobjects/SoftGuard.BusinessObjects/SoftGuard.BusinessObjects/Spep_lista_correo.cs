...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_lista_correo : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_lista_correo _DalObject;
 ...
 ///<summary>
     ...
     public string  plc_name 
		 { 
                    ...
                    get{ return this._DalObject.plc_name; }
        						set{ this._DalObject.plc_name = value; } 										
	   }
	  ///<summary>
     ///plc_dealer property   
     ///</summary>	
     public string  plc_dealer 
		 { 
                    ...
                    get{ return this._DalObject.plc_dealer; }
        						set{ this._DalObject.plc_dealer = value; } 										
	   }
	  ///<summary>
     ...
     public string  plc_correos 
		 { 
                    ...
                    get{ return this._DalObject.plc_correos; }
        						set{ this._DalObject.plc_correos = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_lista_correo(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_lista_correo(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_lista_correo(SqlHelper SqlConfig, int UserId, Simplep_lista_correo Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_lista_correo Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_lista_correo has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_lista_correo GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_lista_correo is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_lista_correo(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_lista_correo)Object;
			o.Name = this.Name;

			o.plc_name = this.plc_name;

			o.plc_dealer = this.plc_dealer;

			o.plc_correos = this.plc_correos;
