...
{ 
   ///<summary>
     ///m_cuetnta_grupo_usuarios class   
     ///</summary>
    public partial class m_cuetnta_grupo_usuarios : Spem_cuetnta_grupo_usuarios
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuetnta_grupo_usuarios(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuetnta_grupo_usuarios(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuetnta_grupo_usuarios(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuetnta_grupo_usuarios(SqlHelper SqlConfig, int UserId, Simplem_cuetnta_grupo_usuarios Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
