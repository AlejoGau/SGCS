...
// Type: SoftGuard.BusinessObjects.Spem_printQueue
...
{
  public abstract class Spem_printQueue : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_printQueue _DalObject;
    ...
    public int prn_cbc_icodigo_id
    {
      get
      {
        return this._DalObject.prn_cbc_icodigo_id;
      }
      set
      {
        this._DalObject.prn_cbc_icodigo_id = value;
      }
    }
    ...
    public int prn_icopia
    {
      get
      {
        return this._DalObject.prn_icopia;
      }
      set
      {
        this._DalObject.prn_icopia = value;
      }
    }
    ...
    public string prn_cbc_ctipocbte
    {
      get
      {
        return this._DalObject.prn_cbc_ctipocbte;
      }
      set
      {
        this._DalObject.prn_cbc_ctipocbte = value;
      }
    }
    ...
    public int prn_cbc_inumerocbte
    {
      get
      {
        return this._DalObject.prn_cbc_inumerocbte;
      }
      set
      {
        this._DalObject.prn_cbc_inumerocbte = value;
      }
    }
    ...
    public string prn_cbc_cprefijocbte
    {
      get
      {
        return this._DalObject.prn_cbc_cprefijocbte;
      }
      set
      {
        this._DalObject.prn_cbc_cprefijocbte = value;
      }
    }
    ...
    public DateTime? prn_cbc_dfecha
    {
      get
      {
        return this._DalObject.prn_cbc_dfecha;
      }
      set
      {
        this._DalObject.prn_cbc_dfecha = value;
      }
    }
    ...
    public string prn_org_cnombre
    {
      get
      {
        return this._DalObject.prn_org_cnombre;
      }
      set
      {
        this._DalObject.prn_org_cnombre = value;
      }
    }
    ...
    public string prn_organizationName
    {
      get
      {
        return this._DalObject.prn_organizationName;
      }
      set
      {
        this._DalObject.prn_organizationName = value;
      }
    }
    ...
    public string prn_cli_cidentificacion
    {
      get
      {
        return this._DalObject.prn_cli_cidentificacion;
      }
      set
      {
        this._DalObject.prn_cli_cidentificacion = value;
      }
    }
    ...
    public int prn_iestado
    {
      get
      {
        return this._DalObject.prn_iestado;
      }
      set
      {
        this._DalObject.prn_iestado = value;
      }
    }
    ...
    public string prn_cfilename
    {
      get
      {
        return this._DalObject.prn_cfilename;
      }
      set
      {
        this._DalObject.prn_cfilename = value;
      }
    }
    ...
    public Spem_printQueue(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_printQueue(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_printQueue(SqlHelper SqlConfig, int UserId, Simplem_printQueue Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_printQueue Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_printQueue has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_printQueue GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_printQueue is null.");
    ...
    {
      this._DalObject = new Dalm_printQueue(SqlConfig, UserId);
    ...
    {
      m_printQueue mPrintQueue = (m_printQueue) Object;
      mPrintQueue.Name = this.Name;
      mPrintQueue.prn_cbc_icodigo_id = this.prn_cbc_icodigo_id;
      mPrintQueue.prn_icopia = this.prn_icopia;
      mPrintQueue.prn_cbc_ctipocbte = this.prn_cbc_ctipocbte;
      mPrintQueue.prn_cbc_inumerocbte = this.prn_cbc_inumerocbte;
      mPrintQueue.prn_cbc_cprefijocbte = this.prn_cbc_cprefijocbte;
      mPrintQueue.prn_cbc_dfecha = this.prn_cbc_dfecha;
      mPrintQueue.prn_org_cnombre = this.prn_org_cnombre;
      mPrintQueue.prn_organizationName = this.prn_organizationName;
      mPrintQueue.prn_cli_cidentificacion = this.prn_cli_cidentificacion;
      mPrintQueue.prn_iestado = this.prn_iestado;
      mPrintQueue.prn_cfilename = this.prn_cfilename;
    }
