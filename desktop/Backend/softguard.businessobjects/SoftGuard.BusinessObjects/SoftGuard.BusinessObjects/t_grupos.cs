...
// Type: SoftGuard.BusinessObjects.t_grupos
...
{
  public class t_grupos : Spet_grupos
  {
    public t_grupos(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_grupos(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_grupos(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_grupos(SqlHelper SqlConfig, int UserId, Simplet_grupos Simple)
