...
// Type: SoftGuard.BusinessObjects.Spet_eventos_feriados
...
{
  public abstract class Spet_eventos_feriados : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_eventos_feriados _DalObject;
    ...
    public string eve_ccodigo
    {
      get
      {
        return this._DalObject.eve_ccodigo;
      }
      set
      {
        this._DalObject.eve_ccodigo = value;
      }
    }
    ...
    public string eve_cdescripcion
    {
      get
      {
        return this._DalObject.eve_cdescripcion;
      }
      set
      {
        this._DalObject.eve_cdescripcion = value;
      }
    }
    ...
    public DateTime? eve_dfechadesdes
    {
      get
      {
        return this._DalObject.eve_dfechadesdes;
      }
      set
      {
        this._DalObject.eve_dfechadesdes = value;
      }
    }
    ...
    public string eve_choradesde
    {
      get
      {
        return this._DalObject.eve_choradesde;
      }
      set
      {
        this._DalObject.eve_choradesde = value;
      }
    }
    ...
    public DateTime? eve_dfechahasta
    {
      get
      {
        return this._DalObject.eve_dfechahasta;
      }
      set
      {
        this._DalObject.eve_dfechahasta = value;
      }
    }
    ...
    public string eve_chorahasta
    {
      get
      {
        return this._DalObject.eve_chorahasta;
      }
      set
      {
        this._DalObject.eve_chorahasta = value;
      }
    }
    ...
    public Spet_eventos_feriados(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_eventos_feriados(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_eventos_feriados(SqlHelper SqlConfig, int UserId, Simplet_eventos_feriados Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_eventos_feriados Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_eventos_feriados has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_eventos_feriados GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_eventos_feriados is null.");
    ...
    {
      this._DalObject = new Dalt_eventos_feriados(SqlConfig, UserId);
    ...
    {
      t_eventos_feriados tEventosFeriados = (t_eventos_feriados) Object;
      tEventosFeriados.Name = this.Name;
      tEventosFeriados.eve_ccodigo = this.eve_ccodigo;
      tEventosFeriados.eve_cdescripcion = this.eve_cdescripcion;
      tEventosFeriados.eve_dfechadesdes = this.eve_dfechadesdes;
      tEventosFeriados.eve_choradesde = this.eve_choradesde;
      tEventosFeriados.eve_dfechahasta = this.eve_dfechahasta;
      tEventosFeriados.eve_chorahasta = this.eve_chorahasta;
    }
