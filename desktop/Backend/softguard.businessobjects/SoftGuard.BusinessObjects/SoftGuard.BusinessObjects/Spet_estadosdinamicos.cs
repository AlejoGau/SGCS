...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_estadosdinamicos : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_estadosdinamicos _DalObject;
 ...
 ///<summary>
     ...
     public string  ted_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.ted_ccodigo; }
        						set{ this._DalObject.ted_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  ted_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.ted_cdescripcion; }
        						set{ this._DalObject.ted_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  ted_ceventos 
		 { 
                    ...
                    get{ return this._DalObject.ted_ceventos; }
        						set{ this._DalObject.ted_ceventos = value; } 										
	   }
	  ///<summary>
     ///ted_ivalor property   
     ///</summary>	
     public int  ted_ivalor 
		 { 
                    ...
                    get{ return this._DalObject.ted_ivalor; }
        						set{ this._DalObject.ted_ivalor = value; } 										
	   }
	  ///<summary>
     ...
     public int  ted_iporusuario 
		 { 
                    ...
                    get{ return this._DalObject.ted_iporusuario; }
        						set{ this._DalObject.ted_iporusuario = value; } 										
	   }
	  ///<summary>
     ...
     public int  ted_iactivo 
		 { 
                    ...
                    get{ return this._DalObject.ted_iactivo; }
        						set{ this._DalObject.ted_iactivo = value; } 										
	   }
	  ///<summary>
     ...
     public int  ted_ieditable 
		 { 
                    ...
                    get{ return this._DalObject.ted_ieditable; }
        						set{ this._DalObject.ted_ieditable = value; } 										
	   }
	  ///<summary>
     ///ted_idcta property   
     ///</summary>	
     public int  ted_idcta 
		 { 
                    ...
                    get{ return this._DalObject.ted_idcta; }
        						set{ this._DalObject.ted_idcta = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_estadosdinamicos(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_estadosdinamicos(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_estadosdinamicos(SqlHelper SqlConfig, int UserId, Simplet_estadosdinamicos Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_estadosdinamicos Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_estadosdinamicos has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_estadosdinamicos GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_estadosdinamicos is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_estadosdinamicos(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_estadosdinamicos)Object;
			o.Name = this.Name;

			o.ted_ccodigo = this.ted_ccodigo;

			o.ted_cdescripcion = this.ted_cdescripcion;

			o.ted_ceventos = this.ted_ceventos;

			o.ted_ivalor = this.ted_ivalor;

			o.ted_iporusuario = this.ted_iporusuario;

			o.ted_iactivo = this.ted_iactivo;

			o.ted_ieditable = this.ted_ieditable;

			o.ted_idcta = this.ted_idcta;
