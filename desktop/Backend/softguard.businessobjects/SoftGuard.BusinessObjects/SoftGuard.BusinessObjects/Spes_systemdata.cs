...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spes_systemdata : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dals_systemdata _DalObject;
 ...
 ///<summary>
     ...
     public DateTime?  sdt_fecha 
		 { 
                    ...
                    get{ return this._DalObject.sdt_fecha; }
        						set{ this._DalObject.sdt_fecha = value; } 										
	   }
	  ///<summary>
     ///sdt_code property   
     ///</summary>	
     public string  sdt_code 
		 { 
                    ...
                    get{ return this._DalObject.sdt_code; }
        						set{ this._DalObject.sdt_code = value; } 										
	   }
	  ///<summary>
     ///sdt_data property   
     ///</summary>	
     public string  sdt_data 
		 { 
                    ...
                    get{ return this._DalObject.sdt_data; }
        						set{ this._DalObject.sdt_data = value; } 										
	   }
	  ///<summary>
     ///sdt_log property   
     ///</summary>	
     public string  sdt_log 
		 { 
                    ...
                    get{ return this._DalObject.sdt_log; }
        						set{ this._DalObject.sdt_log = value; } 										
	   }
	  ///<summary>
     ///sdt_keyid property   
     ///</summary>	
     public string  sdt_keyid 
		 { 
                    ...
                    get{ return this._DalObject.sdt_keyid; }
        						set{ this._DalObject.sdt_keyid = value; } 										
	   }
	  ///<summary>
     ...
     public string  sdt_fingerprint 
		 { 
                    ...
                    get{ return this._DalObject.sdt_fingerprint; }
        						set{ this._DalObject.sdt_fingerprint = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spes_systemdata(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_systemdata(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spes_systemdata(SqlHelper SqlConfig, int UserId, Simples_systemdata Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simples_systemdata Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The s_systemdata has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dals_systemdata GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The s_systemdata is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dals_systemdata(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (s_systemdata)Object;
			o.Name = this.Name;

			o.sdt_fecha = this.sdt_fecha;

			o.sdt_code = this.sdt_code;

			o.sdt_data = this.sdt_data;

			o.sdt_log = this.sdt_log;

			o.sdt_keyid = this.sdt_keyid;

			o.sdt_fingerprint = this.sdt_fingerprint;
