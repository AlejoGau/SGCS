...
{ 
   ///<summary>
     ///SV_Routes class   
     ///</summary>
    public partial class SV_Routes : SpeSV_Routes
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public SV_Routes(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public SV_Routes(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SV_Routes(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SV_Routes(SqlHelper SqlConfig, int UserId, SimpleSV_Routes Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
