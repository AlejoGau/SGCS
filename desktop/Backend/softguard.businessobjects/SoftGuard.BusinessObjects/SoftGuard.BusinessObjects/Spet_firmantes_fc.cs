...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_firmantes_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_firmantes_fc _DalObject;
 ...
 ///<summary>
     ...
     public string  fir_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.fir_ccodigo; }
        						set{ this._DalObject.fir_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  fir_cnombre 
		 { 
                    ...
                    get{ return this._DalObject.fir_cnombre; }
        						set{ this._DalObject.fir_cnombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  fir_ccuenta 
		 { 
                    ...
                    get{ return this._DalObject.fir_ccuenta; }
        						set{ this._DalObject.fir_ccuenta = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  fir_nlimite 
		 { 
                    ...
                    get{ return this._DalObject.fir_nlimite; }
        						set{ this._DalObject.fir_nlimite = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  fir_nestado 
		 { 
                    ...
                    get{ return this._DalObject.fir_nestado; }
        						set{ this._DalObject.fir_nestado = value; } 										
	   }
	  ///<summary>
     ...
     public string  fir_mlegajo 
		 { 
                    ...
                    get{ return this._DalObject.fir_mlegajo; }
        						set{ this._DalObject.fir_mlegajo = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_firmantes_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_firmantes_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_firmantes_fc(SqlHelper SqlConfig, int UserId, Simplet_firmantes_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_firmantes_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_firmantes_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_firmantes_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_firmantes_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_firmantes_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_firmantes_fc)Object;
			o.Name = this.Name;

			o.fir_ccodigo = this.fir_ccodigo;

			o.fir_cnombre = this.fir_cnombre;

			o.fir_ccuenta = this.fir_ccuenta;

			o.fir_nlimite = this.fir_nlimite;

			o.fir_nestado = this.fir_nestado;

			o.fir_mlegajo = this.fir_mlegajo;
