...
// Type: SoftGuard.BusinessObjects.p_VirtualIR
...
{
  public class p_VirtualIR : Spep_VirtualIR
  {
    public p_VirtualIR(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public p_VirtualIR(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public p_VirtualIR(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public p_VirtualIR(SqlHelper SqlConfig, int UserId, Simplep_VirtualIR Simple)
