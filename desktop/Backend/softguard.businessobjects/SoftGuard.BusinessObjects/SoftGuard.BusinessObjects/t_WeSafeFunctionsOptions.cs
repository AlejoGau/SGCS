...
{ 
   ///<summary>
     ///t_WeSafeFunctionsOptions class   
     ///</summary>
    public partial class t_WeSafeFunctionsOptions : Spet_WeSafeFunctionsOptions
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_WeSafeFunctionsOptions(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_WeSafeFunctionsOptions(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_WeSafeFunctionsOptions(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_WeSafeFunctionsOptions(SqlHelper SqlConfig, int UserId, Simplet_WeSafeFunctionsOptions Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
