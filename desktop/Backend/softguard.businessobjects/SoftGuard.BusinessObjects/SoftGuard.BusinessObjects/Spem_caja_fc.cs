...
// Type: SoftGuard.BusinessObjects.Spem_caja_fc
...
{
  public abstract class Spem_caja_fc : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_caja_fc _DalObject;
    ...
    public DateTime? caj_dfecha
    {
      get
      {
        return this._DalObject.caj_dfecha;
      }
      set
      {
        this._DalObject.caj_dfecha = value;
      }
    }
    ...
    public Decimal caj_ytotal
    {
      get
      {
        return this._DalObject.caj_ytotal;
      }
      set
      {
        this._DalObject.caj_ytotal = value;
      }
    }
    ...
    public string caj_ctipomov
    {
      get
      {
        return this._DalObject.caj_ctipomov;
      }
      set
      {
        this._DalObject.caj_ctipomov = value;
      }
    }
    ...
    public string caj_cmotivo
    {
      get
      {
        return this._DalObject.caj_cmotivo;
      }
      set
      {
        this._DalObject.caj_cmotivo = value;
      }
    }
    ...
    public Spem_caja_fc(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_caja_fc(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_caja_fc(SqlHelper SqlConfig, int UserId, Simplem_caja_fc Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_caja_fc Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_caja_fc has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_caja_fc GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_caja_fc is null.");
    ...
    {
      this._DalObject = new Dalm_caja_fc(SqlConfig, UserId);
    ...
    {
      m_caja_fc mCajaFc = (m_caja_fc) Object;
      mCajaFc.Name = this.Name;
      mCajaFc.caj_dfecha = this.caj_dfecha;
      mCajaFc.caj_ytotal = this.caj_ytotal;
      mCajaFc.caj_ctipomov = this.caj_ctipomov;
      mCajaFc.caj_cmotivo = this.caj_cmotivo;
    }
