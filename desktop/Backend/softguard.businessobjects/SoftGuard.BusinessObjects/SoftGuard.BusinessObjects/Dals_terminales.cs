    ...
    {
     ///<summary>
     ///s_terminales data access layer   
     ///</summary>
    public class Dals_terminales : TransactionObject
    { 
    ...
    set{ this._AutoCommit = value; }
     ...
     ///Constructor   
     ///</summary>
    public Dals_terminales(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    {
    InitClass();
    SetConfig(SqlConfig);
    }
     ...
     ///Constructor   
     ///</summary>
    public Dals_terminales(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId)
    {
    InitClass();
    SetConfig(SqlConfig);
    Load(Id);
     ...
     ///Constructor   
     ///</summary>
    public Dals_terminales(SqlHelper SqlConfig, int UserId, Simples_terminales Simple) : base(SqlConfig, UserId)
    {
    InitClass();
    SetConfig(SqlConfig);
    base.Id = Simple.Id;
   ...
   ///<summary>
    ...
    using(var cmd = new SqlCommand("s_terminalesIns", conn))
    {
    // Insert
    ...
    // Update
    using(var conn = new SqlConnection(_ConnectionString))
    using(var cmd = new SqlCommand("s_terminalesUpd", conn))
    {
    cmd.CommandType = CommandType.StoredProcedure;
   ...
   ///<summary>
    ...
    if(base.Id == 0)
    {
    throw new RuntimeException("The s_terminales is null");
    }
    else
    {
    //delete
    ...
    // Delete
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDel = new SqlCommand("s_terminalesDel", conn))
    {
   ...
   ///<summary>
    ...
    // Select
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdSel = new SqlCommand("s_terminalesSel", conn))
    {
   ...
   ///<summary>
    ...
    {
    var Simple = (Simples_terminales)BaseSimple;
    base.Id = Simple.Id;
    base.Name = Simple.Name;
   ...
   ///<summary>
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdChilds = new SqlCommand("s_terminalesByChildObject", conn))
...
Simple.iprs_lastserviceupdate = (Row["iprs_lastserviceupdate"] == DBNull.Value) ? new DateTime(1,1,1) : (DateTime?) Row["iprs_lastserviceupdate"];
   ...
   ///<summary>
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdParents = new SqlCommand("s_terminalesByParentObject", conn))
...
if (Reader.FieldCount > 8)Simple.iprs_lastserviceupdate = (Reader.IsDBNull(8)) ? new DateTime(1,1,1) : Reader.GetDateTime(8);
   ...
   ///<summary>
    ...
    using (var conn = new SqlConnection(_ConnectionString))
    using (var CmdDataByName = new SqlCommand("s_terminalesByName", conn))
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDataByNameWithChild = new SqlCommand("s_terminalesByNameWithChild", conn))
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDataByNameWithParent = new SqlCommand("s_terminalesByNameWithParent", conn))
    ...
    DataTable Data = new DataTable("Object");
    using( var conn = new SqlConnection(_ConnectionString))
    using (var cmd = new SqlCommand("s_terminalesByFilter", conn))
    ...
    DataTable Data = new DataTable("Object");
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDataByText = new SqlCommand("s_terminalesByText", conn))
    ...
    return Data;
     ...
     ///</summary>
    public DataTable GetDataBySimpleObject(Simples_terminales Simple, TaxonomyCollection Taxonomies, int PageCount, int PagePresent, ref int PageTotal, ref int RowTotal)
    {
    base.Load();
    using(var conn = new SqlConnection(_ConnectionString))
    using(var cmd = new SqlCommand("s_terminalesBySimples_terminales", conn))
    using(var Adapter = new SqlDataAdapter(cmd))
    {
    cmd.CommandType = CommandType.StoredProcedure;
    cmd.Parameters.Add(new SqlParameter("@Name", SqlDbType.NVarChar));
   ...
   ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<Simples_terminales> GetByChild(string ObjectType, int ObjectId)
		{
			base.Load();
			
			using(var conn = new SqlConnection(_ConnectionString))
			using(var Cmd = new SqlCommand("s_terminalesByParentObject", conn))
			{
				conn.Open();
				Cmd.CommandType = CommandType.StoredProcedure;
...
if (Reader.FieldCount > 8)Simple.iprs_lastserviceupdate = (Reader.IsDBNull(8)) ? new DateTime(1,1,1) : Reader.GetDateTime(8);
   ...
   ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<Simples_terminales> GetByParent(string ObjectType, int ObjectId)
		{
			base.Load();
			using(var conn = new SqlConnection(_ConnectionString))
			using(var Cmd = new SqlCommand("s_terminalesByChildObject", conn))
			{
				conn.Open();
				Cmd.CommandType = CommandType.StoredProcedure;
				Cmd.Parameters.Add(new SqlParameter("@ObjectType", SqlDbType.NVarChar)).Value = ObjectType;
