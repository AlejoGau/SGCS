...
// Type: SoftGuard.BusinessObjects.SpeSerTecTecnicoVisitas
...
{
  public abstract class SpeSerTecTecnicoVisitas : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalSerTecTecnicoVisitas _DalObject;
    ...
    public int stv_iTecnico
    {
      get
      {
        return this._DalObject.stv_iTecnico;
      }
      set
      {
        this._DalObject.stv_iTecnico = value;
      }
    }
    ...
    public int stv_iVisita
    {
      get
      {
        return this._DalObject.stv_iVisita;
      }
      set
      {
        this._DalObject.stv_iVisita = value;
      }
    }
    ...
    public int stv_iFormaDeViaje
    {
      get
      {
        return this._DalObject.stv_iFormaDeViaje;
      }
      set
      {
        this._DalObject.stv_iFormaDeViaje = value;
      }
    }
    ...
    public SpeSerTecTecnicoVisitas(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeSerTecTecnicoVisitas(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeSerTecTecnicoVisitas(SqlHelper SqlConfig, int UserId, SimpleSerTecTecnicoVisitas Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleSerTecTecnicoVisitas Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The SerTecTecnicoVisitas has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalSerTecTecnicoVisitas GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The SerTecTecnicoVisitas is null.");
    ...
    {
      this._DalObject = new DalSerTecTecnicoVisitas(SqlConfig, UserId);
    ...
    {
      SerTecTecnicoVisitas tecTecnicoVisitas = (SerTecTecnicoVisitas) Object;
