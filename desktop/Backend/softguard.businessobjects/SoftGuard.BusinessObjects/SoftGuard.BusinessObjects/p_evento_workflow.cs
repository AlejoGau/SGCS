...
{ 
   ///<summary>
     ///p_evento_workflow class   
     ///</summary>
    public partial class p_evento_workflow : Spep_evento_workflow
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_evento_workflow(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_evento_workflow(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_evento_workflow(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_evento_workflow(SqlHelper SqlConfig, int UserId, Simplep_evento_workflow Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
