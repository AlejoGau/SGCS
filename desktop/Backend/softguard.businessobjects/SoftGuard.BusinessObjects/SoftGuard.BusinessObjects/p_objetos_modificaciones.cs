...
{ 
   ///<summary>
     ///p_objetos_modificaciones class   
     ///</summary>
    public partial class p_objetos_modificaciones : Spep_objetos_modificaciones
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_objetos_modificaciones(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_objetos_modificaciones(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_objetos_modificaciones(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_objetos_modificaciones(SqlHelper SqlConfig, int UserId, Simplep_objetos_modificaciones Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
