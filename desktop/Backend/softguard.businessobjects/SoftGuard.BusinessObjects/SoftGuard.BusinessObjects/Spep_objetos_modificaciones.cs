...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_objetos_modificaciones : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_objetos_modificaciones _DalObject;
 ...
 ///<summary>
     ...
     public int  pom_usuariopedido 
		 { 
                    ...
                    get{ return this._DalObject.pom_usuariopedido; }
        						set{ this._DalObject.pom_usuariopedido = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  pom_fechapedido 
		 { 
                    ...
                    get{ return this._DalObject.pom_fechapedido; }
        						set{ this._DalObject.pom_fechapedido = value; } 										
	   }
	  ///<summary>
     ...
     public int  pom_idtipoobjeto 
		 { 
                    ...
                    get{ return this._DalObject.pom_idtipoobjeto; }
        						set{ this._DalObject.pom_idtipoobjeto = value; } 										
	   }
	  ///<summary>
     ...
     public int  pom_idobjeto 
		 { 
                    ...
                    get{ return this._DalObject.pom_idobjeto; }
        						set{ this._DalObject.pom_idobjeto = value; } 										
	   }
	  ///<summary>
     ///pom_cueiid property   
     ///</summary>	
     public int  pom_cueiid 
		 { 
                    ...
                    get{ return this._DalObject.pom_cueiid; }
        						set{ this._DalObject.pom_cueiid = value; } 										
	   }
	  ///<summary>
     ...
     public string  pom_sinmodificar 
		 { 
                    ...
                    get{ return this._DalObject.pom_sinmodificar; }
        						set{ this._DalObject.pom_sinmodificar = value; } 										
	   }
	  ///<summary>
     ...
     public string  pom_modificado 
		 { 
                    ...
                    get{ return this._DalObject.pom_modificado; }
        						set{ this._DalObject.pom_modificado = value; } 										
	   }
	  ///<summary>
     ...
     public string  pom_metadata 
		 { 
                    ...
                    get{ return this._DalObject.pom_metadata; }
        						set{ this._DalObject.pom_metadata = value; } 										
	   }
	  ///<summary>
     ///pom_estado property   
     ///</summary>	
     public int  pom_estado 
		 { 
                    ...
                    get{ return this._DalObject.pom_estado; }
        						set{ this._DalObject.pom_estado = value; } 										
	   }
	  ///<summary>
     ///pom_log property   
     ///</summary>	
     public string  pom_log 
		 { 
                    ...
                    get{ return this._DalObject.pom_log; }
        						set{ this._DalObject.pom_log = value; } 										
	   }
	  ///<summary>
     ...
     public int  pom_usuarioultcambio 
		 { 
                    ...
                    get{ return this._DalObject.pom_usuarioultcambio; }
        						set{ this._DalObject.pom_usuarioultcambio = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  pom_fechaultcambio 
		 { 
                    ...
                    get{ return this._DalObject.pom_fechaultcambio; }
        						set{ this._DalObject.pom_fechaultcambio = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_objetos_modificaciones(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_objetos_modificaciones(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_objetos_modificaciones(SqlHelper SqlConfig, int UserId, Simplep_objetos_modificaciones Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_objetos_modificaciones Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_objetos_modificaciones has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_objetos_modificaciones GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_objetos_modificaciones is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_objetos_modificaciones(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_objetos_modificaciones)Object;
			o.Name = this.Name;

			o.pom_usuariopedido = this.pom_usuariopedido;

			o.pom_fechapedido = this.pom_fechapedido;

			o.pom_idtipoobjeto = this.pom_idtipoobjeto;

			o.pom_idobjeto = this.pom_idobjeto;

			o.pom_cueiid = this.pom_cueiid;

			o.pom_sinmodificar = this.pom_sinmodificar;

			o.pom_modificado = this.pom_modificado;

			o.pom_metadata = this.pom_metadata;

			o.pom_estado = this.pom_estado;

			o.pom_log = this.pom_log;

			o.pom_usuarioultcambio = this.pom_usuarioultcambio;

			o.pom_fechaultcambio = this.pom_fechaultcambio;
