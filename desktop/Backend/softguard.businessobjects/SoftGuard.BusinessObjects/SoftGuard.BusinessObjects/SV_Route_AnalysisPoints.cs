...
{ 
   ///<summary>
     ///SV_Route_AnalysisPoints class   
     ///</summary>
    public partial class SV_Route_AnalysisPoints : SpeSV_Route_AnalysisPoints
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public SV_Route_AnalysisPoints(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public SV_Route_AnalysisPoints(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SV_Route_AnalysisPoints(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SV_Route_AnalysisPoints(SqlHelper SqlConfig, int UserId, SimpleSV_Route_AnalysisPoints Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
