...
{ 
   ///<summary>
     ///T_SimCard_APN class   
     ///</summary>
    public partial class T_SimCard_APN : SpeT_SimCard_APN
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public T_SimCard_APN(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public T_SimCard_APN(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_SimCard_APN(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_SimCard_APN(SqlHelper SqlConfig, int UserId, SimpleT_SimCard_APN Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
