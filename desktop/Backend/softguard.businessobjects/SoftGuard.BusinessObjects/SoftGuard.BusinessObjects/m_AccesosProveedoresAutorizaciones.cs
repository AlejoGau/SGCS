...
{ 
   ///<summary>
     ///m_AccesosProveedoresAutorizaciones class   
     ///</summary>
    public partial class m_AccesosProveedoresAutorizaciones : Spem_AccesosProveedoresAutorizaciones
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_AccesosProveedoresAutorizaciones(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_AccesosProveedoresAutorizaciones(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_AccesosProveedoresAutorizaciones(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_AccesosProveedoresAutorizaciones(SqlHelper SqlConfig, int UserId, Simplem_AccesosProveedoresAutorizaciones Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
