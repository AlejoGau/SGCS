...
{ 
   ///<summary>
     ///m_dealer_tgconfig class   
     ///</summary>
    public partial class m_dealer_tgconfig : Spem_dealer_tgconfig
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_dealer_tgconfig(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_dealer_tgconfig(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_dealer_tgconfig(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_dealer_tgconfig(SqlHelper SqlConfig, int UserId, Simplem_dealer_tgconfig Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
