...
// Type: SoftGuard.BusinessObjects.SpeZonaTemp
...
{
  public abstract class SpeZonaTemp : ISpecialization
  {
    private bool _AutoCommit = false;
    protected DalZonaTemp _DalObject;
    ...
    public long zon_idregistro
    {
      get
      {
        return this._DalObject.zon_idregistro;
      }
      set
      {
        this._DalObject.zon_idregistro = value;
      }
    }
    ...
    public int zon_usuario
    {
      get
      {
        return this._DalObject.zon_usuario;
      }
      set
      {
        this._DalObject.zon_usuario = value;
      }
    }
    ...
    public string zon_tipo
    {
      get
      {
        return this._DalObject.zon_tipo;
      }
      set
      {
        this._DalObject.zon_tipo = value;
      }
    }
    ...
    public SpeZonaTemp(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeZonaTemp(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeZonaTemp(SqlHelper SqlConfig, int UserId, SimpleZonaTemp Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleZonaTemp Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The ZonaTemp has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalZonaTemp GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The ZonaTemp is null.");
    ...
    {
      this._DalObject = new DalZonaTemp(SqlConfig, UserId);
