...
{ 
   ///<summary>
     ///UsersDesktopWeb class   
     ///</summary>
    public partial class UsersDesktopWeb : SpeUsersDesktopWeb
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public UsersDesktopWeb(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public UsersDesktopWeb(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public UsersDesktopWeb(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public UsersDesktopWeb(SqlHelper SqlConfig, int UserId, SimpleUsersDesktopWeb Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
