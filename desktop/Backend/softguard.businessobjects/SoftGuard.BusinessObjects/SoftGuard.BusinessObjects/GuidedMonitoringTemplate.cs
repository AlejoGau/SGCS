...
{ 
   ///<summary>
     ///GuidedMonitoringTemplate class   
     ///</summary>
    public partial class GuidedMonitoringTemplate : SpeGuidedMonitoringTemplate
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public GuidedMonitoringTemplate(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public GuidedMonitoringTemplate(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public GuidedMonitoringTemplate(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public GuidedMonitoringTemplate(SqlHelper SqlConfig, int UserId, SimpleGuidedMonitoringTemplate Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
