...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_encuesta : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_encuesta _DalObject;
 ...
 ///<summary>
     ...
     public string  enc_name 
		 { 
                    ...
                    get{ return this._DalObject.enc_name; }
        						set{ this._DalObject.enc_name = value; } 										
	   }
	  ///<summary>
     ...
     public string  enc_descripcion 
		 { 
                    ...
                    get{ return this._DalObject.enc_descripcion; }
        						set{ this._DalObject.enc_descripcion = value; } 										
	   }
	  ///<summary>
     ///enc_status property   
     ///</summary>	
     public int  enc_status 
		 { 
                    ...
                    get{ return this._DalObject.enc_status; }
        						set{ this._DalObject.enc_status = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_encuesta(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_encuesta(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_encuesta(SqlHelper SqlConfig, int UserId, Simplep_encuesta Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_encuesta Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_encuesta has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_encuesta GetDalObject()
		{
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<Simplep_encuesta> GetByParent(string ObjectType, int ObjectId)
		{
			return this._DalObject.GetByParent(ObjectType, ObjectId);
		}
		public IEnumerable<Simplep_encuesta> GetByChild(string ObjectType, int ObjectId)
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_encuesta is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_encuesta(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_encuesta)Object;
			o.Name = this.Name;

			o.enc_name = this.enc_name;

			o.enc_descripcion = this.enc_descripcion;

			o.enc_status = this.enc_status;
