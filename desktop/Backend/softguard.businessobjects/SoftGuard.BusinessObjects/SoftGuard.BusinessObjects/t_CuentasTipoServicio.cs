...
{ 
   ///<summary>
     ///t_CuentasTipoServicio class   
     ///</summary>
    public partial class t_CuentasTipoServicio : Spet_CuentasTipoServicio
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_CuentasTipoServicio(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_CuentasTipoServicio(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_CuentasTipoServicio(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_CuentasTipoServicio(SqlHelper SqlConfig, int UserId, Simplet_CuentasTipoServicio Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
