...
// Type: SoftGuard.BusinessObjects.SpePersonLineRange
...
{
  public abstract class SpePersonLineRange : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalPersonLineRange _DalObject;
    ...
    public string Code
    {
      get
      {
        return this._DalObject.Code;
      }
      set
      {
        this._DalObject.Code = value;
      }
    }
    ...
    public int RangeStart
    {
      get
      {
        return this._DalObject.RangeStart;
      }
      set
      {
        this._DalObject.RangeStart = value;
      }
    }
    ...
    public int RangeEnd
    {
      get
      {
        return this._DalObject.RangeEnd;
      }
      set
      {
        this._DalObject.RangeEnd = value;
      }
    }
    ...
    public int PersonId
    {
      get
      {
        return this._DalObject.PersonId;
      }
      set
      {
        this._DalObject.PersonId = value;
      }
    }
    ...
    public SpePersonLineRange(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpePersonLineRange(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpePersonLineRange(SqlHelper SqlConfig, int UserId, SimplePersonLineRange Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimplePersonLineRange Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The PersonLineRange has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalPersonLineRange GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The PersonLineRange is null.");
    ...
    {
      this._DalObject = new DalPersonLineRange(SqlConfig, UserId);
    ...
    {
      PersonLineRange personLineRange = (PersonLineRange) Object;
      personLineRange.Name = this.Name;
      personLineRange.Code = this.Code;
      personLineRange.RangeStart = this.RangeStart;
      personLineRange.RangeEnd = this.RangeEnd;
      personLineRange.PersonId = this.PersonId;
    }
