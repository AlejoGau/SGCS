...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_CodigosEnFalla : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_CodigosEnFalla _DalObject;
 ...
 ///<summary>
     ...
     public string  cef_cEventosFalla 
		 { 
                    ...
                    get{ return this._DalObject.cef_cEventosFalla; }
        						set{ this._DalObject.cef_cEventosFalla = value; } 										
	   }
	  ///<summary>
     ...
     public string  cef_cEventosRest 
		 { 
                    ...
                    get{ return this._DalObject.cef_cEventosRest; }
        						set{ this._DalObject.cef_cEventosRest = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_CodigosEnFalla(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_CodigosEnFalla(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_CodigosEnFalla(SqlHelper SqlConfig, int UserId, Simplet_CodigosEnFalla Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_CodigosEnFalla Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_CodigosEnFalla has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_CodigosEnFalla GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_CodigosEnFalla is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_CodigosEnFalla(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_CodigosEnFalla)Object;
			o.Name = this.Name;

			o.cef_cEventosFalla = this.cef_cEventosFalla;

			o.cef_cEventosRest = this.cef_cEventosRest;
