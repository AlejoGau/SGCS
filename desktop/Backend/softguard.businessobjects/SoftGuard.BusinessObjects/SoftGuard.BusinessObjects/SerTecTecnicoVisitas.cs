...
// Type: SoftGuard.BusinessObjects.SerTecTecnicoVisitas
...
{
  public class SerTecTecnicoVisitas : SpeSerTecTecnicoVisitas
  {
    public SerTecTecnicoVisitas(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public SerTecTecnicoVisitas(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public SerTecTecnicoVisitas(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public SerTecTecnicoVisitas(SqlHelper SqlConfig, int UserId, SimpleSerTecTecnicoVisitas Simple)
