...
{ 	
  ///<summary>
    ...
    { 
     ...
     ///</summary>
	 [DataMember]
     public string dvc_apptype { get;set;} 
	 ///<summary>
  ...
  InitClass();
        ...
        ///m_dealer_vcconfig Constructor
        ///</summary>
        public Simplem_dealer_vcconfig(int Id, string Name, string dvc_cdealer, string dvc_config, string dvc_apptype) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
				    this.dvc_cdealer = dvc_cdealer;
this.dvc_config = dvc_config;
this.dvc_apptype = dvc_apptype;
...
Caller.dvc_apptype = this.dvc_apptype;
...
dr["dvc_apptype"] = (object)this.dvc_apptype ?? System.DBNull.Value;
