...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_FormulariosST : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_FormulariosST _DalObject;
 ...
 ///<summary>
     ...
     public string  fst_cNombre 
		 { 
                    ...
                    get{ return this._DalObject.fst_cNombre; }
        						set{ this._DalObject.fst_cNombre = value; } 										
	   }
	  ///<summary>
     ...
     public int  fst_iStatus 
		 { 
                    ...
                    get{ return this._DalObject.fst_iStatus; }
        						set{ this._DalObject.fst_iStatus = value; } 										
	   }
	  ///<summary>
     ///fst_iTipo property   
     ///</summary>	
     public int  fst_iTipo 
		 { 
                    ...
                    get{ return this._DalObject.fst_iTipo; }
        						set{ this._DalObject.fst_iTipo = value; } 										
	   }
	  ///<summary>
     ...
     public string  fst_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.fst_cDealer; }
        						set{ this._DalObject.fst_cDealer = value; } 										
	   }
	  ///<summary>
     ...
     public string  fst_cArchivo 
		 { 
                    ...
                    get{ return this._DalObject.fst_cArchivo; }
        						set{ this._DalObject.fst_cArchivo = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_FormulariosST(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_FormulariosST(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_FormulariosST(SqlHelper SqlConfig, int UserId, Simplet_FormulariosST Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_FormulariosST Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_FormulariosST has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_FormulariosST GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_FormulariosST is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_FormulariosST(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_FormulariosST)Object;
			o.Name = this.Name;

			o.fst_cNombre = this.fst_cNombre;

			o.fst_iStatus = this.fst_iStatus;

			o.fst_iTipo = this.fst_iTipo;

			o.fst_cDealer = this.fst_cDealer;

			o.fst_cArchivo = this.fst_cArchivo;
