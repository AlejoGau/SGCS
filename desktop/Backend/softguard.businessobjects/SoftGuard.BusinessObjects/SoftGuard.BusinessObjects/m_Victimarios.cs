...
{ 
   ///<summary>
     ///m_Victimarios class   
     ///</summary>
    public partial class m_Victimarios : Spem_Victimarios
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_Victimarios(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_Victimarios(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_Victimarios(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_Victimarios(SqlHelper SqlConfig, int UserId, Simplem_Victimarios Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
