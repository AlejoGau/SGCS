...
// Type: SoftGuard.BusinessObjects.Spep_posicionesSP
...
{
  public abstract class Spep_posicionesSP : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalp_posicionesSP _DalObject;
    ...
    public DateTime? sp_tfechahora
    {
      get
      {
        return this._DalObject.sp_tfechahora;
      }
      set
      {
        this._DalObject.sp_tfechahora = value;
      }
    }
    ...
    public string sp_cIMEI
    {
      get
      {
        return this._DalObject.sp_cIMEI;
      }
      set
      {
        this._DalObject.sp_cIMEI = value;
      }
    }
    ...
    public float sp_rLatitud
    {
      get
      {
        return this._DalObject.sp_rLatitud;
      }
      set
      {
        this._DalObject.sp_rLatitud = value;
      }
    }
    ...
    public float sp_rLongitud
    {
      get
      {
        return this._DalObject.sp_rLongitud;
      }
      set
      {
        this._DalObject.sp_rLongitud = value;
      }
    }
    ...
    public float sp_rAccuracy
    {
      get
      {
        return this._DalObject.sp_rAccuracy;
      }
      set
      {
        this._DalObject.sp_rAccuracy = value;
      }
    }
    ...
    public int sp_iVelocidad
    {
      get
      {
        return this._DalObject.sp_iVelocidad;
      }
      set
      {
        this._DalObject.sp_iVelocidad = value;
      }
    }
    ...
    public int sp_iRumbo
    {
      get
      {
        return this._DalObject.sp_iRumbo;
      }
      set
      {
        this._DalObject.sp_iRumbo = value;
      }
    }
    ...
    public int sp_iOdometro
    {
      get
      {
        return this._DalObject.sp_iOdometro;
      }
      set
      {
        this._DalObject.sp_iOdometro = value;
      }
    }
    ...
    public int sp_iBatt
    {
      get
      {
        return this._DalObject.sp_iBatt;
      }
      set
      {
        this._DalObject.sp_iBatt = value;
      }
    }
    ...
    public int sp_iSecuencia
    {
      get
      {
        return this._DalObject.sp_iSecuencia;
      }
      set
      {
        this._DalObject.sp_iSecuencia = value;
      }
    }
    ...
    public int sp_reciid
    {
      get
      {
        return this._DalObject.sp_reciid;
      }
      set
      {
        this._DalObject.sp_reciid = value;
      }
    }
    ...
    public Spep_posicionesSP(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spep_posicionesSP(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spep_posicionesSP(SqlHelper SqlConfig, int UserId, Simplep_posicionesSP Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplep_posicionesSP Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The p_posicionesSP has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalp_posicionesSP GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The p_posicionesSP is null.");
    ...
    {
      this._DalObject = new Dalp_posicionesSP(SqlConfig, UserId);
    ...
    {
      p_posicionesSP pPosicionesSp = (p_posicionesSP) Object;
      pPosicionesSp.Name = this.Name;
      pPosicionesSp.sp_tfechahora = this.sp_tfechahora;
      pPosicionesSp.sp_cIMEI = this.sp_cIMEI;
      pPosicionesSp.sp_rLatitud = this.sp_rLatitud;
      pPosicionesSp.sp_rLongitud = this.sp_rLongitud;
      pPosicionesSp.sp_rAccuracy = this.sp_rAccuracy;
      pPosicionesSp.sp_iVelocidad = this.sp_iVelocidad;
      pPosicionesSp.sp_iRumbo = this.sp_iRumbo;
      pPosicionesSp.sp_iOdometro = this.sp_iOdometro;
      pPosicionesSp.sp_iBatt = this.sp_iBatt;
      pPosicionesSp.sp_iSecuencia = this.sp_iSecuencia;
      pPosicionesSp.sp_reciid = this.sp_reciid;
    }
