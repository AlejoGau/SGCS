...
// Type: SoftGuard.BusinessObjects.Scheduler
...
{
  public class Scheduler : SpeScheduler
  {
    public Scheduler(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public Scheduler(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public Scheduler(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public Scheduler(SqlHelper SqlConfig, int UserId, SimpleScheduler Simple)
