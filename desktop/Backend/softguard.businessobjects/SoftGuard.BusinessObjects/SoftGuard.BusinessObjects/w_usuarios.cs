...
// Type: SoftGuard.BusinessObjects.w_usuarios
...
{
  public class w_usuarios : Spew_usuarios
  {
    public w_usuarios(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public w_usuarios(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public w_usuarios(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public w_usuarios(SqlHelper SqlConfig, int UserId, Simplew_usuarios Simple)
