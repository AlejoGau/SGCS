...
{ 
   ///<summary>
     ///MG_Afip_Cae_Ws class   
     ///</summary>
    public partial class MG_Afip_Cae_Ws : SpeMG_Afip_Cae_Ws
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_Afip_Cae_Ws(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_Afip_Cae_Ws(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_Afip_Cae_Ws(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_Afip_Cae_Ws(SqlHelper SqlConfig, int UserId, SimpleMG_Afip_Cae_Ws Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
