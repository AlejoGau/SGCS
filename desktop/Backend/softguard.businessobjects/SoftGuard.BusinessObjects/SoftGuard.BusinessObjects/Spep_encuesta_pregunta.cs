...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_encuesta_pregunta : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_encuesta_pregunta _DalObject;
 ...
 ///<summary>
     ...
     public int  epg_encidkey 
		 { 
                    ...
                    get{ return this._DalObject.epg_encidkey; }
        						set{ this._DalObject.epg_encidkey = value; } 										
	   }
	  ///<summary>
     ///epg_name property   
     ///</summary>	
     public string  epg_name 
		 { 
                    ...
                    get{ return this._DalObject.epg_name; }
        						set{ this._DalObject.epg_name = value; } 										
	   }
	  ///<summary>
     ...
     public string  epg_descripcion 
		 { 
                    ...
                    get{ return this._DalObject.epg_descripcion; }
        						set{ this._DalObject.epg_descripcion = value; } 										
	   }
	  ///<summary>
     ///epg_tipo property   
     ///</summary>	
     public int  epg_tipo 
		 { 
                    ...
                    get{ return this._DalObject.epg_tipo; }
        						set{ this._DalObject.epg_tipo = value; } 										
	   }
	  ///<summary>
     ///epg_status property   
     ///</summary>	
     public int  epg_status 
		 { 
                    ...
                    get{ return this._DalObject.epg_status; }
        						set{ this._DalObject.epg_status = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_encuesta_pregunta(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_encuesta_pregunta(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_encuesta_pregunta(SqlHelper SqlConfig, int UserId, Simplep_encuesta_pregunta Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_encuesta_pregunta Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_encuesta_pregunta has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_encuesta_pregunta GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_encuesta_pregunta is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_encuesta_pregunta(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_encuesta_pregunta)Object;
			o.Name = this.Name;

			o.epg_encidkey = this.epg_encidkey;

			o.epg_name = this.epg_name;

			o.epg_descripcion = this.epg_descripcion;

			o.epg_tipo = this.epg_tipo;

			o.epg_status = this.epg_status;
