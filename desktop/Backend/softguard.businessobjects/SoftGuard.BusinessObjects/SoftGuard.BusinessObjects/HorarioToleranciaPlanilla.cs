...
// Type: SoftGuard.BusinessObjects.HorarioToleranciaPlanilla
...
{
  public class HorarioToleranciaPlanilla : SpeHorarioToleranciaPlanilla
  {
    public HorarioToleranciaPlanilla(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public HorarioToleranciaPlanilla(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public HorarioToleranciaPlanilla(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public HorarioToleranciaPlanilla(SqlHelper SqlConfig, int UserId, SimpleHorarioToleranciaPlanilla Simple)
