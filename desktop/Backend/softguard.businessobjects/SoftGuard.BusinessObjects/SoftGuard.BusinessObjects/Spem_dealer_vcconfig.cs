...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_dealer_vcconfig : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_dealer_vcconfig _DalObject;
 ...
 ///<summary>
     ...
     public string  dvc_cdealer 
		 { 
                    ...
                    get{ return this._DalObject.dvc_cdealer; }
        						set{ this._DalObject.dvc_cdealer = value; } 										
	   }
	  ///<summary>
     ///dvc_config property   
     ///</summary>	
     public string  dvc_config 
		 { 
                    ...
                    get{ return this._DalObject.dvc_config; }
        						set{ this._DalObject.dvc_config = value; } 										
	   }
	  ///<summary>
     ...
     public string  dvc_apptype 
		 { 
                    ...
                    get{ return this._DalObject.dvc_apptype; }
        						set{ this._DalObject.dvc_apptype = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_dealer_vcconfig(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_dealer_vcconfig(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_dealer_vcconfig(SqlHelper SqlConfig, int UserId, Simplem_dealer_vcconfig Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_dealer_vcconfig Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_dealer_vcconfig has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_dealer_vcconfig GetDalObject()
		{
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<Simplem_dealer_vcconfig> GetByParent(string ObjectType, int ObjectId)
		{
			return this._DalObject.GetByParent(ObjectType, ObjectId);
		}
		public IEnumerable<Simplem_dealer_vcconfig> GetByChild(string ObjectType, int ObjectId)
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_dealer_vcconfig is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_dealer_vcconfig(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_dealer_vcconfig)Object;
			o.Name = this.Name;

			o.dvc_cdealer = this.dvc_cdealer;

			o.dvc_config = this.dvc_config;

			o.dvc_apptype = this.dvc_apptype;
