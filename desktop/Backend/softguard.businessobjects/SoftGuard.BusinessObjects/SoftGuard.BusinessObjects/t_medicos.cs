...
// Type: SoftGuard.BusinessObjects.t_medicos
...
{
  public class t_medicos : Spet_medicos
  {
    public t_medicos(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_medicos(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_medicos(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_medicos(SqlHelper SqlConfig, int UserId, Simplet_medicos Simple)
