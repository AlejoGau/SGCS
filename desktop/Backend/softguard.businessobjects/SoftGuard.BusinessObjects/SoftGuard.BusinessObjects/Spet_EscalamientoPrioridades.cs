...
// Type: SoftGuard.BusinessObjects.Spet_EscalamientoPrioridades
...
{
  public abstract class Spet_EscalamientoPrioridades : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_EscalamientoPrioridades _DalObject;
    ...
    public int tep_itiempo
    {
      get
      {
        return this._DalObject.tep_itiempo;
      }
      set
      {
        this._DalObject.tep_itiempo = value;
      }
    }
    ...
    public Decimal tep_ncontrola
    {
      get
      {
        return this._DalObject.tep_ncontrola;
      }
      set
      {
        this._DalObject.tep_ncontrola = value;
      }
    }
    ...
    public Spet_EscalamientoPrioridades(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_EscalamientoPrioridades(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_EscalamientoPrioridades(SqlHelper SqlConfig, int UserId, Simplet_EscalamientoPrioridades Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_EscalamientoPrioridades Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_EscalamientoPrioridades has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_EscalamientoPrioridades GetDalObject()
    {
    ...
    public IEnumerable<Simplet_EscalamientoPrioridades> GetByParent(string ObjectType, int ObjectId)
    {
      return this._DalObject.GetByParent(ObjectType, ObjectId);
    }

    public IEnumerable<Simplet_EscalamientoPrioridades> GetByChild(string ObjectType, int ObjectId)
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_EscalamientoPrioridades is null.");
    ...
    {
      this._DalObject = new Dalt_EscalamientoPrioridades(SqlConfig, UserId);
    ...
    {
      t_EscalamientoPrioridades escalamientoPrioridades = (t_EscalamientoPrioridades) Object;
