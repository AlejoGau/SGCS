...
{ 
   ///<summary>
     ///m_dealer_vcconfig class   
     ///</summary>
    public partial class m_dealer_vcconfig : Spem_dealer_vcconfig
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_dealer_vcconfig(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_dealer_vcconfig(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_dealer_vcconfig(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_dealer_vcconfig(SqlHelper SqlConfig, int UserId, Simplem_dealer_vcconfig Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
