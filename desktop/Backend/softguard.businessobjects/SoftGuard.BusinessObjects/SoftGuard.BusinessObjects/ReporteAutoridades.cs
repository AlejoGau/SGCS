...
{ 
   ///<summary>
     ///ReporteAutoridades class   
     ///</summary>
    public partial class ReporteAutoridades : SpeReporteAutoridades
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public ReporteAutoridades(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public ReporteAutoridades(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public ReporteAutoridades(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public ReporteAutoridades(SqlHelper SqlConfig, int UserId, SimpleReporteAutoridades Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
