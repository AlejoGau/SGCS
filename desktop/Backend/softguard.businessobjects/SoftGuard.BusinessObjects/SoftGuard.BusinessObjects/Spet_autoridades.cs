...
// Type: SoftGuard.BusinessObjects.Spet_autoridades
...
{
  public abstract class Spet_autoridades : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_autoridades _DalObject;
    ...
    public string aut_cnombre
    {
      get
      {
        return this._DalObject.aut_cnombre;
      }
      set
      {
        this._DalObject.aut_cnombre = value;
      }
    }
    ...
    public string aut_meventos
    {
      get
      {
        return this._DalObject.aut_meventos;
      }
      set
      {
        this._DalObject.aut_meventos = value;
      }
    }
    ...
    public string aut_cdealer
    {
      get
      {
        return this._DalObject.aut_cdealer;
      }
      set
      {
        this._DalObject.aut_cdealer = value;
      }
    }
    ...
    public string aut_meventosauto
    {
      get
      {
        return this._DalObject.aut_meventosauto;
      }
      set
      {
        this._DalObject.aut_meventosauto = value;
      }
    }
    ...
    public string aut_cprovincia
    {
      get
      {
        return this._DalObject.aut_cprovincia;
      }
      set
      {
        this._DalObject.aut_cprovincia = value;
      }
    }
    ...
    public string aut_cautoprocesados
    {
      get
      {
        return this._DalObject.aut_cautoprocesados;
      }
      set
      {
        this._DalObject.aut_cautoprocesados = value;
      }
    }
    ...
    public int aut_idestino
    {
      get
      {
        return this._DalObject.aut_idestino;
      }
      set
      {
        this._DalObject.aut_idestino = value;
      }
    }
    ...
    public Spet_autoridades(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_autoridades(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_autoridades(SqlHelper SqlConfig, int UserId, Simplet_autoridades Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_autoridades Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_autoridades has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_autoridades GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_autoridades is null.");
    ...
    {
      this._DalObject = new Dalt_autoridades(SqlConfig, UserId);
    ...
    {
      t_autoridades tAutoridades = (t_autoridades) Object;
      tAutoridades.Name = this.Name;
      tAutoridades.aut_cnombre = this.aut_cnombre;
      tAutoridades.aut_meventos = this.aut_meventos;
      tAutoridades.aut_cdealer = this.aut_cdealer;
      tAutoridades.aut_meventosauto = this.aut_meventosauto;
      tAutoridades.aut_cprovincia = this.aut_cprovincia;
      tAutoridades.aut_cautoprocesados = this.aut_cautoprocesados;
      tAutoridades.aut_idestino = this.aut_idestino;
    }
