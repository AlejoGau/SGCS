...
// Type: SoftGuard.BusinessObjects.m_telefonos_jurisdiccionales
...
{
  public class m_telefonos_jurisdiccionales : Spem_telefonos_jurisdiccionales
  {
    public m_telefonos_jurisdiccionales(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_telefonos_jurisdiccionales(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_telefonos_jurisdiccionales(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_telefonos_jurisdiccionales(SqlHelper SqlConfig, int UserId, Simplem_telefonos_jurisdiccionales Simple)
