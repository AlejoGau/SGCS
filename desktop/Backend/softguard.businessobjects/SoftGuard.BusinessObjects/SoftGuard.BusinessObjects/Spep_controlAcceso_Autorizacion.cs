...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_controlAcceso_Autorizacion : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_controlAcceso_Autorizacion _DalObject;
 ...
 ///<summary>
     ...
     public int  caa_idautorizado 
		 { 
                    ...
                    get{ return this._DalObject.caa_idautorizado; }
        						set{ this._DalObject.caa_idautorizado = value; } 										
	   }
	  ///<summary>
     ///caa_tipo property   
     ///</summary>	
     public int  caa_tipo 
		 { 
                    ...
                    get{ return this._DalObject.caa_tipo; }
        						set{ this._DalObject.caa_tipo = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  caa_fechadesde 
		 { 
                    ...
                    get{ return this._DalObject.caa_fechadesde; }
        						set{ this._DalObject.caa_fechadesde = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  caa_fechahasta 
		 { 
                    ...
                    get{ return this._DalObject.caa_fechahasta; }
        						set{ this._DalObject.caa_fechahasta = value; } 										
	   }
	  ///<summary>
     ...
     public int  caa_diasemana 
		 { 
                    ...
                    get{ return this._DalObject.caa_diasemana; }
        						set{ this._DalObject.caa_diasemana = value; } 										
	   }
	  ///<summary>
     ...
     public string  caa_horadesde 
		 { 
                    ...
                    get{ return this._DalObject.caa_horadesde; }
        						set{ this._DalObject.caa_horadesde = value; } 										
	   }
	  ///<summary>
     ...
     public string  caa_horahasta 
		 { 
                    ...
                    get{ return this._DalObject.caa_horahasta; }
        						set{ this._DalObject.caa_horahasta = value; } 										
	   }
	  ///<summary>
     ///caa_estado property   
     ///</summary>	
     public int  caa_estado 
		 { 
                    ...
                    get{ return this._DalObject.caa_estado; }
        						set{ this._DalObject.caa_estado = value; } 										
	   }
	  ///<summary>
     ///caa_codigo property   
     ///</summary>	
     public string  caa_codigo 
		 { 
                    ...
                    get{ return this._DalObject.caa_codigo; }
        						set{ this._DalObject.caa_codigo = value; } 										
	   }
	  ///<summary>
     ...
     public int  caa_usuautoriza 
		 { 
                    ...
                    get{ return this._DalObject.caa_usuautoriza; }
        						set{ this._DalObject.caa_usuautoriza = value; } 										
	   }
	  ///<summary>
     ...
     public string  caa_marcavehiculo 
		 { 
                    ...
                    get{ return this._DalObject.caa_marcavehiculo; }
        						set{ this._DalObject.caa_marcavehiculo = value; } 										
	   }
	  ///<summary>
     ...
     public string  caa_patenteVehiculo 
		 { 
                    ...
                    get{ return this._DalObject.caa_patenteVehiculo; }
        						set{ this._DalObject.caa_patenteVehiculo = value; } 										
	   }
	  ///<summary>
     ...
     public int  caa_tipoVisita 
		 { 
                    ...
                    get{ return this._DalObject.caa_tipoVisita; }
        						set{ this._DalObject.caa_tipoVisita = value; } 										
	   }
	  ///<summary>
     ...
     public string  caa_comentarios 
		 { 
                    ...
                    get{ return this._DalObject.caa_comentarios; }
        						set{ this._DalObject.caa_comentarios = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_controlAcceso_Autorizacion(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_controlAcceso_Autorizacion(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_controlAcceso_Autorizacion(SqlHelper SqlConfig, int UserId, Simplep_controlAcceso_Autorizacion Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_controlAcceso_Autorizacion Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_controlAcceso_Autorizacion has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_controlAcceso_Autorizacion GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_controlAcceso_Autorizacion is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_controlAcceso_Autorizacion(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_controlAcceso_Autorizacion)Object;
			o.Name = this.Name;

			o.caa_idautorizado = this.caa_idautorizado;

			o.caa_tipo = this.caa_tipo;

			o.caa_fechadesde = this.caa_fechadesde;

			o.caa_fechahasta = this.caa_fechahasta;

			o.caa_diasemana = this.caa_diasemana;

			o.caa_horadesde = this.caa_horadesde;

			o.caa_horahasta = this.caa_horahasta;

			o.caa_estado = this.caa_estado;

			o.caa_codigo = this.caa_codigo;

			o.caa_usuautoriza = this.caa_usuautoriza;

			o.caa_marcavehiculo = this.caa_marcavehiculo;

			o.caa_patenteVehiculo = this.caa_patenteVehiculo;

			o.caa_tipoVisita = this.caa_tipoVisita;

			o.caa_comentarios = this.caa_comentarios;
