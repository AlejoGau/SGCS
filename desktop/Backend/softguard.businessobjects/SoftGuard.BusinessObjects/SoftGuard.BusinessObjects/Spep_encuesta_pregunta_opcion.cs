...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_encuesta_pregunta_opcion : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_encuesta_pregunta_opcion _DalObject;
 ...
 ///<summary>
     ...
     public int  epo_epgidkey 
		 { 
                    ...
                    get{ return this._DalObject.epo_epgidkey; }
        						set{ this._DalObject.epo_epgidkey = value; } 										
	   }
	  ///<summary>
     ///epo_name property   
     ///</summary>	
     public string  epo_name 
		 { 
                    ...
                    get{ return this._DalObject.epo_name; }
        						set{ this._DalObject.epo_name = value; } 										
	   }
	  ///<summary>
     ...
     public string  epo_descripcion 
		 { 
                    ...
                    get{ return this._DalObject.epo_descripcion; }
        						set{ this._DalObject.epo_descripcion = value; } 										
	   }
	  ///<summary>
     ///epo_status property   
     ///</summary>	
     public int  epo_status 
		 { 
                    ...
                    get{ return this._DalObject.epo_status; }
        						set{ this._DalObject.epo_status = value; } 										
	   }
	  ///<summary>
     ///epo_tipo property   
     ///</summary>	
     public int  epo_tipo 
		 { 
                    ...
                    get{ return this._DalObject.epo_tipo; }
        						set{ this._DalObject.epo_tipo = value; } 										
	   }
	  ///<summary>
     ///epo_values property   
     ///</summary>	
     public string  epo_values 
		 { 
                    ...
                    get{ return this._DalObject.epo_values; }
        						set{ this._DalObject.epo_values = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_encuesta_pregunta_opcion(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_encuesta_pregunta_opcion(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_encuesta_pregunta_opcion(SqlHelper SqlConfig, int UserId, Simplep_encuesta_pregunta_opcion Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_encuesta_pregunta_opcion Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_encuesta_pregunta_opcion has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_encuesta_pregunta_opcion GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_encuesta_pregunta_opcion is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_encuesta_pregunta_opcion(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_encuesta_pregunta_opcion)Object;
			o.Name = this.Name;

			o.epo_epgidkey = this.epo_epgidkey;

			o.epo_name = this.epo_name;

			o.epo_descripcion = this.epo_descripcion;

			o.epo_status = this.epo_status;

			o.epo_tipo = this.epo_tipo;

			o.epo_values = this.epo_values;
