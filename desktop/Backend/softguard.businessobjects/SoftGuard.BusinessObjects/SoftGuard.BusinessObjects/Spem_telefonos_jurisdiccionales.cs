...
// Type: SoftGuard.BusinessObjects.Spem_telefonos_jurisdiccionales
...
{
  public abstract class Spem_telefonos_jurisdiccionales : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_telefonos_jurisdiccionales _DalObject;
    ...
    public string tel_clista
    {
      get
      {
        return this._DalObject.tel_clista;
      }
      set
      {
        this._DalObject.tel_clista = value;
      }
    }
    ...
    public string tel_cnombre
    {
      get
      {
        return this._DalObject.tel_cnombre;
      }
      set
      {
        this._DalObject.tel_cnombre = value;
      }
    }
    ...
    public string tel_cobservacion
    {
      get
      {
        return this._DalObject.tel_cobservacion;
      }
      set
      {
        this._DalObject.tel_cobservacion = value;
      }
    }
    ...
    public string tel_ctelefono
    {
      get
      {
        return this._DalObject.tel_ctelefono;
      }
      set
      {
        this._DalObject.tel_ctelefono = value;
      }
    }
    ...
    public Decimal tel_ndiscado
    {
      get
      {
        return this._DalObject.tel_ndiscado;
      }
      set
      {
        this._DalObject.tel_ndiscado = value;
      }
    }
    ...
    public string tel_cpredigito
    {
      get
      {
        return this._DalObject.tel_cpredigito;
      }
      set
      {
        this._DalObject.tel_cpredigito = value;
      }
    }
    ...
    public string tel_cpostdigito
    {
      get
      {
        return this._DalObject.tel_cpostdigito;
      }
      set
      {
        this._DalObject.tel_cpostdigito = value;
      }
    }
    ...
    public string tel_cprovincia
    {
      get
      {
        return this._DalObject.tel_cprovincia;
      }
      set
      {
        this._DalObject.tel_cprovincia = value;
      }
    }
    ...
    public Spem_telefonos_jurisdiccionales(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_telefonos_jurisdiccionales(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_telefonos_jurisdiccionales(SqlHelper SqlConfig, int UserId, Simplem_telefonos_jurisdiccionales Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_telefonos_jurisdiccionales Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_telefonos_jurisdiccionales has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_telefonos_jurisdiccionales GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_telefonos_jurisdiccionales is null.");
    ...
    {
      this._DalObject = new Dalm_telefonos_jurisdiccionales(SqlConfig, UserId);
    ...
    {
      m_telefonos_jurisdiccionales jurisdiccionales = (m_telefonos_jurisdiccionales) Object;
