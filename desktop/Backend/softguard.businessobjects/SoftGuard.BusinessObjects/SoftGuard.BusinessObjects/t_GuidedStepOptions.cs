...
{ 
   ///<summary>
     ///t_GuidedStepOptions class   
     ///</summary>
    public partial class t_GuidedStepOptions : Spet_GuidedStepOptions
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_GuidedStepOptions(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_GuidedStepOptions(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_GuidedStepOptions(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_GuidedStepOptions(SqlHelper SqlConfig, int UserId, Simplet_GuidedStepOptions Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
