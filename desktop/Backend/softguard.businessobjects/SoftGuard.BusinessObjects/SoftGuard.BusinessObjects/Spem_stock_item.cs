...
// Type: SoftGuard.BusinessObjects.Spem_stock_item
...
{
  public abstract class Spem_stock_item : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_stock_item _DalObject;
    ...
    public int sti_idcabecera
    {
      get
      {
        return this._DalObject.sti_idcabecera;
      }
      set
      {
        this._DalObject.sti_idcabecera = value;
      }
    }
    ...
    public int sti_idproducto
    {
      get
      {
        return this._DalObject.sti_idproducto;
      }
      set
      {
        this._DalObject.sti_idproducto = value;
      }
    }
    ...
    public float sti_cant
    {
      get
      {
        return this._DalObject.sti_cant;
      }
      set
      {
        this._DalObject.sti_cant = value;
      }
    }
    ...
    public Spem_stock_item(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_stock_item(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_stock_item(SqlHelper SqlConfig, int UserId, Simplem_stock_item Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_stock_item Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_stock_item has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_stock_item GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_stock_item is null.");
    ...
    {
      this._DalObject = new Dalm_stock_item(SqlConfig, UserId);
    ...
    {
      m_stock_item mStockItem = (m_stock_item) Object;
      mStockItem.Name = this.Name;
      mStockItem.sti_idcabecera = this.sti_idcabecera;
      mStockItem.sti_idproducto = this.sti_idproducto;
      mStockItem.sti_cant = this.sti_cant;
    }
