...
{ 
   ///<summary>
     ///s_online_help class   
     ///</summary>
    public partial class s_online_help : Spes_online_help
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public s_online_help(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public s_online_help(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_online_help(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_online_help(SqlHelper SqlConfig, int UserId, Simples_online_help Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
