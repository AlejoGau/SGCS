...
// Type: SoftGuard.BusinessObjects.EquipoDispositivoMovil
...
{
  public class EquipoDispositivoMovil : SpeEquipoDispositivoMovil
  {
    public EquipoDispositivoMovil(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public EquipoDispositivoMovil(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public EquipoDispositivoMovil(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public EquipoDispositivoMovil(SqlHelper SqlConfig, int UserId, SimpleEquipoDispositivoMovil Simple)
