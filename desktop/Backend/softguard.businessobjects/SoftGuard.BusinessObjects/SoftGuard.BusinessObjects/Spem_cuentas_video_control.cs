...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_cuentas_video_control : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_cuentas_video_control _DalObject;
 ...
 ///<summary>
     ...
     public int  cvc_iIdCta 
		 { 
                    ...
                    get{ return this._DalObject.cvc_iIdCta; }
        						set{ this._DalObject.cvc_iIdCta = value; } 										
	   }
	  ///<summary>
     ...
     public int  cvc_iActivacionTotal 
		 { 
                    ...
                    get{ return this._DalObject.cvc_iActivacionTotal; }
        						set{ this._DalObject.cvc_iActivacionTotal = value; } 										
	   }
	  ///<summary>
     ...
     public string  cvc_cActivacionParcial 
		 { 
                    ...
                    get{ return this._DalObject.cvc_cActivacionParcial; }
        						set{ this._DalObject.cvc_cActivacionParcial = value; } 										
	   }
	  ///<summary>
     ...
     public int  cvc_iDesactivacion 
		 { 
                    ...
                    get{ return this._DalObject.cvc_iDesactivacion; }
        						set{ this._DalObject.cvc_iDesactivacion = value; } 										
	   }
	  ///<summary>
     ...
     public int  cvc_iActivacionParcial 
		 { 
                    ...
                    get{ return this._DalObject.cvc_iActivacionParcial; }
        						set{ this._DalObject.cvc_iActivacionParcial = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_cuentas_video_control(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuentas_video_control(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuentas_video_control(SqlHelper SqlConfig, int UserId, Simplem_cuentas_video_control Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_cuentas_video_control Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_cuentas_video_control has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_cuentas_video_control GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_cuentas_video_control is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_cuentas_video_control(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_cuentas_video_control)Object;
			o.Name = this.Name;

			o.cvc_iIdCta = this.cvc_iIdCta;

			o.cvc_iActivacionTotal = this.cvc_iActivacionTotal;

			o.cvc_cActivacionParcial = this.cvc_cActivacionParcial;

			o.cvc_iDesactivacion = this.cvc_iDesactivacion;

			o.cvc_iActivacionParcial = this.cvc_iActivacionParcial;
