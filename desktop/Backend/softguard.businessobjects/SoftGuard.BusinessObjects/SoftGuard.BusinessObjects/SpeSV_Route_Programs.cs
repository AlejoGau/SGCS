...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeSV_Route_Programs : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalSV_Route_Programs _DalObject;
 ...
 ///<summary>
     ...
     public int  srp_iid 
		 { 
                    ...
                    get{ return this._DalObject.srp_iid; }
        						set{ this._DalObject.srp_iid = value; } 										
	   }
	  ///<summary>
     ...
     public int  srp_iRouteId 
		 { 
                    ...
                    get{ return this._DalObject.srp_iRouteId; }
        						set{ this._DalObject.srp_iRouteId = value; } 										
	   }
	  ///<summary>
     ...
     public string  srp_cProgramType 
		 { 
                    ...
                    get{ return this._DalObject.srp_cProgramType; }
        						set{ this._DalObject.srp_cProgramType = value; } 										
	   }
	  ///<summary>
     ...
     public int  srp_iStartHour 
		 { 
                    ...
                    get{ return this._DalObject.srp_iStartHour; }
        						set{ this._DalObject.srp_iStartHour = value; } 										
	   }
	  ///<summary>
     ...
     public int  srp_iStartMinutes 
		 { 
                    ...
                    get{ return this._DalObject.srp_iStartMinutes; }
        						set{ this._DalObject.srp_iStartMinutes = value; } 										
	   }
	  ///<summary>
     ...
     public int  srp_iDayOfWeek 
		 { 
                    ...
                    get{ return this._DalObject.srp_iDayOfWeek; }
        						set{ this._DalObject.srp_iDayOfWeek = value; } 										
	   }
	  ///<summary>
     ...
     public int  srp_iDayOfMonth 
		 { 
                    ...
                    get{ return this._DalObject.srp_iDayOfMonth; }
        						set{ this._DalObject.srp_iDayOfMonth = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeSV_Route_Programs(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeSV_Route_Programs(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeSV_Route_Programs(SqlHelper SqlConfig, int UserId, SimpleSV_Route_Programs Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleSV_Route_Programs Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The SV_Route_Programs has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalSV_Route_Programs GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The SV_Route_Programs is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalSV_Route_Programs(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.SV_Route_Programs)Object;
			o.Name = this.Name;

			o.srp_iid = this.srp_iid;

			o.srp_iRouteId = this.srp_iRouteId;

			o.srp_cProgramType = this.srp_cProgramType;

			o.srp_iStartHour = this.srp_iStartHour;

			o.srp_iStartMinutes = this.srp_iStartMinutes;

			o.srp_iDayOfWeek = this.srp_iDayOfWeek;

			o.srp_iDayOfMonth = this.srp_iDayOfMonth;
