...
// Type: SoftGuard.BusinessObjects.m_caja_fc
...
{
  public class m_caja_fc : Spem_caja_fc
  {
    public m_caja_fc(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_caja_fc(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_caja_fc(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_caja_fc(SqlHelper SqlConfig, int UserId, Simplem_caja_fc Simple)
