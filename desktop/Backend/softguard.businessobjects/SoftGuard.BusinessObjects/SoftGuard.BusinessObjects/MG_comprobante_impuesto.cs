...
{ 
   ///<summary>
     ///MG_comprobante_impuesto class   
     ///</summary>
    public partial class MG_comprobante_impuesto : SpeMG_comprobante_impuesto
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_comprobante_impuesto(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_comprobante_impuesto(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_comprobante_impuesto(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_comprobante_impuesto(SqlHelper SqlConfig, int UserId, SimpleMG_comprobante_impuesto Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
