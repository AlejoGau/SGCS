...
// Type: SoftGuard.BusinessObjects.Spet_novedades_fc
...
{
  public abstract class Spet_novedades_fc : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_novedades_fc _DalObject;
    ...
    public string nov_cdescripcion
    {
      get
      {
        return this._DalObject.nov_cdescripcion;
      }
      set
      {
        this._DalObject.nov_cdescripcion = value;
      }
    }
    ...
    public Decimal nov_mimporte
    {
      get
      {
        return this._DalObject.nov_mimporte;
      }
      set
      {
        this._DalObject.nov_mimporte = value;
      }
    }
    ...
    public string nov_cimpuesto1
    {
      get
      {
        return this._DalObject.nov_cimpuesto1;
      }
      set
      {
        this._DalObject.nov_cimpuesto1 = value;
      }
    }
    ...
    public string nov_cimpuesto2
    {
      get
      {
        return this._DalObject.nov_cimpuesto2;
      }
      set
      {
        this._DalObject.nov_cimpuesto2 = value;
      }
    }
    ...
    public string nov_cimpuesto3
    {
      get
      {
        return this._DalObject.nov_cimpuesto3;
      }
      set
      {
        this._DalObject.nov_cimpuesto3 = value;
      }
    }
    ...
    public Spet_novedades_fc(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_novedades_fc(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_novedades_fc(SqlHelper SqlConfig, int UserId, Simplet_novedades_fc Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_novedades_fc Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_novedades_fc has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_novedades_fc GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_novedades_fc is null.");
    ...
    {
      this._DalObject = new Dalt_novedades_fc(SqlConfig, UserId);
    ...
    {
      t_novedades_fc tNovedadesFc = (t_novedades_fc) Object;
      tNovedadesFc.Name = this.Name;
      tNovedadesFc.nov_cdescripcion = this.nov_cdescripcion;
      tNovedadesFc.nov_mimporte = this.nov_mimporte;
      tNovedadesFc.nov_cimpuesto1 = this.nov_cimpuesto1;
      tNovedadesFc.nov_cimpuesto2 = this.nov_cimpuesto2;
      tNovedadesFc.nov_cimpuesto3 = this.nov_cimpuesto3;
    }
