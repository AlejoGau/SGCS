...
// Type: SoftGuard.BusinessObjects.Spem_asignacion_movil
...
{
  public abstract class Spem_asignacion_movil : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_asignacion_movil _DalObject;
    ...
    public int amv_rec_iid
    {
      get
      {
        return this._DalObject.amv_rec_iid;
      }
      set
      {
        this._DalObject.amv_rec_iid = value;
      }
    }
    ...
    public int amv_objecttypeid
    {
      get
      {
        return this._DalObject.amv_objecttypeid;
      }
      set
      {
        this._DalObject.amv_objecttypeid = value;
      }
    }
    ...
    public int amv_objectid
    {
      get
      {
        return this._DalObject.amv_objectid;
      }
      set
      {
        this._DalObject.amv_objectid = value;
      }
    }
    ...
    public int amv_estado
    {
      get
      {
        return this._DalObject.amv_estado;
      }
      set
      {
        this._DalObject.amv_estado = value;
      }
    }
    ...
    public int amv_prioridad
    {
      get
      {
        return this._DalObject.amv_prioridad;
      }
      set
      {
        this._DalObject.amv_prioridad = value;
      }
    }
    ...
    public Spem_asignacion_movil(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_asignacion_movil(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_asignacion_movil(SqlHelper SqlConfig, int UserId, Simplem_asignacion_movil Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_asignacion_movil Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_asignacion_movil has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_asignacion_movil GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_asignacion_movil is null.");
    ...
    {
      this._DalObject = new Dalm_asignacion_movil(SqlConfig, UserId);
    ...
    {
      m_asignacion_movil mAsignacionMovil = (m_asignacion_movil) Object;
      mAsignacionMovil.Name = this.Name;
      mAsignacionMovil.amv_rec_iid = this.amv_rec_iid;
      mAsignacionMovil.amv_objecttypeid = this.amv_objecttypeid;
      mAsignacionMovil.amv_objectid = this.amv_objectid;
      mAsignacionMovil.amv_estado = this.amv_estado;
      mAsignacionMovil.amv_prioridad = this.amv_prioridad;
    }
