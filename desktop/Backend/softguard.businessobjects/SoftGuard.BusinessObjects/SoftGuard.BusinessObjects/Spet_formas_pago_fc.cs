...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_formas_pago_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_formas_pago_fc _DalObject;
 ...
 ///<summary>
     ...
     public string  fpg_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.fpg_ccodigo; }
        						set{ this._DalObject.fpg_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  fpg_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.fpg_cdescripcion; }
        						set{ this._DalObject.fpg_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  fpg_cdescripcionreducida 
		 { 
                    ...
                    get{ return this._DalObject.fpg_cdescripcionreducida; }
        						set{ this._DalObject.fpg_cdescripcionreducida = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  fpg_npidenumero 
		 { 
                    ...
                    get{ return this._DalObject.fpg_npidenumero; }
        						set{ this._DalObject.fpg_npidenumero = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  fpg_npidevencimiento 
		 { 
                    ...
                    get{ return this._DalObject.fpg_npidevencimiento; }
        						set{ this._DalObject.fpg_npidevencimiento = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  fpg_npidebanco 
		 { 
                    ...
                    get{ return this._DalObject.fpg_npidebanco; }
        						set{ this._DalObject.fpg_npidebanco = value; } 										
	   }
	  ///<summary>
     ///fpg_ctipo property   
     ///</summary>	
     public string  fpg_ctipo 
		 { 
                    ...
                    get{ return this._DalObject.fpg_ctipo; }
        						set{ this._DalObject.fpg_ctipo = value; } 										
	   }
	  ///<summary>
     ...
     public int  fpg_mgmcidkey 
		 { 
                    ...
                    get{ return this._DalObject.fpg_mgmcidkey; }
        						set{ this._DalObject.fpg_mgmcidkey = value; } 										
	   }
	  ///<summary>
     ...
     public int  fpg_orgidcodigoid 
		 { 
                    ...
                    get{ return this._DalObject.fpg_orgidcodigoid; }
        						set{ this._DalObject.fpg_orgidcodigoid = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_formas_pago_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_formas_pago_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_formas_pago_fc(SqlHelper SqlConfig, int UserId, Simplet_formas_pago_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_formas_pago_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_formas_pago_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_formas_pago_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_formas_pago_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_formas_pago_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_formas_pago_fc)Object;
			o.Name = this.Name;

			o.fpg_ccodigo = this.fpg_ccodigo;

			o.fpg_cdescripcion = this.fpg_cdescripcion;

			o.fpg_cdescripcionreducida = this.fpg_cdescripcionreducida;

			o.fpg_npidenumero = this.fpg_npidenumero;

			o.fpg_npidevencimiento = this.fpg_npidevencimiento;

			o.fpg_npidebanco = this.fpg_npidebanco;

			o.fpg_ctipo = this.fpg_ctipo;

			o.fpg_mgmcidkey = this.fpg_mgmcidkey;

			o.fpg_orgidcodigoid = this.fpg_orgidcodigoid;
