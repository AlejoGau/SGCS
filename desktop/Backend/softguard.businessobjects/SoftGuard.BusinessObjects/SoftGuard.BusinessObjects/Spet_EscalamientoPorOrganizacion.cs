...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_EscalamientoPorOrganizacion : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_EscalamientoPorOrganizacion _DalObject;
 ...
 ///<summary>
     ...
     public int  teo_iTiempo 
		 { 
                    ...
                    get{ return this._DalObject.teo_iTiempo; }
        						set{ this._DalObject.teo_iTiempo = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  teo_nControla 
		 { 
                    ...
                    get{ return this._DalObject.teo_nControla; }
        						set{ this._DalObject.teo_nControla = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_EscalamientoPorOrganizacion(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_EscalamientoPorOrganizacion(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_EscalamientoPorOrganizacion(SqlHelper SqlConfig, int UserId, Simplet_EscalamientoPorOrganizacion Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_EscalamientoPorOrganizacion Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_EscalamientoPorOrganizacion has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_EscalamientoPorOrganizacion GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_EscalamientoPorOrganizacion is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_EscalamientoPorOrganizacion(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_EscalamientoPorOrganizacion)Object;
			o.Name = this.Name;

			o.teo_iTiempo = this.teo_iTiempo;

			o.teo_nControla = this.teo_nControla;
