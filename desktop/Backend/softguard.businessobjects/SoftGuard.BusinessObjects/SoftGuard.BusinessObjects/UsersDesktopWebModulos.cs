...
// Type: SoftGuard.BusinessObjects.UsersDesktopWebModulos
...
{
  public class UsersDesktopWebModulos : SpeUsersDesktopWebModulos
  {
    public UsersDesktopWebModulos(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public UsersDesktopWebModulos(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public UsersDesktopWebModulos(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public UsersDesktopWebModulos(SqlHelper SqlConfig, int UserId, SimpleUsersDesktopWebModulos Simple)
