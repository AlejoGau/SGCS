...
// Type: SoftGuard.BusinessObjects.Spet_resolucionesllamada
...
{
  public abstract class Spet_resolucionesllamada : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_resolucionesllamada _DalObject;
    ...
    public string rll_ccodigo
    {
      get
      {
        return this._DalObject.rll_ccodigo;
      }
      set
      {
        this._DalObject.rll_ccodigo = value;
      }
    }
    ...
    public string rll_cdescripcion
    {
      get
      {
        return this._DalObject.rll_cdescripcion;
      }
      set
      {
        this._DalObject.rll_cdescripcion = value;
      }
    }
    ...
    public Spet_resolucionesllamada(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_resolucionesllamada(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_resolucionesllamada(SqlHelper SqlConfig, int UserId, Simplet_resolucionesllamada Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_resolucionesllamada Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_resolucionesllamada has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_resolucionesllamada GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_resolucionesllamada is null.");
    ...
    {
      this._DalObject = new Dalt_resolucionesllamada(SqlConfig, UserId);
    ...
    {
      t_resolucionesllamada resolucionesllamada = (t_resolucionesllamada) Object;
