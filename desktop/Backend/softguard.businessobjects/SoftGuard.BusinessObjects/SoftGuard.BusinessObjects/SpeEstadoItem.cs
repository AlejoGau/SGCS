...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeEstadoItem : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalEstadoItem _DalObject;
 ...
 ///<summary>
     ...
     public int  est_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.est_iidcuenta; }
        						set{ this._DalObject.est_iidcuenta = value; } 										
	   }
	  ///<summary>
     ///est_czona property   
     ///</summary>	
     public string  est_czona 
		 { 
                    ...
                    get{ return this._DalObject.est_czona; }
        						set{ this._DalObject.est_czona = value; } 										
	   }
	  ///<summary>
     ///est_cData property   
     ///</summary>	
     public string  est_cData 
		 { 
                    ...
                    get{ return this._DalObject.est_cData; }
        						set{ this._DalObject.est_cData = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeEstadoItem(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeEstadoItem(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeEstadoItem(SqlHelper SqlConfig, int UserId, SimpleEstadoItem Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleEstadoItem Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The EstadoItem has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalEstadoItem GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The EstadoItem is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalEstadoItem(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (EstadoItem)Object;
			o.Name = this.Name;

			o.est_iidcuenta = this.est_iidcuenta;

			o.est_czona = this.est_czona;

			o.est_cData = this.est_cData;
