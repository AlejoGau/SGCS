...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_categorias_impositivas_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_categorias_impositivas_fc _DalObject;
 ...
 ///<summary>
     ...
     public string  cat_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.cat_ccodigo; }
        						set{ this._DalObject.cat_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  cat_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.cat_cdescripcion; }
        						set{ this._DalObject.cat_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  cat_cimpuesto1 
		 { 
                    ...
                    get{ return this._DalObject.cat_cimpuesto1; }
        						set{ this._DalObject.cat_cimpuesto1 = value; } 										
	   }
	  ///<summary>
     ...
     public string  cat_cimpuesto2 
		 { 
                    ...
                    get{ return this._DalObject.cat_cimpuesto2; }
        						set{ this._DalObject.cat_cimpuesto2 = value; } 										
	   }
	  ///<summary>
     ...
     public string  cat_cimpuesto3 
		 { 
                    ...
                    get{ return this._DalObject.cat_cimpuesto3; }
        						set{ this._DalObject.cat_cimpuesto3 = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  cat_nTipoResp 
		 { 
                    ...
                    get{ return this._DalObject.cat_nTipoResp; }
        						set{ this._DalObject.cat_nTipoResp = value; } 										
	   }
	  ///<summary>
     ...
     public int  cat_orgicodigoid 
		 { 
                    ...
                    get{ return this._DalObject.cat_orgicodigoid; }
        						set{ this._DalObject.cat_orgicodigoid = value; } 										
	   }
	  ///<summary>
     ...
     public int  cat_cbtidkey 
		 { 
                    ...
                    get{ return this._DalObject.cat_cbtidkey; }
        						set{ this._DalObject.cat_cbtidkey = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_categorias_impositivas_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_categorias_impositivas_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_categorias_impositivas_fc(SqlHelper SqlConfig, int UserId, Simplet_categorias_impositivas_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_categorias_impositivas_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_categorias_impositivas_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_categorias_impositivas_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_categorias_impositivas_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_categorias_impositivas_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_categorias_impositivas_fc)Object;
			o.Name = this.Name;

			o.cat_ccodigo = this.cat_ccodigo;

			o.cat_cdescripcion = this.cat_cdescripcion;

			o.cat_cimpuesto1 = this.cat_cimpuesto1;

			o.cat_cimpuesto2 = this.cat_cimpuesto2;

			o.cat_cimpuesto3 = this.cat_cimpuesto3;

			o.cat_nTipoResp = this.cat_nTipoResp;

			o.cat_orgicodigoid = this.cat_orgicodigoid;

			o.cat_cbtidkey = this.cat_cbtidkey;
