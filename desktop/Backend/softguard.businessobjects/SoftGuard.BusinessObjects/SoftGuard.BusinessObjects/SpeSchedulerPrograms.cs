...
// Type: SoftGuard.BusinessObjects.SpeSchedulerPrograms
...
{
  public abstract class SpeSchedulerPrograms : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalSchedulerPrograms _DalObject;
    ...
    public string eventos
    {
      get
      {
        return this._DalObject.eventos;
      }
      set
      {
        this._DalObject.eventos = value;
      }
    }
    ...
    public string eventogenerar
    {
      get
      {
        return this._DalObject.eventogenerar;
      }
      set
      {
        this._DalObject.eventogenerar = value;
      }
    }
    ...
    public int zonaiid
    {
      get
      {
        return this._DalObject.zonaiid;
      }
      set
      {
        this._DalObject.zonaiid = value;
      }
    }
    ...
    public int usuarioiid
    {
      get
      {
        return this._DalObject.usuarioiid;
      }
      set
      {
        this._DalObject.usuarioiid = value;
      }
    }
    ...
    public string programtype
    {
      get
      {
        return this._DalObject.programtype;
      }
      set
      {
        this._DalObject.programtype = value;
      }
    }
    ...
    public int starthour
    {
      get
      {
        return this._DalObject.starthour;
      }
      set
      {
        this._DalObject.starthour = value;
      }
    }
    ...
    public int startminutes
    {
      get
      {
        return this._DalObject.startminutes;
      }
      set
      {
        this._DalObject.startminutes = value;
      }
    }
    ...
    public int endhour
    {
      get
      {
        return this._DalObject.endhour;
      }
      set
      {
        this._DalObject.endhour = value;
      }
    }
    ...
    public int endminutes
    {
      get
      {
        return this._DalObject.endminutes;
      }
      set
      {
        this._DalObject.endminutes = value;
      }
    }
    ...
    public int dayofweek
    {
      get
      {
        return this._DalObject.dayofweek;
      }
      set
      {
        this._DalObject.dayofweek = value;
      }
    }
    ...
    public int dayofmonth
    {
      get
      {
        return this._DalObject.dayofmonth;
      }
      set
      {
        this._DalObject.dayofmonth = value;
      }
    }
    ...
    public SpeSchedulerPrograms(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeSchedulerPrograms(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeSchedulerPrograms(SqlHelper SqlConfig, int UserId, SimpleSchedulerPrograms Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleSchedulerPrograms Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The SchedulerPrograms has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalSchedulerPrograms GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The SchedulerPrograms is null.");
    ...
    {
      this._DalObject = new DalSchedulerPrograms(SqlConfig, UserId);
    ...
    {
      SchedulerPrograms schedulerPrograms = (SchedulerPrograms) Object;
