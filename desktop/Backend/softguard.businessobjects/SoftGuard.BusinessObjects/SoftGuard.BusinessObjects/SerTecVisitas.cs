...
{ 
   ///<summary>
     ///SerTecVisitas class   
     ///</summary>
    public partial class SerTecVisitas : SpeSerTecVisitas
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public SerTecVisitas(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public SerTecVisitas(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SerTecVisitas(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SerTecVisitas(SqlHelper SqlConfig, int UserId, SimpleSerTecVisitas Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
