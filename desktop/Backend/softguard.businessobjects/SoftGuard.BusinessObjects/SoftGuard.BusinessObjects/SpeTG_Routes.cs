...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeTG_Routes : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalTG_Routes _DalObject;
 ...
 ///<summary>
     ...
     public int  userId 
		 { 
                    ...
                    get{ return this._DalObject.userId; }
        						set{ this._DalObject.userId = value; } 										
	   }
	  ///<summary>
     ///routetype property   
     ///</summary>	
     public string  routetype 
		 { 
                    ...
                    get{ return this._DalObject.routetype; }
        						set{ this._DalObject.routetype = value; } 										
	   }
	  ///<summary>
     ///datestart property   
     ///</summary>	
     public DateTime?  datestart 
		 { 
                    ...
                    get{ return this._DalObject.datestart; }
        						set{ this._DalObject.datestart = value; } 										
	   }
	  ///<summary>
     ///time property   
     ///</summary>	
     public int  time 
		 { 
                    ...
                    get{ return this._DalObject.time; }
        						set{ this._DalObject.time = value; } 										
	   }
	  ///<summary>
     ...
     public int  startbeforetolerance 
		 { 
                    ...
                    get{ return this._DalObject.startbeforetolerance; }
        						set{ this._DalObject.startbeforetolerance = value; } 										
	   }
	  ///<summary>
     ...
     public int  startaftertolerance 
		 { 
                    ...
                    get{ return this._DalObject.startaftertolerance; }
        						set{ this._DalObject.startaftertolerance = value; } 										
	   }
	  ///<summary>
     ...
     public int  endbeforetolerance 
		 { 
                    ...
                    get{ return this._DalObject.endbeforetolerance; }
        						set{ this._DalObject.endbeforetolerance = value; } 										
	   }
	  ///<summary>
     ...
     public int  endaftertolerance 
		 { 
                    ...
                    get{ return this._DalObject.endaftertolerance; }
        						set{ this._DalObject.endaftertolerance = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeTG_Routes(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTG_Routes(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTG_Routes(SqlHelper SqlConfig, int UserId, SimpleTG_Routes Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleTG_Routes Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The TG_Routes has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalTG_Routes GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The TG_Routes is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalTG_Routes(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public void CopyPropertiesTo(ISpecialization Object)
        {
			...
			o.routetype = this.routetype;

			o.datestart = this.datestart;

			o.time = this.time;

			o.startbeforetolerance = this.startbeforetolerance;

			o.startaftertolerance = this.startaftertolerance;

			o.endbeforetolerance = this.endbeforetolerance;

			o.endaftertolerance = this.endaftertolerance;
