...
// Type: SoftGuard.BusinessObjects.SpeHorarioPlanilla
...
{
  public abstract class SpeHorarioPlanilla : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalHorarioPlanilla _DalObject;
    ...
    public int hor_iid
    {
      get
      {
        return this._DalObject.hor_iid;
      }
      set
      {
        this._DalObject.hor_iid = value;
      }
    }
    ...
    public Decimal hor_ndiaapertura
    {
      get
      {
        return this._DalObject.hor_ndiaapertura;
      }
      set
      {
        this._DalObject.hor_ndiaapertura = value;
      }
    }
    ...
    public string hor_choraapertura
    {
      get
      {
        return this._DalObject.hor_choraapertura;
      }
      set
      {
        this._DalObject.hor_choraapertura = value;
      }
    }
    ...
    public Decimal hor_ndiacierre
    {
      get
      {
        return this._DalObject.hor_ndiacierre;
      }
      set
      {
        this._DalObject.hor_ndiacierre = value;
      }
    }
    ...
    public string hor_choracierre
    {
      get
      {
        return this._DalObject.hor_choracierre;
      }
      set
      {
        this._DalObject.hor_choracierre = value;
      }
    }
    ...
    public SpeHorarioPlanilla(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeHorarioPlanilla(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeHorarioPlanilla(SqlHelper SqlConfig, int UserId, SimpleHorarioPlanilla Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleHorarioPlanilla Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The HorarioPlanilla has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalHorarioPlanilla GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The HorarioPlanilla is null.");
    ...
    {
      this._DalObject = new DalHorarioPlanilla(SqlConfig, UserId);
    ...
    {
      HorarioPlanilla horarioPlanilla = (HorarioPlanilla) Object;
      horarioPlanilla.Name = this.Name;
      horarioPlanilla.hor_iid = this.hor_iid;
      horarioPlanilla.hor_ndiaapertura = this.hor_ndiaapertura;
      horarioPlanilla.hor_choraapertura = this.hor_choraapertura;
      horarioPlanilla.hor_ndiacierre = this.hor_ndiacierre;
      horarioPlanilla.hor_choracierre = this.hor_choracierre;
    }
