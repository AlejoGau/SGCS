...
{ 
   ///<summary>
     ///t_codigos_alarma class   
     ///</summary>
    public partial class t_codigos_alarma : Spet_codigos_alarma
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_codigos_alarma(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_codigos_alarma(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_codigos_alarma(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_codigos_alarma(SqlHelper SqlConfig, int UserId, Simplet_codigos_alarma Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
