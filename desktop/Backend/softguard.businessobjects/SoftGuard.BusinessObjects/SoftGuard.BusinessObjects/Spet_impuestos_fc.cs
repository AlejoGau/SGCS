...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_impuestos_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_impuestos_fc _DalObject;
 ...
 ///<summary>
     ...
     public string  imp_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.imp_ccodigo; }
        						set{ this._DalObject.imp_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  imp_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.imp_cdescripcion; }
        						set{ this._DalObject.imp_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  imp_nporcentaje 
		 { 
                    ...
                    get{ return this._DalObject.imp_nporcentaje; }
        						set{ this._DalObject.imp_nporcentaje = value; } 										
	   }
	  ///<summary>
     ...
     public string  imp_extcode 
		 { 
                    ...
                    get{ return this._DalObject.imp_extcode; }
        						set{ this._DalObject.imp_extcode = value; } 										
	   }
	  ///<summary>
     ...
     public int  imp_idorganizacion 
		 { 
                    ...
                    get{ return this._DalObject.imp_idorganizacion; }
        						set{ this._DalObject.imp_idorganizacion = value; } 										
	   }
	  ///<summary>
     ...
     public int  imp_mgmcidkey 
		 { 
                    ...
                    get{ return this._DalObject.imp_mgmcidkey; }
        						set{ this._DalObject.imp_mgmcidkey = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_impuestos_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_impuestos_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_impuestos_fc(SqlHelper SqlConfig, int UserId, Simplet_impuestos_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_impuestos_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_impuestos_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_impuestos_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_impuestos_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_impuestos_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_impuestos_fc)Object;
			o.Name = this.Name;

			o.imp_ccodigo = this.imp_ccodigo;

			o.imp_cdescripcion = this.imp_cdescripcion;

			o.imp_nporcentaje = this.imp_nporcentaje;

			o.imp_extcode = this.imp_extcode;

			o.imp_idorganizacion = this.imp_idorganizacion;

			o.imp_mgmcidkey = this.imp_mgmcidkey;
