...
{ 
   ///<summary>
     ///eventostimeline class   
     ///</summary>
    public partial class eventostimeline : Speeventostimeline
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public eventostimeline(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public eventostimeline(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public eventostimeline(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public eventostimeline(SqlHelper SqlConfig, int UserId, Simpleeventostimeline Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
