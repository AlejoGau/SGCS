...
{ 
   ///<summary>
     ///s_terminales class   
     ///</summary>
    public partial class s_terminales : Spes_terminales
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public s_terminales(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public s_terminales(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_terminales(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_terminales(SqlHelper SqlConfig, int UserId, Simples_terminales Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
