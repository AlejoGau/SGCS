...
{ 
   ///<summary>
     ///m_cuentas_video_links class   
     ///</summary>
    public partial class m_cuentas_video_links : Spem_cuentas_video_links
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuentas_video_links(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuentas_video_links(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuentas_video_links(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuentas_video_links(SqlHelper SqlConfig, int UserId, Simplem_cuentas_video_links Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
