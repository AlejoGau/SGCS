...
{ 
   ///<summary>
     ///HorarioExcepcionPlanilla class   
     ///</summary>
    public partial class HorarioExcepcionPlanilla : SpeHorarioExcepcionPlanilla
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public HorarioExcepcionPlanilla(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public HorarioExcepcionPlanilla(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public HorarioExcepcionPlanilla(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public HorarioExcepcionPlanilla(SqlHelper SqlConfig, int UserId, SimpleHorarioExcepcionPlanilla Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
