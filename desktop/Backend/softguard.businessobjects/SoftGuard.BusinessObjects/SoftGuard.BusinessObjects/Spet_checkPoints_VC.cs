...
// Type: SoftGuard.BusinessObjects.Spet_checkPoints_VC
...
{
  public abstract class Spet_checkPoints_VC : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_checkPoints_VC _DalObject;
    ...
    public string chp_cReference
    {
      get
      {
        return this._DalObject.chp_cReference;
      }
      set
      {
        this._DalObject.chp_cReference = value;
      }
    }
    ...
    public string chp_cZona
    {
      get
      {
        return this._DalObject.chp_cZona;
      }
      set
      {
        this._DalObject.chp_cZona = value;
      }
    }
    ...
    public int chp_iCuenta
    {
      get
      {
        return this._DalObject.chp_iCuenta;
      }
      set
      {
        this._DalObject.chp_iCuenta = value;
      }
    }
    ...
    public float chp_rLatitud
    {
      get
      {
        return this._DalObject.chp_rLatitud;
      }
      set
      {
        this._DalObject.chp_rLatitud = value;
      }
    }
    ...
    public float chp_rLongitud
    {
      get
      {
        return this._DalObject.chp_rLongitud;
      }
      set
      {
        this._DalObject.chp_rLongitud = value;
      }
    }
    ...
    public Decimal chp_nTipo
    {
      get
      {
        return this._DalObject.chp_nTipo;
      }
      set
      {
        this._DalObject.chp_nTipo = value;
      }
    }
    ...
    public int chp_iTolerancia
    {
      get
      {
        return this._DalObject.chp_iTolerancia;
      }
      set
      {
        this._DalObject.chp_iTolerancia = value;
      }
    }
    ...
    public Spet_checkPoints_VC(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_checkPoints_VC(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_checkPoints_VC(SqlHelper SqlConfig, int UserId, Simplet_checkPoints_VC Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_checkPoints_VC Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_checkPoints_VC has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_checkPoints_VC GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_checkPoints_VC is null.");
    ...
    {
      this._DalObject = new Dalt_checkPoints_VC(SqlConfig, UserId);
    ...
    {
      t_checkPoints_VC tCheckPointsVc = (t_checkPoints_VC) Object;
      tCheckPointsVc.Name = this.Name;
      tCheckPointsVc.chp_cReference = this.chp_cReference;
      tCheckPointsVc.chp_cZona = this.chp_cZona;
      tCheckPointsVc.chp_iCuenta = this.chp_iCuenta;
      tCheckPointsVc.chp_rLatitud = this.chp_rLatitud;
      tCheckPointsVc.chp_rLongitud = this.chp_rLongitud;
      tCheckPointsVc.chp_nTipo = this.chp_nTipo;
      tCheckPointsVc.chp_iTolerancia = this.chp_iTolerancia;
    }
