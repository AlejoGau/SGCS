...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_sgnotes : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_sgnotes _DalObject;
 ...
 ///<summary>
     ...
     public string  sgn_title 
		 { 
                    ...
                    get{ return this._DalObject.sgn_title; }
        						set{ this._DalObject.sgn_title = value; } 										
	   }
	  ///<summary>
     ///sgn_body property   
     ///</summary>	
     public string  sgn_body 
		 { 
                    ...
                    get{ return this._DalObject.sgn_body; }
        						set{ this._DalObject.sgn_body = value; } 										
	   }
	  ///<summary>
     ///sgn_userid property   
     ///</summary>	
     public int  sgn_userid 
		 { 
                    ...
                    get{ return this._DalObject.sgn_userid; }
        						set{ this._DalObject.sgn_userid = value; } 										
	   }
	  ///<summary>
     ///sgn_status property   
     ///</summary>	
     public int  sgn_status 
		 { 
                    ...
                    get{ return this._DalObject.sgn_status; }
        						set{ this._DalObject.sgn_status = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  sgn_datecreated 
		 { 
                    ...
                    get{ return this._DalObject.sgn_datecreated; }
        						set{ this._DalObject.sgn_datecreated = value; } 										
	   }
	  ///<summary>
     ...
     public int  sgn_fileduserid 
		 { 
                    ...
                    get{ return this._DalObject.sgn_fileduserid; }
        						set{ this._DalObject.sgn_fileduserid = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_sgnotes(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_sgnotes(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_sgnotes(SqlHelper SqlConfig, int UserId, Simplem_sgnotes Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_sgnotes Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_sgnotes has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_sgnotes GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_sgnotes is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_sgnotes(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_sgnotes)Object;
			o.Name = this.Name;

			o.sgn_title = this.sgn_title;

			o.sgn_body = this.sgn_body;

			o.sgn_userid = this.sgn_userid;

			o.sgn_status = this.sgn_status;

			o.sgn_datecreated = this.sgn_datecreated;

			o.sgn_fileduserid = this.sgn_fileduserid;
