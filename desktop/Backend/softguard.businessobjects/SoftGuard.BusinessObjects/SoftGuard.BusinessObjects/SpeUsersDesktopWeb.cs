...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeUsersDesktopWeb : ISpecialization, ICanCopyProperties
    { 
 ...
 ///<summary>
     ...
     public int  udw_idKey 
		 { 
                    ...
                    get{ return this._DalObject.udw_idKey; }
        						set{ this._DalObject.udw_idKey = value; } 										
	   }
	  ///<summary>
     ...
     public string  udw_usuario 
		 { 
                    ...
                    get{ return this._DalObject.udw_usuario; }
        						set{ this._DalObject.udw_usuario = value; } 										
	   }
	  ///<summary>
     ///udw_clave property   
     ///</summary>	
     public string  udw_clave 
		 { 
                    ...
                    get{ return this._DalObject.udw_clave; }
        						set{ this._DalObject.udw_clave = value; } 										
	   }
	  ///<summary>
     ///udw_nombre property   
     ///</summary>	
     public string  udw_nombre 
		 { 
                    ...
                    get{ return this._DalObject.udw_nombre; }
        						set{ this._DalObject.udw_nombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  udw_apellido 
		 { 
                    ...
                    get{ return this._DalObject.udw_apellido; }
        						set{ this._DalObject.udw_apellido = value; } 										
	   }
	  ///<summary>
     ...
     public string  udw_empresa 
		 { 
                    ...
                    get{ return this._DalObject.udw_empresa; }
        						set{ this._DalObject.udw_empresa = value; } 										
	   }
	  ///<summary>
     ///udw_tipo property   
     ///</summary>	
     public int  udw_tipo 
		 { 
                    ...
                    get{ return this._DalObject.udw_tipo; }
        						set{ this._DalObject.udw_tipo = value; } 										
	   }
	  ///<summary>
     ...
     public int  udw_iperfil 
		 { 
                    ...
                    get{ return this._DalObject.udw_iperfil; }
        						set{ this._DalObject.udw_iperfil = value; } 										
	   }
		///<summary>
		///<summary>
		///udw_estado property   
		...
		public Decimal udw_estado
		{
			...
			get { return this._DalObject.udw_estado; }
			set { this._DalObject.udw_estado = value; }
		}
		///<summary>
		...
		public string udw_metadata
		{
			...
			get { return this._DalObject.udw_metadata; }
			set { this._DalObject.udw_metadata = value; }
		}
		///<summary>
		...
		public int udw_iloginfallido
		{
			...
			get { return this._DalObject.udw_iloginfallido; }
			set { this._DalObject.udw_iloginfallido = value; }
		}
		///Constructor   
		///</summary>
		public SpeUsersDesktopWeb(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeUsersDesktopWeb(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeUsersDesktopWeb(SqlHelper SqlConfig, int UserId, SimpleUsersDesktopWeb Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///</summary>
		public virtual void Load(int Id)
		{
            ...
            //Decrypt Passwords
            string Password = Decrypt(this._DalObject.udw_clave);

            this._DalObject.udw_clave = Password;
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleUsersDesktopWeb Simple)
		{
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        { 							
            ...
            {                
                //Encrypt Passwords                
                string Password = this._DalObject.udw_clave;
                string EncryptedPassword = Encrypt(this._DalObject.udw_clave);
                this._DalObject.udw_clave = EncryptedPassword;
        ...
        public string Decrypt(string text)
        {
            ...
            try
            {
                if (licensetype == 2)
                {
                    SecurityManager manager = new SecurityManager(_sqlConfig.ConnectionString);
                    CustomerInfo info = manager.GetKeyCustomerInfo();
                    //string pass = FingerPrint.Value();

                    logger.Trace("Desencripto con licencia:"+ info.Serial);
            ...
            {
                logger.Error("Error al desencriptar la password:" + d+" "+e.Message);
            }
        ...
        public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The UsersDesktopWeb has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalUsersDesktopWeb GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The UsersDesktopWeb is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalUsersDesktopWeb(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (UsersDesktopWeb)Object;
			o.Name = this.Name;

			o.udw_idKey = this.udw_idKey;

			o.udw_usuario = this.udw_usuario;

			o.udw_clave = this.udw_clave;

			o.udw_nombre = this.udw_nombre;

			o.udw_apellido = this.udw_apellido;

			o.udw_empresa = this.udw_empresa;

			o.udw_tipo = this.udw_tipo;

			o.udw_iperfil = this.udw_iperfil;

			o.udw_estado = this.udw_estado;

			o.udw_metadata = this.udw_metadata;

			o.udw_iloginfallido = this.udw_iloginfallido;
