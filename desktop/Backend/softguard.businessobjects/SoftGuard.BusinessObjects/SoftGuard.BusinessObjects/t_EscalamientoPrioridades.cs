...
// Type: SoftGuard.BusinessObjects.t_EscalamientoPrioridades
...
{
  public class t_EscalamientoPrioridades : Spet_EscalamientoPrioridades
  {
    public t_EscalamientoPrioridades(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_EscalamientoPrioridades(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_EscalamientoPrioridades(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_EscalamientoPrioridades(SqlHelper SqlConfig, int UserId, Simplet_EscalamientoPrioridades Simple)
