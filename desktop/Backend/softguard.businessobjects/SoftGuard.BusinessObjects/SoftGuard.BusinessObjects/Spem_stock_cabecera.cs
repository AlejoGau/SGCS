...
// Type: SoftGuard.BusinessObjects.Spem_stock_cabecera
...
{
  public abstract class Spem_stock_cabecera : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_stock_cabecera _DalObject;
    ...
    public int stc_iddepositoorigen
    {
      get
      {
        return this._DalObject.stc_iddepositoorigen;
      }
      set
      {
        this._DalObject.stc_iddepositoorigen = value;
      }
    }
    ...
    public int stc_iddepositodestino
    {
      get
      {
        return this._DalObject.stc_iddepositodestino;
      }
      set
      {
        this._DalObject.stc_iddepositodestino = value;
      }
    }
    ...
    public int stc_iusuariodss
    {
      get
      {
        return this._DalObject.stc_iusuariodss;
      }
      set
      {
        this._DalObject.stc_iusuariodss = value;
      }
    }
    ...
    public int stc_itecnico
    {
      get
      {
        return this._DalObject.stc_itecnico;
      }
      set
      {
        this._DalObject.stc_itecnico = value;
      }
    }
    ...
    public string stc_tipomov
    {
      get
      {
        return this._DalObject.stc_tipomov;
      }
      set
      {
        this._DalObject.stc_tipomov = value;
      }
    }
    ...
    public string stc_comprobantetipo
    {
      get
      {
        return this._DalObject.stc_comprobantetipo;
      }
      set
      {
        this._DalObject.stc_comprobantetipo = value;
      }
    }
    ...
    public string stc_comprobante
    {
      get
      {
        return this._DalObject.stc_comprobante;
      }
      set
      {
        this._DalObject.stc_comprobante = value;
      }
    }
    ...
    public string stc_referencia
    {
      get
      {
        return this._DalObject.stc_referencia;
      }
      set
      {
        this._DalObject.stc_referencia = value;
      }
    }
    ...
    public string stc_descripcion
    {
      get
      {
        return this._DalObject.stc_descripcion;
      }
      set
      {
        this._DalObject.stc_descripcion = value;
      }
    }
    ...
    public DateTime? stc_fecha
    {
      get
      {
        return this._DalObject.stc_fecha;
      }
      set
      {
        this._DalObject.stc_fecha = value;
      }
    }
    ...
    public Spem_stock_cabecera(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_stock_cabecera(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_stock_cabecera(SqlHelper SqlConfig, int UserId, Simplem_stock_cabecera Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_stock_cabecera Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_stock_cabecera has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_stock_cabecera GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_stock_cabecera is null.");
    ...
    {
      this._DalObject = new Dalm_stock_cabecera(SqlConfig, UserId);
    ...
    {
      m_stock_cabecera mStockCabecera = (m_stock_cabecera) Object;
      mStockCabecera.Name = this.Name;
      mStockCabecera.stc_iddepositoorigen = this.stc_iddepositoorigen;
      mStockCabecera.stc_iddepositodestino = this.stc_iddepositodestino;
      mStockCabecera.stc_iusuariodss = this.stc_iusuariodss;
      mStockCabecera.stc_itecnico = this.stc_itecnico;
      mStockCabecera.stc_tipomov = this.stc_tipomov;
      mStockCabecera.stc_comprobantetipo = this.stc_comprobantetipo;
      mStockCabecera.stc_comprobante = this.stc_comprobante;
      mStockCabecera.stc_referencia = this.stc_referencia;
      mStockCabecera.stc_descripcion = this.stc_descripcion;
      mStockCabecera.stc_fecha = this.stc_fecha;
    }
