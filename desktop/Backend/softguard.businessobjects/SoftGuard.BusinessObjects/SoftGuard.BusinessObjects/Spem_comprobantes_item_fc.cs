...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_comprobantes_item_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_comprobantes_item_fc _DalObject;
 ...
 ///<summary>
     ...
     public int  cbi_icodigocab 
		 { 
                    ...
                    get{ return this._DalObject.cbi_icodigocab; }
        						set{ this._DalObject.cbi_icodigocab = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbi_irenglon 
		 { 
                    ...
                    get{ return this._DalObject.cbi_irenglon; }
        						set{ this._DalObject.cbi_irenglon = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbi_iproducto 
		 { 
                    ...
                    get{ return this._DalObject.cbi_iproducto; }
        						set{ this._DalObject.cbi_iproducto = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbi_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.cbi_cdescripcion; }
        						set{ this._DalObject.cbi_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbi_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.cbi_ccodigo; }
        						set{ this._DalObject.cbi_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbi_inovedad 
		 { 
                    ...
                    get{ return this._DalObject.cbi_inovedad; }
        						set{ this._DalObject.cbi_inovedad = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbi_inovedadTabla 
		 { 
                    ...
                    get{ return this._DalObject.cbi_inovedadTabla; }
        						set{ this._DalObject.cbi_inovedadTabla = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  cbi_yimporte 
		 { 
                    ...
                    get{ return this._DalObject.cbi_yimporte; }
        						set{ this._DalObject.cbi_yimporte = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbi_icantidad 
		 { 
                    ...
                    get{ return this._DalObject.cbi_icantidad; }
        						set{ this._DalObject.cbi_icantidad = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  cbi_ndescuento 
		 { 
                    ...
                    get{ return this._DalObject.cbi_ndescuento; }
        						set{ this._DalObject.cbi_ndescuento = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbi_cimpuestos 
		 { 
                    ...
                    get{ return this._DalObject.cbi_cimpuestos; }
        						set{ this._DalObject.cbi_cimpuestos = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_comprobantes_item_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_comprobantes_item_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_comprobantes_item_fc(SqlHelper SqlConfig, int UserId, Simplem_comprobantes_item_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_comprobantes_item_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_comprobantes_item_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_comprobantes_item_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_comprobantes_item_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_comprobantes_item_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_comprobantes_item_fc)Object;
			o.Name = this.Name;

			o.cbi_icodigocab = this.cbi_icodigocab;

			o.cbi_irenglon = this.cbi_irenglon;

			o.cbi_iproducto = this.cbi_iproducto;

			o.cbi_cdescripcion = this.cbi_cdescripcion;

			o.cbi_ccodigo = this.cbi_ccodigo;

			o.cbi_inovedad = this.cbi_inovedad;

			o.cbi_inovedadTabla = this.cbi_inovedadTabla;

			o.cbi_yimporte = this.cbi_yimporte;

			o.cbi_icantidad = this.cbi_icantidad;

			o.cbi_ndescuento = this.cbi_ndescuento;

			o.cbi_cimpuestos = this.cbi_cimpuestos;
