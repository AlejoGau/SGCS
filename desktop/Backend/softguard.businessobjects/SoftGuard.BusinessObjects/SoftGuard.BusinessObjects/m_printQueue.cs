...
// Type: SoftGuard.BusinessObjects.m_printQueue
...
{
  public class m_printQueue : Spem_printQueue
  {
    public m_printQueue(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_printQueue(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_printQueue(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_printQueue(SqlHelper SqlConfig, int UserId, Simplem_printQueue Simple)
