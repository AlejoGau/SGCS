...
// Type: SoftGuard.BusinessObjects.t_ip_con
...
{
  public class t_ip_con : Spet_ip_con
  {
    public t_ip_con(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_ip_con(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_ip_con(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_ip_con(SqlHelper SqlConfig, int UserId, Simplet_ip_con Simple)
