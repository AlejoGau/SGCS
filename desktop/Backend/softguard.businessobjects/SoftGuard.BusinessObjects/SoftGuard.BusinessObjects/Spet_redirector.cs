...
// Type: SoftGuard.BusinessObjects.Spet_redirector
...
{
  public abstract class Spet_redirector : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_redirector _DalObject;
    ...
    public string trd_cnombre
    {
      get
      {
        return this._DalObject.trd_cnombre;
      }
      set
      {
        this._DalObject.trd_cnombre = value;
      }
    }
    ...
    public string trd_cdealer
    {
      get
      {
        return this._DalObject.trd_cdealer;
      }
      set
      {
        this._DalObject.trd_cdealer = value;
      }
    }
    ...
    public string trd_ceventos
    {
      get
      {
        return this._DalObject.trd_ceventos;
      }
      set
      {
        this._DalObject.trd_ceventos = value;
      }
    }
    ...
    public int trd_idestino
    {
      get
      {
        return this._DalObject.trd_idestino;
      }
      set
      {
        this._DalObject.trd_idestino = value;
      }
    }
    ...
    public Spet_redirector(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_redirector(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_redirector(SqlHelper SqlConfig, int UserId, Simplet_redirector Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_redirector Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_redirector has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_redirector GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_redirector is null.");
    ...
    {
      this._DalObject = new Dalt_redirector(SqlConfig, UserId);
    ...
    {
      t_redirector tRedirector = (t_redirector) Object;
      tRedirector.Name = this.Name;
      tRedirector.trd_cnombre = this.trd_cnombre;
      tRedirector.trd_cdealer = this.trd_cdealer;
      tRedirector.trd_ceventos = this.trd_ceventos;
      tRedirector.trd_idestino = this.trd_idestino;
    }
