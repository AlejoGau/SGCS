...
{ 
   ///<summary>
     ///m_reportes_automaticos_dealer class   
     ///</summary>
    public partial class m_reportes_automaticos_dealer : Spem_reportes_automaticos_dealer
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_reportes_automaticos_dealer(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_reportes_automaticos_dealer(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_reportes_automaticos_dealer(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_reportes_automaticos_dealer(SqlHelper SqlConfig, int UserId, Simplem_reportes_automaticos_dealer Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
