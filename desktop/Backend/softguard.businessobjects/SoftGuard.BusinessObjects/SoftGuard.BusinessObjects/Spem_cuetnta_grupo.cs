...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_cuetnta_grupo : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_cuetnta_grupo _DalObject;
 ...
 ///<summary>
     ...
     public string  cgr_cnombre 
		 { 
                    ...
                    get{ return this._DalObject.cgr_cnombre; }
        						set{ this._DalObject.cgr_cnombre = value; } 										
	   }
	  ///<summary>
     ///cgr_itipo property   
     ///</summary>	
     public int  cgr_itipo 
		 { 
                    ...
                    get{ return this._DalObject.cgr_itipo; }
        						set{ this._DalObject.cgr_itipo = value; } 										
	   }
	  ///<summary>
     ...
     public int  cgr_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.cgr_iidcuenta; }
        						set{ this._DalObject.cgr_iidcuenta = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_cuetnta_grupo(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuetnta_grupo(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuetnta_grupo(SqlHelper SqlConfig, int UserId, Simplem_cuetnta_grupo Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_cuetnta_grupo Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_cuetnta_grupo has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_cuetnta_grupo GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_cuetnta_grupo is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_cuetnta_grupo(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_cuetnta_grupo)Object;
			o.Name = this.Name;

			o.cgr_cnombre = this.cgr_cnombre;

			o.cgr_itipo = this.cgr_itipo;

			o.cgr_iidcuenta = this.cgr_iidcuenta;
