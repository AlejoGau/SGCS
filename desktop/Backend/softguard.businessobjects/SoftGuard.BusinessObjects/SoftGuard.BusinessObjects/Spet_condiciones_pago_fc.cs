...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_condiciones_pago_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_condiciones_pago_fc _DalObject;
 ...
 ///<summary>
     ...
     public string  con_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.con_ccodigo; }
        						set{ this._DalObject.con_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  con_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.con_cdescripcion; }
        						set{ this._DalObject.con_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  con_ncuotas 
		 { 
                    ...
                    get{ return this._DalObject.con_ncuotas; }
        						set{ this._DalObject.con_ncuotas = value; } 										
	   }
	  ///<summary>
     ///con_idias property   
     ///</summary>	
     public int  con_idias 
		 { 
                    ...
                    get{ return this._DalObject.con_idias; }
        						set{ this._DalObject.con_idias = value; } 										
	   }
	  ///<summary>
     ...
     public int  con_ifrecuencia 
		 { 
                    ...
                    get{ return this._DalObject.con_ifrecuencia; }
        						set{ this._DalObject.con_ifrecuencia = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  con_nPideDatos 
		 { 
                    ...
                    get{ return this._DalObject.con_nPideDatos; }
        						set{ this._DalObject.con_nPideDatos = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  con_nCobranzaAut 
		 { 
                    ...
                    get{ return this._DalObject.con_nCobranzaAut; }
        						set{ this._DalObject.con_nCobranzaAut = value; } 										
	   }
	  ///<summary>
     ...
     public string  con_cCodigoBarra 
		 { 
                    ...
                    get{ return this._DalObject.con_cCodigoBarra; }
        						set{ this._DalObject.con_cCodigoBarra = value; } 										
	   }
	  ///<summary>
     ...
     public int  con_iRemesa 
		 { 
                    ...
                    get{ return this._DalObject.con_iRemesa; }
        						set{ this._DalObject.con_iRemesa = value; } 										
	   }
	  ///<summary>
     ...
     public string  con_cDatosExtra 
		 { 
                    ...
                    get{ return this._DalObject.con_cDatosExtra; }
        						set{ this._DalObject.con_cDatosExtra = value; } 										
	   }
	  ///<summary>
     ...
     public string  con_cFormaPagoCobrAut 
		 { 
                    ...
                    get{ return this._DalObject.con_cFormaPagoCobrAut; }
        						set{ this._DalObject.con_cFormaPagoCobrAut = value; } 										
	   }
	  ///<summary>
     ...
     public int  con_orgidcodigoid 
		 { 
                    ...
                    get{ return this._DalObject.con_orgidcodigoid; }
        						set{ this._DalObject.con_orgidcodigoid = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_condiciones_pago_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_condiciones_pago_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_condiciones_pago_fc(SqlHelper SqlConfig, int UserId, Simplet_condiciones_pago_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_condiciones_pago_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_condiciones_pago_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_condiciones_pago_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_condiciones_pago_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_condiciones_pago_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_condiciones_pago_fc)Object;
			o.Name = this.Name;

			o.con_ccodigo = this.con_ccodigo;

			o.con_cdescripcion = this.con_cdescripcion;

			o.con_ncuotas = this.con_ncuotas;

			o.con_idias = this.con_idias;

			o.con_ifrecuencia = this.con_ifrecuencia;

			o.con_nPideDatos = this.con_nPideDatos;

			o.con_nCobranzaAut = this.con_nCobranzaAut;

			o.con_cCodigoBarra = this.con_cCodigoBarra;

			o.con_iRemesa = this.con_iRemesa;

			o.con_cDatosExtra = this.con_cDatosExtra;

			o.con_cFormaPagoCobrAut = this.con_cFormaPagoCobrAut;

			o.con_orgidcodigoid = this.con_orgidcodigoid;
