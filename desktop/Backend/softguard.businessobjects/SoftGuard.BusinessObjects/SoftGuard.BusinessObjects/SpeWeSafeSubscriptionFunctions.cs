...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeWeSafeSubscriptionFunctions : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalWeSafeSubscriptionFunctions _DalObject;
 ...
 ///<summary>
     ...
     public int  wsf_idKey 
		 { 
                    ...
                    get{ return this._DalObject.wsf_idKey; }
        						set{ this._DalObject.wsf_idKey = value; } 										
	   }
	  ///<summary>
     ...
     public int  wsf_iSubscriptionID 
		 { 
                    ...
                    get{ return this._DalObject.wsf_iSubscriptionID; }
        						set{ this._DalObject.wsf_iSubscriptionID = value; } 										
	   }
	  ///<summary>
     ...
     public int  wsf_iFunctionID 
		 { 
                    ...
                    get{ return this._DalObject.wsf_iFunctionID; }
        						set{ this._DalObject.wsf_iFunctionID = value; } 										
	   }
	  ///<summary>
     ...
     public int  wsu_iSelected 
		 { 
                    ...
                    get{ return this._DalObject.wsu_iSelected; }
        						set{ this._DalObject.wsu_iSelected = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeWeSafeSubscriptionFunctions(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeWeSafeSubscriptionFunctions(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeWeSafeSubscriptionFunctions(SqlHelper SqlConfig, int UserId, SimpleWeSafeSubscriptionFunctions Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleWeSafeSubscriptionFunctions Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The WeSafeSubscriptionFunctions has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalWeSafeSubscriptionFunctions GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The WeSafeSubscriptionFunctions is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalWeSafeSubscriptionFunctions(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.WeSafeSubscriptionFunctions)Object;
			o.Name = this.Name;

			o.wsf_idKey = this.wsf_idKey;

			o.wsf_iSubscriptionID = this.wsf_iSubscriptionID;

			o.wsf_iFunctionID = this.wsf_iFunctionID;

			o.wsu_iSelected = this.wsu_iSelected;
