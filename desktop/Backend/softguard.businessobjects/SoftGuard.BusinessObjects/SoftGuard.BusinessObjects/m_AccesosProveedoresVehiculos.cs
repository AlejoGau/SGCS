...
{ 
   ///<summary>
     ///m_AccesosProveedoresVehiculos class   
     ///</summary>
    public partial class m_AccesosProveedoresVehiculos : Spem_AccesosProveedoresVehiculos
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_AccesosProveedoresVehiculos(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_AccesosProveedoresVehiculos(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_AccesosProveedoresVehiculos(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_AccesosProveedoresVehiculos(SqlHelper SqlConfig, int UserId, Simplem_AccesosProveedoresVehiculos Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
