...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_controlAcceso_IO : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_controlAcceso_IO _DalObject;
 ...
 ///<summary>
     ...
     public int  cac_tipoacceso 
		 { 
                    ...
                    get{ return this._DalObject.cac_tipoacceso; }
        						set{ this._DalObject.cac_tipoacceso = value; } 										
	   }
	  ///<summary>
     ...
     public int  cac_idpuerta 
		 { 
                    ...
                    get{ return this._DalObject.cac_idpuerta; }
        						set{ this._DalObject.cac_idpuerta = value; } 										
	   }
	  ///<summary>
     ///cac_fecha property   
     ///</summary>	
     public DateTime?  cac_fecha 
		 { 
                    ...
                    get{ return this._DalObject.cac_fecha; }
        						set{ this._DalObject.cac_fecha = value; } 										
	   }
	  ///<summary>
     ...
     public int  cac_idautorizado 
		 { 
                    ...
                    get{ return this._DalObject.cac_idautorizado; }
        						set{ this._DalObject.cac_idautorizado = value; } 										
	   }
	  ///<summary>
     ...
     public int  cac_autorizatipo 
		 { 
                    ...
                    get{ return this._DalObject.cac_autorizatipo; }
        						set{ this._DalObject.cac_autorizatipo = value; } 										
	   }
	  ///<summary>
     ...
     public int  cac_autorizaid 
		 { 
                    ...
                    get{ return this._DalObject.cac_autorizaid; }
        						set{ this._DalObject.cac_autorizaid = value; } 										
	   }
	  ///<summary>
     ...
     public string  cac_autorizacodigo 
		 { 
                    ...
                    get{ return this._DalObject.cac_autorizacodigo; }
        						set{ this._DalObject.cac_autorizacodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  cac_cobservacion 
		 { 
                    ...
                    get{ return this._DalObject.cac_cobservacion; }
        						set{ this._DalObject.cac_cobservacion = value; } 										
	   }
	  ///<summary>
     ...
     public int  cac_autorizadotipoid 
		 { 
                    ...
                    get{ return this._DalObject.cac_autorizadotipoid; }
        						set{ this._DalObject.cac_autorizadotipoid = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_controlAcceso_IO(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_controlAcceso_IO(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_controlAcceso_IO(SqlHelper SqlConfig, int UserId, Simplep_controlAcceso_IO Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_controlAcceso_IO Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_controlAcceso_IO has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_controlAcceso_IO GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_controlAcceso_IO is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_controlAcceso_IO(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_controlAcceso_IO)Object;
			o.Name = this.Name;

			o.cac_tipoacceso = this.cac_tipoacceso;

			o.cac_idpuerta = this.cac_idpuerta;

			o.cac_fecha = this.cac_fecha;

			o.cac_idautorizado = this.cac_idautorizado;

			o.cac_autorizatipo = this.cac_autorizatipo;

			o.cac_autorizaid = this.cac_autorizaid;

			o.cac_autorizacodigo = this.cac_autorizacodigo;

			o.cac_cobservacion = this.cac_cobservacion;

			o.cac_autorizadotipoid = this.cac_autorizadotipoid;
