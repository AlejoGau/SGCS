...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_notificaciones_dealer : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_notificaciones_dealer _DalObject;
 ...
 ///<summary>
     ...
     public string  tnd_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.tnd_cDealer; }
        						set{ this._DalObject.tnd_cDealer = value; } 										
	   }
	  ///<summary>
     ...
     public string  tnd_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.tnd_cDescripcion; }
        						set{ this._DalObject.tnd_cDescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public int  tnd_iNotificarAlertas 
		 { 
                    ...
                    get{ return this._DalObject.tnd_iNotificarAlertas; }
        						set{ this._DalObject.tnd_iNotificarAlertas = value; } 										
	   }
	  ///<summary>
     ...
     public int  tnd_iGrupoAlarmas 
		 { 
                    ...
                    get{ return this._DalObject.tnd_iGrupoAlarmas; }
        						set{ this._DalObject.tnd_iGrupoAlarmas = value; } 										
	   }
	  ///<summary>
     ...
     public string  tnd_cAlarmas 
		 { 
                    ...
                    get{ return this._DalObject.tnd_cAlarmas; }
        						set{ this._DalObject.tnd_cAlarmas = value; } 										
	   }
	  ///<summary>
     ///tnd_cMail property   
     ///</summary>	
     public string  tnd_cMail 
		 { 
                    ...
                    get{ return this._DalObject.tnd_cMail; }
        						set{ this._DalObject.tnd_cMail = value; } 										
	   }
	  ///<summary>
     ...
     public string  tnd_cPlantillaMail 
		 { 
                    ...
                    get{ return this._DalObject.tnd_cPlantillaMail; }
        						set{ this._DalObject.tnd_cPlantillaMail = value; } 										
	   }
	  ///<summary>
     ///tnd_iTipo property   
     ///</summary>	
     public int  tnd_iTipo 
		 { 
                    ...
                    get{ return this._DalObject.tnd_iTipo; }
        						set{ this._DalObject.tnd_iTipo = value; } 										
	   }
	  ///<summary>
     ///tnd_iAdmin property   
     ///</summary>	
     public int  tnd_iAdmin 
		 { 
                    ...
                    get{ return this._DalObject.tnd_iAdmin; }
        						set{ this._DalObject.tnd_iAdmin = value; } 										
	   }
	  ///<summary>
     ...
     public int  tnd_iNotificarSP 
		 { 
                    ...
                    get{ return this._DalObject.tnd_iNotificarSP; }
        						set{ this._DalObject.tnd_iNotificarSP = value; } 										
	   }
	  ///<summary>
     ///tnd_cSMS property   
     ///</summary>	
     public string  tnd_cSMS 
		 { 
                    ...
                    get{ return this._DalObject.tnd_cSMS; }
        						set{ this._DalObject.tnd_cSMS = value; } 										
	   }
	  ///<summary>
     ...
     public int  tnd_iModemSMS 
		 { 
                    ...
                    get{ return this._DalObject.tnd_iModemSMS; }
        						set{ this._DalObject.tnd_iModemSMS = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_notificaciones_dealer(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_notificaciones_dealer(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_notificaciones_dealer(SqlHelper SqlConfig, int UserId, Simplet_notificaciones_dealer Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_notificaciones_dealer Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_notificaciones_dealer has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_notificaciones_dealer GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_notificaciones_dealer is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_notificaciones_dealer(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_notificaciones_dealer)Object;
			o.Name = this.Name;

			o.tnd_cDealer = this.tnd_cDealer;

			o.tnd_cDescripcion = this.tnd_cDescripcion;

			o.tnd_iNotificarAlertas = this.tnd_iNotificarAlertas;

			o.tnd_iGrupoAlarmas = this.tnd_iGrupoAlarmas;

			o.tnd_cAlarmas = this.tnd_cAlarmas;

			o.tnd_cMail = this.tnd_cMail;

			o.tnd_cPlantillaMail = this.tnd_cPlantillaMail;

			o.tnd_iTipo = this.tnd_iTipo;

			o.tnd_iAdmin = this.tnd_iAdmin;

			o.tnd_iNotificarSP = this.tnd_iNotificarSP;

			o.tnd_cSMS = this.tnd_cSMS;

			o.tnd_iModemSMS = this.tnd_iModemSMS;
