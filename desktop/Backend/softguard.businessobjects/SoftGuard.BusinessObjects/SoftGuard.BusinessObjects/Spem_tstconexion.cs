...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_tstconexion : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_tstconexion _DalObject;
 ...
 ///<summary>
     ...
     public int  txc_idCuenta 
		 { 
                    ...
                    get{ return this._DalObject.txc_idCuenta; }
        						set{ this._DalObject.txc_idCuenta = value; } 										
	   }
	  ///<summary>
     ...
     public int  txc_idIRSConn 
		 { 
                    ...
                    get{ return this._DalObject.txc_idIRSConn; }
        						set{ this._DalObject.txc_idIRSConn = value; } 										
	   }
	  ///<summary>
     ...
     public string  txc_cAlarmaEsperada 
		 { 
                    ...
                    get{ return this._DalObject.txc_cAlarmaEsperada; }
        						set{ this._DalObject.txc_cAlarmaEsperada = value; } 										
	   }
	  ///<summary>
     ...
     public int  txc_iMinutos 
		 { 
                    ...
                    get{ return this._DalObject.txc_iMinutos; }
        						set{ this._DalObject.txc_iMinutos = value; } 										
	   }
	  ///<summary>
     ...
     public string  txc_cAlarmaAGenerar 
		 { 
                    ...
                    get{ return this._DalObject.txc_cAlarmaAGenerar; }
        						set{ this._DalObject.txc_cAlarmaAGenerar = value; } 										
	   }
	  ///<summary>
     ...
     public string  txc_cAlarmaAutoprocesa 
		 { 
                    ...
                    get{ return this._DalObject.txc_cAlarmaAutoprocesa; }
        						set{ this._DalObject.txc_cAlarmaAutoprocesa = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_tstconexion(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_tstconexion(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_tstconexion(SqlHelper SqlConfig, int UserId, Simplem_tstconexion Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_tstconexion Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_tstconexion has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_tstconexion GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_tstconexion is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_tstconexion(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_tstconexion)Object;
			o.Name = this.Name;

			o.txc_idCuenta = this.txc_idCuenta;

			o.txc_idIRSConn = this.txc_idIRSConn;

			o.txc_cAlarmaEsperada = this.txc_cAlarmaEsperada;

			o.txc_iMinutos = this.txc_iMinutos;

			o.txc_cAlarmaAGenerar = this.txc_cAlarmaAGenerar;

			o.txc_cAlarmaAutoprocesa = this.txc_cAlarmaAutoprocesa;
