...
{ 
   ///<summary>
     ///m_dealer_stconfig class   
     ///</summary>
    public partial class m_dealer_stconfig : Spem_dealer_stconfig
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_dealer_stconfig(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_dealer_stconfig(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_dealer_stconfig(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_dealer_stconfig(SqlHelper SqlConfig, int UserId, Simplem_dealer_stconfig Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
