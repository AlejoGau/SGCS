...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_linkurl : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_linkurl _DalObject;
 ...
 ///<summary>
     ...
     public string  url_cname 
		 { 
                    ...
                    get{ return this._DalObject.url_cname; }
        						set{ this._DalObject.url_cname = value; } 										
	   }
	  ///<summary>
     ...
     public string  url_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.url_cdescripcion; }
        						set{ this._DalObject.url_cdescripcion = value; } 										
	   }
	  ///<summary>
     ///url_curl property   
     ///</summary>	
     public string  url_curl 
		 { 
                    ...
                    get{ return this._DalObject.url_curl; }
        						set{ this._DalObject.url_curl = value; } 										
	   }
	  ///<summary>
     ...
     public string  url_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.url_cDealer; }
        						set{ this._DalObject.url_cDealer = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_linkurl(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_linkurl(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_linkurl(SqlHelper SqlConfig, int UserId, Simplet_linkurl Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_linkurl Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_linkurl has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_linkurl GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_linkurl is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_linkurl(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_linkurl)Object;
			o.Name = this.Name;

			o.url_cname = this.url_cname;

			o.url_cdescripcion = this.url_cdescripcion;

			o.url_curl = this.url_curl;

			o.url_cDealer = this.url_cDealer;
