...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeOperadorVirtualConfig : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalOperadorVirtualConfig _DalObject;
 ...
 ///<summary>
     ...
     public string  ovc_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.ovc_cDescripcion; }
        						set{ this._DalObject.ovc_cDescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public int  ovc_iStatus 
		 { 
                    ...
                    get{ return this._DalObject.ovc_iStatus; }
        						set{ this._DalObject.ovc_iStatus = value; } 										
	   }
	  ///<summary>
     ...
     public string  ovc_cDealers 
		 { 
                    ...
                    get{ return this._DalObject.ovc_cDealers; }
        						set{ this._DalObject.ovc_cDealers = value; } 										
	   }
	  ///<summary>
     ...
     public string  ovc_cEventos 
		 { 
                    ...
                    get{ return this._DalObject.ovc_cEventos; }
        						set{ this._DalObject.ovc_cEventos = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  ovc_tLastUpdated 
		 { 
                    ...
                    get{ return this._DalObject.ovc_tLastUpdated; }
        						set{ this._DalObject.ovc_tLastUpdated = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  ovc_tCreatedDate 
		 { 
                    ...
                    get{ return this._DalObject.ovc_tCreatedDate; }
        						set{ this._DalObject.ovc_tCreatedDate = value; } 										
	   }
	  ///<summary>
     ...
     public string  ovc_cEventType 
		 { 
                    ...
                    get{ return this._DalObject.ovc_cEventType; }
        						set{ this._DalObject.ovc_cEventType = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeOperadorVirtualConfig(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeOperadorVirtualConfig(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeOperadorVirtualConfig(SqlHelper SqlConfig, int UserId, SimpleOperadorVirtualConfig Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleOperadorVirtualConfig Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The OperadorVirtualConfig has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalOperadorVirtualConfig GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The OperadorVirtualConfig is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalOperadorVirtualConfig(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.OperadorVirtualConfig)Object;
			o.Name = this.Name;

			o.ovc_cDescripcion = this.ovc_cDescripcion;

			o.ovc_iStatus = this.ovc_iStatus;

			o.ovc_cDealers = this.ovc_cDealers;

			o.ovc_cEventos = this.ovc_cEventos;

			o.ovc_tLastUpdated = this.ovc_tLastUpdated;

			o.ovc_tCreatedDate = this.ovc_tCreatedDate;

			o.ovc_cEventType = this.ovc_cEventType;
