...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeOperadorVirtualConfigDealers : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalOperadorVirtualConfigDealers _DalObject;
 ...
 ///<summary>
     ...
     public int  ovd_iOperadorVirtualConfigId 
		 { 
                    ...
                    get{ return this._DalObject.ovd_iOperadorVirtualConfigId; }
        						set{ this._DalObject.ovd_iOperadorVirtualConfigId = value; } 										
	   }
	  ///<summary>
     ...
     public string  ovd_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.ovd_cDealer; }
        						set{ this._DalObject.ovd_cDealer = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeOperadorVirtualConfigDealers(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeOperadorVirtualConfigDealers(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeOperadorVirtualConfigDealers(SqlHelper SqlConfig, int UserId, SimpleOperadorVirtualConfigDealers Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleOperadorVirtualConfigDealers Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The OperadorVirtualConfigDealers has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalOperadorVirtualConfigDealers GetDalObject()
		{
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<SimpleOperadorVirtualConfigDealers> GetByParent(string ObjectType, int ObjectId)
		{
			return this._DalObject.GetByParent(ObjectType, ObjectId);
		}
		public IEnumerable<SimpleOperadorVirtualConfigDealers> GetByChild(string ObjectType, int ObjectId)
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The OperadorVirtualConfigDealers is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalOperadorVirtualConfigDealers(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.OperadorVirtualConfigDealers)Object;
			o.Name = this.Name;

			o.ovd_iOperadorVirtualConfigId = this.ovd_iOperadorVirtualConfigId;

			o.ovd_cDealer = this.ovd_cDealer;
