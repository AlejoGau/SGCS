...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_WeSafePriceOptions : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_WeSafePriceOptions _DalObject;
 ...
 ///<summary>
     ...
     public Decimal  wpr_nPrice 
		 { 
                    ...
                    get{ return this._DalObject.wpr_nPrice; }
        						set{ this._DalObject.wpr_nPrice = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_WeSafePriceOptions(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_WeSafePriceOptions(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_WeSafePriceOptions(SqlHelper SqlConfig, int UserId, Simplet_WeSafePriceOptions Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_WeSafePriceOptions Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_WeSafePriceOptions has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_WeSafePriceOptions GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_WeSafePriceOptions is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_WeSafePriceOptions(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_WeSafePriceOptions)Object;
			o.Name = this.Name;

			o.wpr_nPrice = this.wpr_nPrice;
