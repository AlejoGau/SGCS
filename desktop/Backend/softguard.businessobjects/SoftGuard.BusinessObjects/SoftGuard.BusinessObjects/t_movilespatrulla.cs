...
// Type: SoftGuard.BusinessObjects.t_movilespatrulla
...
{
  public class t_movilespatrulla : Spet_movilespatrulla
  {
    public t_movilespatrulla(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_movilespatrulla(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_movilespatrulla(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_movilespatrulla(SqlHelper SqlConfig, int UserId, Simplet_movilespatrulla Simple)
