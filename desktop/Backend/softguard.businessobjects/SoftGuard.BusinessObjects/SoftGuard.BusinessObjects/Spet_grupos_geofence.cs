...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_grupos_geofence : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_grupos_geofence _DalObject;
 ...
 ///<summary>
     ...
     public string  grg_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.grg_cdescripcion; }
        						set{ this._DalObject.grg_cdescripcion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_grupos_geofence(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_grupos_geofence(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_grupos_geofence(SqlHelper SqlConfig, int UserId, Simplet_grupos_geofence Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_grupos_geofence Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_grupos_geofence has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_grupos_geofence GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_grupos_geofence is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_grupos_geofence(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_grupos_geofence)Object;
			o.Name = this.Name;

			o.grg_cdescripcion = this.grg_cdescripcion;
