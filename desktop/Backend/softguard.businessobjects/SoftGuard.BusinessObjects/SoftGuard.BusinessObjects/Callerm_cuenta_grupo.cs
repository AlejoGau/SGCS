...
{ 	
   ///<summary>
     ///Caller object class   
     ///</summary>
    public class Callerm_cuenta_grupo : CallerObject
    { 	
     ...
     ///Constructor   
     ///</summary>
        public Callerm_cuenta_grupo() : base()
        {
            InitClass();
        }  
 ///<summary>
     ///Constructor   
     ///</summary>		
        public Callerm_cuenta_grupo(int Id, string Name, string cgr_cnombre, int cgr_itipo, int cgr_iidcuenta) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
...
this._cgr_iidcuenta = cgr_iidcuenta;
        ...
        {														
  				  base.Type = new ObjectType(3218, "m_cuenta_grupo");
        }
 ///<summary>
 ...
 ///<summary>
     ...
     ///</summary>	
		...
		{
			Simplem_cuenta_grupo Simple = new Simplem_cuenta_grupo();
			Simple.Id = base.Id;
...
Simple.cgr_iidcuenta = this._cgr_iidcuenta;
 ...
 ///<summary>
     ///Sets a simpleobject   
     ///</summary>	
		public void SetSimpleObject(Simplem_cuenta_grupo Simple)
		{
			base.Id = Simple.Id;
...
this._cgr_iidcuenta = Simple.cgr_iidcuenta;
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{
			return new Dalm_cuenta_grupo(SqlConfig, UserId, (Simplem_cuenta_grupo) GetSimpleObject());
		}
 ///<summary>
     ///Get object's data   
     ///</summary>
