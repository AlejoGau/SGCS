...
{ 
   ///<summary>
     ///WeSafeSubscription class   
     ///</summary>
    public partial class WeSafeSubscription : SpeWeSafeSubscription
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public WeSafeSubscription(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public WeSafeSubscription(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public WeSafeSubscription(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public WeSafeSubscription(SqlHelper SqlConfig, int UserId, SimpleWeSafeSubscription Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
