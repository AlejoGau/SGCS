...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_AccesosProveedoresVehiculos : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_AccesosProveedoresVehiculos _DalObject;
 ...
 ///<summary>
     ...
     public int  apv_idKeyProveedor 
		 { 
                    ...
                    get{ return this._DalObject.apv_idKeyProveedor; }
        						set{ this._DalObject.apv_idKeyProveedor = value; } 										
	   }
	  ///<summary>
     ...
     public int  apv_idKeyVehiculo 
		 { 
                    ...
                    get{ return this._DalObject.apv_idKeyVehiculo; }
        						set{ this._DalObject.apv_idKeyVehiculo = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_AccesosProveedoresVehiculos(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_AccesosProveedoresVehiculos(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_AccesosProveedoresVehiculos(SqlHelper SqlConfig, int UserId, Simplem_AccesosProveedoresVehiculos Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_AccesosProveedoresVehiculos Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_AccesosProveedoresVehiculos has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_AccesosProveedoresVehiculos GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_AccesosProveedoresVehiculos is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_AccesosProveedoresVehiculos(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_AccesosProveedoresVehiculos)Object;
			o.Name = this.Name;

			o.apv_idKeyProveedor = this.apv_idKeyProveedor;

			o.apv_idKeyVehiculo = this.apv_idKeyVehiculo;
