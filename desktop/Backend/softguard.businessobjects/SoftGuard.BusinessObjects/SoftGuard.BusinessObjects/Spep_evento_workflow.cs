...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_evento_workflow : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_evento_workflow _DalObject;
 ...
 ///<summary>
     ...
     public string  pew_proceso_estados 
		 { 
                    ...
                    get{ return this._DalObject.pew_proceso_estados; }
        						set{ this._DalObject.pew_proceso_estados = value; } 										
	   }
	  ///<summary>
     ///pew_name property   
     ///</summary>	
     public string  pew_name 
		 { 
                    ...
                    get{ return this._DalObject.pew_name; }
        						set{ this._DalObject.pew_name = value; } 										
	   }
	  ///<summary>
     ...
     public string  pew_evento_estados 
		 { 
                    ...
                    get{ return this._DalObject.pew_evento_estados; }
        						set{ this._DalObject.pew_evento_estados = value; } 										
	   }
	  ///<summary>
     ...
     public string  pew_dealers 
		 { 
                    ...
                    get{ return this._DalObject.pew_dealers; }
        						set{ this._DalObject.pew_dealers = value; } 										
	   }
	  ///<summary>
     ...
     public string  pew_codalarmas 
		 { 
                    ...
                    get{ return this._DalObject.pew_codalarmas; }
        						set{ this._DalObject.pew_codalarmas = value; } 										
	   }
	  ///<summary>
     ...
     public int  pew_codalarmagrupo 
		 { 
                    ...
                    get{ return this._DalObject.pew_codalarmagrupo; }
        						set{ this._DalObject.pew_codalarmagrupo = value; } 										
	   }
	  ///<summary>
     ///pew_sql property   
     ///</summary>	
     public string  pew_sql 
		 { 
                    ...
                    get{ return this._DalObject.pew_sql; }
        						set{ this._DalObject.pew_sql = value; } 										
	   }
	  ///<summary>
     ///pew_config property   
     ///</summary>	
     public string  pew_config 
		 { 
                    ...
                    get{ return this._DalObject.pew_config; }
        						set{ this._DalObject.pew_config = value; } 										
	   }
	  ///<summary>
     ...
     public string  pew_form_config 
		 { 
                    ...
                    get{ return this._DalObject.pew_form_config; }
        						set{ this._DalObject.pew_form_config = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_evento_workflow(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_evento_workflow(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_evento_workflow(SqlHelper SqlConfig, int UserId, Simplep_evento_workflow Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_evento_workflow Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_evento_workflow has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_evento_workflow GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_evento_workflow is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_evento_workflow(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (p_evento_workflow)Object;
			o.Name = this.Name;

			o.pew_proceso_estados = this.pew_proceso_estados;

			o.pew_name = this.pew_name;

			o.pew_evento_estados = this.pew_evento_estados;

			o.pew_dealers = this.pew_dealers;

			o.pew_codalarmas = this.pew_codalarmas;

			o.pew_codalarmagrupo = this.pew_codalarmagrupo;

			o.pew_sql = this.pew_sql;

			o.pew_config = this.pew_config;

			o.pew_form_config = this.pew_form_config;
