...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_paneles : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_paneles _DalObject;
 ...
 ///<summary>
     ...
     public string  pan_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.pan_cdescripcion; }
        						set{ this._DalObject.pan_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  pan_mobservacion 
		 { 
                    ...
                    get{ return this._DalObject.pan_mobservacion; }
        						set{ this._DalObject.pan_mobservacion = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  pan_nesgprs 
		 { 
                    ...
                    get{ return this._DalObject.pan_nesgprs; }
        						set{ this._DalObject.pan_nesgprs = value; } 										
	   }
	  ///<summary>
     ...
     public int  pan_iModelo 
		 { 
                    ...
                    get{ return this._DalObject.pan_iModelo; }
        						set{ this._DalObject.pan_iModelo = value; } 										
	   }
	  ///<summary>
     ...
     public string  pan_cImagen 
		 { 
                    ...
                    get{ return this._DalObject.pan_cImagen; }
        						set{ this._DalObject.pan_cImagen = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_paneles(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_paneles(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_paneles(SqlHelper SqlConfig, int UserId, Simplet_paneles Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_paneles Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_paneles has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_paneles GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_paneles is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_paneles(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_paneles)Object;
			o.Name = this.Name;

			o.pan_ccodigo = this.pan_ccodigo;

			o.pan_cdescripcion = this.pan_cdescripcion;

			o.pan_mobservacion = this.pan_mobservacion;

			o.pan_nesgprs = this.pan_nesgprs;

			o.pan_iModelo = this.pan_iModelo;

			o.pan_cImagen = this.pan_cImagen;
