...
// Type: SoftGuard.BusinessObjects.t_videoidXtrainfo
...
{
  public class t_videoidXtrainfo : Spet_videoidXtrainfo
  {
    public t_videoidXtrainfo(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_videoidXtrainfo(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_videoidXtrainfo(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_videoidXtrainfo(SqlHelper SqlConfig, int UserId, Simplet_videoidXtrainfo Simple)
