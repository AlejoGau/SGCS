...
// Type: SoftGuard.BusinessObjects.SerTecTimeLine
...
{
  public class SerTecTimeLine : SpeSerTecTimeLine
  {
    public SerTecTimeLine(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public SerTecTimeLine(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public SerTecTimeLine(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public SerTecTimeLine(SqlHelper SqlConfig, int UserId, SimpleSerTecTimeLine Simple)
