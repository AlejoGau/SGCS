...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeT_AccesosCategoriaProveedor : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalT_AccesosCategoriaProveedor _DalObject;
 ...
 ///<summary>
     ...
     public string  acp_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.acp_cDescripcion; }
        						set{ this._DalObject.acp_cDescripcion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeT_AccesosCategoriaProveedor(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_AccesosCategoriaProveedor(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_AccesosCategoriaProveedor(SqlHelper SqlConfig, int UserId, SimpleT_AccesosCategoriaProveedor Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleT_AccesosCategoriaProveedor Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The T_AccesosCategoriaProveedor has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalT_AccesosCategoriaProveedor GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The T_AccesosCategoriaProveedor is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalT_AccesosCategoriaProveedor(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.T_AccesosCategoriaProveedor)Object;
			o.Name = this.Name;

			o.acp_cDescripcion = this.acp_cDescripcion;
