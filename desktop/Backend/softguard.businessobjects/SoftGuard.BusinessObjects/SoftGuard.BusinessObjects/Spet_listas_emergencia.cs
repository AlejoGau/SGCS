...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_listas_emergencia : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_listas_emergencia _DalObject;
 ...
 ///<summary>
     ...
     public string  lis_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.lis_ccodigo; }
        						set{ this._DalObject.lis_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  lis_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.lis_cdescripcion; }
        						set{ this._DalObject.lis_cdescripcion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_listas_emergencia(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_listas_emergencia(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_listas_emergencia(SqlHelper SqlConfig, int UserId, Simplet_listas_emergencia Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_listas_emergencia Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_listas_emergencia has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_listas_emergencia GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_listas_emergencia is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_listas_emergencia(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_listas_emergencia)Object;
			o.Name = this.Name;

			o.lis_ccodigo = this.lis_ccodigo;

			o.lis_cdescripcion = this.lis_cdescripcion;
