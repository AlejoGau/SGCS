...
{ 
   ///<summary>
     ///t_controlAcceso_puerta class   
     ///</summary>
    public partial class t_controlAcceso_puerta : Spet_controlAcceso_puerta
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_controlAcceso_puerta(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_controlAcceso_puerta(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_controlAcceso_puerta(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_controlAcceso_puerta(SqlHelper SqlConfig, int UserId, Simplet_controlAcceso_puerta Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
