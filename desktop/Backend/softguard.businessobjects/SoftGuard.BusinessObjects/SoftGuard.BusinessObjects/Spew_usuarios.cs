...
// Type: SoftGuard.BusinessObjects.Spew_usuarios
...
{
  public abstract class Spew_usuarios : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalw_usuarios _DalObject;
    ...
    public string nombrelogin
    {
      get
      {
        return this._DalObject.nombrelogin;
      }
      set
      {
        this._DalObject.nombrelogin = value;
      }
    }
    ...
    public string contrasena
    {
      get
      {
        return this._DalObject.contrasena;
      }
      set
      {
        this._DalObject.contrasena = value;
      }
    }
    ...
    public bool first_login
    {
      get
      {
        return this._DalObject.first_login;
      }
      set
      {
        this._DalObject.first_login = value;
      }
    }
    ...
    public string nombre_mostrar
    {
      get
      {
        return this._DalObject.nombre_mostrar;
      }
      set
      {
        this._DalObject.nombre_mostrar = value;
      }
    }
    ...
    public string logo
    {
      get
      {
        return this._DalObject.logo;
      }
      set
      {
        this._DalObject.logo = value;
      }
    }
    ...
    public string html_bienvenida
    {
      get
      {
        return this._DalObject.html_bienvenida;
      }
      set
      {
        this._DalObject.html_bienvenida = value;
      }
    }
    ...
    public int tipo_vista
    {
      get
      {
        return this._DalObject.tipo_vista;
      }
      set
      {
        this._DalObject.tipo_vista = value;
      }
    }
    ...
    public int tipo_vistaM
    {
      get
      {
        return this._DalObject.tipo_vistaM;
      }
      set
      {
        this._DalObject.tipo_vistaM = value;
      }
    }
    ...
    public string email_novedades
    {
      get
      {
        return this._DalObject.email_novedades;
      }
      set
      {
        this._DalObject.email_novedades = value;
      }
    }
    ...
    public string email
    {
      get
      {
        return this._DalObject.email;
      }
      set
      {
        this._DalObject.email = value;
      }
    }
    ...
    public Spew_usuarios(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spew_usuarios(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spew_usuarios(SqlHelper SqlConfig, int UserId, Simplew_usuarios Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplew_usuarios Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The w_usuarios has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalw_usuarios GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The w_usuarios is null.");
    ...
    {
      this._DalObject = new Dalw_usuarios(SqlConfig, UserId);
    ...
    {
      w_usuarios wUsuarios = (w_usuarios) Object;
      wUsuarios.Name = this.Name;
      wUsuarios.nombrelogin = this.nombrelogin;
      wUsuarios.contrasena = this.contrasena;
      wUsuarios.first_login = this.first_login;
      wUsuarios.nombre_mostrar = this.nombre_mostrar;
      wUsuarios.logo = this.logo;
      wUsuarios.html_bienvenida = this.html_bienvenida;
      wUsuarios.tipo_vista = this.tipo_vista;
      wUsuarios.tipo_vistaM = this.tipo_vistaM;
      wUsuarios.email_novedades = this.email_novedades;
      wUsuarios.email = this.email;
    }
