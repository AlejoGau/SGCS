...
// Type: SoftGuard.BusinessObjects.t_checkPoints_VC
...
{
  public class t_checkPoints_VC : Spet_checkPoints_VC
  {
    public t_checkPoints_VC(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_checkPoints_VC(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_checkPoints_VC(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_checkPoints_VC(SqlHelper SqlConfig, int UserId, Simplet_checkPoints_VC Simple)
