...
{ 
   ///<summary>
     ///m_clientes_fc class   
     ///</summary>
    public partial class m_clientes_fc : Spem_clientes_fc
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_clientes_fc(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_clientes_fc(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_clientes_fc(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_clientes_fc(SqlHelper SqlConfig, int UserId, Simplem_clientes_fc Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
