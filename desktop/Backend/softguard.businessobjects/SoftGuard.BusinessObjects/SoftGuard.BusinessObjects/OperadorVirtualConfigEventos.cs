...
{ 
   ///<summary>
     ///OperadorVirtualConfigEventos class   
     ///</summary>
    public partial class OperadorVirtualConfigEventos : SpeOperadorVirtualConfigEventos
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public OperadorVirtualConfigEventos(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public OperadorVirtualConfigEventos(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public OperadorVirtualConfigEventos(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public OperadorVirtualConfigEventos(SqlHelper SqlConfig, int UserId, SimpleOperadorVirtualConfigEventos Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
