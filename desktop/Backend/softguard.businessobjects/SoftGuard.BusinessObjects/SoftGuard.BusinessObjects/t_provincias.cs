...
// Type: SoftGuard.BusinessObjects.t_provincias
...
{
  public class t_provincias : Spet_provincias
  {
    public t_provincias(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_provincias(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_provincias(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_provincias(SqlHelper SqlConfig, int UserId, Simplet_provincias Simple)
