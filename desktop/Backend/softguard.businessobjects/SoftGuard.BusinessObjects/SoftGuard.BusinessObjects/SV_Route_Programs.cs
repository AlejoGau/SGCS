...
{ 
   ///<summary>
     ///SV_Route_Programs class   
     ///</summary>
    public partial class SV_Route_Programs : SpeSV_Route_Programs
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public SV_Route_Programs(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public SV_Route_Programs(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SV_Route_Programs(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SV_Route_Programs(SqlHelper SqlConfig, int UserId, SimpleSV_Route_Programs Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
