...
{ 
   ///<summary>
     ///p_SpRemoteBtn class   
     ///</summary>
    public partial class p_SpRemoteBtn : Spep_SpRemoteBtn
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_SpRemoteBtn(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_SpRemoteBtn(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_SpRemoteBtn(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_SpRemoteBtn(SqlHelper SqlConfig, int UserId, Simplep_SpRemoteBtn Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
