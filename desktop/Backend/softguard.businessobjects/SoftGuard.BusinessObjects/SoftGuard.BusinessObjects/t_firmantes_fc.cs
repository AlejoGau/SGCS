...
{ 
   ///<summary>
     ///t_firmantes_fc class   
     ///</summary>
    public partial class t_firmantes_fc : Spet_firmantes_fc
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_firmantes_fc(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_firmantes_fc(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_firmantes_fc(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_firmantes_fc(SqlHelper SqlConfig, int UserId, Simplet_firmantes_fc Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
