...
{ 
   ///<summary>
     ///t_mensajes_whatsapp class   
     ///</summary>
    public partial class t_mensajes_whatsapp : Spet_mensajes_whatsapp
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_mensajes_whatsapp(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_mensajes_whatsapp(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_mensajes_whatsapp(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_mensajes_whatsapp(SqlHelper SqlConfig, int UserId, Simplet_mensajes_whatsapp Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
