...
// Type: SoftGuard.BusinessObjects.PersonLineRange
...
{
  public class PersonLineRange : SpePersonLineRange
  {
    public PersonLineRange(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public PersonLineRange(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public PersonLineRange(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public PersonLineRange(SqlHelper SqlConfig, int UserId, SimplePersonLineRange Simple)
