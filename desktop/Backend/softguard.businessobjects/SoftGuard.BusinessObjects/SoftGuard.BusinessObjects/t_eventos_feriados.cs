...
// Type: SoftGuard.BusinessObjects.t_eventos_feriados
...
{
  public class t_eventos_feriados : Spet_eventos_feriados
  {
    public t_eventos_feriados(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_eventos_feriados(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_eventos_feriados(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_eventos_feriados(SqlHelper SqlConfig, int UserId, Simplet_eventos_feriados Simple)
