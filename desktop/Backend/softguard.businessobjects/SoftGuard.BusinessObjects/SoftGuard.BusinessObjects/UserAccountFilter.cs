...
{ 
   ///<summary>
     ...
     ///</summary>
    public partial class UserAccountFilter : SpeUserAccountFilter
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public UserAccountFilter(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public UserAccountFilter(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public UserAccountFilter(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public UserAccountFilter(SqlHelper SqlConfig, int UserId, SimpleUserAccountFilter Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
