    ...
    {
     ///<summary>
     ///Telefono data access layer   
     ///</summary>
    public class DalTelefono : TransactionObject
    { 
    ...
    set{ this._AutoCommit = value; }
     ...
     ///Constructor   
     ///</summary>
    public DalTelefono(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    {
    InitClass();
    SetConfig(SqlConfig);
    }
     ...
     ///Constructor   
     ///</summary>
    public DalTelefono(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId)
    {
    InitClass();
    SetConfig(SqlConfig);
    Load(Id);
     ...
     ///Constructor   
     ///</summary>
    public DalTelefono(SqlHelper SqlConfig, int UserId, SimpleTelefono Simple) : base(SqlConfig, UserId)
    {
    InitClass();
    SetConfig(SqlConfig);
    base.Id = Simple.Id;
   ...
   ///<summary>
    ...
    cmd.Parameters["@Name"].Value = base.Name;
		...
		cmd.Parameters["@tel_nsp"].Value = this._tel_nsp;
    ...
    // Update
    using(var conn = new SqlConnection(_ConnectionString))
    using(var cmd = new SqlCommand("TelefonoUpd", conn))
    {
    cmd.CommandType = CommandType.StoredProcedure;
   ...
   ///<summary>
    ...
    if(base.Id == 0)
    {
    throw new RuntimeException("The Telefono is null");
    }
    else
    {
    //delete
    ...
    // Delete
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDel = new SqlCommand("TelefonoDel", conn))
    {
   ...
   ///<summary>
    ...
    // Select
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdSel = new SqlCommand("TelefonoSel", conn))
    {
   ...
   ///<summary>
    ...
    {
    var Simple = (SimpleTelefono)BaseSimple;
    base.Id = Simple.Id;
    base.Name = Simple.Name;
   ...
   ///<summary>
    ...
    {
    CallerTelefono Caller = new CallerTelefono();
    Caller.Id = base.Id;
    Caller.Name = base.Name;
    
      Caller.tel_iidcuenta = this._tel_iidcuenta;
   ...
   ///<summary>
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdChilds = new SqlCommand("TelefonoByChildObject", conn))
    ...
    while(Reader.Read())
    {
    Simple = new SimpleTelefono();
    Simple.Id = Reader.GetInt32(0);
    Simple.Name = Reader.GetString(1);
    if (Reader.FieldCount > 2)Simple.tel_iidcuenta = (Reader.IsDBNull(2)) ? 0 : Reader.GetInt32(2);
...
if (Reader.FieldCount > 16)Simple.tel_nsp = (Reader.IsDBNull(16)) ? new Decimal(0) : Reader.GetDecimal(16);
if (Reader.FieldCount > 17)Simple.tel_cinternacional = (Reader.IsDBNull(17)) ? "" : Reader.GetString(17);
if (Reader.FieldCount > 18)Simple.tel_ccountrycode = (Reader.IsDBNull(18)) ? "" : Reader.GetString(18);
if (Reader.FieldCount > 19)Simple.tel_iismobile = (Reader.IsDBNull(19)) ? 0 : Reader.GetInt32(19);
...
Simple.tel_iidcuenta = (Row["tel_iidcuenta"] == DBNull.Value) ? 0 : (int) Row["tel_iidcuenta"];
...
Simple.tel_nsp = (Row["tel_nsp"] == DBNull.Value) ? new Decimal(0) : (Decimal) Row["tel_nsp"];
...
Simple.tel_iismobile = (Row["tel_iismobile"] == DBNull.Value) ? 0 : (int) Row["tel_iismobile"];
   ...
   ///<summary>
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdParents = new SqlCommand("TelefonoByParentObject", conn))
...
if (Reader.FieldCount > 19)Simple.tel_iismobile = (Reader.IsDBNull(19)) ? 0 : Reader.GetInt32(19);
   ...
   ///<summary>
    ...
    using (var conn = new SqlConnection(_ConnectionString))
    using (var CmdDataByName = new SqlCommand("TelefonoByName", conn))
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDataByNameWithChild = new SqlCommand("TelefonoByNameWithChild", conn))
    ...
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDataByNameWithParent = new SqlCommand("TelefonoByNameWithParent", conn))
    ...
    DataTable Data = new DataTable("Object");
    using( var conn = new SqlConnection(_ConnectionString))
    using (var cmd = new SqlCommand("TelefonoByFilter", conn))
    ...
    DataTable Data = new DataTable("Object");
    using(var conn = new SqlConnection(_ConnectionString))
    using(var CmdDataByText = new SqlCommand("TelefonoByText", conn))
    ...
    return Data;
     ...
     ///</summary>
    public DataTable GetDataBySimpleObject(SimpleTelefono Simple, TaxonomyCollection Taxonomies, int PageCount, int PagePresent, ref int PageTotal, ref int RowTotal)
    {
    base.Load();
    using(var conn = new SqlConnection(_ConnectionString))
    using(var cmd = new SqlCommand("TelefonoBySimpleTelefono", conn))
    using(var Adapter = new SqlDataAdapter(cmd))
    {
    cmd.CommandType = CommandType.StoredProcedure;
    cmd.Parameters.Add(new SqlParameter("@Name", SqlDbType.NVarChar));
   ...
   ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<SimpleTelefono> GetByChild(string ObjectType, int ObjectId)
		{
			base.Load();
			
			using(var conn = new SqlConnection(_ConnectionString))
			using(var Cmd = new SqlCommand("TelefonoByParentObject", conn))
			{
				conn.Open();
				Cmd.CommandType = CommandType.StoredProcedure;
...
if (Reader.FieldCount > 19)Simple.tel_iismobile = (Reader.IsDBNull(19)) ? 0 : Reader.GetInt32(19);
   ...
   ///<summary>
     ...
     ///</summary>
		...
		public IEnumerable<SimpleTelefono> GetByParent(string ObjectType, int ObjectId)
		{
			base.Load();
			using(var conn = new SqlConnection(_ConnectionString))
			using(var Cmd = new SqlCommand("TelefonoByChildObject", conn))
			{
				conn.Open();
				Cmd.CommandType = CommandType.StoredProcedure;
				Cmd.Parameters.Add(new SqlParameter("@ObjectType", SqlDbType.NVarChar)).Value = ObjectType;
...
if (Reader.FieldCount > 19)Simple.tel_iismobile = (Reader.IsDBNull(19)) ? 0 : Reader.GetInt32(19);
    ...
    if (Reader.FieldCount > 2)this._tel_iidcuenta = (Reader.IsDBNull(2)) ? 0 : Reader.GetInt32(2);
...
if (Reader.FieldCount > 16)this._tel_nsp = (Reader.IsDBNull(16)) ? new Decimal(0) : Reader.GetDecimal(16);
if (Reader.FieldCount > 17)this._tel_cinternacional = (Reader.IsDBNull(17)) ? "" : Reader.GetString(17);
if (Reader.FieldCount > 18)this._tel_ccountrycode = (Reader.IsDBNull(18)) ? "" : Reader.GetString(18);
if (Reader.FieldCount > 19)this._tel_iismobile = (Reader.IsDBNull(19)) ? 0 : Reader.GetInt32(19);
