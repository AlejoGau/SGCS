...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeTG_mantenimiento_historico : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalTG_mantenimiento_historico _DalObject;
 ...
 ///<summary>
     ...
     public int  tgmh_idservicio 
		 { 
                    ...
                    get{ return this._DalObject.tgmh_idservicio; }
        						set{ this._DalObject.tgmh_idservicio = value; } 										
	   }
	  ///<summary>
     ...
     public string  tgmh_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.tgmh_cdescripcion; }
        						set{ this._DalObject.tgmh_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgmh_iodometro 
		 { 
                    ...
                    get{ return this._DalObject.tgmh_iodometro; }
        						set{ this._DalObject.tgmh_iodometro = value; } 										
	   }
	  ///<summary>
     ...
     public int  tgmh_idispositivomovil 
		 { 
                    ...
                    get{ return this._DalObject.tgmh_idispositivomovil; }
        						set{ this._DalObject.tgmh_idispositivomovil = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  tgmh_dfecha 
		 { 
                    ...
                    get{ return this._DalObject.tgmh_dfecha; }
        						set{ this._DalObject.tgmh_dfecha = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeTG_mantenimiento_historico(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTG_mantenimiento_historico(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTG_mantenimiento_historico(SqlHelper SqlConfig, int UserId, SimpleTG_mantenimiento_historico Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleTG_mantenimiento_historico Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The TG_mantenimiento_historico has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalTG_mantenimiento_historico GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The TG_mantenimiento_historico is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalTG_mantenimiento_historico(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (TG_mantenimiento_historico)Object;
			o.Name = this.Name;

			o.tgmh_idservicio = this.tgmh_idservicio;

			o.tgmh_cdescripcion = this.tgmh_cdescripcion;

			o.tgmh_iodometro = this.tgmh_iodometro;

			o.tgmh_idispositivomovil = this.tgmh_idispositivomovil;

			o.tgmh_dfecha = this.tgmh_dfecha;
