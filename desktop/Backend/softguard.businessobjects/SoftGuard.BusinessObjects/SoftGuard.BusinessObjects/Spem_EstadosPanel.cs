...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_EstadosPanel : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_EstadosPanel _DalObject;
 ...
 ///<summary>
     ...
     public int  mep_idCuenta 
		 { 
                    ...
                    get{ return this._DalObject.mep_idCuenta; }
        						set{ this._DalObject.mep_idCuenta = value; } 										
	   }
	  ///<summary>
     ...
     public string  mep_cAlarmaControl 
		 { 
                    ...
                    get{ return this._DalObject.mep_cAlarmaControl; }
        						set{ this._DalObject.mep_cAlarmaControl = value; } 										
	   }
	  ///<summary>
     ...
     public int  mep_iUsuarioControl 
		 { 
                    ...
                    get{ return this._DalObject.mep_iUsuarioControl; }
        						set{ this._DalObject.mep_iUsuarioControl = value; } 										
	   }
	  ///<summary>
     ...
     public string  mep_cAlarmaEsperada 
		 { 
                    ...
                    get{ return this._DalObject.mep_cAlarmaEsperada; }
        						set{ this._DalObject.mep_cAlarmaEsperada = value; } 										
	   }
	  ///<summary>
     ...
     public int  mep_iUsuarioEsperado 
		 { 
                    ...
                    get{ return this._DalObject.mep_iUsuarioEsperado; }
        						set{ this._DalObject.mep_iUsuarioEsperado = value; } 										
	   }
	  ///<summary>
     ...
     public int  mep_iMinutos 
		 { 
                    ...
                    get{ return this._DalObject.mep_iMinutos; }
        						set{ this._DalObject.mep_iMinutos = value; } 										
	   }
	  ///<summary>
     ...
     public int  mep_iAutoProcesa 
		 { 
                    ...
                    get{ return this._DalObject.mep_iAutoProcesa; }
        						set{ this._DalObject.mep_iAutoProcesa = value; } 										
	   }
	  ///<summary>
     ...
     public string  mep_cAlarmaAGenerar 
		 { 
                    ...
                    get{ return this._DalObject.mep_cAlarmaAGenerar; }
        						set{ this._DalObject.mep_cAlarmaAGenerar = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_EstadosPanel(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_EstadosPanel(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_EstadosPanel(SqlHelper SqlConfig, int UserId, Simplem_EstadosPanel Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_EstadosPanel Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_EstadosPanel has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_EstadosPanel GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_EstadosPanel is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_EstadosPanel(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_EstadosPanel)Object;
			o.Name = this.Name;

			o.mep_idCuenta = this.mep_idCuenta;

			o.mep_cAlarmaControl = this.mep_cAlarmaControl;

			o.mep_iUsuarioControl = this.mep_iUsuarioControl;

			o.mep_cAlarmaEsperada = this.mep_cAlarmaEsperada;

			o.mep_iUsuarioEsperado = this.mep_iUsuarioEsperado;

			o.mep_iMinutos = this.mep_iMinutos;

			o.mep_iAutoProcesa = this.mep_iAutoProcesa;

			o.mep_cAlarmaAGenerar = this.mep_cAlarmaAGenerar;
