...
{ 
   ///<summary>
     ///m_comprobantes_cab_fc class   
     ///</summary>
    public partial class m_comprobantes_cab_fc : Spem_comprobantes_cab_fc
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_comprobantes_cab_fc(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_comprobantes_cab_fc(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_comprobantes_cab_fc(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_comprobantes_cab_fc(SqlHelper SqlConfig, int UserId, Simplem_comprobantes_cab_fc Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
