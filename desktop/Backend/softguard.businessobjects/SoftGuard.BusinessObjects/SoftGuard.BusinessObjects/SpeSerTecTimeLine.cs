...
// Type: SoftGuard.BusinessObjects.SpeSerTecTimeLine
...
{
  public abstract class SpeSerTecTimeLine : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalSerTecTimeLine _DalObject;
    ...
    public int stl_iServicio
    {
      get
      {
        return this._DalObject.stl_iServicio;
      }
      set
      {
        this._DalObject.stl_iServicio = value;
      }
    }
    ...
    public DateTime? stl_tFechaHora
    {
      get
      {
        return this._DalObject.stl_tFechaHora;
      }
      set
      {
        this._DalObject.stl_tFechaHora = value;
      }
    }
    ...
    public string stl_cAccion
    {
      get
      {
        return this._DalObject.stl_cAccion;
      }
      set
      {
        this._DalObject.stl_cAccion = value;
      }
    }
    ...
    public string stl_cObservacion
    {
      get
      {
        return this._DalObject.stl_cObservacion;
      }
      set
      {
        this._DalObject.stl_cObservacion = value;
      }
    }
    ...
    public int stl_iUsuarioDSS
    {
      get
      {
        return this._DalObject.stl_iUsuarioDSS;
      }
      set
      {
        this._DalObject.stl_iUsuarioDSS = value;
      }
    }
    ...
    public SpeSerTecTimeLine(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeSerTecTimeLine(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeSerTecTimeLine(SqlHelper SqlConfig, int UserId, SimpleSerTecTimeLine Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleSerTecTimeLine Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The SerTecTimeLine has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalSerTecTimeLine GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The SerTecTimeLine is null.");
    ...
    {
      this._DalObject = new DalSerTecTimeLine(SqlConfig, UserId);
    ...
    {
      SerTecTimeLine serTecTimeLine = (SerTecTimeLine) Object;
      serTecTimeLine.Name = this.Name;
      serTecTimeLine.stl_iServicio = this.stl_iServicio;
      serTecTimeLine.stl_tFechaHora = this.stl_tFechaHora;
      serTecTimeLine.stl_cAccion = this.stl_cAccion;
      serTecTimeLine.stl_cObservacion = this.stl_cObservacion;
      serTecTimeLine.stl_iUsuarioDSS = this.stl_iUsuarioDSS;
    }
