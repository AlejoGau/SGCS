...
{ 
   ///<summary>
     ///t_listas_emergencia class   
     ///</summary>
    public partial class t_listas_emergencia : Spet_listas_emergencia
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_listas_emergencia(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_listas_emergencia(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_listas_emergencia(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_listas_emergencia(SqlHelper SqlConfig, int UserId, Simplet_listas_emergencia Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
