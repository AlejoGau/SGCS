...
// Type: SoftGuard.BusinessObjects.SpePoi
...
{
  public abstract class SpePoi : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalPoi _DalObject;
    ...
    public string FullAddress
    {
      get
      {
        return this._DalObject.FullAddress;
      }
      set
      {
        this._DalObject.FullAddress = value;
      }
    }
    ...
    public string Icon
    {
      get
      {
        return this._DalObject.Icon;
      }
      set
      {
        this._DalObject.Icon = value;
      }
    }
    ...
    public string Country
    {
      get
      {
        return this._DalObject.Country;
      }
      set
      {
        this._DalObject.Country = value;
      }
    }
    ...
    public string State
    {
      get
      {
        return this._DalObject.State;
      }
      set
      {
        this._DalObject.State = value;
      }
    }
    ...
    public string City
    {
      get
      {
        return this._DalObject.City;
      }
      set
      {
        this._DalObject.City = value;
      }
    }
    ...
    public string Address
    {
      get
      {
        return this._DalObject.Address;
      }
      set
      {
        this._DalObject.Address = value;
      }
    }
    ...
    public string Number
    {
      get
      {
        return this._DalObject.Number;
      }
      set
      {
        this._DalObject.Number = value;
      }
    }
    ...
    public double Latitude
    {
      get
      {
        return this._DalObject.Latitude;
      }
      set
      {
        this._DalObject.Latitude = value;
      }
    }
    ...
    public double Longitude
    {
      get
      {
        return this._DalObject.Longitude;
      }
      set
      {
        this._DalObject.Longitude = value;
      }
    }
    ...
    public string CDealer
    {
      get
      {
        return this._DalObject.CDealer;
      }
      set
      {
        this._DalObject.CDealer = value;
      }
    }
    ...
    public int Organization
    {
      get
      {
        return this._DalObject.Organization;
      }
      set
      {
        this._DalObject.Organization = value;
      }
    }
    ...
    public SpePoi(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpePoi(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpePoi(SqlHelper SqlConfig, int UserId, SimplePoi Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimplePoi Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The Poi has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The Poi is null.");
    ...
    {
      this._DalObject = new DalPoi(SqlConfig, UserId);
    ...
    public void CopyPropertiesTo(ISpecialization Object)
    {
      Poi poi = (Poi) Object;
      poi.Name = this.Name;
      poi.FullAddress = this.FullAddress;
      poi.Icon = this.Icon;
      poi.Country = this.Country;
      poi.State = this.State;
      poi.City = this.City;
      poi.Address = this.Address;
      poi.Number = this.Number;
      poi.Latitude = this.Latitude;
      poi.Longitude = this.Longitude;
      poi.CDealer = this.CDealer;
      poi.Organization = this.Organization;
    }
