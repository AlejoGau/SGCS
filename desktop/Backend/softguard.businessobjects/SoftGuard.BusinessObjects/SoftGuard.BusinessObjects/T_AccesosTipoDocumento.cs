...
{ 
   ///<summary>
     ///T_AccesosTipoDocumento class   
     ///</summary>
    public partial class T_AccesosTipoDocumento : SpeT_AccesosTipoDocumento
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public T_AccesosTipoDocumento(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public T_AccesosTipoDocumento(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_AccesosTipoDocumento(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_AccesosTipoDocumento(SqlHelper SqlConfig, int UserId, SimpleT_AccesosTipoDocumento Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
