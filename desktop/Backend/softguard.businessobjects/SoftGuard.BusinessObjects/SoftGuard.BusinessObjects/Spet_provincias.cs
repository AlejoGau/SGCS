...
// Type: SoftGuard.BusinessObjects.Spet_provincias
...
{
  public abstract class Spet_provincias : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_provincias _DalObject;
    ...
    public string pro_ccodigo
    {
      get
      {
        return this._DalObject.pro_ccodigo;
      }
      set
      {
        this._DalObject.pro_ccodigo = value;
      }
    }
    ...
    public string pro_cdescripcion
    {
      get
      {
        return this._DalObject.pro_cdescripcion;
      }
      set
      {
        this._DalObject.pro_cdescripcion = value;
      }
    }
    ...
    public string pro_cletra
    {
      get
      {
        return this._DalObject.pro_cletra;
      }
      set
      {
        this._DalObject.pro_cletra = value;
      }
    }
    ...
    public Decimal pro_nTipo
    {
      get
      {
        return this._DalObject.pro_nTipo;
      }
      set
      {
        this._DalObject.pro_nTipo = value;
      }
    }
    ...
    public int pro_iParentID
    {
      get
      {
        return this._DalObject.pro_iParentID;
      }
      set
      {
        this._DalObject.pro_iParentID = value;
      }
    }
    ...
    public Spet_provincias(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_provincias(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_provincias(SqlHelper SqlConfig, int UserId, Simplet_provincias Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_provincias Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_provincias has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_provincias GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_provincias is null.");
    ...
    {
      this._DalObject = new Dalt_provincias(SqlConfig, UserId);
    ...
    {
      t_provincias tProvincias = (t_provincias) Object;
      tProvincias.Name = this.Name;
      tProvincias.pro_ccodigo = this.pro_ccodigo;
      tProvincias.pro_cdescripcion = this.pro_cdescripcion;
      tProvincias.pro_cletra = this.pro_cletra;
      tProvincias.pro_nTipo = this.pro_nTipo;
      tProvincias.pro_iParentID = this.pro_iParentID;
    }
