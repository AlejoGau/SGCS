...
{ 
   ///<summary>
     ///TelefonoPlanilla class   
     ///</summary>
    public partial class TelefonoPlanilla : SpeTelefonoPlanilla
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public TelefonoPlanilla(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public TelefonoPlanilla(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TelefonoPlanilla(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TelefonoPlanilla(SqlHelper SqlConfig, int UserId, SimpleTelefonoPlanilla Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
