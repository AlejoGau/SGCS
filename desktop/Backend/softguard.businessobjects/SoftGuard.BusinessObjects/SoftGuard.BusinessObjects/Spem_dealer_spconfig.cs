...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_dealer_spconfig : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_dealer_spconfig _DalObject;
 ...
 ///<summary>
     ...
     public string  dsp_cdealer 
		 { 
                    ...
                    get{ return this._DalObject.dsp_cdealer; }
        						set{ this._DalObject.dsp_cdealer = value; } 										
	   }
	  ///<summary>
     ///dsp_config property   
     ///</summary>	
     public string  dsp_config 
		 { 
                    ...
                    get{ return this._DalObject.dsp_config; }
        						set{ this._DalObject.dsp_config = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_dealer_spconfig(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_dealer_spconfig(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_dealer_spconfig(SqlHelper SqlConfig, int UserId, Simplem_dealer_spconfig Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_dealer_spconfig Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_dealer_spconfig has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_dealer_spconfig GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_dealer_spconfig is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_dealer_spconfig(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_dealer_spconfig)Object;
			o.Name = this.Name;

			o.dsp_cdealer = this.dsp_cdealer;

			o.dsp_config = this.dsp_config;
