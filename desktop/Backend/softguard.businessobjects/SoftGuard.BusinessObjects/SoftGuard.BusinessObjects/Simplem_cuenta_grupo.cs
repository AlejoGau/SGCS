...
{ 	
  ///<summary>
    ///m_cuenta_grupo Slbf Class
    ///</summary>
    [DataContract]
    public class Simplem_cuenta_grupo : SimpleBaseObject
    { 
			 ///<summary>
     ///cgr_cnombre   
     ///</summary>
	 ...
	 ///<summary>
        ///m_cuenta_grupo Constructor
        ///</summary>
        public Simplem_cuenta_grupo() : base()
  {
  InitClass();
  }
        ///<summary>
        ///m_cuenta_grupo Constructor
        ///</summary>
        public Simplem_cuenta_grupo(int Id, string Name, string cgr_cnombre, int cgr_itipo, int cgr_iidcuenta) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
...
///<summary>
    ...
    ///</summary>  
		...
		{
			BaseObject Object = new Dalm_cuenta_grupo(SqlConfig, UserId, this);
...
///<summary>
    ...
    ///</summary>
		...
		{
			Callerm_cuenta_grupo Caller = new Callerm_cuenta_grupo();
			Caller.Id = base.Id;
