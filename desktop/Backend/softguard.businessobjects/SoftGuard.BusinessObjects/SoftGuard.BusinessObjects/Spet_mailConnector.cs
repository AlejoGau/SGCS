...
// Type: SoftGuard.BusinessObjects.Spet_mailConnector
...
{
  public abstract class Spet_mailConnector : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_mailConnector _DalObject;
    ...
    public string mcn_name
    {
      get
      {
        return this._DalObject.mcn_name;
      }
      set
      {
        this._DalObject.mcn_name = value;
      }
    }
    ...
    public string mcn_username
    {
      get
      {
        return this._DalObject.mcn_username;
      }
      set
      {
        this._DalObject.mcn_username = value;
      }
    }
    ...
    public string mcn_password
    {
      get
      {
        return this._DalObject.mcn_password;
      }
      set
      {
        this._DalObject.mcn_password = value;
      }
    }
    ...
    public string mcn_popserver
    {
      get
      {
        return this._DalObject.mcn_popserver;
      }
      set
      {
        this._DalObject.mcn_popserver = value;
      }
    }
    ...
    public int mcn_popport
    {
      get
      {
        return this._DalObject.mcn_popport;
      }
      set
      {
        this._DalObject.mcn_popport = value;
      }
    }
    ...
    public int mcn_popssl
    {
      get
      {
        return this._DalObject.mcn_popssl;
      }
      set
      {
        this._DalObject.mcn_popssl = value;
      }
    }
    ...
    public int mcn_ipconid
    {
      get
      {
        return this._DalObject.mcn_ipconid;
      }
      set
      {
        this._DalObject.mcn_ipconid = value;
      }
    }
    ...
    public Spet_mailConnector(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_mailConnector(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_mailConnector(SqlHelper SqlConfig, int UserId, Simplet_mailConnector Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_mailConnector Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_mailConnector has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_mailConnector GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_mailConnector is null.");
    ...
    {
      this._DalObject = new Dalt_mailConnector(SqlConfig, UserId);
    ...
    {
      t_mailConnector tMailConnector = (t_mailConnector) Object;
      tMailConnector.Name = this.Name;
      tMailConnector.mcn_name = this.mcn_name;
      tMailConnector.mcn_username = this.mcn_username;
      tMailConnector.mcn_password = this.mcn_password;
      tMailConnector.mcn_popserver = this.mcn_popserver;
      tMailConnector.mcn_popport = this.mcn_popport;
      tMailConnector.mcn_popssl = this.mcn_popssl;
      tMailConnector.mcn_ipconid = this.mcn_ipconid;
    }
