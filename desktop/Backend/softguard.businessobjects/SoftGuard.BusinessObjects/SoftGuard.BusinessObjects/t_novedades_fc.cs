...
// Type: SoftGuard.BusinessObjects.t_novedades_fc
...
{
  public class t_novedades_fc : Spet_novedades_fc
  {
    public t_novedades_fc(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_novedades_fc(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_novedades_fc(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_novedades_fc(SqlHelper SqlConfig, int UserId, Simplet_novedades_fc Simple)
