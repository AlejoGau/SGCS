...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeT_SimCard_APN : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalT_SimCard_APN _DalObject;
 ...
 ///<summary>
     ...
     public string  tsa_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.tsa_cDescripcion; }
        						set{ this._DalObject.tsa_cDescripcion = value; } 										
	   }
	  ///<summary>
     ///tsa_cURL property   
     ///</summary>	
     public string  tsa_cURL 
		 { 
                    ...
                    get{ return this._DalObject.tsa_cURL; }
        						set{ this._DalObject.tsa_cURL = value; } 										
	   }
	  ///<summary>
     ///tsa_cUser property   
     ///</summary>	
     public string  tsa_cUser 
		 { 
                    ...
                    get{ return this._DalObject.tsa_cUser; }
        						set{ this._DalObject.tsa_cUser = value; } 										
	   }
	  ///<summary>
     ...
     public string  tnd_cPassword 
		 { 
                    ...
                    get{ return this._DalObject.tnd_cPassword; }
        						set{ this._DalObject.tnd_cPassword = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeT_SimCard_APN(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_SimCard_APN(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_SimCard_APN(SqlHelper SqlConfig, int UserId, SimpleT_SimCard_APN Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleT_SimCard_APN Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The T_SimCard_APN has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalT_SimCard_APN GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The T_SimCard_APN is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalT_SimCard_APN(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.T_SimCard_APN)Object;
			o.Name = this.Name;

			o.tsa_cDescripcion = this.tsa_cDescripcion;

			o.tsa_cURL = this.tsa_cURL;

			o.tsa_cUser = this.tsa_cUser;

			o.tnd_cPassword = this.tnd_cPassword;
