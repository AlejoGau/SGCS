...
{ 
   ///<summary>
     ///t_CodigosEnFalla class   
     ///</summary>
    public partial class t_CodigosEnFalla : Spet_CodigosEnFalla
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_CodigosEnFalla(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_CodigosEnFalla(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_CodigosEnFalla(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_CodigosEnFalla(SqlHelper SqlConfig, int UserId, Simplet_CodigosEnFalla Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
