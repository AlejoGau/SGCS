...
{ 
   ///<summary>
     ///t_ControlEventosDealer class   
     ///</summary>
    public partial class t_ControlEventosDealer : Spet_ControlEventosDealer
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_ControlEventosDealer(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_ControlEventosDealer(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_ControlEventosDealer(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_ControlEventosDealer(SqlHelper SqlConfig, int UserId, Simplet_ControlEventosDealer Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
