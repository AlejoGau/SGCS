...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_stock_depositos : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_stock_depositos _DalObject;
 ...
 ///<summary>
     ...
     public int  tsd_idorganizacion 
		 { 
                    ...
                    get{ return this._DalObject.tsd_idorganizacion; }
        						set{ this._DalObject.tsd_idorganizacion = value; } 										
	   }
	  ///<summary>
     ...
     public int  tsd_idtecnico 
		 { 
                    ...
                    get{ return this._DalObject.tsd_idtecnico; }
        						set{ this._DalObject.tsd_idtecnico = value; } 										
	   }
	  ///<summary>
     ///tsd_estado property   
     ///</summary>	
     public int  tsd_estado 
		 { 
                    ...
                    get{ return this._DalObject.tsd_estado; }
        						set{ this._DalObject.tsd_estado = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_stock_depositos(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_stock_depositos(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_stock_depositos(SqlHelper SqlConfig, int UserId, Simplet_stock_depositos Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_stock_depositos Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_stock_depositos has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_stock_depositos GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_stock_depositos is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_stock_depositos(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_stock_depositos)Object;
			o.Name = this.Name;

			o.tsd_idorganizacion = this.tsd_idorganizacion;

			o.tsd_idtecnico = this.tsd_idtecnico;

			o.tsd_estado = this.tsd_estado;
