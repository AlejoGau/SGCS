...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeT_SimCard_Marca : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalT_SimCard_Marca _DalObject;
 ...
 ///<summary>
     ...
     public string  tsm_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.tsm_cDescripcion; }
        						set{ this._DalObject.tsm_cDescripcion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeT_SimCard_Marca(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_SimCard_Marca(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeT_SimCard_Marca(SqlHelper SqlConfig, int UserId, SimpleT_SimCard_Marca Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleT_SimCard_Marca Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The T_SimCard_Marca has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalT_SimCard_Marca GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The T_SimCard_Marca is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalT_SimCard_Marca(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.T_SimCard_Marca)Object;
			o.Name = this.Name;

			o.tsm_cDescripcion = this.tsm_cDescripcion;
