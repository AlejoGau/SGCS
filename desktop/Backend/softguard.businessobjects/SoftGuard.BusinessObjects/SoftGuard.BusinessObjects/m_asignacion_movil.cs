...
// Type: SoftGuard.BusinessObjects.m_asignacion_movil
...
{
  public class m_asignacion_movil : Spem_asignacion_movil
  {
    public m_asignacion_movil(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_asignacion_movil(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_asignacion_movil(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_asignacion_movil(SqlHelper SqlConfig, int UserId, Simplem_asignacion_movil Simple)
