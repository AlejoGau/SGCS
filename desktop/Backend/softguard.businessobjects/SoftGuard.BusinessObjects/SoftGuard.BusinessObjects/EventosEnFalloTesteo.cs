...
{ 
   ///<summary>
     ///EventosEnFalloTesteo class   
     ///</summary>
    public partial class EventosEnFalloTesteo : SpeEventosEnFalloTesteo
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public EventosEnFalloTesteo(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public EventosEnFalloTesteo(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public EventosEnFalloTesteo(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public EventosEnFalloTesteo(SqlHelper SqlConfig, int UserId, SimpleEventosEnFalloTesteo Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
