...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeTelefonoPlanilla : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalTelefonoPlanilla _DalObject;
 ...
 ///<summary>
     ...
     public int  tel_iidpla 
		 { 
                    ...
                    get{ return this._DalObject.tel_iidpla; }
        						set{ this._DalObject.tel_iidpla = value; } 										
	   }
	  ///<summary>
     ///tel_iid property   
     ///</summary>	
     ...
     ///Constructor   
     ///</summary>
    		public SpeTelefonoPlanilla(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTelefonoPlanilla(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTelefonoPlanilla(SqlHelper SqlConfig, int UserId, SimpleTelefonoPlanilla Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleTelefonoPlanilla Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The TelefonoPlanilla has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalTelefonoPlanilla GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The TelefonoPlanilla is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalTelefonoPlanilla(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (TelefonoPlanilla)Object;
			o.Name = this.Name;

			o.tel_iidpla = this.tel_iidpla;
