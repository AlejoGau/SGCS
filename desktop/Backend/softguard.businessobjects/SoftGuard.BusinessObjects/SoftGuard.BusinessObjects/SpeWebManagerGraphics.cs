...
// Type: SoftGuard.BusinessObjects.SpeWebManagerGraphics
...
{
  public abstract class SpeWebManagerGraphics : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalWebManagerGraphics _DalObject;
    ...
    public int Height
    {
      get
      {
        return this._DalObject.Height;
      }
      set
      {
        this._DalObject.Height = value;
      }
    }
    ...
    public SpeWebManagerGraphics(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeWebManagerGraphics(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeWebManagerGraphics(SqlHelper SqlConfig, int UserId, SimpleWebManagerGraphics Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleWebManagerGraphics Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The WebManagerGraphics has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalWebManagerGraphics GetDalObject()
    {
    ...
    public IEnumerable<SimpleWebManagerGraphics> GetByParent(string ObjectType, int ObjectId)
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The WebManagerGraphics is null.");
    ...
    {
      this._DalObject = new DalWebManagerGraphics(SqlConfig, UserId);
    ...
    {
      WebManagerGraphics webManagerGraphics = (WebManagerGraphics) Object;
