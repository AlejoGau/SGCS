...
// Type: SoftGuard.BusinessObjects.m_stock_item
...
{
  public class m_stock_item : Spem_stock_item
  {
    public m_stock_item(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_stock_item(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_stock_item(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_stock_item(SqlHelper SqlConfig, int UserId, Simplem_stock_item Simple)
