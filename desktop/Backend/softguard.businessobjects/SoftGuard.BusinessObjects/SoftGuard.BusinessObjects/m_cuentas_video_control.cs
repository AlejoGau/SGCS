...
{ 
   ///<summary>
     ///m_cuentas_video_control class   
     ///</summary>
    public partial class m_cuentas_video_control : Spem_cuentas_video_control
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuentas_video_control(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_cuentas_video_control(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuentas_video_control(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_cuentas_video_control(SqlHelper SqlConfig, int UserId, Simplem_cuentas_video_control Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
