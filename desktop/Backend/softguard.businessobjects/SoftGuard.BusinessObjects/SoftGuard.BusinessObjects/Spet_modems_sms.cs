...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_modems_sms : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_modems_sms _DalObject;
 ...
 ///<summary>
     ...
     public int  sms_icodigo 
		 { 
                    ...
                    get{ return this._DalObject.sms_icodigo; }
        						set{ this._DalObject.sms_icodigo = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  sms_nport 
		 { 
                    ...
                    get{ return this._DalObject.sms_nport; }
        						set{ this._DalObject.sms_nport = value; } 										
	   }
	  ///<summary>
     ///sms_cseteo property   
     ///</summary>	
     public string  sms_cseteo 
		 { 
                    ...
                    get{ return this._DalObject.sms_cseteo; }
        						set{ this._DalObject.sms_cseteo = value; } 										
	   }
	  ///<summary>
     ///sms_cinbox property   
     ///</summary>	
     public string  sms_cinbox 
		 { 
                    ...
                    get{ return this._DalObject.sms_cinbox; }
        						set{ this._DalObject.sms_cinbox = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  sms_ndefault 
		 { 
                    ...
                    get{ return this._DalObject.sms_ndefault; }
        						set{ this._DalObject.sms_ndefault = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_cterminal 
		 { 
                    ...
                    get{ return this._DalObject.sms_cterminal; }
        						set{ this._DalObject.sms_cterminal = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_csource 
		 { 
                    ...
                    get{ return this._DalObject.sms_csource; }
        						set{ this._DalObject.sms_csource = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  sms_nEstado 
		 { 
                    ...
                    get{ return this._DalObject.sms_nEstado; }
        						set{ this._DalObject.sms_nEstado = value; } 										
	   }
	  ///<summary>
     ...
     public int  sms_iGateway 
		 { 
                    ...
                    get{ return this._DalObject.sms_iGateway; }
        						set{ this._DalObject.sms_iGateway = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.sms_cDealer; }
        						set{ this._DalObject.sms_cDealer = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_modems_sms(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_modems_sms(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_modems_sms(SqlHelper SqlConfig, int UserId, Simplet_modems_sms Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_modems_sms Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_modems_sms has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_modems_sms GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_modems_sms is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_modems_sms(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_modems_sms)Object;
			o.Name = this.Name;

			o.sms_icodigo = this.sms_icodigo;

			o.sms_cdescripcion = this.sms_cdescripcion;

			o.sms_nport = this.sms_nport;

			o.sms_cseteo = this.sms_cseteo;

			o.sms_cinbox = this.sms_cinbox;

			o.sms_ndefault = this.sms_ndefault;

			o.sms_cterminal = this.sms_cterminal;

			o.sms_csource = this.sms_csource;

			o.sms_nEstado = this.sms_nEstado;

			o.sms_iGateway = this.sms_iGateway;

			o.sms_cDealer = this.sms_cDealer;
