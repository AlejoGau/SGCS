...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_plantillas_sms : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_plantillas_sms _DalObject;
 ...
 ///<summary>
     ...
     public string  pls_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.pls_ccodigo; }
        						set{ this._DalObject.pls_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  pls_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.pls_cdescripcion; }
        						set{ this._DalObject.pls_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  pls_mplantilla 
		 { 
                    ...
                    get{ return this._DalObject.pls_mplantilla; }
        						set{ this._DalObject.pls_mplantilla = value; } 										
	   }
	  ///<summary>
     ...
     public string  pls_mplantillaOpnClo 
		 { 
                    ...
                    get{ return this._DalObject.pls_mplantillaOpnClo; }
        						set{ this._DalObject.pls_mplantillaOpnClo = value; } 										
	   }
	  ///<summary>
     ///pls_iTipo property   
     ///</summary>	
     public int  pls_iTipo 
		 { 
                    ...
                    get{ return this._DalObject.pls_iTipo; }
        						set{ this._DalObject.pls_iTipo = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_plantillas_sms(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_plantillas_sms(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_plantillas_sms(SqlHelper SqlConfig, int UserId, Simplet_plantillas_sms Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_plantillas_sms Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_plantillas_sms has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_plantillas_sms GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_plantillas_sms is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_plantillas_sms(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_plantillas_sms)Object;
			o.Name = this.Name;

			o.pls_ccodigo = this.pls_ccodigo;

			o.pls_cdescripcion = this.pls_cdescripcion;

			o.pls_mplantilla = this.pls_mplantilla;

			o.pls_mplantillaOpnClo = this.pls_mplantillaOpnClo;

			o.pls_iTipo = this.pls_iTipo;
