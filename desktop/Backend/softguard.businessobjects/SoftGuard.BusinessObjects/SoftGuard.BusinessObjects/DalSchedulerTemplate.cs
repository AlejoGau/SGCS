...
// Type: SoftGuard.BusinessObjects.DalSchedulerTemplate
...
{
  public class DalSchedulerTemplate : TransactionObject
  {
    ...
    public DalSchedulerTemplate(SqlHelper SqlConfig, int UserId)
    ...
    public DalSchedulerTemplate(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId)
    {
      this.InitClass();
      this.SetConfig(SqlConfig);
    ...
    public DalSchedulerTemplate(SqlHelper SqlConfig, int UserId, SimpleSchedulerTemplate Simple)
      : base(SqlConfig, UserId)
    {
      this.InitClass();
      this.SetConfig(SqlConfig);
    ...
    public override void Save()
    {
      ...
      try
      {
        if (this.Id == 0)
        {
          ...
          {
            using (SqlCommand sqlCommand = new SqlCommand("SchedulerTemplateIns", connection))
            {
        ...
        else
        {
          using (SqlConnection connection = new SqlConnection(this._ConnectionString))
          {
            using (SqlCommand sqlCommand = new SqlCommand("SchedulerTemplateUpd", connection))
            {
              sqlCommand.CommandType = CommandType.StoredProcedure;
    ...
    public override void Delete()
    {
      base.Delete();
      if (this.Id == 0)
        throw new RuntimeException("The SchedulerTemplate is null");
      try
      {
        this.BeginTran();
        using (SqlConnection connection = new SqlConnection(this._ConnectionString))
        {
          using (SqlCommand sqlCommand = new SqlCommand("SchedulerTemplateDel", connection))
          {
            sqlCommand.CommandType = CommandType.StoredProcedure;
            sqlCommand.Parameters.Add(new SqlParameter("@Id", SqlDbType.Int));
            sqlCommand.Parameters["@Id"].Value = (object) this.Id;
    ...
    public new virtual void Load(int Id)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand sqlCommand = new SqlCommand("SchedulerTemplateSel", connection))
        {
          sqlCommand.CommandType = CommandType.StoredProcedure;
          sqlCommand.Parameters.Add(new SqlParameter("@Id", SqlDbType.Int));
          connection.Open();
    ...
    public override SimpleBaseObject GetSimpleObject()
    {
      ...
      if (this.CallerObject != null)
        schedulerTemplate.CallerObject = this.CallerObject;
      return (SimpleBaseObject) schedulerTemplate;
    }

    public void SetSimpleObject(SimpleBaseObject BaseSimple)
    {
      SimpleSchedulerTemplate schedulerTemplate = (SimpleSchedulerTemplate) BaseSimple;
      this.Id = schedulerTemplate.Id;
      this.Name = schedulerTemplate.Name;
      this._config = schedulerTemplate.config;
      this._sql = schedulerTemplate.sql;
      if (schedulerTemplate.CallerObject != null)
        this.CallerObject = schedulerTemplate.CallerObject;
      this.OriginalObject = this.GetSimpleObject();
    }
    ...
    public DataTable GetDataChildsByObject(SimpleBaseObject Object)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand selectCommand = new SqlCommand("SchedulerTemplateByChildObject", connection))
        {
    ...
    public SimpleBaseObjectCollection GetChildsByObject(SimpleBaseObject Object)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand sqlCommand = new SqlCommand("SchedulerTemplateByChildObject", connection))
        {
          sqlCommand.CommandType = CommandType.StoredProcedure;
          ...
          using (SqlDataReader sqlDataReader = sqlCommand.ExecuteReader())
          {
            ...
            {
              SimpleSchedulerTemplate schedulerTemplate = new SimpleSchedulerTemplate();
              schedulerTemplate.Id = sqlDataReader.GetInt32(0);
              schedulerTemplate.Name = sqlDataReader.GetString(1);
              if (sqlDataReader.FieldCount > 2)
                schedulerTemplate.config = sqlDataReader.IsDBNull(2) ? "" : sqlDataReader.GetString(2);
              if (sqlDataReader.FieldCount > 3)
                schedulerTemplate.sql = sqlDataReader.IsDBNull(3) ? "" : sqlDataReader.GetString(3);
              schedulerTemplate.CallerObject = Object.GetCallerObject();
              schedulerTemplate.CallerObject.Relation = new RelationHelper(this.Security.SqlConfig).GetValuesWithRelation(Object, (SimpleBaseObject) schedulerTemplate);
              objectCollection.Add((SimpleBaseObject) schedulerTemplate);
            }
          }
          connection.Close();
        }
    ...
    public SimpleBaseObjectCollection GetChildsByObject(SimpleBaseObject Object, bool Recursive)
    {
      ...
      {
        SimpleSchedulerTemplate schedulerTemplate = new SimpleSchedulerTemplate();
        schedulerTemplate.Id = (int) row["Id"];
        schedulerTemplate.Name = (string) row["Name"];
        schedulerTemplate.config = row["config"] == DBNull.Value ? "" : (string) row["config"];
        schedulerTemplate.sql = row["sql"] == DBNull.Value ? "" : (string) row["sql"];
        schedulerTemplate.CallerObject = Object.GetCallerObject();
        schedulerTemplate.CallerObject.Relation = new RelationHelper(this.Security.SqlConfig).GetValuesWithRelation(Object, (SimpleBaseObject) schedulerTemplate);
        if (Recursive)
          schedulerTemplate.Dependencies = this.GetChildsByObject((SimpleBaseObject) schedulerTemplate, Recursive);
        objectCollection.Add((SimpleBaseObject) schedulerTemplate);
      }
      return objectCollection;
    }
    ...
    public DataTable GetDataParentsByObject(SimpleBaseObject Object)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand selectCommand = new SqlCommand("SchedulerTemplateByParentObject", connection))
        {
          using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
          {
            selectCommand.CommandType = CommandType.StoredProcedure;
    ...
    public SimpleBaseObjectCollection GetParentsByObject(SimpleBaseObject Object)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand sqlCommand = new SqlCommand("SchedulerTemplateByParentObject", connection))
        {
          sqlCommand.CommandType = CommandType.StoredProcedure;
          sqlCommand.Parameters.Add(new SqlParameter("@ObjectType", SqlDbType.NVarChar));
          sqlCommand.Parameters.Add(new SqlParameter("@Id", SqlDbType.Int));
    ...
    public DataTable GetDataByName(string Name, TaxonomyCollection Taxonomies, int PageCount, int PagePresent, string OrderBy, ref int PageTotal, ref int RowTotal)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand selectCommand = new SqlCommand("SchedulerTemplateByName", connection))
        {
          using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
          {
            selectCommand.CommandType = CommandType.StoredProcedure;
    ...
    public DataTable GetDataByNameWithChild(string Name, TaxonomyCollection Taxonomies, SimpleBaseObject FilterChildObject, int PageCount, int PagePresent, ref int PageTotal, ref int RowTotal)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand selectCommand = new SqlCommand("SchedulerTemplateByNameWithChild", connection))
        {
          using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
          {
            selectCommand.CommandType = CommandType.StoredProcedure;
    ...
    public DataTable GetDataByNameWithParent(string Name, TaxonomyCollection Taxonomies, SimpleBaseObject FilterParentObject, int PageCount, int PagePresent, ref int PageTotal, ref int RowTotal)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand selectCommand = new SqlCommand("SchedulerTemplateByNameWithParent", connection))
        {
          using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
          {
            selectCommand.CommandType = CommandType.StoredProcedure;
    ...
    public DataTable GetDataByFilter(int Page, int Start, int Limit, string Sort, string Group, string Filter, ref int TotalRows)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand selectCommand = new SqlCommand("SchedulerTemplateByFilter", connection))
        {
          using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
          {
            selectCommand.CommandType = CommandType.StoredProcedure;
    ...
    public DataTable GetDataByText(string Text, TaxonomyCollection Taxonomies, int PageCount, int PagePresent, ref int PageTotal, ref int RowTotal)
    {
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand selectCommand = new SqlCommand("SchedulerTemplateByText", connection))
        {
          using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
          {
            selectCommand.CommandType = CommandType.StoredProcedure;
    ...
    public DataTable GetDataBySimpleObject(SimpleSchedulerTemplate Simple, TaxonomyCollection Taxonomies, int PageCount, int PagePresent, ref int PageTotal, ref int RowTotal)
    {
      this.Load();
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand selectCommand = new SqlCommand("SchedulerTemplateBySimpleSchedulerTemplate", connection))
        {
          using (SqlDataAdapter sqlDataAdapter = new SqlDataAdapter(selectCommand))
          {
            selectCommand.CommandType = CommandType.StoredProcedure;
      ...
      using (SqlConnection connection = new SqlConnection(this._ConnectionString))
      {
        using (SqlCommand sqlCommand = new SqlCommand("SchedulerTemplateByParentObject", connection))
        {
          ...
          using (SqlDataReader sqlDataReader = sqlCommand.ExecuteReader())
          {
            while (sqlDataReader.Read())
            {
              SimpleSchedulerTemplate Simple = new SimpleSchedulerTemplate();
              Simple.Id = sqlDataReader.GetInt32(0);
              Simple.Name = sqlDataReader.GetString(1);
              if (sqlDataReader.FieldCount > 2)
                Simple.config = sqlDataReader.IsDBNull(2) ? "" : sqlDataReader.GetString(2);
              if (sqlDataReader.FieldCount > 3)
                Simple.sql = sqlDataReader.IsDBNull(3) ? "" : sqlDataReader.GetString(3);
              yield return Simple;
            }
          }
        }
    ...
    private void FillObject(SqlDataReader Reader)
    {
      while (Reader.Read())
      {
        ...
        if (Reader.FieldCount > 2)
          this._config = Reader.IsDBNull(2) ? "" : Reader.GetString(2);
        if (Reader.FieldCount > 3)
          this._sql = Reader.IsDBNull(3) ? "" : Reader.GetString(3);
      }
      Reader.Close();
    }
  }
