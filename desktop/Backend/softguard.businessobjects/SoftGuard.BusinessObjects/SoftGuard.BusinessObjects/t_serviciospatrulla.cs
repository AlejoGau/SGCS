...
// Type: SoftGuard.BusinessObjects.t_serviciospatrulla
...
{
  public class t_serviciospatrulla : Spet_serviciospatrulla
  {
    public t_serviciospatrulla(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_serviciospatrulla(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_serviciospatrulla(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_serviciospatrulla(SqlHelper SqlConfig, int UserId, Simplet_serviciospatrulla Simple)
