...
{ 
   ///<summary>
     ///T_AccesosVehiculoProveedor class   
     ///</summary>
    public partial class T_AccesosVehiculoProveedor : SpeT_AccesosVehiculoProveedor
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public T_AccesosVehiculoProveedor(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public T_AccesosVehiculoProveedor(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_AccesosVehiculoProveedor(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_AccesosVehiculoProveedor(SqlHelper SqlConfig, int UserId, SimpleT_AccesosVehiculoProveedor Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
