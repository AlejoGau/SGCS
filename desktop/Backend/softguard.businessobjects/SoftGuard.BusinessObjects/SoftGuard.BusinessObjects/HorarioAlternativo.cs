...
// Type: SoftGuard.BusinessObjects.HorarioAlternativo
...
{
  public class HorarioAlternativo : SpeHorarioAlternativo
  {
    public HorarioAlternativo(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public HorarioAlternativo(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public HorarioAlternativo(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public HorarioAlternativo(SqlHelper SqlConfig, int UserId, SimpleHorarioAlternativo Simple)
