...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeTelefono : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalTelefono _DalObject;
 ...
 ///<summary>
     ...
     public int  tel_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.tel_iidcuenta; }
        						set{ this._DalObject.tel_iidcuenta = value; } 										
	   }
	  ///<summary>
     ///tel_iid property   
     ///</summary>	
     public int  tel_iid 
		 { 
                    ...
                    get{ return this._DalObject.tel_iid; }
        						set{ this._DalObject.tel_iid = value; } 										
	   }
	  ///<summary>
     ///tel_clista property   
     ///</summary>	
     public string  tel_clista 
		 { 
                    ...
                    get{ return this._DalObject.tel_clista; }
        						set{ this._DalObject.tel_clista = value; } 										
	   }
	  ///<summary>
     ...
     public string  tel_cnombre 
		 { 
                    ...
                    get{ return this._DalObject.tel_cnombre; }
        						set{ this._DalObject.tel_cnombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  tel_cobservacion 
		 { 
                    ...
                    get{ return this._DalObject.tel_cobservacion; }
        						set{ this._DalObject.tel_cobservacion = value; } 										
	   }
	  ///<summary>
     ...
     public string  tel_ctelefono 
		 { 
                    ...
                    get{ return this._DalObject.tel_ctelefono; }
        						set{ this._DalObject.tel_ctelefono = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  tel_ndiscado 
		 { 
                    ...
                    get{ return this._DalObject.tel_ndiscado; }
        						set{ this._DalObject.tel_ndiscado = value; } 										
	   }
	  ///<summary>
     ...
     public string  tel_cpredigito 
		 { 
                    ...
                    get{ return this._DalObject.tel_cpredigito; }
        						set{ this._DalObject.tel_cpredigito = value; } 										
	   }
	  ///<summary>
     ...
     public string  tel_cpostdigito 
		 { 
                    ...
                    get{ return this._DalObject.tel_cpostdigito; }
        						set{ this._DalObject.tel_cpostdigito = value; } 										
	   }
	  ///<summary>
     ///tel_norden property   
     ///</summary>	
     public int  tel_norden 
		 { 
                    ...
                    get{ return this._DalObject.tel_norden; }
        						set{ this._DalObject.tel_norden = value; } 										
	   }
	  ///<summary>
     ///tel_ntr property   
     ///</summary>	
     public Decimal  tel_ntr 
		 { 
                    ...
                    get{ return this._DalObject.tel_ntr; }
        						set{ this._DalObject.tel_ntr = value; } 										
	   }
	  ///<summary>
     ///tel_cclave property   
     ///</summary>	
     public string  tel_cclave 
		 { 
                    ...
                    get{ return this._DalObject.tel_cclave; }
        						set{ this._DalObject.tel_cclave = value; } 										
	   }
	  ///<summary>
     ...
     public string  tel_cpermiso 
		 { 
                    ...
                    get{ return this._DalObject.tel_cpermiso; }
        						set{ this._DalObject.tel_cpermiso = value; } 										
	   }
	  ///<summary>
     ///tel_nsms property   
     ///</summary>	
     public Decimal  tel_nsms 
		 { 
                    ...
                    get{ return this._DalObject.tel_nsms; }
        						set{ this._DalObject.tel_nsms = value; } 										
	   }
	  ///<summary>
     ///tel_nsp property   
     ///</summary>	
     public Decimal  tel_nsp 
		 { 
                    ...
                    get{ return this._DalObject.tel_nsp; }
        						set{ this._DalObject.tel_nsp = value; } 										
	   }
	  ///<summary>
     ...
     public string  tel_cinternacional 
		 { 
                    ...
                    get{ return this._DalObject.tel_cinternacional; }
        						set{ this._DalObject.tel_cinternacional = value; } 										
	   }
	  ///<summary>
     ...
     public string  tel_ccountrycode 
		 { 
                    ...
                    get{ return this._DalObject.tel_ccountrycode; }
        						set{ this._DalObject.tel_ccountrycode = value; } 										
	   }
	  ///<summary>
     ...
     public int  tel_iismobile 
		 { 
                    ...
                    get{ return this._DalObject.tel_iismobile; }
        						set{ this._DalObject.tel_iismobile = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeTelefono(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTelefono(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTelefono(SqlHelper SqlConfig, int UserId, SimpleTelefono Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleTelefono Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The Telefono has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalTelefono GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The Telefono is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalTelefono(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.Telefono)Object;
			o.Name = this.Name;

			o.tel_iidcuenta = this.tel_iidcuenta;

			o.tel_iid = this.tel_iid;

			o.tel_clista = this.tel_clista;

			o.tel_cnombre = this.tel_cnombre;

			o.tel_cobservacion = this.tel_cobservacion;

			o.tel_ctelefono = this.tel_ctelefono;

			o.tel_ndiscado = this.tel_ndiscado;

			o.tel_cpredigito = this.tel_cpredigito;

			o.tel_cpostdigito = this.tel_cpostdigito;

			o.tel_norden = this.tel_norden;

			o.tel_ntr = this.tel_ntr;

			o.tel_cclave = this.tel_cclave;

			o.tel_cpermiso = this.tel_cpermiso;

			o.tel_nsms = this.tel_nsms;

			o.tel_nsp = this.tel_nsp;

			o.tel_cinternacional = this.tel_cinternacional;

			o.tel_ccountrycode = this.tel_ccountrycode;

			o.tel_iismobile = this.tel_iismobile;
