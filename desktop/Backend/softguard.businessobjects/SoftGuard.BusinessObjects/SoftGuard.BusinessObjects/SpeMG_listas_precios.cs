...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeMG_listas_precios : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalMG_listas_precios _DalObject;
 ...
 ///<summary>
     ...
     public string  mglp_nombre 
		 { 
                    ...
                    get{ return this._DalObject.mglp_nombre; }
        						set{ this._DalObject.mglp_nombre = value; } 										
	   }
	  ///<summary>
     ///mglp_tipo property   
     ///</summary>	
     public int  mglp_tipo 
		 { 
                    ...
                    get{ return this._DalObject.mglp_tipo; }
        						set{ this._DalObject.mglp_tipo = value; } 										
	   }
	  ///<summary>
     ...
     public Single  mglp_multiplicador 
		 { 
                    ...
                    get{ return this._DalObject.mglp_multiplicador; }
        						set{ this._DalObject.mglp_multiplicador = value; } 										
	   }
	  ///<summary>
     ...
     public int  mglp_idorganizacion 
		 { 
                    ...
                    get{ return this._DalObject.mglp_idorganizacion; }
        						set{ this._DalObject.mglp_idorganizacion = value; } 										
	   }
	  ///<summary>
     ...
     public string  mglp_currency 
		 { 
                    ...
                    get{ return this._DalObject.mglp_currency; }
        						set{ this._DalObject.mglp_currency = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeMG_listas_precios(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_listas_precios(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_listas_precios(SqlHelper SqlConfig, int UserId, SimpleMG_listas_precios Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleMG_listas_precios Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The MG_listas_precios has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalMG_listas_precios GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The MG_listas_precios is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalMG_listas_precios(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (MG_listas_precios)Object;
			o.Name = this.Name;

			o.mglp_nombre = this.mglp_nombre;

			o.mglp_tipo = this.mglp_tipo;

			o.mglp_multiplicador = this.mglp_multiplicador;

			o.mglp_idorganizacion = this.mglp_idorganizacion;

			o.mglp_currency = this.mglp_currency;
