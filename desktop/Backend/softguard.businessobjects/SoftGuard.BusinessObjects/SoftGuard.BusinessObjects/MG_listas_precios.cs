...
{ 
   ///<summary>
     ///MG_listas_precios class   
     ///</summary>
    public partial class MG_listas_precios : SpeMG_listas_precios
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_listas_precios(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public MG_listas_precios(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_listas_precios(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public MG_listas_precios(SqlHelper SqlConfig, int UserId, SimpleMG_listas_precios Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
