...
// Type: SoftGuard.BusinessObjects.t_InstaladoresDealer
...
{
  public class t_InstaladoresDealer : Spet_InstaladoresDealer
  {
    public t_InstaladoresDealer(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_InstaladoresDealer(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_InstaladoresDealer(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_InstaladoresDealer(SqlHelper SqlConfig, int UserId, Simplet_InstaladoresDealer Simple)
