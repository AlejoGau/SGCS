...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeSms : ISpecialization, ICanCopyProperties
    { 
 ...
 ///<summary>
     ...
     public int  sms_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.sms_iidcuenta; }
        						set{ this._DalObject.sms_iidcuenta = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_meventos 
		 { 
                    ...
                    get{ return this._DalObject.sms_meventos; }
        						set{ this._DalObject.sms_meventos = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_csmsparaeventos 
		 { 
                    ...
                    get{ return this._DalObject.sms_csmsparaeventos; }
        						set{ this._DalObject.sms_csmsparaeventos = value; } 										
	   }
	  ///<summary>
     ...
     public int  sms_imodemsms 
		 { 
                    ...
                    get{ return this._DalObject.sms_imodemsms; }
        						set{ this._DalObject.sms_imodemsms = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_cplantillasms 
		 { 
                    ...
                    get{ return this._DalObject.sms_cplantillasms; }
        						set{ this._DalObject.sms_cplantillasms = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_cmailparaeventos 
		 { 
                    ...
                    get{ return this._DalObject.sms_cmailparaeventos; }
        						set{ this._DalObject.sms_cmailparaeventos = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_cplantillamail 
		 { 
                    ...
                    get{ return this._DalObject.sms_cplantillamail; }
        						set{ this._DalObject.sms_cplantillamail = value; } 										
	   }
	  ///<summary>
     ...
     public int  sms_inotificaralertas 
		 { 
                    ...
                    get{ return this._DalObject.sms_inotificaralertas; }
        						set{ this._DalObject.sms_inotificaralertas = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_cplantillapush 
		 { 
                    ...
                    get{ return this._DalObject.sms_cplantillapush; }
        						set{ this._DalObject.sms_cplantillapush = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_cidspushsmartpanic 
		 { 
                    ...
                    get{ return this._DalObject.sms_cidspushsmartpanic; }
        						set{ this._DalObject.sms_cidspushsmartpanic = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.sms_cDescripcion; }
        						set{ this._DalObject.sms_cDescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public int  sms_iGrupoAlarmas 
		 { 
                    ...
                    get{ return this._DalObject.sms_iGrupoAlarmas; }
        						set{ this._DalObject.sms_iGrupoAlarmas = value; } 										
	   }
	  ///<summary>
     ///sms_czona property   
     ///</summary>	
     public string  sms_czona 
		 { 
                    ...
                    get{ return this._DalObject.sms_czona; }
        						set{ this._DalObject.sms_czona = value; } 										
	   }
	  ///<summary>
     ...
     public int  sms_iEventosSP 
		 { 
                    ...
                    get{ return this._DalObject.sms_iEventosSP; }
        						set{ this._DalObject.sms_iEventosSP = value; } 										
	   }
	  ///<summary>
     ...
     public string  sms_cSonido 
		 { 
                    ...
                    get{ return this._DalObject.sms_cSonido; }
        						set{ this._DalObject.sms_cSonido = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeSms(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeSms(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeSms(SqlHelper SqlConfig, int UserId, SimpleSms Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleSms Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The Sms has dependencies.");
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The Sms is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalSms(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.Sms)Object;
			o.Name = this.Name;

			o.sms_iidcuenta = this.sms_iidcuenta;

			o.sms_meventos = this.sms_meventos;

			o.sms_csmsparaeventos = this.sms_csmsparaeventos;

			o.sms_imodemsms = this.sms_imodemsms;

			o.sms_cplantillasms = this.sms_cplantillasms;

			o.sms_cmailparaeventos = this.sms_cmailparaeventos;

			o.sms_cplantillamail = this.sms_cplantillamail;

			o.sms_inotificaralertas = this.sms_inotificaralertas;

			o.sms_cplantillapush = this.sms_cplantillapush;

			o.sms_cidspushsmartpanic = this.sms_cidspushsmartpanic;

			o.sms_cDescripcion = this.sms_cDescripcion;

			o.sms_iGrupoAlarmas = this.sms_iGrupoAlarmas;

			o.sms_czona = this.sms_czona;

			o.sms_iEventosSP = this.sms_iEventosSP;

			o.sms_cSonido = this.sms_cSonido;
