...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeWeSafeConfig : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalWeSafeConfig _DalObject;
 ...
 ///<summary>
     ...
     public string  wcf_cDealer 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cDealer; }
        						set{ this._DalObject.wcf_cDealer = value; } 										
	   }
	  ///<summary>
     ...
     public string  wcf_cEndPointAppStore 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cEndPointAppStore; }
        						set{ this._DalObject.wcf_cEndPointAppStore = value; } 										
	   }
	  ///<summary>
     ...
     public string  wcf_cMailGoogleStore 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cMailGoogleStore; }
        						set{ this._DalObject.wcf_cMailGoogleStore = value; } 										
	   }
	  ///<summary>
     ...
     public string  wcf_cAppNameAppStore 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cAppNameAppStore; }
        						set{ this._DalObject.wcf_cAppNameAppStore = value; } 										
	   }
	  ///<summary>
     ...
     public string  wcf_cIssuerID 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cIssuerID; }
        						set{ this._DalObject.wcf_cIssuerID = value; } 										
	   }
	  ///<summary>
     ...
     public string  wcf_cKeyIdAppStore 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cKeyIdAppStore; }
        						set{ this._DalObject.wcf_cKeyIdAppStore = value; } 										
	   }
	  ///<summary>
     ...
     public string  wcf_cAppNameGoogleStore 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cAppNameGoogleStore; }
        						set{ this._DalObject.wcf_cAppNameGoogleStore = value; } 										
	   }
	  ///<summary>
     ...
     public string  wcf_cEndPointGooglePlay 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cEndPointGooglePlay; }
        						set{ this._DalObject.wcf_cEndPointGooglePlay = value; } 										
	   }
	  ///<summary>
     ...
     public string  wcf_cPrivateKeyAppStore 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cPrivateKeyAppStore; }
        						set{ this._DalObject.wcf_cPrivateKeyAppStore = value; } 										
	   }
	  ///<summary>
     ...
     public string  wcf_cPrivateKeyGoogleStore 
		 { 
                    ...
                    get{ return this._DalObject.wcf_cPrivateKeyGoogleStore; }
        						set{ this._DalObject.wcf_cPrivateKeyGoogleStore = value; } 										
	   }
	  ///<summary>
     ...
     public string  idsPublicidad 
		 { 
                    ...
                    get{ return this._DalObject.idsPublicidad; }
        						set{ this._DalObject.idsPublicidad = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeWeSafeConfig(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeWeSafeConfig(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeWeSafeConfig(SqlHelper SqlConfig, int UserId, SimpleWeSafeConfig Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleWeSafeConfig Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The WeSafeConfig has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalWeSafeConfig GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The WeSafeConfig is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalWeSafeConfig(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.WeSafeConfig)Object;
			o.Name = this.Name;

			o.wcf_cDealer = this.wcf_cDealer;

			o.wcf_cEndPointAppStore = this.wcf_cEndPointAppStore;

			o.wcf_cMailGoogleStore = this.wcf_cMailGoogleStore;

			o.wcf_cAppNameAppStore = this.wcf_cAppNameAppStore;

			o.wcf_cIssuerID = this.wcf_cIssuerID;

			o.wcf_cKeyIdAppStore = this.wcf_cKeyIdAppStore;

			o.wcf_cAppNameGoogleStore = this.wcf_cAppNameGoogleStore;

			o.wcf_cEndPointGooglePlay = this.wcf_cEndPointGooglePlay;

			o.wcf_cPrivateKeyAppStore = this.wcf_cPrivateKeyAppStore;

			o.wcf_cPrivateKeyGoogleStore = this.wcf_cPrivateKeyGoogleStore;

			o.idsPublicidad = this.idsPublicidad;
