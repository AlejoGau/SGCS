...
{ 
   ///<summary>
     ///t_WeSafePeriodicityOptions class   
     ///</summary>
    public partial class t_WeSafePeriodicityOptions : Spet_WeSafePeriodicityOptions
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_WeSafePeriodicityOptions(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_WeSafePeriodicityOptions(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_WeSafePeriodicityOptions(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_WeSafePeriodicityOptions(SqlHelper SqlConfig, int UserId, Simplet_WeSafePeriodicityOptions Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
