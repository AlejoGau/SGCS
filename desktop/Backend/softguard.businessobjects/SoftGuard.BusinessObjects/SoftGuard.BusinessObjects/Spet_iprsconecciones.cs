...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_iprsconecciones : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_iprsconecciones _DalObject;
 ...
 ///<summary>
     ...
     public int  iprsc_iprsiid 
		 { 
                    ...
                    get{ return this._DalObject.iprsc_iprsiid; }
        						set{ this._DalObject.iprsc_iprsiid = value; } 										
	   }
	  ///<summary>
     ...
     public int  iprsc_ipcidkey 
		 { 
                    ...
                    get{ return this._DalObject.iprsc_ipcidkey; }
        						set{ this._DalObject.iprsc_ipcidkey = value; } 										
	   }
	  ///<summary>
     ...
     public string  iprsc_status 
		 { 
                    ...
                    get{ return this._DalObject.iprsc_status; }
        						set{ this._DalObject.iprsc_status = value; } 										
	   }
	  ///<summary>
     ...
     public string  iprsc_config 
		 { 
                    ...
                    get{ return this._DalObject.iprsc_config; }
        						set{ this._DalObject.iprsc_config = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  iprsc_lastserviceupdate 
		 { 
                    ...
                    get{ return this._DalObject.iprsc_lastserviceupdate; }
        						set{ this._DalObject.iprsc_lastserviceupdate = value; } 										
	   }
	  ///<summary>
     ...
     public int  iprsc_iduplicado 
		 { 
                    ...
                    get{ return this._DalObject.iprsc_iduplicado; }
        						set{ this._DalObject.iprsc_iduplicado = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_iprsconecciones(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_iprsconecciones(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_iprsconecciones(SqlHelper SqlConfig, int UserId, Simplet_iprsconecciones Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_iprsconecciones Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_iprsconecciones has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_iprsconecciones GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_iprsconecciones is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_iprsconecciones(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_iprsconecciones)Object;
			o.Name = this.Name;

			o.iprsc_iprsiid = this.iprsc_iprsiid;

			o.iprsc_ipcidkey = this.iprsc_ipcidkey;

			o.iprsc_status = this.iprsc_status;

			o.iprsc_config = this.iprsc_config;

			o.iprsc_lastserviceupdate = this.iprsc_lastserviceupdate;

			o.iprsc_iduplicado = this.iprsc_iduplicado;
