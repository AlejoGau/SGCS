...
{ 
   ///<summary>
     ///GeoFense class   
     ///</summary>
    public partial class GeoFense : SpeGeoFense
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public GeoFense(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public GeoFense(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public GeoFense(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public GeoFense(SqlHelper SqlConfig, int UserId, SimpleGeoFense Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
