...
{ 
   ///<summary>
     ///s_systemdata class   
     ///</summary>
    public partial class s_systemdata : Spes_systemdata
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public s_systemdata(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public s_systemdata(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_systemdata(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_systemdata(SqlHelper SqlConfig, int UserId, Simples_systemdata Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
