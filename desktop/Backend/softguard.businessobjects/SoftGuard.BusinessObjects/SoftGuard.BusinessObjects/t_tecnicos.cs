...
// Type: SoftGuard.BusinessObjects.t_tecnicos
...
{
  public class t_tecnicos : Spet_tecnicos
  {
    public t_tecnicos(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_tecnicos(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_tecnicos(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_tecnicos(SqlHelper SqlConfig, int UserId, Simplet_tecnicos Simple)
