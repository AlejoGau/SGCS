...
// Type: SoftGuard.BusinessObjects.T_ProtocolosComandos
...
{
  public class T_ProtocolosComandos : SpeT_ProtocolosComandos
  {
    public T_ProtocolosComandos(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public T_ProtocolosComandos(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public T_ProtocolosComandos(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public T_ProtocolosComandos(SqlHelper SqlConfig, int UserId, SimpleT_ProtocolosComandos Simple)
