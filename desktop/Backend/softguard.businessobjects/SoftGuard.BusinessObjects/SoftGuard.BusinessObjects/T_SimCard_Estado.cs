...
{ 
   ///<summary>
     ///T_SimCard_Estado class   
     ///</summary>
    public partial class T_SimCard_Estado : SpeT_SimCard_Estado
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public T_SimCard_Estado(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public T_SimCard_Estado(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_SimCard_Estado(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public T_SimCard_Estado(SqlHelper SqlConfig, int UserId, SimpleT_SimCard_Estado Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
