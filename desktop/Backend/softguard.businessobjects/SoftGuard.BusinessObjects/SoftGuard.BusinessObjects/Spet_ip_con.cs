...
// Type: SoftGuard.BusinessObjects.Spet_ip_con
...
{
  public abstract class Spet_ip_con : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_ip_con _DalObject;
    ...
    public int ipc_icodigo
    {
      get
      {
        return this._DalObject.ipc_icodigo;
      }
      set
      {
        this._DalObject.ipc_icodigo = value;
      }
    }
    ...
    public string ipc_cdescripcion
    {
      get
      {
        return this._DalObject.ipc_cdescripcion;
      }
      set
      {
        this._DalObject.ipc_cdescripcion = value;
      }
    }
    ...
    public int ipc_ireceptor
    {
      get
      {
        return this._DalObject.ipc_ireceptor;
      }
      set
      {
        this._DalObject.ipc_ireceptor = value;
      }
    }
    ...
    public Decimal ipc_nestado
    {
      get
      {
        return this._DalObject.ipc_nestado;
      }
      set
      {
        this._DalObject.ipc_nestado = value;
      }
    }
    ...
    public Decimal ipc_nport
    {
      get
      {
        return this._DalObject.ipc_nport;
      }
      set
      {
        this._DalObject.ipc_nport = value;
      }
    }
    ...
    public Decimal ipc_nprotocolo
    {
      get
      {
        return this._DalObject.ipc_nprotocolo;
      }
      set
      {
        this._DalObject.ipc_nprotocolo = value;
      }
    }
    ...
    public Decimal ipc_crespondeack
    {
      get
      {
        return this._DalObject.ipc_crespondeack;
      }
      set
      {
        this._DalObject.ipc_crespondeack = value;
      }
    }
    ...
    public int ipc_itiempoinactividad
    {
      get
      {
        return this._DalObject.ipc_itiempoinactividad;
      }
      set
      {
        this._DalObject.ipc_itiempoinactividad = value;
      }
    }
    ...
    public Decimal ipc_cresetxhb
    {
      get
      {
        return this._DalObject.ipc_cresetxhb;
      }
      set
      {
        this._DalObject.ipc_cresetxhb = value;
      }
    }
    ...
    public int ipc_imodemsms
    {
      get
      {
        return this._DalObject.ipc_imodemsms;
      }
      set
      {
        this._DalObject.ipc_imodemsms = value;
      }
    }
    ...
    public string ipc_cremotehostip
    {
      get
      {
        return this._DalObject.ipc_cremotehostip;
      }
      set
      {
        this._DalObject.ipc_cremotehostip = value;
      }
    }
    ...
    public Spet_ip_con(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_ip_con(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_ip_con(SqlHelper SqlConfig, int UserId, Simplet_ip_con Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_ip_con Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_ip_con has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_ip_con GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_ip_con is null.");
    ...
    {
      this._DalObject = new Dalt_ip_con(SqlConfig, UserId);
    ...
    {
      t_ip_con tIpCon = (t_ip_con) Object;
      tIpCon.Name = this.Name;
      tIpCon.ipc_icodigo = this.ipc_icodigo;
      tIpCon.ipc_cdescripcion = this.ipc_cdescripcion;
      tIpCon.ipc_ireceptor = this.ipc_ireceptor;
      tIpCon.ipc_nestado = this.ipc_nestado;
      tIpCon.ipc_nport = this.ipc_nport;
      tIpCon.ipc_nprotocolo = this.ipc_nprotocolo;
      tIpCon.ipc_crespondeack = this.ipc_crespondeack;
      tIpCon.ipc_itiempoinactividad = this.ipc_itiempoinactividad;
      tIpCon.ipc_cresetxhb = this.ipc_cresetxhb;
      tIpCon.ipc_imodemsms = this.ipc_imodemsms;
      tIpCon.ipc_cremotehostip = this.ipc_cremotehostip;
    }
