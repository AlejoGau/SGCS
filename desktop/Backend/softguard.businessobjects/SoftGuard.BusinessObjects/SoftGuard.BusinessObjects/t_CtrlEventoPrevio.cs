...
{ 
   ///<summary>
     ///t_CtrlEventoPrevio class   
     ///</summary>
    public partial class t_CtrlEventoPrevio : Spet_CtrlEventoPrevio
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_CtrlEventoPrevio(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_CtrlEventoPrevio(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_CtrlEventoPrevio(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_CtrlEventoPrevio(SqlHelper SqlConfig, int UserId, Simplet_CtrlEventoPrevio Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
