...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_dealer_stconfig : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_dealer_stconfig _DalObject;
 ...
 ///<summary>
     ...
     public string  dst_cdealer 
		 { 
                    ...
                    get{ return this._DalObject.dst_cdealer; }
        						set{ this._DalObject.dst_cdealer = value; } 										
	   }
	  ///<summary>
     ///dst_config property   
     ///</summary>	
     public string  dst_config 
		 { 
                    ...
                    get{ return this._DalObject.dst_config; }
        						set{ this._DalObject.dst_config = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_dealer_stconfig(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_dealer_stconfig(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_dealer_stconfig(SqlHelper SqlConfig, int UserId, Simplem_dealer_stconfig Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_dealer_stconfig Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_dealer_stconfig has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_dealer_stconfig GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_dealer_stconfig is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_dealer_stconfig(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_dealer_stconfig)Object;
			o.Name = this.Name;

			o.dst_cdealer = this.dst_cdealer;

			o.dst_config = this.dst_config;
