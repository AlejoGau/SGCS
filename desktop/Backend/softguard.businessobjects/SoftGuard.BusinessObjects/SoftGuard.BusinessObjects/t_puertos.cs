...
// Type: SoftGuard.BusinessObjects.t_puertos
...
{
  public class t_puertos : Spet_puertos
  {
    public t_puertos(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_puertos(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_puertos(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_puertos(SqlHelper SqlConfig, int UserId, Simplet_puertos Simple)
