...
// Type: SoftGuard.BusinessObjects.SpeHorarioAlternativoPlantilla
...
{
  public abstract class SpeHorarioAlternativoPlantilla : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalHorarioAlternativoPlantilla _DalObject;
    ...
    public int Alt_iid
    {
      get
      {
        return this._DalObject.Alt_iid;
      }
      set
      {
        this._DalObject.Alt_iid = value;
      }
    }
    ...
    public Decimal Alt_ndiaapertura
    {
      get
      {
        return this._DalObject.Alt_ndiaapertura;
      }
      set
      {
        this._DalObject.Alt_ndiaapertura = value;
      }
    }
    ...
    public string Alt_choraapertura
    {
      get
      {
        return this._DalObject.Alt_choraapertura;
      }
      set
      {
        this._DalObject.Alt_choraapertura = value;
      }
    }
    ...
    public Decimal Alt_ndiacierre
    {
      get
      {
        return this._DalObject.Alt_ndiacierre;
      }
      set
      {
        this._DalObject.Alt_ndiacierre = value;
      }
    }
    ...
    public string Alt_choracierre
    {
      get
      {
        return this._DalObject.Alt_choracierre;
      }
      set
      {
        this._DalObject.Alt_choracierre = value;
      }
    }
    ...
    public SpeHorarioAlternativoPlantilla(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeHorarioAlternativoPlantilla(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeHorarioAlternativoPlantilla(SqlHelper SqlConfig, int UserId, SimpleHorarioAlternativoPlantilla Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleHorarioAlternativoPlantilla Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The HorarioAlternativoPlantilla has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalHorarioAlternativoPlantilla GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The HorarioAlternativoPlantilla is null.");
    ...
    {
      this._DalObject = new DalHorarioAlternativoPlantilla(SqlConfig, UserId);
    ...
    {
      HorarioAlternativoPlantilla alternativoPlantilla = (HorarioAlternativoPlantilla) Object;
