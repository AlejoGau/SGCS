...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Specrm_contrato : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalcrm_contrato _DalObject;
 ...
 ///<summary>
     ...
     public int  cnt_org_fc 
		 { 
                    ...
                    get{ return this._DalObject.cnt_org_fc; }
        						set{ this._DalObject.cnt_org_fc = value; } 										
	   }
	  ///<summary>
     ...
     public int  cnt_idcliente 
		 { 
                    ...
                    get{ return this._DalObject.cnt_idcliente; }
        						set{ this._DalObject.cnt_idcliente = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  cnt_fechaalta 
		 { 
                    ...
                    get{ return this._DalObject.cnt_fechaalta; }
        						set{ this._DalObject.cnt_fechaalta = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  cnt_fechavto 
		 { 
                    ...
                    get{ return this._DalObject.cnt_fechavto; }
        						set{ this._DalObject.cnt_fechavto = value; } 										
	   }
	  ///<summary>
     ...
     public int  cnt_formapago 
		 { 
                    ...
                    get{ return this._DalObject.cnt_formapago; }
        						set{ this._DalObject.cnt_formapago = value; } 										
	   }
	  ///<summary>
     ...
     public string  cnt_metadata 
		 { 
                    ...
                    get{ return this._DalObject.cnt_metadata; }
        						set{ this._DalObject.cnt_metadata = value; } 										
	   }
	  ///<summary>
     ///cnt_estado property   
     ///</summary>	
     public int  cnt_estado 
		 { 
                    ...
                    get{ return this._DalObject.cnt_estado; }
        						set{ this._DalObject.cnt_estado = value; } 										
	   }
	  ///<summary>
     ///cnt_tmp_id property   
     ///</summary>	
     public int  cnt_tmp_id 
		 { 
                    ...
                    get{ return this._DalObject.cnt_tmp_id; }
        						set{ this._DalObject.cnt_tmp_id = value; } 										
	   }
	  ///<summary>
     ...
     public int  cnt_dinamico 
		 { 
                    ...
                    get{ return this._DalObject.cnt_dinamico; }
        						set{ this._DalObject.cnt_dinamico = value; } 										
	   }
	  ///<summary>
     ...
     public int  cnt_cantidad_auto 
		 { 
                    ...
                    get{ return this._DalObject.cnt_cantidad_auto; }
        						set{ this._DalObject.cnt_cantidad_auto = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Specrm_contrato(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Specrm_contrato(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Specrm_contrato(SqlHelper SqlConfig, int UserId, Simplecrm_contrato Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplecrm_contrato Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The crm_contrato has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalcrm_contrato GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The crm_contrato is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalcrm_contrato(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.crm_contrato)Object;
			o.Name = this.Name;

			o.cnt_org_fc = this.cnt_org_fc;

			o.cnt_idcliente = this.cnt_idcliente;

			o.cnt_fechaalta = this.cnt_fechaalta;

			o.cnt_fechavto = this.cnt_fechavto;

			o.cnt_formapago = this.cnt_formapago;

			o.cnt_metadata = this.cnt_metadata;

			o.cnt_estado = this.cnt_estado;

			o.cnt_tmp_id = this.cnt_tmp_id;

			o.cnt_dinamico = this.cnt_dinamico;

			o.cnt_cantidad_auto = this.cnt_cantidad_auto;
