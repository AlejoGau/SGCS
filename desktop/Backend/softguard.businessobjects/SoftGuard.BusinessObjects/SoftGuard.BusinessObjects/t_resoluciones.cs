...
// Type: SoftGuard.BusinessObjects.t_resoluciones
...
{
  public class t_resoluciones : Spet_resoluciones
  {
    public t_resoluciones(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_resoluciones(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_resoluciones(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_resoluciones(SqlHelper SqlConfig, int UserId, Simplet_resoluciones Simple)
