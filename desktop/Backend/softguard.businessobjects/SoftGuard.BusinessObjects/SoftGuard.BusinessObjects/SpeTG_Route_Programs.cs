...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeTG_Route_Programs : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalTG_Route_Programs _DalObject;
 ...
 ///<summary>
     ...
     public int  routeId 
		 { 
                    ...
                    get{ return this._DalObject.routeId; }
        						set{ this._DalObject.routeId = value; } 										
	   }
	  ///<summary>
     ...
     public string  programtype 
		 { 
                    ...
                    get{ return this._DalObject.programtype; }
        						set{ this._DalObject.programtype = value; } 										
	   }
	  ///<summary>
     ///starthour property   
     ///</summary>	
     public int  starthour 
		 { 
                    ...
                    get{ return this._DalObject.starthour; }
        						set{ this._DalObject.starthour = value; } 										
	   }
	  ///<summary>
     ...
     public int  startminutes 
		 { 
                    ...
                    get{ return this._DalObject.startminutes; }
        						set{ this._DalObject.startminutes = value; } 										
	   }
	  ///<summary>
     ///dayofweek property   
     ///</summary>	
     public int  dayofweek 
		 { 
                    ...
                    get{ return this._DalObject.dayofweek; }
        						set{ this._DalObject.dayofweek = value; } 										
	   }
	  ///<summary>
     ///dayofmonth property   
     ///</summary>	
     public int  dayofmonth 
		 { 
                    ...
                    get{ return this._DalObject.dayofmonth; }
        						set{ this._DalObject.dayofmonth = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeTG_Route_Programs(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTG_Route_Programs(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeTG_Route_Programs(SqlHelper SqlConfig, int UserId, SimpleTG_Route_Programs Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleTG_Route_Programs Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The TG_Route_Programs has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalTG_Route_Programs GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The TG_Route_Programs is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalTG_Route_Programs(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (TG_Route_Programs)Object;
			o.Name = this.Name;

			o.routeId = this.routeId;

			o.programtype = this.programtype;

			o.starthour = this.starthour;

			o.startminutes = this.startminutes;

			o.dayofweek = this.dayofweek;

			o.dayofmonth = this.dayofmonth;
