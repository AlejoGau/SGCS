...
{ 
   ///<summary>
     ///p_encuesta class   
     ///</summary>
    public partial class p_encuesta : Spep_encuesta
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_encuesta(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_encuesta(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_encuesta(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_encuesta(SqlHelper SqlConfig, int UserId, Simplep_encuesta Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
