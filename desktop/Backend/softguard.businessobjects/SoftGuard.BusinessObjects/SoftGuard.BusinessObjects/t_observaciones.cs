...
// Type: SoftGuard.BusinessObjects.t_observaciones
...
{
  public class t_observaciones : Spet_observaciones
  {
    public t_observaciones(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_observaciones(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_observaciones(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_observaciones(SqlHelper SqlConfig, int UserId, Simplet_observaciones Simple)
