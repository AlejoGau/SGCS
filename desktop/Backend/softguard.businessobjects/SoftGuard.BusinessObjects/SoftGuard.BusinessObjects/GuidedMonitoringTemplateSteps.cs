...
{ 
   ///<summary>
     ///GuidedMonitoringTemplateSteps class   
     ///</summary>
    public partial class GuidedMonitoringTemplateSteps : SpeGuidedMonitoringTemplateSteps
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public GuidedMonitoringTemplateSteps(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public GuidedMonitoringTemplateSteps(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public GuidedMonitoringTemplateSteps(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public GuidedMonitoringTemplateSteps(SqlHelper SqlConfig, int UserId, SimpleGuidedMonitoringTemplateSteps Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
