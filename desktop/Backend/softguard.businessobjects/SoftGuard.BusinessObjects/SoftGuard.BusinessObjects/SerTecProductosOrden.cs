...
// Type: SoftGuard.BusinessObjects.SerTecProductosOrden
...
{
  public class SerTecProductosOrden : SpeSerTecProductosOrden
  {
    public SerTecProductosOrden(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public SerTecProductosOrden(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public SerTecProductosOrden(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public SerTecProductosOrden(SqlHelper SqlConfig, int UserId, SimpleSerTecProductosOrden Simple)
