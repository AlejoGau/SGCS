...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_monedas : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_monedas _DalObject;
 ...
 ///<summary>
     ...
     public string  mon_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.mon_ccodigo; }
        						set{ this._DalObject.mon_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  mon_cnombre 
		 { 
                    ...
                    get{ return this._DalObject.mon_cnombre; }
        						set{ this._DalObject.mon_cnombre = value; } 										
	   }
	  ///<summary>
     ...
     public string  mon_csymbol 
		 { 
                    ...
                    get{ return this._DalObject.mon_csymbol; }
        						set{ this._DalObject.mon_csymbol = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_monedas(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_monedas(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_monedas(SqlHelper SqlConfig, int UserId, Simplet_monedas Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_monedas Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_monedas has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_monedas GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_monedas is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_monedas(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_monedas)Object;
			o.Name = this.Name;

			o.mon_ccodigo = this.mon_ccodigo;

			o.mon_cnombre = this.mon_cnombre;

			o.mon_csymbol = this.mon_csymbol;
