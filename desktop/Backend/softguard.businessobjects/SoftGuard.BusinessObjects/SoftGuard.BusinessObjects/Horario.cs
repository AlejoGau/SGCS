...
// Type: SoftGuard.BusinessObjects.Horario
...
{
  public class Horario : SpeHorario
  {
    public Horario(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public Horario(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public Horario(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public Horario(SqlHelper SqlConfig, int UserId, SimpleHorario Simple)
