...
// Type: SoftGuard.BusinessObjects.SpeEquipoDispositivoMovil
...
{
  public abstract class SpeEquipoDispositivoMovil : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalEquipoDispositivoMovil _DalObject;
    ...
    public int idEquipo
    {
      get
      {
        return this._DalObject.idEquipo;
      }
      set
      {
        this._DalObject.idEquipo = value;
      }
    }
    ...
    public int isTemplate
    {
      get
      {
        return this._DalObject.isTemplate;
      }
      set
      {
        this._DalObject.isTemplate = value;
      }
    }
    ...
    public SpeEquipoDispositivoMovil(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeEquipoDispositivoMovil(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeEquipoDispositivoMovil(SqlHelper SqlConfig, int UserId, SimpleEquipoDispositivoMovil Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleEquipoDispositivoMovil Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The EquipoDispositivoMovil has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalEquipoDispositivoMovil GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The EquipoDispositivoMovil is null.");
    ...
    {
      this._DalObject = new DalEquipoDispositivoMovil(SqlConfig, UserId);
    ...
    {
      EquipoDispositivoMovil dispositivoMovil = (EquipoDispositivoMovil) Object;
