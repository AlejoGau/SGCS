...
{ 
   ///<summary>
     ///t_WeSafePriceOptions class   
     ///</summary>
    public partial class t_WeSafePriceOptions : Spet_WeSafePriceOptions
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_WeSafePriceOptions(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_WeSafePriceOptions(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_WeSafePriceOptions(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_WeSafePriceOptions(SqlHelper SqlConfig, int UserId, Simplet_WeSafePriceOptions Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
