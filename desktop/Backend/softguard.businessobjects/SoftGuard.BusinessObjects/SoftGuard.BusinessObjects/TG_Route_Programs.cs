...
{ 
   ///<summary>
     ///TG_Route_Programs class   
     ///</summary>
    public partial class TG_Route_Programs : SpeTG_Route_Programs
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public TG_Route_Programs(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public TG_Route_Programs(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TG_Route_Programs(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public TG_Route_Programs(SqlHelper SqlConfig, int UserId, SimpleTG_Route_Programs Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
