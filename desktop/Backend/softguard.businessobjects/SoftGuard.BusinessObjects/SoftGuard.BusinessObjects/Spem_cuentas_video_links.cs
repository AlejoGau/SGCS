...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_cuentas_video_links : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_cuentas_video_links _DalObject;
 ...
 ///<summary>
     ...
     public int  cvl_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.cvl_iidcuenta; }
        						set{ this._DalObject.cvl_iidcuenta = value; } 										
	   }
	  ///<summary>
     ...
     public string  cvl_calarma 
		 { 
                    ...
                    get{ return this._DalObject.cvl_calarma; }
        						set{ this._DalObject.cvl_calarma = value; } 										
	   }
	  ///<summary>
     ///cvl_czona property   
     ///</summary>	
     public string  cvl_czona 
		 { 
                    ...
                    get{ return this._DalObject.cvl_czona; }
        						set{ this._DalObject.cvl_czona = value; } 										
	   }
	  ///<summary>
     ///cvl_clink property   
     ///</summary>	
     public string  cvl_clink 
		 { 
                    ...
                    get{ return this._DalObject.cvl_clink; }
        						set{ this._DalObject.cvl_clink = value; } 										
	   }
	  ///<summary>
     ...
     public string  cvl_clinkdss 
		 { 
                    ...
                    get{ return this._DalObject.cvl_clinkdss; }
        						set{ this._DalObject.cvl_clinkdss = value; } 										
	   }
	  ///<summary>
     ...
     public int  cvl_ivideoid 
		 { 
                    ...
                    get{ return this._DalObject.cvl_ivideoid; }
        						set{ this._DalObject.cvl_ivideoid = value; } 										
	   }
	  ///<summary>
     ...
     public Single  cvl_rlatitud 
		 { 
                    ...
                    get{ return this._DalObject.cvl_rlatitud; }
        						set{ this._DalObject.cvl_rlatitud = value; } 										
	   }
	  ///<summary>
     ...
     public Single  cvl_rlongitud 
		 { 
                    ...
                    get{ return this._DalObject.cvl_rlongitud; }
        						set{ this._DalObject.cvl_rlongitud = value; } 										
	   }
	  ///<summary>
     ...
     public int  cuv_iTodosLosEventos 
		 { 
                    ...
                    get{ return this._DalObject.cuv_iTodosLosEventos; }
        						set{ this._DalObject.cuv_iTodosLosEventos = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_cuentas_video_links(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuentas_video_links(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuentas_video_links(SqlHelper SqlConfig, int UserId, Simplem_cuentas_video_links Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_cuentas_video_links Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_cuentas_video_links has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_cuentas_video_links GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_cuentas_video_links is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_cuentas_video_links(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_cuentas_video_links)Object;
			o.Name = this.Name;

			o.cvl_iidcuenta = this.cvl_iidcuenta;

			o.cvl_calarma = this.cvl_calarma;

			o.cvl_czona = this.cvl_czona;

			o.cvl_clink = this.cvl_clink;

			o.cvl_clinkdss = this.cvl_clinkdss;

			o.cvl_ivideoid = this.cvl_ivideoid;

			o.cvl_rlatitud = this.cvl_rlatitud;

			o.cvl_rlongitud = this.cvl_rlongitud;

			o.cuv_iTodosLosEventos = this.cuv_iTodosLosEventos;
