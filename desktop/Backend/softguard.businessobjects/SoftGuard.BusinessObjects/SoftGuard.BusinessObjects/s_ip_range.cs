...
{ 
   ///<summary>
     ///s_ip_range class   
     ///</summary>
    public partial class s_ip_range : Spes_ip_range
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public s_ip_range(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public s_ip_range(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_ip_range(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public s_ip_range(SqlHelper SqlConfig, int UserId, Simples_ip_range Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
