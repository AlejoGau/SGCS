...
// Type: SoftGuard.BusinessObjects.t_bancos_fc
...
{
  public class t_bancos_fc : Spet_bancos_fc
  {
    public t_bancos_fc(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_bancos_fc(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_bancos_fc(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_bancos_fc(SqlHelper SqlConfig, int UserId, Simplet_bancos_fc Simple)
