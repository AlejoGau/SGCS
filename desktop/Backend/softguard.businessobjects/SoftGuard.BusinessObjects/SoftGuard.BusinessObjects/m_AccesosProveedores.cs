...
{ 
   ///<summary>
     ///m_AccesosProveedores class   
     ///</summary>
    public partial class m_AccesosProveedores : Spem_AccesosProveedores
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_AccesosProveedores(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_AccesosProveedores(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_AccesosProveedores(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_AccesosProveedores(SqlHelper SqlConfig, int UserId, Simplem_AccesosProveedores Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
