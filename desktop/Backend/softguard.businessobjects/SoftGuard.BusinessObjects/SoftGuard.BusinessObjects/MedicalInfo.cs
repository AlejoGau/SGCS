...
// Type: SoftGuard.BusinessObjects.MedicalInfo
...
{
  public class MedicalInfo : SpeMedicalInfo
  {
    public MedicalInfo(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public MedicalInfo(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token;
    }

    public MedicalInfo(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public MedicalInfo(SqlHelper SqlConfig, int UserId, SimpleMedicalInfo Simple)
