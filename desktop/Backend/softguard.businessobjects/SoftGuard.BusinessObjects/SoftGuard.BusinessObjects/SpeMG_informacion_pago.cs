...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeMG_informacion_pago : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalMG_informacion_pago _DalObject;
 ...
 ///<summary>
     ...
     public int  mip_fpgidkey 
		 { 
                    ...
                    get{ return this._DalObject.mip_fpgidkey; }
        						set{ this._DalObject.mip_fpgidkey = value; } 										
	   }
	  ///<summary>
     ...
     public int  mip_idcliente 
		 { 
                    ...
                    get{ return this._DalObject.mip_idcliente; }
        						set{ this._DalObject.mip_idcliente = value; } 										
	   }
	  ///<summary>
     ///mip_codigo property   
     ///</summary>	
     public string  mip_codigo 
		 { 
                    ...
                    get{ return this._DalObject.mip_codigo; }
        						set{ this._DalObject.mip_codigo = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  mip_fechadesde 
		 { 
                    ...
                    get{ return this._DalObject.mip_fechadesde; }
        						set{ this._DalObject.mip_fechadesde = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  mip_fechahasta 
		 { 
                    ...
                    get{ return this._DalObject.mip_fechahasta; }
        						set{ this._DalObject.mip_fechahasta = value; } 										
	   }
	  ///<summary>
     ///mip_emisor property   
     ///</summary>	
     public int  mip_emisor 
		 { 
                    ...
                    get{ return this._DalObject.mip_emisor; }
        						set{ this._DalObject.mip_emisor = value; } 										
	   }
	  ///<summary>
     ///mip_clave property   
     ///</summary>	
     public string  mip_clave 
		 { 
                    ...
                    get{ return this._DalObject.mip_clave; }
        						set{ this._DalObject.mip_clave = value; } 										
	   }
	  ///<summary>
     ...
     public string  mip_nombreusuario 
		 { 
                    ...
                    get{ return this._DalObject.mip_nombreusuario; }
        						set{ this._DalObject.mip_nombreusuario = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeMG_informacion_pago(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_informacion_pago(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeMG_informacion_pago(SqlHelper SqlConfig, int UserId, SimpleMG_informacion_pago Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleMG_informacion_pago Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The MG_informacion_pago has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalMG_informacion_pago GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The MG_informacion_pago is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalMG_informacion_pago(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
		...
		public void CopyPropertiesTo(ISpecialization Object)
        {
			...
			var o = (MG_informacion_pago)Object;

			o.Name = this.Name;

			o.mip_fpgidkey = this.mip_fpgidkey;

			o.mip_idcliente = this.mip_idcliente;

			o.mip_codigo = this.mip_codigo;

			o.mip_fechadesde = this.mip_fechadesde;

			o.mip_fechahasta = this.mip_fechahasta;

			o.mip_emisor = this.mip_emisor;

			o.mip_clave = this.mip_clave;

			o.mip_nombreusuario = this.mip_nombreusuario;
