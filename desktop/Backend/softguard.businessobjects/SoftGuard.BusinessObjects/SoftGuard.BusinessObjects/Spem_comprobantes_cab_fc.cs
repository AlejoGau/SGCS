...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_comprobantes_cab_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_comprobantes_cab_fc _DalObject;
 ...
 ///<summary>
     ...
     public int  cbc_icliente 
		 { 
                    ...
                    get{ return this._DalObject.cbc_icliente; }
        						set{ this._DalObject.cbc_icliente = value; } 										
	   }
	  ///<summary>
     ///cbc_dfecha property   
     ///</summary>	
     public DateTime?  cbc_dfecha 
		 { 
                    ...
                    get{ return this._DalObject.cbc_dfecha; }
        						set{ this._DalObject.cbc_dfecha = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbc_ctipocbte 
		 { 
                    ...
                    get{ return this._DalObject.cbc_ctipocbte; }
        						set{ this._DalObject.cbc_ctipocbte = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbc_cprefijocbte 
		 { 
                    ...
                    get{ return this._DalObject.cbc_cprefijocbte; }
        						set{ this._DalObject.cbc_cprefijocbte = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbc_inumerocbte 
		 { 
                    ...
                    get{ return this._DalObject.cbc_inumerocbte; }
        						set{ this._DalObject.cbc_inumerocbte = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  cbc_ysubtotal 
		 { 
                    ...
                    get{ return this._DalObject.cbc_ysubtotal; }
        						set{ this._DalObject.cbc_ysubtotal = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  cbc_yimpuesto1 
		 { 
                    ...
                    get{ return this._DalObject.cbc_yimpuesto1; }
        						set{ this._DalObject.cbc_yimpuesto1 = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  cbc_yimpuesto2 
		 { 
                    ...
                    get{ return this._DalObject.cbc_yimpuesto2; }
        						set{ this._DalObject.cbc_yimpuesto2 = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  cbc_yimpuesto3 
		 { 
                    ...
                    get{ return this._DalObject.cbc_yimpuesto3; }
        						set{ this._DalObject.cbc_yimpuesto3 = value; } 										
	   }
	  ///<summary>
     ///cbc_ytotal property   
     ///</summary>	
     public Decimal  cbc_ytotal 
		 { 
                    ...
                    get{ return this._DalObject.cbc_ytotal; }
        						set{ this._DalObject.cbc_ytotal = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbc_cestado 
		 { 
                    ...
                    get{ return this._DalObject.cbc_cestado; }
        						set{ this._DalObject.cbc_cestado = value; } 										
	   }
	  ///<summary>
     ///cbc_ccae property   
     ///</summary>	
     public string  cbc_ccae 
		 { 
                    ...
                    get{ return this._DalObject.cbc_ccae; }
        						set{ this._DalObject.cbc_ccae = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbc_cvtocae 
		 { 
                    ...
                    get{ return this._DalObject.cbc_cvtocae; }
        						set{ this._DalObject.cbc_cvtocae = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbc_iversion 
		 { 
                    ...
                    get{ return this._DalObject.cbc_iversion; }
        						set{ this._DalObject.cbc_iversion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_comprobantes_cab_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_comprobantes_cab_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_comprobantes_cab_fc(SqlHelper SqlConfig, int UserId, Simplem_comprobantes_cab_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_comprobantes_cab_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_comprobantes_cab_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_comprobantes_cab_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_comprobantes_cab_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_comprobantes_cab_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_comprobantes_cab_fc)Object;
			o.Name = this.Name;

			o.cbc_icliente = this.cbc_icliente;

			o.cbc_dfecha = this.cbc_dfecha;

			o.cbc_ctipocbte = this.cbc_ctipocbte;

			o.cbc_cprefijocbte = this.cbc_cprefijocbte;

			o.cbc_inumerocbte = this.cbc_inumerocbte;

			o.cbc_ysubtotal = this.cbc_ysubtotal;

			o.cbc_yimpuesto1 = this.cbc_yimpuesto1;

			o.cbc_yimpuesto2 = this.cbc_yimpuesto2;

			o.cbc_yimpuesto3 = this.cbc_yimpuesto3;

			o.cbc_ytotal = this.cbc_ytotal;

			o.cbc_cestado = this.cbc_cestado;

			o.cbc_ccae = this.cbc_ccae;

			o.cbc_cvtocae = this.cbc_cvtocae;

			o.cbc_iversion = this.cbc_iversion;
