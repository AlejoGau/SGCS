...
// Type: SoftGuard.BusinessObjects.t_tipos_formapago_fc
...
{
  public class t_tipos_formapago_fc : Spet_tipos_formapago_fc
  {
    public t_tipos_formapago_fc(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_tipos_formapago_fc(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_tipos_formapago_fc(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_tipos_formapago_fc(SqlHelper SqlConfig, int UserId, Simplet_tipos_formapago_fc Simple)
