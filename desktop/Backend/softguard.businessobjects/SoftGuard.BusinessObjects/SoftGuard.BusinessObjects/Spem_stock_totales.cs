...
// Type: SoftGuard.BusinessObjects.Spem_stock_totales
...
{
  public abstract class Spem_stock_totales : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalm_stock_totales _DalObject;
    ...
    public int stt_iddeposito
    {
      get
      {
        return this._DalObject.stt_iddeposito;
      }
      set
      {
        this._DalObject.stt_iddeposito = value;
      }
    }
    ...
    public int stt_idproducto
    {
      get
      {
        return this._DalObject.stt_idproducto;
      }
      set
      {
        this._DalObject.stt_idproducto = value;
      }
    }
    ...
    public int stt_idtecnico
    {
      get
      {
        return this._DalObject.stt_idtecnico;
      }
      set
      {
        this._DalObject.stt_idtecnico = value;
      }
    }
    ...
    public float stt_cant
    {
      get
      {
        return this._DalObject.stt_cant;
      }
      set
      {
        this._DalObject.stt_cant = value;
      }
    }
    ...
    public DateTime? stt_fecha
    {
      get
      {
        return this._DalObject.stt_fecha;
      }
      set
      {
        this._DalObject.stt_fecha = value;
      }
    }
    ...
    public Spem_stock_totales(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spem_stock_totales(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spem_stock_totales(SqlHelper SqlConfig, int UserId, Simplem_stock_totales Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplem_stock_totales Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The m_stock_totales has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalm_stock_totales GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The m_stock_totales is null.");
    ...
    {
      this._DalObject = new Dalm_stock_totales(SqlConfig, UserId);
    ...
    {
      m_stock_totales mStockTotales = (m_stock_totales) Object;
      mStockTotales.Name = this.Name;
      mStockTotales.stt_iddeposito = this.stt_iddeposito;
      mStockTotales.stt_idproducto = this.stt_idproducto;
      mStockTotales.stt_idtecnico = this.stt_idtecnico;
      mStockTotales.stt_cant = this.stt_cant;
      mStockTotales.stt_fecha = this.stt_fecha;
    }
