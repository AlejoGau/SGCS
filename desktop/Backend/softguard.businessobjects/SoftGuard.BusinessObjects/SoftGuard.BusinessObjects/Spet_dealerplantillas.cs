...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_dealerplantillas : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_dealerplantillas _DalObject;
 ...
 ///<summary>
     ...
     public int  lin_idkey 
		 { 
                    ...
                    get{ return this._DalObject.lin_idkey; }
        						set{ this._DalObject.lin_idkey = value; } 										
	   }
	  ///<summary>
     ///pls_idkey property   
     ///</summary>	
     public int  pls_idkey 
		 { 
                    ...
                    get{ return this._DalObject.pls_idkey; }
        						set{ this._DalObject.pls_idkey = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_dealerplantillas(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_dealerplantillas(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_dealerplantillas(SqlHelper SqlConfig, int UserId, Simplet_dealerplantillas Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_dealerplantillas Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_dealerplantillas has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_dealerplantillas GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_dealerplantillas is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_dealerplantillas(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_dealerplantillas)Object;
			o.Name = this.Name;

			o.lin_idkey = this.lin_idkey;

			o.pls_idkey = this.pls_idkey;
