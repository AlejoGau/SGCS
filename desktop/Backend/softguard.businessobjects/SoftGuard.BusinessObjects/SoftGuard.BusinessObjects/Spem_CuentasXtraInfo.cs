...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_CuentasXtraInfo : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_CuentasXtraInfo _DalObject;
 ...
 ///<summary>
     ...
     public int  cue_iidcuenta 
		 { 
                    ...
                    get{ return this._DalObject.cue_iidcuenta; }
        						set{ this._DalObject.cue_iidcuenta = value; } 										
	   }
	  ///<summary>
     ...
     public string  cue_cconfig 
		 { 
                    ...
                    get{ return this._DalObject.cue_cconfig; }
        						set{ this._DalObject.cue_cconfig = value; } 										
	   }
	  ///<summary>
     ...
     public int  cue_ilicenciassp 
		 { 
                    ...
                    get{ return this._DalObject.cue_ilicenciassp; }
        						set{ this._DalObject.cue_ilicenciassp = value; } 										
	   }
	  ///<summary>
     ...
     public int  cue_iImportancia 
		 { 
                    ...
                    get{ return this._DalObject.cue_iImportancia; }
        						set{ this._DalObject.cue_iImportancia = value; } 										
	   }
	  ///<summary>
     ...
     public int  cue_iteclado 
		 { 
                    ...
                    get{ return this._DalObject.cue_iteclado; }
        						set{ this._DalObject.cue_iteclado = value; } 										
	   }
	  ///<summary>
     ...
     public string  cue_cHoraAperturaAutomonitoreo 
		 { 
                    ...
                    get{ return this._DalObject.cue_cHoraAperturaAutomonitoreo; }
        						set{ this._DalObject.cue_cHoraAperturaAutomonitoreo = value; } 										
	   }
	  ///<summary>
     ...
     public string  cue_cHoraCierreAutomonitoreo  
		 { 
                    ...
                    get{ return this._DalObject.cue_cHoraCierreAutomonitoreo ; }
        						set{ this._DalObject.cue_cHoraCierreAutomonitoreo  = value; } 										
	   }
	  ///<summary>
     ...
     public int  cue_ilicenciapar 
		 { 
                    ...
                    get{ return this._DalObject.cue_ilicenciapar; }
        						set{ this._DalObject.cue_ilicenciapar = value; } 										
	   }
	  ///<summary>
     ...
     public int  cue_iTipoServicio 
		 { 
                    ...
                    get{ return this._DalObject.cue_iTipoServicio; }
        						set{ this._DalObject.cue_iTipoServicio = value; } 										
	   }
	  ///<summary>
     ...
     public int  cue_iExcesoLimiteDia 
		 { 
                    ...
                    get{ return this._DalObject.cue_iExcesoLimiteDia; }
        						set{ this._DalObject.cue_iExcesoLimiteDia = value; } 										
	   }
	  ///<summary>
     ...
     public int  cue_iExcesoLimiteHora 
		 { 
                    ...
                    get{ return this._DalObject.cue_iExcesoLimiteHora; }
        						set{ this._DalObject.cue_iExcesoLimiteHora = value; } 										
	   }
	  ///<summary>
     ...
     public string  cue_cInstrucciones 
		 { 
                    ...
                    get{ return this._DalObject.cue_cInstrucciones; }
        						set{ this._DalObject.cue_cInstrucciones = value; } 										
	   }
	  ///<summary>
     ...
     public int  cue_iInstrMostrar 
		 { 
                    ...
                    get{ return this._DalObject.cue_iInstrMostrar; }
        						set{ this._DalObject.cue_iInstrMostrar = value; } 										
	   }
	  ///<summary>
     ...
     public int  cue_iVigiladoresVC 
		 { 
                    ...
                    get{ return this._DalObject.cue_iVigiladoresVC; }
        						set{ this._DalObject.cue_iVigiladoresVC = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spem_CuentasXtraInfo(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_CuentasXtraInfo(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_CuentasXtraInfo(SqlHelper SqlConfig, int UserId, Simplem_CuentasXtraInfo Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_CuentasXtraInfo Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_CuentasXtraInfo has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_CuentasXtraInfo GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_CuentasXtraInfo is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_CuentasXtraInfo(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.m_CuentasXtraInfo)Object;
			o.Name = this.Name;

			o.cue_iidcuenta = this.cue_iidcuenta;

			o.cue_ccustom = this.cue_ccustom;

			o.cue_cconfig = this.cue_cconfig;

			o.cue_ilicenciassp = this.cue_ilicenciassp;

			o.cue_iImportancia = this.cue_iImportancia;

			o.cue_iteclado = this.cue_iteclado;

			o.cue_cHoraAperturaAutomonitoreo = this.cue_cHoraAperturaAutomonitoreo;

			o.cue_cHoraCierreAutomonitoreo  = this.cue_cHoraCierreAutomonitoreo ;

			o.cue_ilicenciapar = this.cue_ilicenciapar;

			o.cue_iTipoServicio = this.cue_iTipoServicio;

			o.cue_iExcesoLimiteDia = this.cue_iExcesoLimiteDia;

			o.cue_iExcesoLimiteHora = this.cue_iExcesoLimiteHora;

			o.cue_cInstrucciones = this.cue_cInstrucciones;

			o.cue_iInstrMostrar = this.cue_iInstrMostrar;

			o.cue_iVigiladoresVC = this.cue_iVigiladoresVC;
