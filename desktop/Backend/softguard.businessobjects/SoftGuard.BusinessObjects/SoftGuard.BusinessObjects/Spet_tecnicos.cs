...
// Type: SoftGuard.BusinessObjects.Spet_tecnicos
...
{
  public abstract class Spet_tecnicos : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_tecnicos _DalObject;
    ...
    public string tec_ccodigo
    {
      get
      {
        return this._DalObject.tec_ccodigo;
      }
      set
      {
        this._DalObject.tec_ccodigo = value;
      }
    }
    ...
    public string tec_cnombre
    {
      get
      {
        return this._DalObject.tec_cnombre;
      }
      set
      {
        this._DalObject.tec_cnombre = value;
      }
    }
    ...
    public string tec_ctelefono
    {
      get
      {
        return this._DalObject.tec_ctelefono;
      }
      set
      {
        this._DalObject.tec_ctelefono = value;
      }
    }
    ...
    public string tec_cmail
    {
      get
      {
        return this._DalObject.tec_cmail;
      }
      set
      {
        this._DalObject.tec_cmail = value;
      }
    }
    ...
    public Decimal tec_ningreso
    {
      get
      {
        return this._DalObject.tec_ningreso;
      }
      set
      {
        this._DalObject.tec_ningreso = value;
      }
    }
    ...
    public Decimal tec_negreso
    {
      get
      {
        return this._DalObject.tec_negreso;
      }
      set
      {
        this._DalObject.tec_negreso = value;
      }
    }
    ...
    public string tec_cobservaciones
    {
      get
      {
        return this._DalObject.tec_cobservaciones;
      }
      set
      {
        this._DalObject.tec_cobservaciones = value;
      }
    }
    ...
    public Decimal tec_nestado
    {
      get
      {
        return this._DalObject.tec_nestado;
      }
      set
      {
        this._DalObject.tec_nestado = value;
      }
    }
    ...
    public Spet_tecnicos(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_tecnicos(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_tecnicos(SqlHelper SqlConfig, int UserId, Simplet_tecnicos Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_tecnicos Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_tecnicos has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_tecnicos GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_tecnicos is null.");
    ...
    {
      this._DalObject = new Dalt_tecnicos(SqlConfig, UserId);
    ...
    {
      t_tecnicos tTecnicos = (t_tecnicos) Object;
      tTecnicos.Name = this.Name;
      tTecnicos.tec_ccodigo = this.tec_ccodigo;
      tTecnicos.tec_cnombre = this.tec_cnombre;
      tTecnicos.tec_ctelefono = this.tec_ctelefono;
      tTecnicos.tec_cmail = this.tec_cmail;
      tTecnicos.tec_ningreso = this.tec_ningreso;
      tTecnicos.tec_negreso = this.tec_negreso;
      tTecnicos.tec_cobservaciones = this.tec_cobservaciones;
      tTecnicos.tec_nestado = this.tec_nestado;
    }
