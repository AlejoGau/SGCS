...
// Type: SoftGuard.BusinessObjects.SpeScheduler
...
{
  public abstract class SpeScheduler : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected DalScheduler _DalObject;
    ...
    public int template
    {
      get
      {
        return this._DalObject.template;
      }
      set
      {
        this._DalObject.template = value;
      }
    }
    ...
    public DateTime? limitdate
    {
      get
      {
        return this._DalObject.limitdate;
      }
      set
      {
        this._DalObject.limitdate = value;
      }
    }
    ...
    public int status
    {
      get
      {
        return this._DalObject.status;
      }
      set
      {
        this._DalObject.status = value;
      }
    }
    ...
    public DateTime? lastchange
    {
      get
      {
        return this._DalObject.lastchange;
      }
      set
      {
        this._DalObject.lastchange = value;
      }
    }
    ...
    public string config
    {
      get
      {
        return this._DalObject.config;
      }
      set
      {
        this._DalObject.config = value;
      }
    }
    ...
    public int eventid
    {
      get
      {
        return this._DalObject.eventid;
      }
      set
      {
        this._DalObject.eventid = value;
      }
    }
    ...
    public string eventtype
    {
      get
      {
        return this._DalObject.eventtype;
      }
      set
      {
        this._DalObject.eventtype = value;
      }
    }
    ...
    public string condition
    {
      get
      {
        return this._DalObject.condition;
      }
      set
      {
        this._DalObject.condition = value;
      }
    }
    ...
    public string sql
    {
      get
      {
        return this._DalObject.sql;
      }
      set
      {
        this._DalObject.sql = value;
      }
    }
    ...
    public SpeScheduler(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeScheduler(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeScheduler(SqlHelper SqlConfig, int UserId, SimpleScheduler Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleScheduler Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The Scheduler has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalScheduler GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The Scheduler is null.");
    ...
    {
      this._DalObject = new DalScheduler(SqlConfig, UserId);
    ...
    public void CopyPropertiesTo(ISpecialization Object)
    {
      ...
      scheduler.template = this.template;
      scheduler.limitdate = this.limitdate;
      scheduler.status = this.status;
      scheduler.lastchange = this.lastchange;
      scheduler.config = this.config;
      scheduler.eventid = this.eventid;
      scheduler.eventtype = this.eventtype;
      scheduler.condition = this.condition;
      scheduler.sql = this.sql;
    }
