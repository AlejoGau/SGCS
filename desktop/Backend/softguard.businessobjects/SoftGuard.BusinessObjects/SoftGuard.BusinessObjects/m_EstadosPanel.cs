...
{ 
   ///<summary>
     ///m_EstadosPanel class   
     ///</summary>
    public partial class m_EstadosPanel : Spem_EstadosPanel
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public m_EstadosPanel(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public m_EstadosPanel(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_EstadosPanel(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public m_EstadosPanel(SqlHelper SqlConfig, int UserId, Simplem_EstadosPanel Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
