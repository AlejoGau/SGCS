...
{ 
   ///<summary>
     ///t_monitoreo_dealer class   
     ///</summary>
    public partial class t_monitoreo_dealer : Spet_monitoreo_dealer
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_monitoreo_dealer(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_monitoreo_dealer(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_monitoreo_dealer(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_monitoreo_dealer(SqlHelper SqlConfig, int UserId, Simplet_monitoreo_dealer Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
