...
// Type: SoftGuard.BusinessObjects.TaskStatus
...
{
  public class TaskStatus : SpeTaskStatus
  {
    public TaskStatus(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public TaskStatus(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public TaskStatus(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public TaskStatus(SqlHelper SqlConfig, int UserId, SimpleTaskStatus Simple)
