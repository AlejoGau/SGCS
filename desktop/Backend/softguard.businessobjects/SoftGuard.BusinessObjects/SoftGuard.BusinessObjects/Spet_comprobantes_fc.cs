...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_comprobantes_fc : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_comprobantes_fc _DalObject;
 ...
 ///<summary>
     ...
     public string  cbt_ccodigo 
		 { 
                    ...
                    get{ return this._DalObject.cbt_ccodigo; }
        						set{ this._DalObject.cbt_ccodigo = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbt_cdescripcion 
		 { 
                    ...
                    get{ return this._DalObject.cbt_cdescripcion; }
        						set{ this._DalObject.cbt_cdescripcion = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbt_cdescripcionreducida 
		 { 
                    ...
                    get{ return this._DalObject.cbt_cdescripcionreducida; }
        						set{ this._DalObject.cbt_cdescripcionreducida = value; } 										
	   }
	  ///<summary>
     ///cbt_ntipo property   
     ///</summary>	
     public int  cbt_ntipo 
		 { 
                    ...
                    get{ return this._DalObject.cbt_ntipo; }
        						set{ this._DalObject.cbt_ntipo = value; } 										
	   }
	  ///<summary>
     ///cbt_cletra property   
     ///</summary>	
     public string  cbt_cletra 
		 { 
                    ...
                    get{ return this._DalObject.cbt_cletra; }
        						set{ this._DalObject.cbt_cletra = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbt_cprefijo 
		 { 
                    ...
                    get{ return this._DalObject.cbt_cprefijo; }
        						set{ this._DalObject.cbt_cprefijo = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbt_inumero 
		 { 
                    ...
                    get{ return this._DalObject.cbt_inumero; }
        						set{ this._DalObject.cbt_inumero = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbt_ncopias 
		 { 
                    ...
                    get{ return this._DalObject.cbt_ncopias; }
        						set{ this._DalObject.cbt_ncopias = value; } 										
	   }
	  ///<summary>
     ...
     public string  cbt_casociado 
		 { 
                    ...
                    get{ return this._DalObject.cbt_casociado; }
        						set{ this._DalObject.cbt_casociado = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbt_nCbteCAE 
		 { 
                    ...
                    get{ return this._DalObject.cbt_nCbteCAE; }
        						set{ this._DalObject.cbt_nCbteCAE = value; } 										
	   }
	  ///<summary>
     ...
     public int  cbt_idOrganizacionFacturadora 
		 { 
                    ...
                    get{ return this._DalObject.cbt_idOrganizacionFacturadora; }
        						set{ this._DalObject.cbt_idOrganizacionFacturadora = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_comprobantes_fc(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_comprobantes_fc(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_comprobantes_fc(SqlHelper SqlConfig, int UserId, Simplet_comprobantes_fc Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_comprobantes_fc Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_comprobantes_fc has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_comprobantes_fc GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_comprobantes_fc is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_comprobantes_fc(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (t_comprobantes_fc)Object;
			o.Name = this.Name;

			o.cbt_ccodigo = this.cbt_ccodigo;

			o.cbt_cdescripcion = this.cbt_cdescripcion;

			o.cbt_cdescripcionreducida = this.cbt_cdescripcionreducida;

			o.cbt_ntipo = this.cbt_ntipo;

			o.cbt_cletra = this.cbt_cletra;

			o.cbt_cprefijo = this.cbt_cprefijo;

			o.cbt_inumero = this.cbt_inumero;

			o.cbt_ncopias = this.cbt_ncopias;

			o.cbt_casociado = this.cbt_casociado;

			o.cbt_nCbteCAE = this.cbt_nCbteCAE;

			o.cbt_idOrganizacionFacturadora = this.cbt_idOrganizacionFacturadora;
