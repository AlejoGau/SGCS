...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_GuidedStepOptions : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_GuidedStepOptions _DalObject;
 ...
 ///<summary>
     ...
     public string  gso_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.gso_cDescripcion; }
        						set{ this._DalObject.gso_cDescripcion = value; } 										
	   }
	  ///<summary>
     ///gso_cType property   
     ///</summary>	
     public string  gso_cType 
		 { 
                    ...
                    get{ return this._DalObject.gso_cType; }
        						set{ this._DalObject.gso_cType = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_GuidedStepOptions(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_GuidedStepOptions(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_GuidedStepOptions(SqlHelper SqlConfig, int UserId, Simplet_GuidedStepOptions Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_GuidedStepOptions Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_GuidedStepOptions has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_GuidedStepOptions GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_GuidedStepOptions is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_GuidedStepOptions(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_GuidedStepOptions)Object;
			o.Name = this.Name;

			o.gso_cDescripcion = this.gso_cDescripcion;

			o.gso_cType = this.gso_cType;
