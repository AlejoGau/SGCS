...
// Type: SoftGuard.BusinessObjects.m_stock_cabecera
...
{
  public class m_stock_cabecera : Spem_stock_cabecera
  {
    public m_stock_cabecera(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public m_stock_cabecera(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public m_stock_cabecera(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public m_stock_cabecera(SqlHelper SqlConfig, int UserId, Simplem_stock_cabecera Simple)
