...
// Type: SoftGuard.BusinessObjects.Spet_autoridaddestino
...
{
  public abstract class Spet_autoridaddestino : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalt_autoridaddestino _DalObject;
    ...
    public string tad_cnombre
    {
      get
      {
        return this._DalObject.tad_cnombre;
      }
      set
      {
        this._DalObject.tad_cnombre = value;
      }
    }
    ...
    public string tad_curl
    {
      get
      {
        return this._DalObject.tad_curl;
      }
      set
      {
        this._DalObject.tad_curl = value;
      }
    }
    ...
    public string tad_cconfig
    {
      get
      {
        return this._DalObject.tad_cconfig;
      }
      set
      {
        this._DalObject.tad_cconfig = value;
      }
    }
    ...
    public string tad_cmetadata
    {
      get
      {
        return this._DalObject.tad_cmetadata;
      }
      set
      {
        this._DalObject.tad_cmetadata = value;
      }
    }
    ...
    public Spet_autoridaddestino(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spet_autoridaddestino(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spet_autoridaddestino(SqlHelper SqlConfig, int UserId, Simplet_autoridaddestino Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplet_autoridaddestino Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The t_autoridaddestino has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalt_autoridaddestino GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The t_autoridaddestino is null.");
    ...
    {
      this._DalObject = new Dalt_autoridaddestino(SqlConfig, UserId);
    ...
    {
      t_autoridaddestino autoridaddestino = (t_autoridaddestino) Object;
