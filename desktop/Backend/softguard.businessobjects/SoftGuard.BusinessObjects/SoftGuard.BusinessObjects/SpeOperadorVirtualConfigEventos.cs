...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeOperadorVirtualConfigEventos : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalOperadorVirtualConfigEventos _DalObject;
 ...
 ///<summary>
     ...
     public int  ove_iOperadorVirtualConfigId 
		 { 
                    ...
                    get{ return this._DalObject.ove_iOperadorVirtualConfigId; }
        						set{ this._DalObject.ove_iOperadorVirtualConfigId = value; } 										
	   }
	  ///<summary>
     ...
     public string  ove_cEvento 
		 { 
                    ...
                    get{ return this._DalObject.ove_cEvento; }
        						set{ this._DalObject.ove_cEvento = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeOperadorVirtualConfigEventos(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeOperadorVirtualConfigEventos(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeOperadorVirtualConfigEventos(SqlHelper SqlConfig, int UserId, SimpleOperadorVirtualConfigEventos Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleOperadorVirtualConfigEventos Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The OperadorVirtualConfigEventos has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalOperadorVirtualConfigEventos GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The OperadorVirtualConfigEventos is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalOperadorVirtualConfigEventos(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.OperadorVirtualConfigEventos)Object;
			o.Name = this.Name;

			o.ove_iOperadorVirtualConfigId = this.ove_iOperadorVirtualConfigId;

			o.ove_cEvento = this.ove_cEvento;
