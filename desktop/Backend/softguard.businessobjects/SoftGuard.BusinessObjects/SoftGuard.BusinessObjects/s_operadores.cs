...
// Type: SoftGuard.BusinessObjects.s_operadores
...
{
  public class s_operadores : Spes_operadores
  {
    public s_operadores(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public s_operadores(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public s_operadores(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public s_operadores(SqlHelper SqlConfig, int UserId, Simples_operadores Simple)
