...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spet_WeSafeFunctionsOptions : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalt_WeSafeFunctionsOptions _DalObject;
 ...
 ///<summary>
     ...
     public int  wco_idKey 
		 { 
                    ...
                    get{ return this._DalObject.wco_idKey; }
        						set{ this._DalObject.wco_idKey = value; } 										
	   }
	  ///<summary>
     ...
     public string  wco_cDescripcion 
		 { 
                    ...
                    get{ return this._DalObject.wco_cDescripcion; }
        						set{ this._DalObject.wco_cDescripcion = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spet_WeSafeFunctionsOptions(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_WeSafeFunctionsOptions(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spet_WeSafeFunctionsOptions(SqlHelper SqlConfig, int UserId, Simplet_WeSafeFunctionsOptions Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplet_WeSafeFunctionsOptions Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The t_WeSafeFunctionsOptions has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalt_WeSafeFunctionsOptions GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The t_WeSafeFunctionsOptions is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalt_WeSafeFunctionsOptions(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.t_WeSafeFunctionsOptions)Object;
			o.Name = this.Name;

			o.wco_idKey = this.wco_idKey;

			o.wco_cDescripcion = this.wco_cDescripcion;
