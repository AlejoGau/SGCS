...
{ 
   ///<summary>
     ///t_gatewaysmsg class   
     ///</summary>
    public partial class t_gatewaysmsg : Spet_gatewaysmsg
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_gatewaysmsg(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_gatewaysmsg(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_gatewaysmsg(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_gatewaysmsg(SqlHelper SqlConfig, int UserId, Simplet_gatewaysmsg Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
