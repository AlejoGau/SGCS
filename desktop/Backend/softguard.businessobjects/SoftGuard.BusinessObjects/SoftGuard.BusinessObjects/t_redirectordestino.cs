...
// Type: SoftGuard.BusinessObjects.t_redirectordestino
...
{
  public class t_redirectordestino : Spet_redirectordestino
  {
    public t_redirectordestino(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public t_redirectordestino(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public t_redirectordestino(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public t_redirectordestino(SqlHelper SqlConfig, int UserId, Simplet_redirectordestino Simple)
