...
{ 	
   ///<summary>
     ///Caller object class   
     ///</summary>
    public class CallerSmartPanic : CallerObject
    { 	
 ...
 ///<summary>
     ///Constructor   
     ///</summary>		
        public CallerSmartPanic(int Id, string Name, string Telefono, string Imei, string Modelo, string Marca, string Version, string Tipo, int CuentaId, string Nombre, string Config, int GrupoId, string Linea, int awccUserId, string pushToken, string AppVersion, int AppType) : base()
        {
            base.Id = Id;
						base.Name = Name;				 																																					 
...
Simple.AppType = this._AppType;
 ...
 ///<summary>
     ///Sets a simpleobject   
     ///</summary>	
		public void SetSimpleObject(SimpleSmartPanic Simple)
		{
			base.Id = Simple.Id;
...
this._AppType = Simple.AppType;
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{
			return new DalSmartPanic(SqlConfig, UserId, (SimpleSmartPanic) GetSimpleObject());
		}
 ///<summary>
     ///Get object's data   
     ///</summary>
