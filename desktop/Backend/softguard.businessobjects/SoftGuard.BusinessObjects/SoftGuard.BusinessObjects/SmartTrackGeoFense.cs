...
// Type: SoftGuard.BusinessObjects.SmartTrackGeoFense
...
{
  public class SmartTrackGeoFense : SpeSmartTrackGeoFense
  {
    public SmartTrackGeoFense(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public SmartTrackGeoFense(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public SmartTrackGeoFense(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public SmartTrackGeoFense(SqlHelper SqlConfig, int UserId, SimpleSmartTrackGeoFense Simple)
