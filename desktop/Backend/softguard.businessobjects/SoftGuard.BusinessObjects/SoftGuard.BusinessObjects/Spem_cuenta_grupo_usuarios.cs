...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spem_cuenta_grupo_usuarios : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalm_cuenta_grupo_usuarios _DalObject;
 ...
 ///<summary>
     ...
     ///Constructor   
     ///</summary>
    		public Spem_cuenta_grupo_usuarios(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuenta_grupo_usuarios(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spem_cuenta_grupo_usuarios(SqlHelper SqlConfig, int UserId, Simplem_cuenta_grupo_usuarios Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplem_cuenta_grupo_usuarios Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The m_cuenta_grupo_usuarios has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalm_cuenta_grupo_usuarios GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The m_cuenta_grupo_usuarios is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalm_cuenta_grupo_usuarios(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (m_cuenta_grupo_usuarios)Object;
			o.Name = this.Name;
