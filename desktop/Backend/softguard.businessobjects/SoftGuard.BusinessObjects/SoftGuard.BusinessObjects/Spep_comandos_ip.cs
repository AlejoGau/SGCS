...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class Spep_comandos_ip : ISpecialization, ICanCopyProperties
    { 
	...
	protected Dalp_comandos_ip _DalObject;
 ...
 ///<summary>
     ...
     public DateTime?  cmd_tfechahora 
		 { 
                    ...
                    get{ return this._DalObject.cmd_tfechahora; }
        						set{ this._DalObject.cmd_tfechahora = value; } 										
	   }
	  ///<summary>
     ...
     public int  cmd_idCuenta 
		 { 
                    ...
                    get{ return this._DalObject.cmd_idCuenta; }
        						set{ this._DalObject.cmd_idCuenta = value; } 										
	   }
	  ///<summary>
     ...
     public int  cmd_idReceptor 
		 { 
                    ...
                    get{ return this._DalObject.cmd_idReceptor; }
        						set{ this._DalObject.cmd_idReceptor = value; } 										
	   }
	  ///<summary>
     ...
     public int  cmd_iComando 
		 { 
                    ...
                    get{ return this._DalObject.cmd_iComando; }
        						set{ this._DalObject.cmd_iComando = value; } 										
	   }
	  ///<summary>
     ...
     public string  cmd_cValores 
		 { 
                    ...
                    get{ return this._DalObject.cmd_cValores; }
        						set{ this._DalObject.cmd_cValores = value; } 										
	   }
	  ///<summary>
     ...
     public Decimal  cmd_nEstado 
		 { 
                    ...
                    get{ return this._DalObject.cmd_nEstado; }
        						set{ this._DalObject.cmd_nEstado = value; } 										
	   }
	  ///<summary>
     ...
     public string  cmd_cObservaciones 
		 { 
                    ...
                    get{ return this._DalObject.cmd_cObservaciones; }
        						set{ this._DalObject.cmd_cObservaciones = value; } 										
	   }
	  ///<summary>
     ...
     public int  cmd_iEsCustom 
		 { 
                    ...
                    get{ return this._DalObject.cmd_iEsCustom; }
        						set{ this._DalObject.cmd_iEsCustom = value; } 										
	   }
	  ///<summary>
     ...
     public string  cmd_cAlarmaGenerar 
		 { 
                    ...
                    get{ return this._DalObject.cmd_cAlarmaGenerar; }
        						set{ this._DalObject.cmd_cAlarmaGenerar = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public Spep_comandos_ip(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_comandos_ip(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public Spep_comandos_ip(SqlHelper SqlConfig, int UserId, Simplep_comandos_ip Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(Simplep_comandos_ip Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The p_comandos_ip has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public Dalp_comandos_ip GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The p_comandos_ip is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new Dalp_comandos_ip(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.p_comandos_ip)Object;
			o.Name = this.Name;

			o.cmd_tfechahora = this.cmd_tfechahora;

			o.cmd_idCuenta = this.cmd_idCuenta;

			o.cmd_idReceptor = this.cmd_idReceptor;

			o.cmd_iComando = this.cmd_iComando;

			o.cmd_cValores = this.cmd_cValores;

			o.cmd_nEstado = this.cmd_nEstado;

			o.cmd_cObservaciones = this.cmd_cObservaciones;

			o.cmd_iEsCustom = this.cmd_iEsCustom;

			o.cmd_cAlarmaGenerar = this.cmd_cAlarmaGenerar;
