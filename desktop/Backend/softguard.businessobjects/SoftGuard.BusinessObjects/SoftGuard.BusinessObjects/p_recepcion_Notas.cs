...
// Type: SoftGuard.BusinessObjects.p_recepcion_notas
...
{
  public class p_recepcion_notas : Spep_recepcion_notas
  {
    public p_recepcion_notas(SqlHelper SqlConfig, int UserId)
      : base(SqlConfig, UserId)
    {
    }

    public p_recepcion_notas(SqlHelper SqlConfig, string Token)
      : base(SqlConfig, UserService.GetId(Token))
    {
      this._DalObject.Token = Token ?? UserService.GetContextToken((object) null);
    }

    public p_recepcion_notas(SqlHelper SqlConfig, int UserId, int Id)
      : base(SqlConfig, UserId, Id)
    {
    }

    public p_recepcion_notas(SqlHelper SqlConfig, int UserId, Simplep_recepcion_notas Simple)
