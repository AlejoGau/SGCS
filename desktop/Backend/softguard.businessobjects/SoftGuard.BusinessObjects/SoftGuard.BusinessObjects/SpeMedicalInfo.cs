...
// Type: SoftGuard.BusinessObjects.SpeMedicalInfo
...
{
  public abstract class SpeMedicalInfo : ISpecialization
  {
    private bool _AutoCommit = false;
    protected DalMedicalInfo _DalObject;
    ...
    public int mnf_iidcuenta
    {
      get
      {
        return this._DalObject.mnf_iidcuenta;
      }
      set
      {
        this._DalObject.mnf_iidcuenta = value;
      }
    }
    ...
    public int mnf_iid
    {
      get
      {
        return this._DalObject.mnf_iid;
      }
      set
      {
        this._DalObject.mnf_iid = value;
      }
    }
    ...
    public string mnf_cprotegido
    {
      get
      {
        return this._DalObject.mnf_cprotegido;
      }
      set
      {
        this._DalObject.mnf_cprotegido = value;
      }
    }
    ...
    public string mnf_cdoctor
    {
      get
      {
        return this._DalObject.mnf_cdoctor;
      }
      set
      {
        this._DalObject.mnf_cdoctor = value;
      }
    }
    ...
    public string mnf_cobrasocial
    {
      get
      {
        return this._DalObject.mnf_cobrasocial;
      }
      set
      {
        this._DalObject.mnf_cobrasocial = value;
      }
    }
    ...
    public Decimal mnf_nsexo
    {
      get
      {
        return this._DalObject.mnf_nsexo;
      }
      set
      {
        this._DalObject.mnf_nsexo = value;
      }
    }
    ...
    public Decimal mnf_ndiscapacitado
    {
      get
      {
        return this._DalObject.mnf_ndiscapacitado;
      }
      set
      {
        this._DalObject.mnf_ndiscapacitado = value;
      }
    }
    ...
    public Decimal mnf_nambulancia
    {
      get
      {
        return this._DalObject.mnf_nambulancia;
      }
      set
      {
        this._DalObject.mnf_nambulancia = value;
      }
    }
    ...
    public Decimal mnf_nvivesolo
    {
      get
      {
        return this._DalObject.mnf_nvivesolo;
      }
      set
      {
        this._DalObject.mnf_nvivesolo = value;
      }
    }
    ...
    public DateTime mnf_dfechanacimiento
    {
      get
      {
        return this._DalObject.mnf_dfechanacimiento;
      }
      set
      {
        this._DalObject.mnf_dfechanacimiento = value;
      }
    }
    ...
    public int mnf_nedad
    {
      get
      {
        return this._DalObject.mnf_nedad;
      }
      set
      {
        this._DalObject.mnf_nedad = value;
      }
    }
    ...
    public string mnf_tobservaciones
    {
      get
      {
        return this._DalObject.mnf_tobservaciones;
      }
      set
      {
        this._DalObject.mnf_tobservaciones = value;
      }
    }
    ...
    public string mnf_casociado
    {
      get
      {
        return this._DalObject.mnf_casociado;
      }
      set
      {
        this._DalObject.mnf_casociado = value;
      }
    }
    ...
    public SpeMedicalInfo(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public SpeMedicalInfo(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public SpeMedicalInfo(SqlHelper SqlConfig, int UserId, SimpleMedicalInfo Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(SimpleMedicalInfo Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The MedicalInfo has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public DalMedicalInfo GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The MedicalInfo is null.");
    ...
    {
      this._DalObject = new DalMedicalInfo(SqlConfig, UserId);
