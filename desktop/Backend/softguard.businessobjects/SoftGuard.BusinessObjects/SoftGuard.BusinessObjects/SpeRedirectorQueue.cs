...
{ 
   ///<summary>
     ...
     ///</summary>
    public abstract class SpeRedirectorQueue : ISpecialization, ICanCopyProperties
    { 
	...
	protected DalRedirectorQueue _DalObject;
 ...
 ///<summary>
     ...
     public int  rdq_iReDirector 
		 { 
                    ...
                    get{ return this._DalObject.rdq_iReDirector; }
        						set{ this._DalObject.rdq_iReDirector = value; } 										
	   }
	  ///<summary>
     ///rdq_idRec property   
     ///</summary>	
     public int  rdq_idRec 
		 { 
                    ...
                    get{ return this._DalObject.rdq_idRec; }
        						set{ this._DalObject.rdq_idRec = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  rdq_tFechaHora 
		 { 
                    ...
                    get{ return this._DalObject.rdq_tFechaHora; }
        						set{ this._DalObject.rdq_tFechaHora = value; } 										
	   }
	  ///<summary>
     ...
     public string  rdq_cLlamado 
		 { 
                    ...
                    get{ return this._DalObject.rdq_cLlamado; }
        						set{ this._DalObject.rdq_cLlamado = value; } 										
	   }
	  ///<summary>
     ...
     public string  rdq_cRespuesta 
		 { 
                    ...
                    get{ return this._DalObject.rdq_cRespuesta; }
        						set{ this._DalObject.rdq_cRespuesta = value; } 										
	   }
	  ///<summary>
     ...
     public int  rdq_iStatus 
		 { 
                    ...
                    get{ return this._DalObject.rdq_iStatus; }
        						set{ this._DalObject.rdq_iStatus = value; } 										
	   }
	  ///<summary>
     ...
     public DateTime?  rdq_tStatusExec 
		 { 
                    ...
                    get{ return this._DalObject.rdq_tStatusExec; }
        						set{ this._DalObject.rdq_tStatusExec = value; } 										
	   }
	  ///<summary>
     ///Constructor   
     ///</summary>
    		public SpeRedirectorQueue(SqlHelper SqlConfig, int UserId)
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeRedirectorQueue(SqlHelper SqlConfig, int UserId, int Id)
    		{
    			InitClass(SqlConfig, UserId);        			
			    Load(Id);						
    		}	
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public SpeRedirectorQueue(SqlHelper SqlConfig, int UserId, SimpleRedirectorQueue Simple)
    		{
    			InitClass(SqlConfig, UserId);    			
    			Load(Simple);								
    		}														
 ///<summary>
     ...
     ///Load object data   
     ///</summary>
		public virtual void Load(SimpleRedirectorQueue Simple)
		{
     ...
     ///</summary>
		public virtual void Delete()
		{
			if(this._Relations.Count != 0)
			   throw new RuntimeException("The RedirectorQueue has dependencies.");
 ...
 ///<summary>
     ///Gets a DAL object   
     ///</summary>
		public DalRedirectorQueue GetDalObject()
		{
     ...
     ///</summary>
		public BaseObject NewChild(ISpecialization Child, ValueCollection Values)
		{
			...
			if(this._DalObject.Id == 0)
				throw new InvalidObjectException(this.GetObject(), "The RedirectorQueue is null.");
 ...
 ///<summary>
     ...
     ///</summary>
		...
		{			
			this._DalObject = new DalRedirectorQueue(SqlConfig, UserId);		
 ...
 ///<summary>
     ...
     ///</summary>
        ...
        {
			var o = (SoftGuard.BusinessObjects.RedirectorQueue)Object;
			o.Name = this.Name;

			o.rdq_iReDirector = this.rdq_iReDirector;

			o.rdq_idRec = this.rdq_idRec;

			o.rdq_tFechaHora = this.rdq_tFechaHora;

			o.rdq_cLlamado = this.rdq_cLlamado;

			o.rdq_cRespuesta = this.rdq_cRespuesta;

			o.rdq_iStatus = this.rdq_iStatus;

			o.rdq_tStatusExec = this.rdq_tStatusExec;
