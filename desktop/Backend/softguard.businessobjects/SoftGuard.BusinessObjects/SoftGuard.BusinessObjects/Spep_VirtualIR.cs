...
// Type: SoftGuard.BusinessObjects.Spep_VirtualIR
...
{
  public abstract class Spep_VirtualIR : ISpecialization, ICanCopyProperties
  {
    private bool _AutoCommit = false;
    protected Dalp_VirtualIR _DalObject;
    ...
    public string vir_cDll
    {
      get
      {
        return this._DalObject.vir_cDll;
      }
      set
      {
        this._DalObject.vir_cDll = value;
      }
    }
    ...
    public DateTime? vir_tFechaHora
    {
      get
      {
        return this._DalObject.vir_tFechaHora;
      }
      set
      {
        this._DalObject.vir_tFechaHora = value;
      }
    }
    ...
    public Decimal vir_nStatus
    {
      get
      {
        return this._DalObject.vir_nStatus;
      }
      set
      {
        this._DalObject.vir_nStatus = value;
      }
    }
    ...
    public string vir_cPackage
    {
      get
      {
        return this._DalObject.vir_cPackage;
      }
      set
      {
        this._DalObject.vir_cPackage = value;
      }
    }
    ...
    public Spep_VirtualIR(SqlHelper SqlConfig, int UserId)
    {
      this.InitClass(SqlConfig, UserId);
      this._Taxonomies.Load(this.Security.UserId);
    }

    public Spep_VirtualIR(SqlHelper SqlConfig, int UserId, int Id)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Id);
    }

    public Spep_VirtualIR(SqlHelper SqlConfig, int UserId, Simplep_VirtualIR Simple)
    {
      this.InitClass(SqlConfig, UserId);
      this.Load(Simple);
    }
    ...
    public virtual void Load(Simplep_VirtualIR Simple)
    {
    ...
    public virtual void Delete()
    {
      if (this._Relations.Count != 0)
        throw new RuntimeException("The p_VirtualIR has dependencies.");
      if (this._AutoCommit)
        this.BeginTran();
      try
      {
    ...
    public Dalp_VirtualIR GetDalObject()
    {
    ...
    public BaseObject NewChild(ISpecialization Child, Slbf.ValueCollection Values)
    {
      ...
      if (this._DalObject.Id == 0)
        throw new InvalidObjectException(this.GetObject(), "The p_VirtualIR is null.");
    ...
    {
      this._DalObject = new Dalp_VirtualIR(SqlConfig, UserId);
    ...
    {
      p_VirtualIR pVirtualIr = (p_VirtualIR) Object;
      pVirtualIr.Name = this.Name;
      pVirtualIr.vir_cDll = this.vir_cDll;
      pVirtualIr.vir_tFechaHora = this.vir_tFechaHora;
      pVirtualIr.vir_nStatus = this.vir_nStatus;
      pVirtualIr.vir_cPackage = this.vir_cPackage;
    }
