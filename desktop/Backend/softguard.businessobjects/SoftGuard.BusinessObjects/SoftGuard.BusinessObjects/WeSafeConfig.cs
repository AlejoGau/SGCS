...
{ 
   ///<summary>
     ///WeSafeConfig class   
     ///</summary>
    public partial class WeSafeConfig : SpeWeSafeConfig
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public WeSafeConfig(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public WeSafeConfig(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public WeSafeConfig(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public WeSafeConfig(SqlHelper SqlConfig, int UserId, SimpleWeSafeConfig Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
