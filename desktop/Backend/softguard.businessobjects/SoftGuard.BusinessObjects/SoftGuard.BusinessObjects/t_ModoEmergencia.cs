...
{ 
   ///<summary>
     ///t_ModoEmergencia class   
     ///</summary>
    public partial class t_ModoEmergencia : Spet_ModoEmergencia
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public t_ModoEmergencia(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public t_ModoEmergencia(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_ModoEmergencia(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public t_ModoEmergencia(SqlHelper SqlConfig, int UserId, Simplet_ModoEmergencia Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
