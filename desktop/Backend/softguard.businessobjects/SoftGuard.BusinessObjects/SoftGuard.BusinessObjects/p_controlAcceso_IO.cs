...
{ 
   ///<summary>
     ///p_controlAcceso_IO class   
     ///</summary>
    public partial class p_controlAcceso_IO : Spep_controlAcceso_IO
    {  ///<summary>
     ///Constructor   
     ///</summary>
    		public p_controlAcceso_IO(SqlHelper SqlConfig, int UserId) : base(SqlConfig, UserId)
    		{
    		}
 ...
 ///<summary>
     ///Constructor   
     ///</summary>
    		public p_controlAcceso_IO(SqlHelper SqlConfig, string Token) : base(SqlConfig, Slbf.Security.UserService.GetId(Token))
    		{
 ...
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_controlAcceso_IO(SqlHelper SqlConfig, int UserId, int Id) : base(SqlConfig, UserId, Id)
    		{
    		}
 ///<summary>
     ///Constructor   
     ///</summary>			
    		public p_controlAcceso_IO(SqlHelper SqlConfig, int UserId, Simplep_controlAcceso_IO Simple) : base(SqlConfig, UserId, Simple)
    		{
    		}					
 ///<summary>
     ///Saves object data   
