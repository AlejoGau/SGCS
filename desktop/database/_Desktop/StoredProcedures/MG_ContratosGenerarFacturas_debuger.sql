CREATE OR ALTER PROCEDURE [dbo].[MG_ContratosGenerarFacturas_debuger]
...
declare @te table (totalContratos int,  totalFacturas int)

insert @te values(@totalContratos,2)
