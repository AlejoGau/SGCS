CREATE OR ALTER PROCEDURE [dbo].[UIApplicationByNameWithParent]
              		@Name Varchar(128) = '',
              	...
              	AS
							...
							SELECT Id, Name , [MenuName], [Icon], [SmallComment], [Description], [RazorTemplateId], [Viewport], [Version]
							FROM (
							SELECT t.[Id] Id,  Name , t.[MenuName], t.[Icon], t.[SmallComment], t.[Description], t.[RazorTemplateId], t.[Viewport], t.[Version] , taxo.Id as Taxo,
							ROW_NUMBER() OVER(
