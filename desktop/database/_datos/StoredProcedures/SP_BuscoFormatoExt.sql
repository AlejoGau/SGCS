CREATE OR ALTER PROCEDURE [dbo].[SP_BuscoFormatoExt] @iReceptor Int, @cFormato nVarChar(10), @iCuenta Int, @cZona  nVarChar(10), @cEvento nVarChar(10) AS
--Busca Formato para ModemIII Extendido
--Autor .Pablo O. Canónico 22/02/2011
SET NOCOUNT ON
